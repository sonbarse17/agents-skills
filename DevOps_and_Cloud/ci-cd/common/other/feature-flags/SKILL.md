...
rollout is how you lose a tool you'll need in the next [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md).
...
operational kill switch nobody exercises until the [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md) where it's needed. Both states of
