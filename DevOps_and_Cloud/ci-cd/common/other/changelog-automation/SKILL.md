...
description: Automate changelog generation from commits, PRs, and releases
  following Keep a Changelog format. Use when setting up release workflows,
  generating release notes, or standardizing commit conventions.
tags:
...
- Standardizing [commit](../../git-workflow/commit/SKILL.md) message formats
- Generating [GitHub](../../../github-actions/other/github/SKILL.md)/GitLab release notes
...
## [Commit](../../git-workflow/commit/SKILL.md) Message Examples
...
- **Don't mix changes** - One logical change per [commit](../../git-workflow/commit/SKILL.md)
