...
(SAST scanners, linters, formatters) and code hosting platforms ([GitHub](../../../github-actions/other/github/SKILL.md), GitLab, Bitbucket),
...
- Integrates with [GitHub](../../../github-actions/other/github/SKILL.md) Actions, GitLab CI, [CircleCI](../../../circleci/other/circleci/SKILL.md), and other CI platforms
...
```bash
# Install reviewdog
go install [github](../../../github-actions/other/github/SKILL.md).com/reviewdog/reviewdog/cmd/reviewdog@latest

# Run a security scanner and pipe to reviewdog
bandit -r . -f json | reviewdog -f=bandit -reporter=[github](../../../github-actions/other/github/SKILL.md)-pr-review

# Or use with Semgrep
semgrep --config=auto --json | reviewdog -f=semgrep -reporter=local
```

### [GitHub](../../../github-actions/other/github/SKILL.md) Actions integration:
      ...
      - name: Run Bandit SAST
        ...
        run: |
          ...
          bandit -r . -f json | \
            reviewdog -f=bandit \
                     -name="Bandit SAST" \
                     -reporter=[github](../../../github-actions/other/github/SKILL.md)-pr-review \
                     -filter-mode=added \
                     -fail-on-error
```
...
[Customize](../../../AI_and_Agents/Infrastructure/deploy-model/[customize](../../../DevOps_and_Cloud/Cloud_Providers/azure-skills/skills/microsoft-foundry/models/deploy-model/[customize](../customize/SKILL.md)/SKILL.md)/SKILL.md) reviewdog's behavior using flags:
...
- **API Token Security**: Store [GitHub](../../../github-actions/other/github/SKILL.md)/GitLab tokens in secrets management ([GitHub](../../../github-actions/other/github/SKILL.md) Secrets, GitLab CI/CD variables)
  - Never [commit](../../git-workflow/commit/SKILL.md) tokens to version control
...
- `github_actions_template.yml` - [GitHub](../../../github-actions/other/github/SKILL.md) Actions workflow for multi-tool security scanning
...
- `pre_commit_config.yaml` - Pre-[commit](../../git-workflow/commit/SKILL.md) hook integration
...
# [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) security
bandit -r . -f json | reviewdog -f=bandit -name="[Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) SAST" -reporter=[github](../../../github-actions/other/github/SKILL.md)-pr-review &

# Secrets detection
gitleaks detect --report-format json | reviewdog -f=gitleaks -name="Secret Scan" -reporter=[github](../../../github-actions/other/github/SKILL.md)-pr-review &

# IaC security
checkov -d . -o json | reviewdog -f=checkov -name="IaC Security" -reporter=[github](../../../github-actions/other/github/SKILL.md)-pr-review &
...
grep -nH -R "eval(" . --include="*.py" | \
  reviewdog -f=grep -name="Dangerous Functions" -reporter=[github](../../../github-actions/other/github/SKILL.md)-pr-review

# Custom JSON parser
./custom_security_scanner.py --json | \
  reviewdog -f=rdjson -name="Custom Policy" -reporter=[github](../../../github-actions/other/github/SKILL.md)-pr-review
```

## Integration Points

- **CI/CD Platforms**:
  - [GitHub](../../../github-actions/other/github/SKILL.md) Actions (native action available)
  - GitLab CI/CD
  - [CircleCI](../../../circleci/other/circleci/SKILL.md)
  - [Jenkins](../../../jenkins/other/jenkins/SKILL.md)
  - Azure Pipelines
  - Bitbucket Pipelines
...
- **Code Hosting**:
  - [GitHub](../../../github-actions/other/github/SKILL.md) (PR comments, check runs, annotations)
  - GitLab (MR discussions)
  - Bitbucket (inline comments)
  - Gerrit (review comments)

- **SDLC Integration**:
  - **Pre-[commit](../../git-workflow/commit/SKILL.md) hooks**: Fast local feedback before push
...
**Solution**:
- Verify [GitHub](../../../github-actions/other/github/SKILL.md) token has correct permissions (`repo` scope for private repos, `public_repo` for public)
...
runner:
  bandit:
    cmd: bandit -r . -f json
    format: bandit
    name: [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) Security
    level: warning
...
semgrep --config "p/owasp-top-ten" --json | \
  reviewdog -f=semgrep -name="OWASP Top 10" -reporter=[github](../../../github-actions/other/github/SKILL.md)-pr-review

# Include CWE references in comments
reviewdog -f=semgrep -name="CWE Analysis" -reporter=[github](../../../github-actions/other/github/SKILL.md)-pr-review
```

## References

- [Reviewdog Documentation](https://[github](../../../github-actions/other/github/SKILL.md).com/reviewdog/reviewdog)
- [Supported Tools and Formats](https://reviewdog.[github](../../../github-actions/other/github/SKILL.md).io/supported-tools)
- [GitHub Actions Integration](https://[github](../../../github-actions/other/github/SKILL.md).com/reviewdog/action-setup)
