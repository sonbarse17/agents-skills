...
description: Master advanced Git workflows including rebasing, cherry-picking,
  bisect, worktrees, and reflog to maintain clean history and recover from any
...
Detailed pattern documentation lives in `../../../references/git-advanced-workflows_details.md`. Read that file when the navigation tier above is insufficient.
