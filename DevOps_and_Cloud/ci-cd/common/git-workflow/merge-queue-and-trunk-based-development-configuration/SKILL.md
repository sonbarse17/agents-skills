...
**merge queue** ([GitHub](../../../github-actions/other/github/SKILL.md)'s native merge queue, or a bot like Mergify)
...
- A team's merge-to-`main` rate is high enough that "PR passed CI, but
  ...
  are recurring.
- Setting up [GitHub](../../../github-actions/other/github/SKILL.md)'s native merge queue or a Mergify configuration for
...
- For [GitHub](../../../github-actions/other/github/SKILL.md)'s native merge queue: a [GitHub](../../../github-actions/other/github/SKILL.md) repository with branch
  protection enabled and at least one required status check configured;
  [GitHub](../../../github-actions/other/github/SKILL.md) merge queue is available on [GitHub](../../../github-actions/other/github/SKILL.md) Team/Enterprise plans for
  private repos (public repos on any plan) — confirm current plan
  eligibility before assuming availability.
- For Mergify: a Mergify [GitHub](../../../github-actions/other/github/SKILL.md) App (or GitLab equivalent) installed on the
...
1. **Enable [GitHub](../../../github-actions/other/github/SKILL.md)'s native merge queue on the protected branch**, requiring
   ...
   ```
   When a PR is added to the queue, [GitHub](../../../github-actions/other/github/SKILL.md) creates a temporary merge
   [commit](../commit/SKILL.md) combining it with the current `main` (and, depending on batch
...
2. **Configure Mergify as an equivalent (or [GitHub](../../../github-actions/other/github/SKILL.md) Enterprise-independent)
...
8. **Set a queue timeout and a clear failure path** for a PR that fails
   ...
   queue (both [GitHub](../../../github-actions/other/github/SKILL.md)'s merge queue and Mergify do this by default) and the
...
- Prefer squash-merge for a clean, linear `main` history when using a merge
  queue — it keeps the trunk's [commit](../commit/SKILL.md) history readable and avoids
  merge-[commit](../commit/SKILL.md) noise from queue batching mechanics.
...
has several feature branches open for 2+ weeks. They adopt [GitHub](../../../github-actions/other/github/SKILL.md)'s merge
