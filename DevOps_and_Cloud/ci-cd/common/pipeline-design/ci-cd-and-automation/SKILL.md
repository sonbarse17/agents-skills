...
## [GitHub](../../../github-actions/other/github/SKILL.md) Actions Configuration

### Basic CI Pipeline

```yaml
# .[github](../../../github-actions/other/github/SKILL.md)/workflows/ci.yml
name: CI
  ...
  integration:
    ...
    steps:
      ...
      - name: Run migrations
        ...
        env:
          DATABASE_URL: [postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://ci_user:${{ secrets.CI_DB_PASSWORD }}@localhost:5432/testdb
...
deploy-preview:
  runs-on: ubuntu-latest
  if: [github](../../../github-actions/other/github/SKILL.md).event_name == 'pull_request'
  steps:
    - uses: actions/checkout@v4
    - name: Deploy preview
...
CI secrets          → Stored in [GitHub](../../../github-actions/other/github/SKILL.md) Secrets / [vault](../../../../Security/cryptography-secrets/vault/SKILL.md)
Production secrets  → Stored in deployment platform / [vault](../../../../Security/cryptography-secrets/vault/SKILL.md)
```
...
```yaml
# .[github](../../../github-actions/other/github/SKILL.md)/dependabot.yml
version: 2
updates:
...
└── Use larger runners
    └── [GitHub](../../../github-actions/other/github/SKILL.md)-hosted larger runners or self-hosted for CPU-heavy builds
```
