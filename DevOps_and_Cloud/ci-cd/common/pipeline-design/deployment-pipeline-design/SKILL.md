...
Detailed pattern documentation lives in `../../../references/deployment-pipeline-design_details.md`. Read that file when the navigation tier above is insufficient.
...
- [`../../../references/advanced-strategies.md`](../../../references/advanced-strategies.md) — Extended YAML examples, platform-specific configs ([GitHub](../../../github-actions/other/github/SKILL.md) Actions, GitLab CI, Azure Pipelines), multi-region canary patterns, and database migration rollback strategies
