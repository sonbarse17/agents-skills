...
notice and act. OIDC federation ([GitHub](../../../github-actions/other/github/SKILL.md) Actions ↔ AWS/GCP/Azure via workload identity) issues
...
Makefiles, pre-[commit](../../git-workflow/commit/SKILL.md) hooks) as part of the trusted codebase, not incidental tooling.
...
# durable: this exact [commit](../../git-workflow/commit/SKILL.md)'s code, verified once, never silently changes
- uses: actions/checkout@11bd71901bbe5b1630ceea73d27597364c9af683  # v4.2.2
```

**Done when:** every third-party action or reusable workflow the pipeline depends on is pinned to
a [commit](../../git-workflow/commit/SKILL.md) SHA, not a mutable tag.
...
closes the loop with `[artifact-management](../../build/artifact-management/SKILL.md)`'s provenance tracking by making provenance
