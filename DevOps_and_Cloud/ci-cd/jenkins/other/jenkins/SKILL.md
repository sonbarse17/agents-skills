    ...
    stages {
        stage('Deploy') {
            steps {
                withCredentials([
                    usernamePassword(
                        credentialsId: '[github](../../../github-actions/other/github/SKILL.md)-token',
                        usernameVariable: 'GH_USER',
                        passwordVariable: 'GH_TOKEN'
                    )
                ]) {
                    sh 'git push https://${GH_USER}:${GH_TOKEN}@[github](../../../github-actions/other/github/SKILL.md).com/repo.git'
                }
            }
        }
    }
...
- [github-actions](../[github-actions](../[github](../github/SKILL.md)-actions/SKILL.md)/) - [GitHub](../../../github-actions/other/github/SKILL.md) native CI/CD
