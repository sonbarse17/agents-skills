...
Production patterns for Linkerd service mesh - the lightweight, security-first service mesh for [Kubernetes](../kubernetes/SKILL.md).
...
# Install CRDs
linkerd install --crds | [kubectl](../kubectl/SKILL.md) apply -f -

# Install control plane
linkerd install | [kubectl](../kubectl/SKILL.md) apply -f -

# Verify installation
linkerd check

# Install viz extension (optional)
linkerd viz install | [kubectl](../kubectl/SKILL.md) apply -f -
```
...
linkerd multicluster install | [kubectl](../kubectl/SKILL.md) apply -f -

# Link clusters
linkerd multicluster link --cluster-name west \
  --api-server-address https://west.example.com:6443 \
  | [kubectl](../kubectl/SKILL.md) apply -f -

# Export a service to other clusters
[kubectl](../kubectl/SKILL.md) label svc/my-service mirror.linkerd.io/exported=true
...
# View proxy logs
[kubectl](../kubectl/SKILL.md) logs deploy/my-app -c linkerd-proxy
