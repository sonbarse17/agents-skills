...
- **`ImagePullBackOff`**: registry auth or a typo'd tag — see `[container-registry](../container-registry/SKILL.md)`.
...
after an [incident](../../Observability_and_SecOps/incident/SKILL.md).
