...
- `[kubectl](../kubectl/SKILL.md)` and `helm` ≥ 3.8 if the self-hosted-Backstage path is chosen;
...
- **Slimmed Backstage**: a single-replica backend (no HA, since the
  ...
  packaging follows
  [helm-chart-authoring](../../../[kubernetes](../../Containers_and_Orchestration/kubernetes/SKILL.md)-platform/skills/[helm-chart-authoring](../helm-chart-authoring/SKILL.md)/SKILL.md);
...
3. **Phase 3:** One golden-path template is authored: a Dockerfile, a
   single [GitHub](../../../ci-cd/github-actions/other/github/SKILL.md) Actions workflow, and an OpsLevel registration call —
   no tiers.
...
- [helm-chart-authoring](../../../[kubernetes](../../Containers_and_Orchestration/kubernetes/SKILL.md)-platform/skills/[helm-chart-authoring](../helm-chart-authoring/SKILL.md)/SKILL.md), [backstage-plugin-development](../[backstage-plugin-development](../../../Software_Engineering_and_Other/Backend/backstage-plugin-development/SKILL.md)/SKILL.md) — Phase 2 self-hosted path.
