...
| Bulkhead without [monitoring](../../Observability_and_SecOps/monitoring/SKILL.md) | Can't tell when bulkhead is saturated | Monitor pool utilization, queue depth, rejections |
