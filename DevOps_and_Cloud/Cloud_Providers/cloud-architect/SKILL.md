...
description: Designs cloud architectures, creates migration plans, generates
  cost optimization recommendations, and produces disaster recovery strategies
  across AWS, Azure, and GCP. Use when designing cloud architectures, planning
  migrations, or optimizing multi-cloud deployments. Invoke for Well-Architected
  Framework, cost optimization, disaster recovery, landing zones, security
...
metadata:
  ...
  triggers: AWS, Azure, GCP, Google Cloud, cloud migration, cloud architecture,
    multi-cloud, cloud cost, Well-Architected, landing zone, cloud security,
    disaster recovery, cloud native, serverless architecture
  role: architect
  scope: infrastructure
  output-format: architecture
  related-skills: devops-engineer, kubernetes-specialist, terraform-engineer,
    security-reviewer, microservices-architect, monitoring-expert
tags:
  - cloud_providers
  - cloud-architect
depends_on: []
...
6. **Operate** — Set up [monitoring](../../Observability_and_SecOps/monitoring/SKILL.md), automation, continuous optimization
...
| [Multi-Cloud](../multi-cloud/SKILL.md) | `../../../Global_References/[multi-cloud](../multi-cloud/SKILL.md).md` | Abstraction layers, portability, vendor lock-in mitigation |
...
- Use infrastructure as code (Terraform, [CloudFormation](../../Infrastructure_as_Code/cloudformation/SKILL.md))
- Enable cost allocation tags and [monitoring](../../Observability_and_SecOps/monitoring/SKILL.md)
...
- Deploy without proper [monitoring](../../Observability_and_SecOps/monitoring/SKILL.md)
...
[Documentation](https://jeffallan.[github](../../CI_CD/github/SKILL.md).io/claude-skills/skills/infrastructure/cloud-architect/)
