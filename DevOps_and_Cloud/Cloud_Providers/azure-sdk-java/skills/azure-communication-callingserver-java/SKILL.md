...
description: Azure Communication Services CallingServer (legacy) Java SDK. Note
  ...
  new projects. Only use this skill when maintaining legacy code.
license: MIT
metadata:
  author: Microsoft
  version: 1.0.0
...
See the `[azure-communication-callautomation-java](../../../[azure-communication-callautomation-java](../azure-communication-callautomation-java/SKILL.md)/SKILL.md)` skill for:
