...
|----------|-------------|
| Run `azd up` or execute an existing deployment | `[azure-deploy](../[azure-deploy](../../../../Infrastructure_as_Code/azure-deploy/SKILL.md)/SKILL.md)` |
| Optimize existing Azure spend | `[azure-cost](../../../[azure-cost](../azure-cost/SKILL.md)/SKILL.md)` |
| Generate Bicep/Terraform for a known architecture | `[azure-prepare](../../../[azure-prepare](../azure-prepare/SKILL.md)/SKILL.md)` |
| Validate infrastructure or run preflight checks | `[azure-validate](../[azure-validate](../../../azure-validate/SKILL.md)/SKILL.md)` |
| Troubleshoot a running Azure deployment | `[azure-diagnostics](../../../[azure-diagnostics](../azure-diagnostics/SKILL.md)/SKILL.md)` |
| Deploy to or manage AKS/[Kubernetes](../../../../Containers_and_Orchestration/kubernetes/SKILL.md) directly | `[azure-kubernetes](../[azure-kubernetes](../../../../Containers_and_Orchestration/azure-[kubernetes](../../../../Containers_and_Orchestration/kubernetes/SKILL.md)/SKILL.md)/SKILL.md)` |
| Look up or list existing Azure resources | `[azure-resource-lookup](../../../[azure-resource-lookup](../azure-resource-lookup/SKILL.md)/SKILL.md)` |

## Pipeline Rules

> ⛔ **You MUST read [`../../../../../Global_References/pipeline-rules.md`](../../../../../Global_References/pipeline-rules.md) at the start of every AppOnboard session.** It contains approval gates, phase lifecycle, session artifacts, deploy-as-is, and security baseline rules.

## Workflow

> ⛔ **Deploy recovery:** After deploy gate approval OR before any `az deployment`/`az webapp deploy`/`az acr build` — if you haven't read `deploy/SKILL.md`, read `.copilot-azure/sessions/{id}/deploy-checklist.md` first, then `deploy/SKILL.md`. ⛔ NEVER invoke `{"skill": "[azure-deploy](../[azure-deploy](../../../../Infrastructure_as_Code/azure-deploy/SKILL.md)/SKILL.md)"}` — that is a DIFFERENT skill for a DIFFERENT workflow.
...
| 3 | **Prereq scan** | ⛔ Skip if `completedPhases` includes `"prereq"`. Otherwise: invoke `{"skill": "[azure-app-onboard-prereq](../[azure-app-onboard-prereq](../../../../Containers_and_Orchestration/[azure-app-onboard](../../../azure-app-onboard/SKILL.md)-prereq/SKILL.md)/SKILL.md)"}`. Write `prereq-output.json`, update `context.json`. **Halt if:** `overallHealth: "blocked"` OR `routeToSkill` set. | |
...
| 8 | **Deploy approval gate** | Display validation summary. ⛔ After approval: FIRST read deploy-checklist.md → deploy/SKILL.md. NEVER `{"skill": "[azure-deploy](../[azure-deploy](../../../../Infrastructure_as_Code/azure-deploy/SKILL.md)/SKILL.md)"}`. | ⛔ Read [approval-gates.md](../../../../../Global_References/approval-gates.md) § Deploy Gate |
...
> **Shared references:** [MCP tools](../../../../../Global_References/mcp-tool-reference.md) (cross-phase tool parameters) | [IaC resources](../../../../../Global_References/iac-resources.md) (Azure resource docs for troubleshooting)
