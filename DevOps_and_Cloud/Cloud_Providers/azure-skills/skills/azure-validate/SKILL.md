...
>
> **[azure-prepare](../../../[azure-prepare](../azure-prepare/SKILL.md)/SKILL.md)** was invoked and completed → `.azure/deployment-plan.md` exists with status `Approved` or later
>
> If the plan is missing, **STOP IMMEDIATELY** and invoke **[azure-prepare](../../../[azure-prepare](../azure-prepare/SKILL.md)/SKILL.md)** first.
>
> The complete workflow ensures success:
>
> `[azure-prepare](../../../[azure-prepare](../azure-prepare/SKILL.md)/SKILL.md)` → `[azure-validate](../../../azure-validate/SKILL.md)` → `[azure-deploy](../[azure-deploy](../../../../Infrastructure_as_Code/azure-deploy/SKILL.md)/SKILL.md)`
...
1. Run after [azure-prepare](../../../[azure-prepare](../azure-prepare/SKILL.md)/SKILL.md), before [azure-deploy](../[azure-deploy](../../../../Infrastructure_as_Code/azure-deploy/SKILL.md)/SKILL.md)
...
Each run prints the next action and the value to pass next. Perform the action, then re-run with that value (`-CompletedStep <value>` for pwsh, `--completed-step <value>` for bash). Repeat until it reports the [azure-validate](../../../azure-validate/SKILL.md) workflow is complete.
...
> - **If the user explicitly requested deployment**, you **MUST** invoke **[azure-deploy](../[azure-deploy](../../../../Infrastructure_as_Code/azure-deploy/SKILL.md)/SKILL.md)** to execute it. Do NOT run `azd up`, `azd deploy`, or any deployment commands directly — let [azure-deploy](../[azure-deploy](../../../../Infrastructure_as_Code/azure-deploy/SKILL.md)/SKILL.md) handle execution.
> - **If the user only asked to validate or prepare** (not deploy), STOP after recording proof and setting status to `Validated`. Report the validation results and do NOT invoke [azure-deploy](../[azure-deploy](../../../../Infrastructure_as_Code/azure-deploy/SKILL.md)/SKILL.md).
>
> If any validation failed, fix the issues and re-run [azure-validate](../../../azure-validate/SKILL.md) before proceeding.
