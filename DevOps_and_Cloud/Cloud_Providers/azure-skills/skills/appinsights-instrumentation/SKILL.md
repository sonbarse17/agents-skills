...
> **⛔ ADDING COMPONENTS?**
>
> If the user wants to **add App Insights to their app**, invoke **[azure-prepare](../../../[azure-prepare](../azure-prepare/SKILL.md)/SKILL.md)** instead.
> This skill provides reference material—[azure-prepare](../../../[azure-prepare](../azure-prepare/SKILL.md)/SKILL.md) orchestrates the actual changes.

## When to Use This Skill

- User asks **how** to instrument (guidance, patterns, examples)
- User needs SDK setup instructions
- [azure-prepare](../../../[azure-prepare](../azure-prepare/SKILL.md)/SKILL.md) invokes this skill during research phase
- User wants to understand App Insights concepts

## When to Use [azure-prepare](../../../[azure-prepare](../azure-prepare/SKILL.md)/SKILL.md) Instead
