...
# Azure Quotas - Service Limits & [Capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) Management

> **AUTHORITATIVE GUIDANCE** — Follow these instructions exactly for quota management and [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) validation.
...
- Represent **available [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md)** in each region
...
- **Planning a new deployment** - Validate [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) before deployment
...
- **Comparing regional [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md)** - Find regions with available quota
...
| **Complete CLI Reference** | [commands.md](./../../../Global_References/commands.md) |
...
> **📖 Detailed mapping examples and workflow:** See [commands.md - Resource Name Mapping](./../../../Global_References/commands.md#resource-name-mapping)

## Scripts

Pre-built scripts handle quota extension installation, usage queries, and [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) calculation. Use these instead of constructing commands manually. A single call returns limits, usage, and available [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md).

| Script | Purpose | Usage |
|--------|---------|-------|
| `scripts/check-quota.ps1` | Returns limit, usage, and available [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) for all quotas (or a single quota when resource name is provided) | Primary script for quota checks |
...
Run the script with the resource provider and region. It returns a table of **all** quotas with their limit, current usage, and available [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) in a single call:
...
> **📖 See also:** [az quota show](./../../../Global_References/commands.md#az-quota-show), [az quota usage show](./../../../Global_References/commands.md#az-quota-usage-show)

### Workflow 2: Compare Quotas Across Regions

**Scenario:** Find the best region for deployment based on available [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md)
...
> **📖 See also:** [commands.md](./../../../Global_References/commands.md#az-quota-show) for full scripted multi-region loop patterns
...
> **📖 See also:** [az quota update](./../../../Global_References/commands.md#az-quota-update), [az quota request status](./../../../Global_References/advanced-commands.md#az-quota-request-status-list)
...
> **📖 See also:** [az quota list](./../../../Global_References/commands.md#az-quota-list)
...
> **📖 See also:** [Troubleshooting Guide](./../../../Global_References/commands.md#troubleshooting)

## Additional Resources

| Resource | Link |
|----------|------|
| **CLI Commands Reference** | [commands.md](./../../../Global_References/commands.md) - Complete syntax, parameters, examples |
...
3. ✅ **Compare regions** - Find regions with available [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md)
