...
4. **Phase 4 — experiment tracking.** Stand up MLflow (self-hosted on EKS,
   ...
   store) per
   [experiment-tracking](../[experiment-tracking](../../../Data_Engineering/experiment-tracking/SKILL.md)/SKILL.md), **before** any
...
5. **Phase 5 — feature store (if the use case needs point-in-time-correct
   ...
   [feature-store-design](../[feature-store-design](../../../Data_Engineering/feature-store-design/SKILL.md)/SKILL.md). Skip this
