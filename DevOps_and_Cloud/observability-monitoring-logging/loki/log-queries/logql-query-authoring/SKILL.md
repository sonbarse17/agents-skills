...
5. **Turn a log stream into a metric query for [dashboards](../../../common/dashboard-design/dashboards/SKILL.md)/alerts** using
...
- **Symptom:** An ad hoc investigation query run directly against
  production during an active [incident](../../../common/incident-detection/incident/SKILL.md) makes Loki itself slow to respond
  for everyone, compounding the [incident](../../../common/incident-detection/incident/SKILL.md).
  **Fix:** This is exactly the unbounded-query risk — an under-scoped
  selector with a wide time range and a regex filter run under
  [incident](../../../common/incident-detection/incident/SKILL.md)-time pressure. Scope by every known label, keep the range as
  ...
  as a red flag during a live [incident](../../../common/incident-detection/incident/SKILL.md), not a shortcut.
...
**Scenario:** During an [incident](../../../common/incident-detection/incident/SKILL.md), `payments-api` is returning elevated
