...
- Integrating logs with Grafana [dashboards](../../../common/dashboard-design/dashboards/SKILL.md)
...
helm install loki grafana/loki-stack \
  --namespace [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md) \
  --create-namespace \
