...
# Kibana [Dashboards](../../../common/dashboard-design/dashboards/SKILL.md) and Visualizations

## Overview

The Kibana [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) and visualizations APIs provide a declarative, Git-friendly format for defining [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) and
...
> as inline panels within [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) using the Dashboard API.
>
> **Inline vs Saved Object References:** When embedding visualization panels in [dashboards](../../../common/dashboard-design/dashboards/SKILL.md), prefer inline definitions
...
Kibana connection is configured via environment variables. Run `node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js test` to verify the
...
Then run `node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js test` to verify the connection.
...
node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js test

# Dashboard operations
node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js dashboard get <id>
echo '<json>' | node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js dashboard create -
echo '<json>' | node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js dashboard update <id> -
node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js dashboard delete <id>
echo '<json>' | node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js dashboard upsert <id> -

# Visualization operations (standalone saved objects)
node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js vis list
node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js vis get <id>
echo '<json>' | node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js vis create -
echo '<json>' | node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js vis update <id> -
node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js vis delete <id>
echo '<json>' | node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js vis upsert <id> -
```

## [Dashboards](../../../common/dashboard-design/dashboards/SKILL.md) API
...
Use inline definitions (properties directly in `config`) for self-contained, portable [dashboards](../../../common/dashboard-design/dashboards/SKILL.md):
...
[Dashboards](../../../common/dashboard-design/dashboards/SKILL.md) use a **48-column, infinite-row grid**. On 16:9 screens, approximately **20-24 rows** are visible without
...
[Chart Types Reference](../../../../Global_References/observability-monitoring-logging/chart-types-reference.md) for details.
...
> in [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) via the Dashboard API.
...
For detailed schemas and all chart type options, see [Chart Types Reference](../../../../Global_References/observability-monitoring-logging/chart-types-reference.md).
...
- [Dashboard API Reference](../../../../Global_References/observability-monitoring-logging/dashboard-api-reference.md) — Dashboard endpoints and schemas
- [Visualizations API Reference](../../../../Global_References/observability-monitoring-logging/visualizations-api-reference.md) — Visualization endpoints
- [Chart Types Reference](../../../../Global_References/observability-monitoring-logging/chart-types-reference.md) — Detailed schemas for each chart type
...
1. **Design for density** — Operational [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) must show 8-12 panels above the fold (within the first 24 rows). Use
...
6. **Inline definitions** — Prefer inline properties in `config` over `config.ref_id` for portable [dashboards](../../../common/dashboard-design/dashboards/SKILL.md)
7. **Test connection first** — Run `node scripts/kibana-[dashboards](../../../common/dashboard-design/dashboards/SKILL.md).js test` before creating resources
...
10. **Format numbers with units** — Use the `format` property on metrics and y-axis columns to display proper units
    ...
    `"format": { "type": "bytes", "decimals": 0 }`. See [Chart Types Reference](../../../../Global_References/observability-monitoring-logging/chart-types-reference.md) for
