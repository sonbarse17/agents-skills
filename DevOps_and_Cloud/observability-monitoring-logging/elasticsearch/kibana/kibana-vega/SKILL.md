...
Create and manage Kibana [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) and Vega visualizations with ES|QL data sources.
...
# Create dashboard
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) create "My Dashboard"

# Add visualization with grid position
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) add-panel <dashboard-id> <vis-id> --x 0 --y 0 --w 24 --h 15

# Apply a complete layout from stdin
echo '<layout-json>' | node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) apply-layout <dashboard-id> -
```
...
echo '{"panels":[{"visualization":"<id>","x":0,"y":0,"w":24,"h":10}]}' | \
  node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) apply-layout <dash-id> -
```
...
Kibana [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) use a **48-column grid**:
...
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) add-panel $DASH $VIS1 --x 0 --y 0 --w 24 --h 10
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) add-panel $DASH $VIS2 --x 24 --y 0 --w 24 --h 10

# Row 2: Full-width timeline (above fold)
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) add-panel $DASH $VIS3 --x 0 --y 10 --w 48 --h 12

# Row 3: Below fold content
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) add-panel $DASH $VIS4 --x 0 --y 22 --w 48 --h 12
```
...
```bash
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) apply-layout <dashboard-id> layout.json
```
...
```bash
# [Dashboards](../../../common/dashboard-design/dashboards/SKILL.md)
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) list [search]
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) get <id>
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) create <title>
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) delete <id>
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) add-panel <dash-id> <vis-id> [--x N] [--y N] [--w N] [--h N]
node scripts/kibana-vega.js [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) apply-layout <dash-id> <file|->
