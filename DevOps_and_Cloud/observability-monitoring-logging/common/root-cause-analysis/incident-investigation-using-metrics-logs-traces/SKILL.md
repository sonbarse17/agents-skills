...
# [Incident](../../incident-detection/incident/SKILL.md) Investigation Using Metrics, Logs, and Traces
...
- Coordinating a live [incident](../../incident-detection/incident/SKILL.md) where different responders are looking
...
8. **State a working hypothesis explicitly and look for evidence that
   ...
   live [incident](../../incident-detection/incident/SKILL.md) it's easy to stop investigating the moment a plausible
...
10. **After the [incident](../../incident-detection/incident/SKILL.md), check whether the cross-signal pivot was
...
- Narrow every log/trace query to the metrics-derived time window
  ...
  wide, unscoped query during an active [incident](../../incident-detection/incident/SKILL.md) risks becoming its
...
- Treat a missing cross-signal pivot (no trace instrumentation on an
  ...
  [incident](../../incident-detection/incident/SKILL.md) as a concrete follow-up action, not an accepted permanent
  gap.
...
- **Symptom:** The same class of [incident](../../incident-detection/incident/SKILL.md) recurs weeks later, and the
...
- **Symptom:** An ad hoc, broad log query run directly against
  production during an active [incident](../../incident-detection/incident/SKILL.md) makes the log backend itself
  slow, compounding the [incident](../../incident-detection/incident/SKILL.md) for everyone.
  **Fix:** This is the unbounded-query risk covered in
  ...
  grep everything" as a red flag during a live [incident](../../incident-detection/incident/SKILL.md), not a
  shortcut.
...
8. **Document:** the PromQL query, the trace ID, the specific log line,
   and the deploy correlation are all recorded in the [incident](../../incident-detection/incident/SKILL.md) channel
