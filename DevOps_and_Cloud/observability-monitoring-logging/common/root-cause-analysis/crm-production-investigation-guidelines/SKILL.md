...
You are investigating a real production [incident](../../incident-detection/incident/SKILL.md) in the CRM application. This is a live production environment serving active sales teams.
...
The three possible [incident](../../incident-detection/incident/SKILL.md) titles are:
...
4. Do NOT conclude that the new [incident](../../incident-detection/incident/SKILL.md) is a symptom or side effect of an existing investigation.
...
Every [incident](../../incident-detection/incident/SKILL.md) is real and requires thorough investigation. Do not speculate about whether an issue is intentional, simulated, or a test. Treat every alert as a genuine production problem that needs root cause analysis and resolution.
...
Follow the evidence. Use CloudWatch Logs, CloudTrail, CloudWatch Metrics, and [Datadog](../../../datadog/other/datadog/SKILL.md) to trace the timeline of events and identify what changed.
...
- API: REST API via API Gateway → Lambda ([Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md))
- Database: Aurora DSQL ([PostgreSQL](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)-compatible) behind RDS Proxy
...
- [Monitoring](../../monitoring-strategy/monitoring/SKILL.md): CloudWatch Metrics, CloudWatch Logs, [Datadog](../../../datadog/other/datadog/SKILL.md)
