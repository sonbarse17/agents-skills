...
decision made in advance rather than an argument during an [incident](../../incident-detection/incident/SKILL.md). This
...
with real teeth, and [alerting](../../alerting/alerting/SKILL.md) on budget *burn rate* — not just breach at
the end of the window — so a fast-burning [incident](../../incident-detection/incident/SKILL.md) pages someone while
...
- A metrics pipeline that can compute request-level success/failure and
  ...
  skill for the underlying scrape/PromQL/[alerting](../../alerting/alerting/SKILL.md) mechanics; this skill
...
4. **Write an error-budget policy with explicit thresholds and actions.**
   ...
   | >100% (budget exhausted) | Mandatory [incident](../../incident-detection/incident/SKILL.md) postmortem (see [blameless-postmortem-and-root-cause-analysis](../[blameless-postmortem-and-root-cause-analysis](../blameless-postmortem-and-[root-cause-analysis](../../../DevOps_and_Cloud/Observability_and_SecOps/root-cause-analysis/SKILL.md)/SKILL.md)/SKILL.md)) and leadership sign-off required to resume feature launches, even after the rolling window recovers. |
...
- **Symptom:** The team only discovers an SLO breach when someone
  manually checks the dashboard at month-end, days after the [incident](../../incident-detection/incident/SKILL.md)
  that caused it.
  **Fix:** No burn-rate [alerting](../../alerting/alerting/SKILL.md) exists — only an end-of-window
