...
Search and filter logs to support [incident](../../incident-detection/incident/SKILL.md) investigation. The workflow mirrors Kibana Discover: apply a time range and
...
Use consistent names for [Observability](../../fundamentals/observability/SKILL.md) log search:
...
`[kubernetes](../../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md).namespace`. Query ECS names only; [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) aliases map automatically in [Observability](../../fundamentals/observability/SKILL.md) indices.
...
`event.original`, `exception.message`, `error.exception.message`, `attributes.exception.message` (OTel). [Observability](../../fundamentals/observability/SKILL.md)
