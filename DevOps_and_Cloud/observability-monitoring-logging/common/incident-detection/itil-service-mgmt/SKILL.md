...
## Purpose
Guides IT service management practice using the ITIL 4 framework across the full service lifecycle including [incident](../incident/SKILL.md), problem, change, release, and service level management.
...
Service Management Practices: Availability management, business analysis, [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../../../DevOps_and_Cloud/Cloud_Providers/azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../../DevOps_and_Cloud/Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) and performance management, change enablement, [incident](../incident/SKILL.md) management, IT asset management, [monitoring](../../monitoring-strategy/monitoring/SKILL.md) and event management, problem management, release management, service catalog management, service configuration management, service continuity management, service design, service desk, service level management, service request management, service validation and testing.
...
Level 1 - Initial: Processes are ad hoc and reactive. Success depends on individual heroics. No consistent [incident](../incident/SKILL.md), problem, or change management.

Level 2 - Repeatable: Basic processes documented for [incident](../incident/SKILL.md), problem, and change management. Some consistency but not integrated. Metrics are basic (ticket counts, resolution times).
...
Level 5 - Optimizing: Continuous process improvement based on quantitative feedback. IT and business strategy tightly aligned. Innovation-driven rather than [incident](../incident/SKILL.md)-driven. Proactive service management culture.

## Architecture / Decision Trees

### [Incident](../incident/SKILL.md) Priority Matrix
...
Emergency Change: Urgent fix for active [incident](../incident/SKILL.md)
...
```
[Incident](../incident/SKILL.md) -> Problem: recurring incidents trigger problem investigation
...
[Incident](../incident/SKILL.md) -> Change: emergency change may be needed for [incident](../incident/SKILL.md) resolution
Service Level -> [Incident](../incident/SKILL.md): SLA targets define [incident](../incident/SKILL.md) priority and response time
```

## Agent Protocol

### Trigger
Exact user phrases: ITIL, service management, [incident](../incident/SKILL.md), problem, change management, release, service level, SLA, service strategy, service design, service transition, service operation, CSI, continual improvement.
...
- [ ] [Incident](../incident/SKILL.md) priority matrix defined with SLA targets
...
Integrate [incident](../incident/SKILL.md), problem, change, release, and service level processes. Maintain process interfaces and handoffs. Ensure process consistency and tool integration. Conduct periodic process maturity assessments.
...
Pitfall 4: [Incident](../incident/SKILL.md) management without problem management. Fixing incidents without investigating root causes leads to repeat incidents and firefighting culture. Problem management breaks the cycle.
...
Practice 1: Start with the highest-pain processes. Assess which ITIL process gaps cause the most operational pain. Fix those first. For most organizations, [incident](../incident/SKILL.md) and problem management are the highest impact.
...
Practice 4: Measure what matters. Link process KPIs to business outcomes. [Incident](../incident/SKILL.md) resolution time matters less if the business impact is low. Focus on business-impacting metrics: customer-facing downtime, revenue-impacting incidents, SLA breach rate.

Practice 5: Hold regular process review meetings. [Incident](../incident/SKILL.md) review weekly, problem review bi-weekly, change advisory board weekly, CAB/emergency review monthly, CSI review quarterly.
...
|------------------|-------------------------------|----------------------|
| [Incident](../incident/SKILL.md)         | Mean Time to Resolve (MTTR)   | < 4 hours (P1/P2)    |
| [Incident](../incident/SKILL.md)         | First Response Time           | < 15 min (P1)        |
| [Incident](../incident/SKILL.md)         | SLA Breach Rate               | < 2%                 |
| Problem          | Problem-to-[Incident](../incident/SKILL.md) Ratio     | > 1:10               |
...
|-----------------|-----------------|-----------------|
| [Incident](../incident/SKILL.md) Management | [Incident](../incident/SKILL.md) Management | Added AI/automation, shifted to value focus |
...
- PagerDuty / OpsGenie for [incident](../incident/SKILL.md) management and escalation
- Microsoft Teams / Slack for collaboration and notifications
- Lucidchart for process documentation
- Grafana / Splunk for [monitoring](../../monitoring-strategy/monitoring/SKILL.md) and event management

## Case Studies

### Case Study 1: [Incident](../incident/SKILL.md)-to-Problem Transformation
A SaaS company was firefighting 200+ incidents per month with recurring issues accounting for 60% of volume. Implementing ITIL problem management with known error database reduced recurring incidents by 70% over 6 months. Root cause analysis on the top-10 recurring incidents identified 3 systemic issues. Fixing those eliminated 40% of total [incident](../incident/SKILL.md) volume. Operational costs reduced by 25%.
...
### [Incident](../incident/SKILL.md) Priority Calculator ([Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md))
...
@dataclass
class [Incident](../incident/SKILL.md):
    title: str
    impact: Impact
    urgency: Urgency
    affected_users: int
...
[incident](../incident/SKILL.md) = [Incident](../incident/SKILL.md)("Payment gateway down", Impact.MAJOR, Urgency.CRITICAL, 50000, 50000, datetime.now())
print(f"Priority: {[incident](../incident/SKILL.md).priority()}, Resolution SLA: {[incident](../incident/SKILL.md).sla_target()}")
```
...
### Problem Management Workflow ([Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md))
```[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)
@dataclass
class KnownError:
    id: str
...
### SLA Compliance Calculator ([Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md))
```[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)
@dataclass
class SLAMetric:
    name: str
...
Implementing all ITIL processes in one massive project with a 12-month timeline. By month 8, the business needs have changed and the implemented processes are already outdated. Adopt ITIL iteratively: start with [incident](../incident/SKILL.md) + problem management (highest pain), then add change, then release, then service level.

### Anti-Pattern 2: Process Without Automation
Designing elaborate workflows that require manual ticket routing, manual SLA tracking, and manual escalation. The process collapses under volume. Automate routing, SLA [monitoring](../../monitoring-strategy/monitoring/SKILL.md), notification, and escalation. People should only intervene for judgment decisions.
...
### Anti-Pattern 4: [Incident](../incident/SKILL.md)-Myopic Culture
Tracking [incident](../incident/SKILL.md) metrics but ignoring problem management. The team becomes great at firefighting but never reduces the fire load. Every P1 and recurring P2 [incident](../incident/SKILL.md) must trigger a problem record. Track problem-to-[incident](../incident/SKILL.md) ratio as a KPI.
...
- Major incidents require immediate escalation to [incident](../incident/SKILL.md) manager and CAB.
...
- [Incident](../incident/SKILL.md) response time measured from ticket creation to first responder assignment.
...
```yaml
# [Incident](../incident/SKILL.md) Management Process Definition
incident_management:
  process_owner: [incident](../incident/SKILL.md)-manager@example.com
  triggers:
    - "User reports service disruption"
    - "[Monitoring](../../monitoring-strategy/monitoring/SKILL.md) alert fires"
    - "Automated health check failure"
    - "Vendor reports [incident](../incident/SKILL.md)"
  process_flow:
    1: { step: "Log and categorize", owner: "service-desk", target_sla: "5min" }
    2: { step: "Initial diagnosis", owner: "l1-support", target_sla: "15min" }
    3: { step: "Priority assignment", owner: "[incident](../incident/SKILL.md)-manager", target_sla: "10min" }
    4: { step: "P1/P2 escalation", owner: "[incident](../incident/SKILL.md)-manager", target_sla: "5min", channel: "pagerduty" }
    ...
    7: { step: "[Incident](../incident/SKILL.md) closure", owner: "service-desk", criteria: "user-confirms-resolution" }
    8: { step: "Post-[incident](../incident/SKILL.md) review", owner: "[incident](../incident/SKILL.md)-manager", trigger: "P1-and-P2", timeline: "5-business-days" }
  escalation_rules:
...
problem_management:
  triggers:
    ...
    - "Any P1 [incident](../incident/SKILL.md) requiring root cause"
...
| ID | Opportunity | Source | Priority | Owner | Status | Target Date |
|----|-------------|--------|----------|-------|--------|-------------|
| CSI-001 | Automate [incident](../incident/SKILL.md) categorization | [Incident](../incident/SKILL.md) Review | High | Platform Team | In Progress | 2026-07-15 |
| CSI-002 | Reduce P1 MTTR by 20% | Q2 Metrics | High | SRE Team | Planned | 2026-09-01 |
| CSI-003 | Implement SLI dashboard | Customer Feedback | Medium | [Monitoring](../../monitoring-strategy/monitoring/SKILL.md) Team | Not Started | 2026-08-01 |
...
## Handoff
For compliance alignment, hand off to `[enterprise-compliance-audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)/SKILL.md)` for regulatory control mapping. For architecture decisions, hand off to `[enterprise-architecture-governance](../../../../Software_Engineering_and_Other/Patterns/architecture/architecture-governance/SKILL.md)` for review board approvals.
