...
# [Incident](../incident/SKILL.md) Management

Implement effective [incident](../incident/SKILL.md) management processes including severity definitions, escalation matrices, war room procedures, and blameless post-mortem templates.

## When to Use

- Establishing [incident](../incident/SKILL.md) management processes for production systems
- Defining severity levels and escalation procedures
- Running war rooms and coordinating [incident](../incident/SKILL.md) response
- Conducting blameless post-[incident](../incident/SKILL.md) reviews
- Building on-call schedules and notification workflows
- Meeting compliance requirements for [incident](../incident/SKILL.md) response (SOC 2, HIPAA, PCI DSS)
...
severity_definitions:
  SEV1_critical:
    ...
    examples:
      ...
      - Security [incident](../incident/SKILL.md) with active exploitation
    response_time: "Immediate (within 5 minutes)"
    update_frequency: "Every 15-30 minutes"
    who_is_paged: "On-call engineer, engineering manager, [incident](../incident/SKILL.md) commander, executive on-call"
  ...
  SEV4_low:
    ...
    examples:
      - UI cosmetic bug
      - Non-critical [monitoring](../../monitoring-strategy/monitoring/SKILL.md) gap
...
escalation_matrix:
  ...
  tier_3_engineering_management:
    ...
    responsibilities:
      - Assign [incident](../incident/SKILL.md) commander (if not already)
...
war_room:
  ...
  setup:
    communication_channel:
      primary: "Dedicated Slack channel (#[incident](../incident/SKILL.md)-YYYY-MM-DD-brief-name)"
      voice: "Zoom/Google Meet bridge (persistent link)"
      backup: "Phone conference bridge"
    channel_rules:
      - "Only [incident](../incident/SKILL.md)-related communication in the channel"
  ...
  roles:
    incident_commander:
      responsibilities:
        - Own the [incident](../incident/SKILL.md) from declaration to resolution
        - Coordinate all response activities
        - Make decisions on response actions
        - Assign tasks to responders
        - Determine when [incident](../incident/SKILL.md) is resolved
        - Schedule post-mortem
      selection: "On-call IC roster, or senior engineer who declares the [incident](../incident/SKILL.md)"
  ...
  workflow:
    1_declare:
      - "IC declares [incident](../incident/SKILL.md) with severity level"
    ...
    4_resolve:
      ...
      - "Verify [monitoring](../../monitoring-strategy/monitoring/SKILL.md) shows healthy metrics"
      - "IC declares [incident](../incident/SKILL.md) resolved"
...
```markdown
# Post-[Incident](../incident/SKILL.md) Review: [Incident Title]

**Date:** YYYY-MM-DD
**Severity:** SEV[1-4]
**Duration:** [Start time] to [End time] ([X hours Y minutes])
**[Incident](../incident/SKILL.md) Commander:** [Name]
**Author:** [Name]
...
## Detection
- **How was the [incident](../incident/SKILL.md) detected?** [Monitoring alert / customer report / manual observation]
...
- **What went well:**
  ...
  - [E.g., "[Runbook](../runbook/SKILL.md) for database failover was accurate and followed successfully"]
...
- **What could be improved:**
  ...
  - [E.g., "[Monitoring](../../monitoring-strategy/monitoring/SKILL.md) did not alert on the specific failure mode"]

## Contributing Factors
[List all factors that contributed to the [incident](../incident/SKILL.md) occurring or being worse than it could have been. This is not about blame - it is about understanding the system.]
...
## Appendix
- [Link to [monitoring](../../monitoring-strategy/monitoring/SKILL.md) [dashboards](../../dashboard-design/dashboards/SKILL.md) during incident]
...
## [Incident](../incident/SKILL.md) Metrics

```yaml
incident_metrics:
  mttr:
    name: "Mean Time to Resolve"
    definition: "Average time from [incident](../incident/SKILL.md) detection to resolution"
    target: "SEV1: <1h, SEV2: <4h"
    trending: "Track monthly, aim for improvement"

  mttd:
    name: "Mean Time to Detect"
    definition: "Average time from [incident](../incident/SKILL.md) start to detection"
    target: "< 5 minutes for SEV1/2"
    trending: "Monitors effectiveness of [alerting](../../alerting/alerting/SKILL.md)"
  ...
  recurring_incidents:
    name: "Percentage of incidents with same root cause as previous [incident](../incident/SKILL.md)"
    target: "< 10%"
    trending: "Monitors effectiveness of preventive actions"
```

## [Incident](../incident/SKILL.md) Management Checklist
...
incident_management_checklist:
  process_setup:
    ...
    - [ ] [Incident](../incident/SKILL.md) management tool configured (PagerDuty, OpsGenie)

  per_incident:
    - [ ] [Incident](../incident/SKILL.md) declared with severity level
    ...
    - [ ] Resolution verified with [monitoring](../../monitoring-strategy/monitoring/SKILL.md)
  ...
  compliance:
    ...
    - [ ] Annual [incident](../incident/SKILL.md) response plan test completed
```

## Best Practices

- Define severity levels with concrete examples so there is no ambiguity during an active [incident](../incident/SKILL.md)
...
- Track post-mortem action items to completion: an unfinished action item means the same [incident](../incident/SKILL.md) can recur
- Monitor [incident](../incident/SKILL.md) metrics (MTTR, MTTD, frequency) as leading indicators of system reliability
- Protect on-call health: track page volume per person and redistribute if someone is overburdened
- Separate the [incident](../incident/SKILL.md) commander role from the technical lead role in SEV1/2 incidents
- Practice [incident](../incident/SKILL.md) response regularly with game days or chaos engineering exercises
- Archive [incident](../incident/SKILL.md) records and post-mortems for compliance evidence and organizational learning
