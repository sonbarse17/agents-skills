...
- **Link to [dashboards](../../dashboard-design/dashboards/SKILL.md)** - Quick access during stress
...
- Current status (Investigating / Mitigating / [Monitoring](../../monitoring-strategy/monitoring/SKILL.md))
