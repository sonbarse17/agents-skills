...
# APM and [Observability](../../fundamentals/observability/SKILL.md)

## Purpose
Design and implement [observability](../../fundamentals/observability/SKILL.md) for distributed systems using metrics, traces, and logs with [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md), SLI/SLO frameworks, and actionable [alerting](../../alerting/alerting/SKILL.md).

## Agent Protocol

### Trigger
Exact user phrases: "APM", "[observability](../../fundamentals/observability/SKILL.md)", "[Datadog](../../../datadog/other/datadog/SKILL.md)", "New Relic", "Grafana", "Prometheus", "[OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)", "distributed tracing", "SLI", "SLO", "error budget", "application performance [monitoring](../../monitoring-strategy/monitoring/SKILL.md)", "RUM", "synthetics", "instrumentation".
...
- Existing [monitoring](../../monitoring-strategy/monitoring/SKILL.md) tools (if migrating from legacy).
- Budget constraints ([observability](../../fundamentals/observability/SKILL.md) tools can be expensive).
- Compliance requirements (log retention, [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) trails, PII masking).

### Output Artifact
Writes to [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) instrumentation config, Prometheus rules, Grafana dashboard JSON, [Datadog](../../../datadog/other/datadog/SKILL.md)/New Relic config, alert rules, SLI/SLO definitions.

### Response Format
Configuration YAML, Prometheus rules, dashboard JSON, or Terraform HCL for [monitoring](../../monitoring-strategy/monitoring/SKILL.md) resources.

No preamble. No postamble. No explanations. No filler/hedging/transitions.

### Completion Criteria
- [ ] Three pillars configured: metrics, traces, logs (at least 2 of 3).
- [ ] [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) instrumentation for key services.
- [ ] SLIs and SLOs defined for critical user journeys.
- [ ] [Alerting](../../alerting/alerting/SKILL.md) rules with proper severity levels and escalation.
- [ ] Dashboard created for system overview.
- [ ] Cost budget set for [observability](../../fundamentals/observability/SKILL.md) tool spend.
...
### [Observability](../../fundamentals/observability/SKILL.md) Tool Selection
| Tool | Best For | Cost | Self-Hosted |
|---|---|---|---|
| [Datadog](../../../datadog/other/datadog/SKILL.md) | Full-stack [observability](../../fundamentals/observability/SKILL.md), large enterprises | $$$ (per-host + per-event) | No |
...
| [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) | Vendor-neutral instrumentation | Free (standards) | N/A |
| Elastic (ELK) | Log-centric, search-heavy | $ (self-hosted) / $$ (cloud) | Yes |
| SigNoz | [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)-native APM | $$$ (cloud) / Free (self-hosted) | Yes |
...
## Quick Start
[OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) SDK → Export metrics/traces to collector → Prometheus for metrics → Grafana for [dashboards](../../dashboard-design/dashboards/SKILL.md) → Alertmanager for alerts → SLI/SLO tracking.

## Core Workflow

### Step 1: [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) Instrumentation
```yaml
...
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) import trace, metrics
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).sdk.resources import Resource
...
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).exporter.otlp.proto.grpc.trace_exporter import OTLPSpanExporter
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).exporter.otlp.proto.grpc.metric_exporter import OTLPMetricExporter
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).sdk.trace.export import BatchSpanProcessor
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).sdk.metrics.export import PeriodicExportingMetricReader
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).instrumentation.flask import FlaskInstrumentor
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).instrumentation.requests import RequestsInstrumentor
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).instrumentation.sqlalchemy import SQLAlchemyInstrumentor
...
## Tool Comparison: [Observability](../../fundamentals/observability/SKILL.md) Platforms

| Feature | [Datadog](../../../datadog/other/datadog/SKILL.md) | Grafana Cloud | New Relic | Self-Hosted (Prom + Grafana) |
|---|---|---|---|---|
...
| APM Agents | Many languages | Many languages | Many languages | [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) |
| [Alerting](../../alerting/alerting/SKILL.md) | Good | Excellent (Grafana [Alerting](../../alerting/alerting/SKILL.md)) | Good | Prometheus + Alertmanager |
...
| [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) support | Native | Native | Native | Native |

## Anti-Patterns

### Anti-Pattern 1: [Observability](../../fundamentals/observability/SKILL.md) as an Afterthought
...
Creating hundreds of [dashboards](../../dashboard-design/dashboards/SKILL.md) that nobody looks at. Focus on a small number of high-quality [dashboards](../../dashboard-design/dashboards/SKILL.md) aligned to team ownership.
...
### Anti-Pattern 6: Ignoring [Observability](../../fundamentals/observability/SKILL.md) Costs
Letting [observability](../../fundamentals/observability/SKILL.md) spend grow unchecked. Set budgets, monitor data ingestion, and adjust retention/sampling to control costs.
...
- [Audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) who modifies [dashboards](../../dashboard-design/dashboards/SKILL.md) and alert rules.
...
### High Availability
- Run multiple [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) Collector instances behind a load balancer.
...
| [Dashboards](../../dashboard-design/dashboards/SKILL.md) show no data | Grafana data source not configured | Verify data source URL and access |
...
## Rules & Constraints
- Instrument with [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) SDK — avoid vendor-specific agents.
...
- Alerts must have [runbooks](../../incident-detection/runbooks/SKILL.md) — no alert without documented response.
- [Dashboards](../../dashboard-design/dashboards/SKILL.md) must be version-controlled (Grafana as code).
...
- Test [alerting](../../alerting/alerting/SKILL.md) rules in staging before deploying to production.
...
- Next skill: **[monitoring](../../monitoring-strategy/monitoring/SKILL.md)** — infrastructure [monitoring](../../monitoring-strategy/monitoring/SKILL.md), Prometheus operator
