...
## Purpose
Implement Site Reliability Engineering practices: define SLIs/SLOs aligned with business goals, manage error budgets with burn rate alerts, systematically reduce toil, conduct blameless [incident](../../incident-detection/incident/SKILL.md) analysis, build production readiness reviews, and mature reliability culture across the organization.

## Agent Protocol

### Trigger
Exact user phrases: "SRE", "site reliability", "SLI", "SLO", "error budget", "error budget policy", "burn rate", "toil", "toil reduction", "reliability engineering", "postmortem", "[incident](../../incident-detection/incident/SKILL.md) analysis", "5 whys", "production readiness review", "PRR", "reliability dashboard", "multi-window", "multi-burn-rate", "reliability maturity", "SLO [monitoring](../../monitoring-strategy/monitoring/SKILL.md)", "service level objective", "service level indicator".

### Input Context
- Current [monitoring](../../monitoring-strategy/monitoring/SKILL.md) and [alerting](../../alerting/alerting/SKILL.md) stack (Prometheus, [Datadog](../../../datadog/other/datadog/SKILL.md), Grafana)
- Existing [incident](../../incident-detection/incident/SKILL.md) response process
...
What is the service's business criticality?
  ...
  Internal platform (CI/CD, [monitoring](../../monitoring-strategy/monitoring/SKILL.md), API gateways):
...
```yaml
# Prometheus [alerting](../../alerting/alerting/SKILL.md) rules for SLO burn rate
groups:
  - name: slo_burn_rate
    interval: 30s
    rules:
...
error_budget_policy:
  ...
  consequences:
    ...
    - "[Incident](../../incident-detection/incident/SKILL.md) review required for budget-exhausting events"
...
toil_assessment:
  ...
  categories:
    ...
    alert_triage:
      ...
      automation_strategy: "Tune alert thresholds, add [runbooks](../../incident-detection/runbooks/SKILL.md), auto-remediate"
      target_hours_week: 3
...
production_readiness_review:
  ...
  checklist:
    ...
    [observability](../../fundamentals/observability/SKILL.md):
      ...
      - "Distributed tracing ([OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)) configured"
    ...
    operations:
      - "[Runbook](../../incident-detection/runbook/SKILL.md) documented ([incident](../../incident-detection/incident/SKILL.md) response, recovery, escalation)"
...
### Step 8: Postmortem and [Incident](../../incident-detection/incident/SKILL.md) Analysis
...
postmortem:
  ...
  guidelines:
    ...
    - "Share postmortem org-wide — every [incident](../../incident-detection/incident/SKILL.md) is a learning opportunity"
...
reliability_maturity:
  ...
  level_4_quantitative:
    ...
    characteristics:
      ...
      - "Reliability [dashboards](../../dashboard-design/dashboards/SKILL.md) visible org-wide"
...
| [Incident](../../incident-detection/incident/SKILL.md) response | Blameless postmortem | Blameless | Root cause analysis |
| Automation | Toil elimination | CI/CD | Manual [runbooks](../../incident-detection/runbooks/SKILL.md) |
...
## References
- ../../../references/sre-practices_error-budget-policy.md — Error Budget Policy Design
...
## Handoff
Related skills: [platform-engineering](../../../../containers-orchestration/common/other/platform-engineering/SKILL.md) (IDP for self-service toil reduction), [incident-response](../../../DevOps_and_Cloud/Observability_and_SecOps/[incident](../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md)-response/SKILL.md) (on-call and [incident](../../incident-detection/incident/SKILL.md) management), [chaos-engineering](../../../../containers-orchestration/common/other/chaos-engineering/SKILL.md) (resilience testing), [monitoring](../../monitoring-strategy/monitoring/SKILL.md) ([observability](../../fundamentals/observability/SKILL.md) stack for SLO data), [progressive-delivery](../../../../ci-cd/common/deployment/progressive-delivery/SKILL.md) (deployment strategies for safe changes).
