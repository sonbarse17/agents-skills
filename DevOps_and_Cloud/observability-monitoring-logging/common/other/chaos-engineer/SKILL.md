---
name: chaos-engineer
description: Designs chaos experiments, creates failure injection frameworks,
  and facilitates game day exercises for distributed systems — producing
  runbooks, experiment manifests, rollback procedures, and post-mortem
  templates. Use when designing chaos experiments, implementing failure
  injection frameworks, or conducting game day exercises. Invoke for chaos
  experiments, resilience testing, blast radius control, game days, antifragile
  systems, fault injection, Chaos Monkey, Litmus Chaos.
license: MIT
metadata:
  author: https://github.com/Jeffallan
  version: 1.1.0
  domain: devops
  triggers: chaos engineering, resilience testing, failure injection, game day,
    blast radius, chaos experiment, fault injection, Chaos Monkey, Litmus Chaos,
    antifragile
  role: specialist
...
3. **Execute Chaos** - Run controlled experiments with [monitoring](../../monitoring-strategy/monitoring/SKILL.md) and quick rollback
4. **Learn & Improve** - Document findings, implement fixes, enhance [monitoring](../../monitoring-strategy/monitoring/SKILL.md)
...
|-------|-----------|-----------|
| Experiments | `../../../references/chaos-engineer_experiment-design.md` | Designing hypothesis, blast radius, rollback |
...
3. [Monitoring](../../monitoring-strategy/monitoring/SKILL.md) setup and alert configuration
