...
[Runbooks](../../incident-detection/runbooks/SKILL.md) for startups and small teams where engineers double as the IT department.
...
**MFA recovery flow:** Verify identity via video call, generate backup codes or reset factors, have user re-enroll immediately, confirm old device is deregistered, log the [incident](../../incident-detection/incident/SKILL.md).
...
cat > Brewfile <<'EOF'
brew "git"; brew "node"; brew "[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)@3.12"; brew "awscli"; brew "jq"; brew "gh"
...
- [incident-management](../../../compliance/continuity/[incident-management](../[incident](../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md)-management/SKILL.md)/) -- Structured [incident](../../incident-detection/incident/SKILL.md) handling
