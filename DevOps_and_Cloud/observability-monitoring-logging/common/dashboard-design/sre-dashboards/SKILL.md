...
- Creating [incident](../../incident-detection/incident/SKILL.md) command-center views
- Standardizing dashboard patterns across teams

## Prerequisites

- Metrics pipeline (Prometheus, [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md), or vendor equivalent)
...
1. **Executive Reliability View**: SLO attainment, [incident](../../incident-detection/incident/SKILL.md) counts, MTTR trends.
...
- Default time windows to [incident](../../incident-detection/incident/SKILL.md)-friendly ranges (15m, 1h, 6h, 24h)
- Minimize panel count per dashboard to reduce cognitive load
- Add [runbook](../../incident-detection/runbook/SKILL.md) links directly in panel descriptions
