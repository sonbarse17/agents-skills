...
npm install @azure/monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)

# Low-level exporters (custom [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) setup)
npm install @azure/monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)-exporter
...
```bash
node --import @azure/monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)/loader ./dist/index.js
```
...
{
  "scripts": {
    "start": "node --import @azure/monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)/loader ./dist/index.js"
  }
}
```
...
const options: AzureMonitorOpenTelemetryOptions = {
  ...
  instrumentationOptions: {
    ...
    http: { enabled: true },
    [mongoDb](../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md): { enabled: true },
    [mySql](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md): { enabled: true },
    [postgreSql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md): { enabled: true },
    redis: { enabled: true },
...
import {
  ...
  InstrumentationOptions
} from "@azure/monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)";
...
import {
  ...
  AzureMonitorExporterOptions
} from "@azure/monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)-exporter";
...
2. **Use ESM loader for ESM projects** - `--import @azure/monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)/loader`
