...
- Building [observability](../../../common/fundamentals/observability/SKILL.md) [dashboards](../../../common/dashboard-design/dashboards/SKILL.md)
...
8. **Separate concerns** - [Observability](../../../common/fundamentals/observability/SKILL.md) code shouldn't pollute business logic
9. **Test your [observability](../../../common/fundamentals/observability/SKILL.md)** - Verify logs and metrics in integration tests
10. **Set up alerts** - Metrics are useless without [alerting](../../../common/alerting/alerting/SKILL.md)
