...
- [OpenTelemetry .NET instrumentation](https://[opentelemetry](../../other/opentelemetry/SKILL.md).io/docs/zero-code/net/)
...
See the [EDOT .NET setup guide](https://www.elastic.co/docs/reference/[opentelemetry](../../other/opentelemetry/SKILL.md)/edot-sdks/dotnet/setup) for complete
examples.
