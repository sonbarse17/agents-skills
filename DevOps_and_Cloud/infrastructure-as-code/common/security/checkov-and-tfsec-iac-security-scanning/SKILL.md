...
[Infrastructure-as-code](../../other/infrastructure-as-code/SKILL.md) misconfigurations are a distinct risk category from
...
- Adding a pre-`terraform apply` (or pre-[CloudFormation](../../../cloudformation/other/cloudformation/SKILL.md)-deploy) security
...
- The IaC source tree itself (Terraform `.tf`/`.tfvars`, [CloudFormation](../../../cloudformation/other/cloudformation/SKILL.md)
...
7. **Run the scan before `terraform plan`/`apply` in the pipeline sequence**
   ...
   discovering it via a runtime scan or an [incident](../../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md) after the resource is
