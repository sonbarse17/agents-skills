...
| CLI commands, [vault](../../../../Security/cryptography-secrets/vault/SKILL.md), galaxy | `resources/command-cookbook.md` | User needs ansible/ansible-playbook/ansible-[vault](../../../../Security/cryptography-secrets/vault/SKILL.md)/galaxy commands |
...
- Protect secrets with `ansible-[vault](../../../../Security/cryptography-secrets/vault/SKILL.md) encrypt` — never [commit](../../../../ci-cd/common/git-workflow/commit/SKILL.md) plaintext passwords.
...
- **[pulumi](../../../pulumi/other/pulumi/SKILL.md)** — IaC with code; Ansible handles post-provision configuration
