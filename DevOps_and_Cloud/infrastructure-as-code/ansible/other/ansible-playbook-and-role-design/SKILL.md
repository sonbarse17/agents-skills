...
provisioning tools: Terraform/[CloudFormation](../../../cloudformation/other/cloudformation/SKILL.md) create the VM, network, and
...
- Deciding whether a given change belongs in [Ansible](../ansible/SKILL.md) (configuration of
  ...
  [CloudFormation](../../../cloudformation/other/cloudformation/SKILL.md) (creating/destroying the resources themselves).
...
7. **Know when to reach for a provisioning tool instead.** If the task is
   ...
   [CloudFormation](../../../cloudformation/other/cloudformation/SKILL.md) territory (see
   [infrastructure-as-code-terraform](../../../devops/skills/[infrastructure-as-code-terraform](../[infrastructure-as-code](../infrastructure-as-code/SKILL.md)-terraform/SKILL.md)/SKILL.md)
   and
   [aws-[cloudformation](../../../cloudformation/other/cloudformation/SKILL.md)-templates](../[aws-[cloudformation](../cloudformation/SKILL.md)-templates](../aws-[cloudformation](../cloudformation/SKILL.md)-templates/SKILL.md)/SKILL.md)).
   If the task is "this host exists — install/configure/run something on
   it," that's [Ansible](../ansible/SKILL.md). Many pipelines chain both: Terraform/[CloudFormation](../../../cloudformation/other/cloudformation/SKILL.md)
...
- Keep roles single-purpose and reusable (`nginx`, `app-runtime`,
  `[monitoring](../../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md)-agent`) rather than one monolithic `webserver` role that
