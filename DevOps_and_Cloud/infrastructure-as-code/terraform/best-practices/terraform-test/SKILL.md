...
- `../../../references/CI_CD.md` — [GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md) Actions and GitLab CI pipeline examples
- `../../../references/terraform-test_EXAMPLES.md` — Complete example test suite (unit, integration, and mock tests for a VPC module)
