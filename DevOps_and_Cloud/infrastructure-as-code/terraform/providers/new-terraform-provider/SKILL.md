...
1. Run `go get -u [github](../../../../ci-cd/github-actions/other/github/SKILL.md).com/hashicorp/terraform-plugin-framework@latest`.
...
validation), use the `[provider-configuration](../[provider-configuration](../../../Software_Engineering_and_Other/Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-configuration/SKILL.md)/SKILL.md)` skill (if available). To add
the first resource or data source, use the `[provider-resources](../[provider-resources](../../../Software_Engineering_and_Other/Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-resources/SKILL.md)/SKILL.md)` skill (if
available).
