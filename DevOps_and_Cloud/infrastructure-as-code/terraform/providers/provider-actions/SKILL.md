...
- Reference implementations: `terraform-provider-tfe` (`action_query_run.go`, `action_query_run_test.go`), `terraform-provider-[vault](../../../../Security/cryptography-secrets/vault/SKILL.md)` (`action_rotate_root.go`)
