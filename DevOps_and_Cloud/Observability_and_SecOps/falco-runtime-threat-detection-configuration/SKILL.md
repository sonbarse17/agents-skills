...
[alerting](../alerting/SKILL.md) on legitimate activity, and wiring detections to real
...
- **Symptom:** Falco is running and clearly detecting events (visible in
  ...
  **Fix:** Falcosidekick (or an equivalent router) either isn't
  ...
  [alerting](../alerting/SKILL.md). Wire Falcosidekick to at least one monitored destination
...
- [incident-response-and-on-call-management](../../../site-reliability-engineering/skills/[incident-response-and-on-call-management](../../../Software_Engineering_and_Other/Frontend/[incident-response](../../Observability_and_SecOps/[incident](../../Observability_and_SecOps/incident/SKILL.md)-response/SKILL.md)-and-[on-call-management](../on-call-management/SKILL.md)/SKILL.md)/SKILL.md) —
  the [incident](../incident/SKILL.md) process a `critical`-priority Falco detection routed to
