...
Phase 2 - Understand: Map controls to system components. Group by control domain (access control, encryption, logging, change management, [incident](../incident/SKILL.md) response). Document inherited controls from cloud providers and vendors.
...
Phase 4 - Implement: Deploy technical controls. Configure logging, [monitoring](../monitoring/SKILL.md), and [alerting](../alerting/SKILL.md). Establish access review workflows. Implement change management and deployment pipelines with compliance gates.
...
Logging and [Monitoring](../monitoring/SKILL.md) (All frameworks): [Audit](../../../AI_and_Agents/Operations/audit/SKILL.md) trails for admin actions, data access, configuration changes. Log retention per framework. [Alerting](../alerting/SKILL.md) on security events.
...
[Incident](../incident/SKILL.md) Response (All frameworks): [Incident](../incident/SKILL.md) response plan, tested annually, documented procedures, communication plan, post-[incident](../incident/SKILL.md) review.
...
- [ ] Continuous [monitoring](../monitoring/SKILL.md) configured for critical controls
...
Identify the applicable compliance framework. Map each framework control to system components. Group by control domain (access control, encryption, logging, change management, [incident](../incident/SKILL.md) response). Document inherited controls from cloud provider.
...
Evidence types:
- Configuration snapshots: [Infrastructure-as-Code](../../Infrastructure_as_Code/infrastructure-as-code/SKILL.md) state files, CI/CD pipeline definitions
- Log exports: System logs, [audit](../../../AI_and_Agents/Operations/audit/SKILL.md) logs, access logs, change logs
- Policy documents: Signed policies, procedure documents, [runbooks](../runbooks/SKILL.md)
...
[Monitoring](../monitoring/SKILL.md) tools: AWS Config, Azure Policy, GCP Organization Policy, CSPM platforms (Wiz, Prisma Cloud, CrowdStrike), SIEM integration.
...
Pitfall 1: Treating compliance as a point-in-time exercise. Compliance is not a project with an end date. It is an ongoing program. Controls degrade, personnel change, architecture evolves. Continuous [monitoring](../monitoring/SKILL.md) is essential.
...
Practice 1: Build compliance into development workflows. [Infrastructure-as-Code](../../Infrastructure_as_Code/infrastructure-as-code/SKILL.md) templates should enforce compliance defaults. CI/CD pipelines should run compliance checks. Pull request templates should include compliance review checklist.
...
Practice 5: Train teams on compliance responsibilities. Developers should understand what controls apply to their code. Operations should understand evidence collection requirements. Security should understand [monitoring](../monitoring/SKILL.md) expectations.
...
| [Incident](../incident/SKILL.md) Response | CC7.3 | A.5.24 | Art. 33 | 164.308(a)(6) | Req. 12.10 |
...
- [ ] Procedure documents (operating procedures, [runbooks](../runbooks/SKILL.md))
...
# [Compliance-as-Code](../../../Security/compliance-as-code/SKILL.md): automated control testing
...
| Logging and [Monitoring](../monitoring/SKILL.md) | Yes  | A.12      | Art 33| 164.312| Req 10 |
| Change Management      | Yes  | A.12      | -    | 164.310| Req 6  |
| [Incident](../incident/SKILL.md) Response      | Yes  | A.16      | Art 33| 164.308| Req 12 |
...
Implementing controls that look good in documentation but have no operational reality. Examples: writing an access control policy without enforcing MFA, having a password policy that allows `Password123!`, maintaining a [runbook](../runbook/SKILL.md) that no one follows. Auditors increasingly test operating effectiveness, not just design.
...
- [Incident](../incident/SKILL.md) response plan tested at least annually.
