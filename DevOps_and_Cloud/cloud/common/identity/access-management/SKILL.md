...
Manage identity and access for an Elastic Cloud organization and its [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) projects: invite users, assign
...
For detailed API endpoints and request schemas, see [../../../references/access-management_api-reference.md](../../../references/access-management_api-reference.md).

## Jobs to Be Done

- Invite a user to the organization and assign them a [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) project role
...
- Create a Cloud API key that can also call Elasticsearch and Kibana APIs on [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) projects
- List and revoke Cloud API keys
- Create a custom role inside a [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) project with ES cluster, index, and Kibana privileges
- Assign or remove a custom role for a user on a [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) project using the Cloud API's `application_roles`
...
| **Project endpoint** | Elasticsearch endpoint of a [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) project. Required only for custom role operations.               |
...
The following permissions are required for common access management operations in Elastic Cloud [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md).
...
| **What**         | Which [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) project(s) or org-level access?                    |
...
### [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) project-level roles
...
[../../../references/access-management_api-reference.md](../../../references/access-management_api-reference.md) for the `role_assignments` JSON schema including the
`project` scope.

## Custom Roles ([Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md))

When predefined roles lack the required granularity, create a custom role inside the [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) project using the
...
- The `assign-custom-role` command sets `role_id` to the project-type Viewer role (`elasticsearch-viewer`,
  ...
  inside the project.
- Cloud API keys can also use `application_roles` to gain ES/Kibana API access on [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) projects. See
...
not available in [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md).
...
Cloud API keys can now optionally access Elasticsearch and Kibana APIs on [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) projects, in addition to the Cloud
