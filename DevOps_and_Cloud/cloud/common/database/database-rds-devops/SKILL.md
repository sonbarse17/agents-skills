...
- `../../../references/database-rds-devops_best-practices.md` — Platform-specific best practices (Aurora vs RDS vs EC2)
...
| Auto Scaling | Read replica scaling config | `aws application-[autoscaling](../../../../Software_Engineering_and_Other/Backend/patterns/autoscaling/SKILL.md) describe-scalable-targets --service-namespace rds` |
