...
(no [reverse-engineering](../../../../Security/pentest-redteam/reverse-engineering/SKILL.md) or chained exploit required), and git history
...
- A team wants to set up HashiCorp [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md), AWS Secrets Manager, Azure Key
  [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md), GCP Secret Manager, or a [GitOps](../../../../containers-orchestration/common/gitops/gitops/SKILL.md)-friendly encrypted-secrets
...
- A secrets manager choice appropriate to the environment:
  - **HashiCorp [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)** (OSS or Enterprise) — most flexible, supports
    ...
    requires running/operating a [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) cluster (or using HCP [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)) —
    non-trivial operational overhead if self-hosted.
  - **AWS Secrets Manager / Azure Key [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) / GCP Secret Manager** —
...
3. **Stand up the secrets manager.** [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) example — enable a KV v2
   secrets engine and a policy scoped to least privilege:
   ```bash
   [vault](../../../../Security/cryptography-secrets/vault/SKILL.md) secrets enable -path=myapp kv-v2
   [vault](../../../../Security/cryptography-secrets/vault/SKILL.md) kv put myapp/prod/db username="svc-myapp" password="<generated>"
   ```
   ```hcl
...
4. **Authenticate workloads, not humans, to fetch secrets at runtime.**
   [Kubernetes](../../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) example using [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)'s [Kubernetes](../../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) auth method with the [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)
   Agent Injector (annotations on a pod spec):
   ```yaml
   metadata:
     annotations:
       [vault](../../../../Security/cryptography-secrets/vault/SKILL.md).hashicorp.com/agent-inject: "true"
       [vault](../../../../Security/cryptography-secrets/vault/SKILL.md).hashicorp.com/role: "myapp-prod"
       [vault](../../../../Security/cryptography-secrets/vault/SKILL.md).hashicorp.com/agent-inject-secret-db-creds: "myapp/data/prod/db"
   ```
...
6. **Prefer dynamic, short-lived secrets over long-lived static ones**
   where the backing system supports it ([Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)'s database secrets engine
...
- Scope access with least privilege per environment/workload identity,
  not one shared "CI" or "prod" credential used everywhere — a [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)
...
- **Symptom:** [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) (or another secrets manager) is deployed, but every
...
newly-added Gitleaks scan, and migrates the service to [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)-issued
...
2. Remove the hardcoded key from `config/settings.py` and replace with a
   [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)-issued dynamic credential:
   ```bash
   [vault](../../../../Security/cryptography-secrets/vault/SKILL.md) secrets enable -path=aws aws
   [vault](../../../../Security/cryptography-secrets/vault/SKILL.md) write aws/roles/myapp-prod \
...
- [secure-cicd-gates](../../../../Security/app-security/secure-cicd-gates/SKILL.md)/SKILL.md) — where
