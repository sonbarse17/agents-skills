...
description: "Deploy, evaluate, fine-tune, and manage Foundry agents end-to-end
  with azd: hosted agent scaffold/run/deploy, prompt agent create, batch eval,
  continuous eval, prompt optimizer, Agent Optimizer scaffold, agent.yaml,
  dataset curation from traces, model fine-tuning (SFT/DPO/RFT). USE FOR: azd ai
  agent, azd provision/deploy, deploy agent, hosted agent, create agent, add
  tool to agent, invoke agent, evaluate agent, continuous eval, continuous
  monitoring, agent CI/CD, optimize prompt, improve prompt, optimize agent
  instructions, agent optimizer, deploy model, Foundry project, RBAC, role
  assignment, permissions, quota, capacity, region, troubleshoot agent,
  deployment failure, AI Services, create Foundry resource, provision, knowledge
  index, customize deployment, onboard, availability, fine-tune, SFT, DPO, RFT,
  training-data, grader, distillation, fine-tuned model, large file upload. DO
  NOT USE FOR: Azure Functions, App Service, general Azure deploy (use
...
| **models/[deploy-model](../../../../../AI_and_Agents/Infrastructure/[deploy-model](models/deploy-model/SKILL.md)/SKILL.md)** | Unified model deployment with intelligent routing. Handles quick [preset](../../../../../AI_and_Agents/Infrastructure/deploy-model/[preset](../../../../../AI_and_Agents/Models_and_FineTuning/[preset](models/deploy-model/preset/SKILL.md)/SKILL.md)/SKILL.md) deployments, fully customized deployments (version/SKU/[capacity](../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](models/deploy-model/[capacity](../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md)/RAI), and [capacity](../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](models/deploy-model/[capacity](../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) discovery across regions. Routes to sub-skills: `[preset](../../../../../AI_and_Agents/Infrastructure/deploy-model/[preset](../../../../../AI_and_Agents/Models_and_FineTuning/[preset](models/deploy-model/preset/SKILL.md)/SKILL.md)/SKILL.md)` (quick deploy), `[customize](../customize/SKILL.md)/SKILL.md)/SKILL.md)` (full control), `[capacity](../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](models/deploy-model/[capacity](../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md)` (find availability). | [models/[deploy-model](../../../../../AI_and_Agents/Infrastructure/[deploy-model](models/deploy-model/SKILL.md)/SKILL.md)/SKILL.md](models/[deploy-model](../../../../../AI_and_Agents/Infrastructure/[deploy-model](models/deploy-model/SKILL.md)/SKILL.md)/SKILL.md) |
| **quota** | Managing quotas and [capacity](../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](models/deploy-model/[capacity](../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) for Microsoft Foundry resources. Use when checking quota usage, troubleshooting deployment failures due to insufficient quota, requesting quota increases, or planning [capacity](../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](models/deploy-model/[capacity](../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md). | [quota/quota.md](quota/quota.md) |
...
| **[finetuning](../../../../../AI_and_Agents/Models_and_FineTuning/[finetuning](finetuning/SKILL.md)/SKILL.md)** | Fine-tune models on Microsoft Foundry — SFT distillation, DPO preference optimization, RFT with graders and tool calling. Dataset preparation, grader calibration, training, checkpoint selection, deployment, evaluation. Use for: fine-tune, SFT, DPO, RFT, training data, grader, distillation, fine-tuned model, large file upload. | [finetuning/SKILL.md]([finetuning](../../../../../AI_and_Agents/Models_and_FineTuning/[finetuning](finetuning/SKILL.md)/SKILL.md)/SKILL.md) |
...
> 💡 **Tip:** For a complete onboarding flow: `project/create` (public) or `private-network` (VNet isolation) → `models/[deploy-model](../../../../../AI_and_Agents/Infrastructure/[deploy-model](models/deploy-model/SKILL.md)/SKILL.md)` → agent workflows (`create` → `deploy` → `invoke`).

> 💡 **Fine-Tuning:** Use `[finetuning](../../../../../AI_and_Agents/Models_and_FineTuning/[finetuning](finetuning/SKILL.md)/SKILL.md)` for all model customization — SFT distillation, DPO preference optimization, and RFT with graders. Includes quickstart, grader calibration, and training curve analysis.

> 💡 **Model Deployment:** Use `models/[deploy-model](../../../../../AI_and_Agents/Infrastructure/[deploy-model](models/deploy-model/SKILL.md)/SKILL.md)` for all deployment scenarios — it intelligently routes between quick [preset](../../../../../AI_and_Agents/Infrastructure/deploy-model/[preset](../../../../../AI_and_Agents/Models_and_FineTuning/[preset](models/deploy-model/preset/SKILL.md)/SKILL.md)/SKILL.md) deployment, customized deployment with full control, and [capacity](../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](models/deploy-model/[capacity](../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) discovery across regions.
...
| Optimize existing [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) hosted agent | [dependency check and setup](#dependency-check-and-setup) → [azd-guidance](foundry-agent/azd-guidance/azd-guidance.md) → [agent-optimizer](foundry-agent/agent-optimizer/agent-optimizer.md) → scaffold/review → eval.yaml → optimize → apply candidate → deploy → invoke |
...
- [Azure Authentication Best Practices](../../../../Global_References/cloud/microsoft-foundry_auth-best-practices.md)
