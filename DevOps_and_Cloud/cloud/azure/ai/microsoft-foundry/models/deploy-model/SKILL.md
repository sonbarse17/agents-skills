...
| **[Customize](../../../customize/SKILL.md)/SKILL.md)/SKILL.md)** | Full control: version, SKU, [capacity](../../../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity]([capacity](../../../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md), RAI policy | [customize/SKILL.md](../../../customize/SKILL.md)/SKILL.md)/SKILL.md)/SKILL.md) |
...
User Prompt
    ...
    │  └─> [CUSTOMIZE](../../../customize/SKILL.md)/SKILL.md)/SKILL.md) mode
    │
...
| "custom", "configure", "choose", "select" | **[Customize](../../../customize/SKILL.md)/SKILL.md)/SKILL.md)** | User wants control |
...
| Specific [capacity](../../../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity]([capacity](../../../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) number + "custom" keywords | **[Capacity](../../../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity]([capacity](../../../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) → [Customize](../../../customize/SKILL.md)/SKILL.md)/SKILL.md)** | Discover then deploy with options |
| "PTU", "provisioned throughput" | **[Customize](../../../customize/SKILL.md)/SKILL.md)/SKILL.md)** | PTU requires SKU selection |
...
3. Ask: "Would you like to deploy with **quick defaults** or **[customize](../../../customize/SKILL.md)/SKILL.md)/SKILL.md) settings**?"
4. Route to **[Preset](../../../../../../../AI_and_Agents/Infrastructure/deploy-model/[preset](../../../../../../../AI_and_Agents/Models_and_FineTuning/[preset](preset/SKILL.md)/SKILL.md)/SKILL.md)** or **[Customize](../../../customize/SKILL.md)/SKILL.md)/SKILL.md)** based on answer
...
Before any deployment, resolve which project to deploy to. This applies to **all** modes ([preset](../../../../../../../AI_and_Agents/Infrastructure/deploy-model/[preset](../../../../../../../AI_and_Agents/Models_and_FineTuning/[preset](preset/SKILL.md)/SKILL.md)/SKILL.md), [customize](../../../customize/SKILL.md)/SKILL.md)/SKILL.md), and after [capacity](../../../../../../../AI_and_Agents/Infrastructure/deploy-model/[capacity]([capacity](../../../../../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) discovery).
...
- **[customize/SKILL.md](../../../customize/SKILL.md)/SKILL.md)/SKILL.md)/SKILL.md)** — Interactive guided flow with full configuration control
