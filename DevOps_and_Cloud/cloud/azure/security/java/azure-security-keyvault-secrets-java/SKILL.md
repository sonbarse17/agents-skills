...
# Azure Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) Secrets (Java)
...
SecretAsyncClient asyncClient = new SecretClientBuilder()
    .vaultUrl("https://<[vault](../../../../../Security/cryptography-secrets/vault/SKILL.md)>.[vault](../../../../../Security/cryptography-secrets/vault/SKILL.md).azure.net")
...
// Usage
ConfigLoader loader = new ConfigLoader("https://my-[vault](../../../../../Security/cryptography-secrets/vault/SKILL.md).[vault](../../../../../Security/cryptography-secrets/vault/SKILL.md).azure.net");
...
```bash
AZURE_KEYVAULT_URL=https://<[vault](../../../../../Security/cryptography-secrets/vault/SKILL.md)-name>.[vault](../../../../../Security/cryptography-secrets/vault/SKILL.md).azure.net  # Required for [vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) URL
...
6. **Access Logging** - Enable diagnostic logging on Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md)
...
- "Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) secrets Java", "secret management Java"
- "store password", "store API key", "connection string"
- "retrieve secret", "rotate secret"
- "Azure secrets", "[vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) secrets"
