...
- Store securely (Key [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) recommended)
...
Create a .NET/[Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)/Node.js console app that authenticates users.

**Required Information:**
- Programming language (C#, [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md), JavaScript, etc.)
...
|----------|---------------|
| **Never hardcode secrets** | Use environment variables, Azure Key [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md), or managed identity |
...
- [Troubleshooting](../../../references/entra-app-registration_troubleshooting.md) - Common issues and solutions
