...
description: Build applications using Azure App Configuration SDK for JavaScript
  ...
  feature flags, Key Vault references, dynamic refresh, or centralized
...
# Azure App Configuration SDK for [TypeScript](../../../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md)
...
### Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) References
