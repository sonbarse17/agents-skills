...
> See [shared tools](../references/mcp-tool-reference.md) for cross-phase tools and global parameters. See [scaffold tools](../../../../../../AI_and_Agents/references/scaffold_mcp-tools.md) for full parameter tables.
...
5. **IaC generation** — ⛔ **You MUST dispatch [`subagent-iac-gen.md`](../../../../../../AI_and_Agents/references/subagent-iac-gen.md) as a `task`.** ⛔ agent_type: `"task"` — NEVER `"general-purpose"`.
   ```
   <<<TEMPLATE_START>>>
...
6–9. **Self-review** — ⛔ **You MUST dispatch [`subagent-review.md`](../../../../../../AI_and_Agents/references/subagent-review.md) as a `task`.** ⛔ agent_type: `"task"` — NEVER `"general-purpose"`.
   ```
   <<<TEMPLATE_START>>>
...
10b–12.5. **Validation + manifest** — ⛔ **You MUST dispatch [`subagent-validate.md`](../../../../../../AI_and_Agents/references/subagent-validate.md) as a `task`.** ⛔ agent_type: `"task"` — NEVER `"general-purpose"`.
   ```
   <<<TEMPLATE_START>>>
...
On validation failure → read [`scaffold-healing-rules.md`](../../../../../../AI_and_Agents/references/scaffold-healing-rules.md) (healing cadence, PLAN_LEVEL_CHANGE, artifact consistency). Do NOT pre-read.
...
- FLAGGED findings and healing exhaustion: see [scaffold-healing-rules.md](../../../../../../AI_and_Agents/references/scaffold-healing-rules.md).
