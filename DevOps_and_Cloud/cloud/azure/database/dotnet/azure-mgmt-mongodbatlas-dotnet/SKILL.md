...
description: Manage MongoDB Atlas Organizations as Azure ARM resources using
  ...
  or deleting MongoDB Atlas organizations through Azure Marketplace integration.
  This SDK manages the Azure-side organization resource, not Atlas
  clusters/databases directly.
license: MIT
metadata:
  author: Microsoft
  version: 1.0.0
...
Manage [MongoDB](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md) Atlas Organizations as Azure ARM resources with unified billing through Azure Marketplace.
...
| Resource Type | `[MongoDB](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md).Atlas/organizations` |
...
This SDK manages **[MongoDB](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md) Atlas Organizations as Azure ARM resources** for marketplace integration. It does NOT directly manage:
- Atlas clusters
- Databases
- Collections
- Users/roles

For cluster management, use the [MongoDB](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md) Atlas API directly after creating the organization.
...
| `MongoDBAtlasPartnerProperties` | [MongoDB](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)-specific properties (org name, ID) |
    ...
    Properties = new MongoDBAtlasOrganizationProperties(
        marketplace: new MongoDBAtlasMarketplaceDetails(
            ...
            offerDetails: new MongoDBAtlasOfferDetails(
                publisherId: "[mongodb](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)",
...
| `PartnerProperties` | `MongoDBAtlasPartnerProperties` | [MongoDB](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)-specific properties |
...
| Property | Type | Description |
|----------|------|-------------|
| `PublisherId` | `string` | Required. Publisher ID (typically "[mongodb](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)") |
...
| Property | Type | Description |
|----------|------|-------------|
| `OrganizationName` | `string` | Name of the [MongoDB](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md) Atlas organization |
| `OrganizationId` | `string` | Read-only. [MongoDB](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md) Atlas organization ID |
...
- [Microsoft Learn: [MongoDB](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md) Atlas on Azure](https://learn.microsoft.com/en-us/azure/partner-solutions/[mongodb](../../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)-atlas/)
