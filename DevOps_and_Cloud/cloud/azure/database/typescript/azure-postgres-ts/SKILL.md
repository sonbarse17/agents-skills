...
# Azure [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) for [TypeScript](../../../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md) (node-postgres)

Connect to Azure Database for [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) Flexible Server using the `pg` (node-postgres) package with support for password and Microsoft Entra ID (passwordless) authentication.
...
// Acquire access token for Azure [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)
  ...
  if (error instanceof DatabaseError) {
    switch (error.code) {
      ...
      case "57P03":  // cannot_connect_now (server starting)
        ...
        break;
      default:
        console.error(`[PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) error ${error.code}: ${error.message}`);
    }
  }
  throw error;
}
...
| Default port | `5432` | Standard [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) port |
...
> **Note**: Azure [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) has connection limits based on SKU. Check your tier's max connections.
...
| Azure [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) Docs | https://learn.microsoft.com/azure/[postgresql](../../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)/flexible-server/ |
| Passwordless Connection | https://learn.microsoft.com/azure/[postgresql](../../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)/flexible-server/how-to-connect-with-managed-identity |
