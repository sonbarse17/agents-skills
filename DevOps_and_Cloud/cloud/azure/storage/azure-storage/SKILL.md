...
For building applications that interact with Azure Storage programmatically, Azure provides SDK packages in multiple languages (.NET, Java, JavaScript, [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md), Go, Rust). See [SDK Usage Guide](../../../references/sdk-usage.md) for package names, installation commands, and quick start examples.
