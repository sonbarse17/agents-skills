...
| Key [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) | `keyvault` | ⚠️ Partial — secrets/keys only, no [vault](../../../../Security/cryptography-secrets/vault/SKILL.md) listing |
...
See [Azure Resource Graph Query Patterns](../../../references/azure-resource-lookup_azure-resource-graph.md) for common KQL patterns.
...
- ❌ **Never** use ARG for real-time [monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) (data has slight delay)
