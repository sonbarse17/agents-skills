...
4. **Ensure RG → Plan (`P0v3 --is-linux`) → Web App (`--runtime "[PYTHON](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md):3.14"`)** exist. On transient ARM errors, follow [transient-retry.md](../../../references/transient-retry.md). [create-app.md](../../../references/create-app.md).
5. **Set startup** — Flask/Django: none (Oryx auto-detects). FastAPI: always `[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) -m uvicorn main:app --host 0.0.0.0`. Other: warn. [startup-commands.md](../../../references/startup-commands.md).
