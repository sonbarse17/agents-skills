...
`[provider-resources](../[provider-resources](../../../Software_Engineering_and_Other/Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-resources/SKILL.md)/SKILL.md)` skill, if available, shows it); the client comes from
...
the `[provider-test-patterns](../[provider-test-patterns](../../../Software_Engineering_and_Other/Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-test-patterns/SKILL.md)/SKILL.md)` skill (if available) — its ephemeral testing
...
`tfplugindocs` like every other page type. Use the `[provider-docs](../[provider-docs](../../../Software_Engineering_and_Other/Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-docs/SKILL.md)/SKILL.md)` skill
