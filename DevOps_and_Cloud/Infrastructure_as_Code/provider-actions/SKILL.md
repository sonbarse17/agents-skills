...
1. **Type Mismatches**
   - Model structs use `types.String`/`types.Int64` and schemas use
     ...
     `[github](../../CI_CD/github/SKILL.md).com/hashicorp/terraform-plugin-framework/types` — don't mix in
...
4. **Validator Imports**
   ...
   "[github](../../CI_CD/github/SKILL.md).com/hashicorp/terraform-plugin-framework-validators/int64validator"
   "[github](../../CI_CD/github/SKILL.md).com/hashicorp/terraform-plugin-framework-validators/stringvalidator"
   ```
...
`[github](../../CI_CD/github/SKILL.md).com/hashicorp/terraform-plugin-sdk/v2/helper/retry`, the same waiter
...
`[provider-test-patterns](../[provider-test-patterns](../../../Software_Engineering_and_Other/Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-test-patterns/SKILL.md)/SKILL.md)` skill (if available) for the sweep function
...
it (use the `[provider-docs](../[provider-docs](../../../Software_Engineering_and_Other/Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-docs/SKILL.md)/SKILL.md)` skill, if available, for that workflow). Each
...
[go-changelog](https://[github](../../CI_CD/github/SKILL.md).com/hashicorp/go-changelog): one file per PR
...
- [terraform-plugin-framework GitHub](https://[github](../../CI_CD/github/SKILL.md).com/hashicorp/terraform-plugin-framework)
