...
## Purpose
Deploy and operate HashiCorp Nomad for workload scheduling, service orchestration, batch processing, and canary deployments with Consul and [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) integration.
...
- Integration with Consul and [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md).
...
- [ ] Secrets from [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) or template stanza configured.
...
client {
  ...
  host_volume "[docker](../../../docker/other/docker/SKILL.md)-data" {
    path      = "/data/[docker](../../../docker/other/docker/SKILL.md)"
    read_only = false
  }
...
# [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) integration
[vault](../../../../Security/cryptography-secrets/vault/SKILL.md) {
  enabled          = true
  address          = "https://[vault](../../../../Security/cryptography-secrets/vault/SKILL.md).service.consul:8200"
...
- Always template secrets from [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) — never embed in job HCL.
...
- Consul ACL tokens should be scoped per job (`template` stanza with [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)).
- [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) token role `nomad-cluster` must allow token creation for Nomad workloads.
...
## References
  ...
  - references/nomad-security.md — ACLs and [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) Integration
## Handoff
- `devops-consul` for Consul service discovery and Connect mesh.
- `devops-[vault](../../../../Security/cryptography-secrets/vault/SKILL.md)` for [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) secrets management integration.
