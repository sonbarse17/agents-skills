...
# Complete [GitOps](../../../common/gitops/gitops/SKILL.md)/Argo CD Deployment on AKS, From Scratch
...
successor to the deprecated AAD Pod Identity) federates a [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)
...
- Starting from a bare, already-provisioned AKS cluster with nothing
  [GitOps](../../../common/gitops/gitops/SKILL.md)-related installed, needing a working Argo CD + first deployed app
...
- Standing up a second/third AKS-hosted environment for a service already
  [GitOps](../../../common/gitops/gitops/SKILL.md)-managed in one cluster.
- Migrating a team off manual `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply`/`helm upgrade` deploys to AKS
  onto a full [GitOps](../../../common/gitops/gitops/SKILL.md) flow, starting from zero.
...
- An AKS cluster already provisioned with the OIDC issuer and Workload
  ...
  [managed-[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-eks-aks-gke](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[managed-[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-eks-aks-gke](../managed-[kubernetes](../kubernetes/SKILL.md)-eks-aks-gke/SKILL.md)/SKILL.md)
  and is not repeated here.
- `helm` ≥ 3.12, `[kubectl](../../../kubernetes/other/kubectl/SKILL.md)`, `az` CLI ≥ 2.60, and the **Azure Workload
  Identity webhook** already installed on the cluster (bundled by
  `--enable-workload-identity`, but confirm with
  `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get pods -n kube-system -l azure-workload-identity.io/system=true`).
...
```bash
helm repo add argo https://argoproj.[github](../../../../ci-cd/github-actions/other/github/SKILL.md).io/argo-helm
helm repo update
helm install [argocd](../argocd/SKILL.md) argo/[argo-cd](../argo-cd/SKILL.md) \
  --namespace [argocd](../argocd/SKILL.md) --create-namespace \
  --version 7.6.12 \
  --set server.service.type=ClusterIP
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get pods -n [argocd](../argocd/SKILL.md)
```
...
1. **Cross-cluster access.** For Argo CD to manage a second AKS cluster
   ...
   `Azure [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Service Cluster User Role` plus an AKS **Azure RBAC**
   binding (`Azure [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Service RBAC Writer`) scoped to
   `payments-staging`:
   ```bash
   ...
   az role assignment create \
     ...
     --role "Azure [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Service RBAC Writer" \
...
[cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../../kubernetes/security/cert-manager-tls-automation/SKILL.md)/SKILL.md)
...
```bash
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply -f payments-api-staging-application.yaml
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) exec -n [argocd](../argocd/SKILL.md) deploy/[argocd](../argocd/SKILL.md)-repo-server -- az account show
```
...
- [ingress-nginx-configuration](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[ingress-nginx-configuration](../../../kubernetes/networking/ingress-nginx-configuration/SKILL.md)/SKILL.md) and [cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../../kubernetes/security/cert-manager-tls-automation/SKILL.md)/SKILL.md) — Phase 3's Ingress/TLS mechanics.
