...
Argo CD is the reconciler that makes `[gitops](../../../common/gitops/gitops/SKILL.md)` real, but knowing the [GitOps](../../../common/gitops/gitops/SKILL.md) model doesn't tell you
...
[commit](../../../../ci-cd/common/git-workflow/commit/SKILL.md) to add a new service everywhere it belongs. ApplicationSets go further, generating
...
**Done when:** onboarding a new service to an existing environment pattern is one small [commit](../../../../ci-cd/common/git-workflow/commit/SKILL.md), not
...
`[operators-and-crds](../../../kubernetes/workloads/operators-and-crds/SKILL.md)` for what those resources are and `[kubernetes-operations](../../Containers_and_Orchestration/[kubernetes](../../Containers_and_Orchestration/kubernetes/SKILL.md)-operations/SKILL.md)` for reading the
...
Applications on manual sync long-term reintroduces the human-in-the-loop step [GitOps](../../../common/gitops/gitops/SKILL.md) exists to
...
`[release-management](../../../../ci-cd/common/deployment/release-management/SKILL.md)` rather than disabling automation outright.
...
Argo CD is reporting the [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-level problem, not causing it. See `[kubernetes-operations](../../Containers_and_Orchestration/[kubernetes](../../Containers_and_Orchestration/kubernetes/SKILL.md)-operations/SKILL.md)` for
...
Application use the `default` project with unrestricted scope. This is what turns "anyone can [commit](../../../../ci-cd/common/git-workflow/commit/SKILL.md)
an Application manifest" from a security risk into a bounded one. See `[multi-tenancy](../../../common/other/multi-tenancy/SKILL.md)` for the
