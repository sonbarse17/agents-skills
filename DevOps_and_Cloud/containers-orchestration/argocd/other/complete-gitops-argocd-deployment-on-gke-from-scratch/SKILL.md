...
# Complete [GitOps](../../../common/gitops/gitops/SKILL.md)/Argo CD Deployment on GKE, From Scratch
...
[Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) ServiceAccount to a Google service account (GSA) via the
...
- Migrating a team off manual `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply`/`helm upgrade` deploys to GKE
...
- `helm` ≥ 3.12, `[kubectl](../../../kubernetes/other/kubectl/SKILL.md)`, `gcloud` CLI, and the
   ...
   config: |
     {
       "execProviderConfig": {
         ...
         "installHint": "Install gke-gcloud-auth-plugin for use with [kubectl](../../../kubernetes/other/kubectl/SKILL.md) by following https://cloud.google.com/blog/products/containers-[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)/[kubectl](../../../kubernetes/other/kubectl/SKILL.md)-auth-changes-in-gke",
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) exec -n [argocd](../argocd/SKILL.md) deploy/[argocd](../argocd/SKILL.md)-repo-server -- gcloud auth list
```
...
- Default to manual sync until the config repo's CI gates are trusted,
  matching the EKS/AKS variants of this [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md).
...
- [gitops-workflow](../../../devops/skills/[gitops-workflow](../[gitops](../gitops/SKILL.md)-workflow/SKILL.md)/SKILL.md) — the vendor-neutral [GitOps](../../../common/gitops/gitops/SKILL.md) concepts this GKE-specific [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) implements.
