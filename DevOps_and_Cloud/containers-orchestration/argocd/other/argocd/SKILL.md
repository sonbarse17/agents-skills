...
Use this skill to manage [GitOps](../../../common/gitops/gitops/SKILL.md) deployments with Argo CD declaratively and safely.
...
- `resources/rbac-and-projects.md` — AppProject CRD, RBAC policies, SSO, [multi-tenancy](../../../common/other/multi-tenancy/SKILL.md)
...
argocd app create my-app \
  --repo https://[github](../../../../ci-cd/github-actions/other/github/SKILL.md).com/org/repo \
  --path k8s/overlays/production \
  --dest-server https://[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).default.svc \
...
- Store repository credentials as [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) secrets, not as plain-text in Application manifests.

## Related Skills

[kubectl](../../../kubernetes/other/kubectl/SKILL.md), helm
