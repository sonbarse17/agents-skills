...
- oc CLI installed
- Basic [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) knowledge
...
# Deploy from [Docker](../../../docker/other/docker/SKILL.md) Hub
oc new-app [docker](../../../docker/other/docker/SKILL.md).io/library/nginx:latest
...
oc new-app [postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)-persistent \
...
spec:
  source:
    ...
    git:
      ...
      ref: main
  strategy:
    type: [Docker](../../../docker/other/docker/SKILL.md)
    dockerStrategy:
...
oc import-image myapp:latest \
  --from=[docker](../../../docker/other/docker/SKILL.md).io/library/nginx:latest \
  --confirm
...
```bash
oc create secret [docker](../../../docker/other/docker/SKILL.md)-registry regcred \
  --[docker](../../../docker/other/docker/SKILL.md)-server=registry.example.com \
  --[docker](../../../docker/other/docker/SKILL.md)-username=user \
  --[docker](../../../docker/other/docker/SKILL.md)-password=pass
