...
- Managing containers on systems without [Docker](../../../docker/other/docker/SKILL.md)
...
## Key Differences from [Docker](../../../docker/other/docker/SKILL.md)

| Feature | [Docker](../../../docker/other/docker/SKILL.md) | Podman |
|---------|--------|--------|
| Architecture | Client-daemon | Daemonless |
| Root required | Default | Optional (rootless) |
| Pod support | No | Yes ([Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-style) |
| Systemd integration | Limited | Native |
| Socket | [docker](../../../docker/other/docker/SKILL.md).sock | podman.sock (optional) |
...
```bash
# Run container (identical to [Docker](../../../docker/other/docker/SKILL.md))
...
```bash
# Pull image
podman pull [docker](../../../docker/other/docker/SKILL.md).io/library/nginx:latest
...
# Generate [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) YAML from pod
...
[Container]
Image=[docker](../../../docker/other/docker/SKILL.md).io/library/nginx:latest
PublishPort=8080:80
...
# Or use [Docker](../../../docker/other/docker/SKILL.md) Compose with Podman socket
...
```bash
# Play [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) YAML
...
```toml
unqualified-search-registries = ["[docker](../../../docker/other/docker/SKILL.md).io", "quay.io"]

[[registry]]
prefix = "[docker](../../../docker/other/docker/SKILL.md).io"
location = "[docker](../../../docker/other/docker/SKILL.md).io"
...
```bash
# Login to registry
podman login [docker](../../../docker/other/docker/SKILL.md).io
...
podman build --format [docker](../../../docker/other/docker/SKILL.md) -t myapp .
...
- Alias `[docker](../../../docker/other/docker/SKILL.md)` to `podman` for compatibility
