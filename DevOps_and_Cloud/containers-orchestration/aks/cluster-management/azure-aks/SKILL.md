...
- You need tight integration with Azure AD, Key [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md), and Container Registry.
...
```bash
# Install Azure CLI and [kubectl](../../../kubernetes/other/kubectl/SKILL.md)
...
# Verify [kubectl](../../../kubernetes/other/kubectl/SKILL.md)
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) version --client
```
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get nodes -o wide
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) cluster-info
```
...
az aks nodepool upgrade \
  ...
  --cluster-name myapp-aks \
  --name apppool \
  --[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-version 1.28.3
...
helm repo add ingress-nginx https://[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).[github](../../../../ci-cd/github-actions/other/github/SKILL.md).io/ingress-nginx
helm repo update
...
helm install ingress-nginx ingress-nginx/ingress-nginx \
  ...
  --set controller.nodeSelector."[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)\.io/os"=linux \
  --set controller.service.annotations."service\.beta\.[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)\.io/azure-load-balancer-health-probe-request-path"=/healthz \
  --set controller.service.externalTrafficPolicy=Local

# Verify the ingress controller and get external IP
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get svc -n ingress-nginx
```
...
metadata:
  ...
  namespace: myapp
  annotations:
    nginx.ingress.[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/ssl-redirect: "true"
    nginx.ingress.[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/proxy-body-size: "50m"
...
# Enable Key [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) secrets provider
az aks enable-addons \
  --resource-group myapp-rg \
  --name myapp-aks \
  --addons [azure-keyvault](../../../../cloud/azure/security/azure-keyvault/SKILL.md)-secrets-provider
...
# Verify pull access
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) run test --image=myappacr.azurecr.io/myapp:v1.0 --rm -it --restart=Never -- echo "ACR pull works"
```
...
```bash
# Check available [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) versions
az aks get-upgrades \
  --resource-group myapp-rg \
  --name myapp-aks \
  --output table
...
| Symptom | Cause | Fix |
|---------|-------|-----|
| Nodes in `NotReady` state | VM resource exhaustion or network issues | Run `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) describe node <name>` and check events; scale up if needed |
...
| Ingress returns 404 | Service or path mismatch in Ingress spec | Verify `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get ingress` and service endpoints |
...
| Azure Policy violations blocking pods | Restrictive policies applied | Check `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get constrainttemplate` and adjust policy assignments |
| Persistent volume not binding | StorageClass mismatch or zone issue | Verify `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get pvc` and ensure StorageClass matches node pool zones |

## Related Skills

- `[terraform-azure](../../../../cloud/azure/iac/terraform-azure/SKILL.md)` -- Provision AKS clusters with Terraform for repeatable infrastructure.
- `[azure-networking](../../../../cloud/azure/networking/azure-networking/SKILL.md)` -- VNet and subnet configuration required by Azure CNI.
- `[arm-templates](../../../../cloud/azure/iac/arm-templates/SKILL.md)` -- Bicep-based AKS deployment as an alternative to Terraform.
- `[azure-vms](../../../../cloud/azure/compute/azure-vms/SKILL.md)` -- Understanding VM sizes for node pool selection.
