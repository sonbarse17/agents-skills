...
request-level [observability](../../../../observability-monitoring-logging/common/fundamentals/observability/SKILL.md) — out of application code and into a shared sidecar proxy layer. That's
...
Plain [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) already provides L3/L4 segmentation (NetworkPolicy) and L7 HTTP routing at the edge
...
- **Write down the specific problem** the mesh is meant to solve before adopting one — "[observability](../../../../observability-monitoring-logging/common/fundamentals/observability/SKILL.md)"
  alone is rarely enough justification since most of it is achievable via `[distributed-tracing](../../../../observability-monitoring-logging/common/distributed-tracing/distributed-tracing/SKILL.md)` and
...
a fully overwhelmed one during an [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md). Pick one layer to own retry/timeout policy per call
