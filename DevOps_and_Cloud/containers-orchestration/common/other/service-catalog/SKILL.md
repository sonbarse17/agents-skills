...
During an [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md), "who owns this" is a question that should never require asking around. A
...
worse than no entry, because it sends the [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md) responder to the wrong team with false
confidence.
...
call." See `[on-call-management](../../../../observability-monitoring-logging/common/alerting/on-call-management/SKILL.md)` for wiring that owner field into the paging path itself.
...
- **Link [runbooks](../../../../observability-monitoring-logging/common/incident-detection/runbooks/SKILL.md) directly on the service page** — see `[runbooks](../../../../observability-monitoring-logging/common/incident-detection/runbooks/SKILL.md)` for what belongs in them.
