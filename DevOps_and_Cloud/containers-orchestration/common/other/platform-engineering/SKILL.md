...
### Production [Docker](../../../docker/other/docker/SKILL.md) Build
...
Crossplane extends [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) to provision and manage cloud infrastructure through declarative YAML.
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply -f - <<EOF
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) create secret generic aws-creds \
  -n crossplane-system \
              ...
              properties:
                parameters:
                  ...
                  properties:
                    engine:
                      type: string
                      enum: ["postgres", "[mysql](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)"]
                      default: "postgres"
                    engineVersion:
                      type: string
                      default: "15"
...
metadata:
  ...
  description: Create a production-ready Node.js service with CI/CD, [monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md), and [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) manifests.
  tags:
    - recommended
    - nodejs
spec:
    ...
    - title: Infrastructure
      properties:
        database:
          title: Database
          type: string
          enum: ["none", "postgres", "[mysql](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)"]
          default: "none"
        cacheLayer:
          title: Cache
          type: string
  ...
  steps:
    ...
    - id: create-[argocd](../../../argocd/other/argocd/SKILL.md)-app
      name: Register with [ArgoCD](../../../argocd/other/argocd/SKILL.md)
      action: [argocd](../../../argocd/other/argocd/SKILL.md):create-resources
      input:
...
// cookiecutter.json
{
  ...
  "owner_team": "platform",
  "port": "3000",
  "database": ["none", "postgres", "[mysql](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)"],
  "node_version": "18"
}
```
...
metadata:
  ...
  annotations:
    ...
    backstage.io/[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-id: orders-service
    backstage.io/[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-namespace: team-commerce
    [argocd](../../../argocd/other/argocd/SKILL.md)/app-name: orders-service
...
techdocs:
  builder: external
  generator:
    runIn: [docker](../../../docker/other/docker/SKILL.md)
  publisher:
    type: awsS3
    awsS3:
...
### [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Plugin

```bash
# Install [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) plugin
yarn --cwd packages/app add @backstage/plugin-[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)
yarn --cwd packages/backend add @backstage/plugin-[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-backend
```
...
# Install score-k8s for [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) targets
brew install score-spec/tap/score-k8s

# Generate [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) manifests from score.yaml
score-k8s init
...
output "kubeconfig_command" {
  value = "[kubectl](../../../kubernetes/other/kubectl/SKILL.md) config set-context ${var.team_name}-${var.environment} --namespace=${module.namespace.name}"
}
```

### Environment Request CRD ([Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Operator Pattern)
