...
- [no-code-idp-[service-catalog](../service-catalog/SKILL.md)-tools-port-cortex-opslevel](../[no-code-idp-[service-catalog](../../DevOps_and_Cloud/Observability_and_SecOps/service-catalog/SKILL.md)-tools-port-cortex-opslevel](../../DevOps_and_Cloud/Observability_and_SecOps/no-code-idp-[service-catalog](../../DevOps_and_Cloud/Observability_and_SecOps/service-catalog/SKILL.md)-tools-port-cortex-opslevel/SKILL.md)/SKILL.md) — Port's self-service Action model and its `reportWorkflowStatus` pattern are a SaaS-hosted equivalent of the Backstage/custom-API workflow designed here.
- [humanitec-score-workload-specification](../humanitec-score-workload-specification/SKILL.md)/SKILL.md) — the workload-spec side of a self-service request when the provisioning target is a Humanitec Application/Environment rather than a standalone resource.
