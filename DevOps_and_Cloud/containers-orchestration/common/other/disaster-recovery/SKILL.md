...
| Target | Drives |
|---|---|
| RTO (time to recover) | Standby infra, automation level, [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) complexity |
...
system that just failed, it's inaccessible exactly when needed. Write it like a `[runbooks](../../../../observability-monitoring-logging/common/incident-detection/runbooks/SKILL.md)`
