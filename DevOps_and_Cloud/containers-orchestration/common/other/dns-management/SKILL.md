...
- **Test the failover deliberately** on a schedule, the same way you'd test a [disaster-recovery](../disaster-recovery/SKILL.md)
  [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) — see `[disaster-recovery](../disaster-recovery/SKILL.md)` for the broader failover practice this feeds into.
