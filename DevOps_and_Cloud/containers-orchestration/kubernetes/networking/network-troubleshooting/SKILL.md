...
definitively rules out the network layer and hands the investigation to `[root-cause-analysis](../../../../observability-monitoring-logging/common/root-cause-analysis/root-cause-analysis/SKILL.md)` at
