...
type BackupSource struct {
    // Type of source: "postgres", "[mysql](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)", "filesystem", "volume"
    // +kubebuilder:validation:Enum=postgres;[mysql](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md);filesystem;volume
...
func (r *BackupJob) validateBackupJob() (admission.Warnings, error) {
    ...
    validSources := map[string]bool{
        "postgres": true, "[mysql](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)": true, "filesystem": true, "volume": true,
    }
...
- ../../../references/operator-patterns.md — [Kubernetes](../../other/kubernetes/SKILL.md) Operator Design Patterns
