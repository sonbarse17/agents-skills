...
# [Kubernetes](../../other/kubernetes/SKILL.md) for Data Agent

## Purpose
Configures [Kubernetes](../../other/kubernetes/SKILL.md) for data-intensive workloads: Spark, Airflow, Kafka, with GPU scheduling, node pools, and storage optimization.

## Agent Protocol

### Trigger
User request includes: [Kubernetes](../../other/kubernetes/SKILL.md) for data, Spark on K8s, Airflow on K8s, Kafka on K8s, Strimzi, Spark Operator, Volcano, GPU scheduling, node pools, data workloads K8s, Karpenter.
...
## Output
[Kubernetes](../../other/kubernetes/SKILL.md) configuration for data workloads with Spark/Airflow/Kafka setup, GPU strategy, storage plan.

### Response Format
```
## Data Workloads on [Kubernetes](../../other/kubernetes/SKILL.md)
...
- **Spark Operator**: [Kubernetes](../../other/kubernetes/SKILL.md) operator for Apache Spark. Handles driver/executor lifecycle, resource management, dynamic allocation.
...
spec:
  ...
  sparkConf:
    ...
    spark.[kubernetes](../../other/kubernetes/SKILL.md).allocation.driver.requests.cores: "1"
    spark.[kubernetes](../../other/kubernetes/SKILL.md).allocation.executor.requests.cores: "2"
...
spec:
  template:
    spec:
      requirements:
      - key: [kubernetes](../../other/kubernetes/SKILL.md).io/arch
        operator: In
        values: ["amd64"]
      - key: karpenter.sh/[capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../../Cloud_Providers/azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md)-type
        operator: In
        values: ["spot"]
      - key: node.[kubernetes](../../other/kubernetes/SKILL.md).io/instance-type
        operator: In
  ...
  kafka:
    ...
    storage:
      ...
      - id: 0
        ...
        class: kafka-ssd
    rack:
      topologyKey: topology.[kubernetes](../../other/kubernetes/SKILL.md).io/zone
    template:
      pod:
        affinity:
          podAntiAffinity:
            ...
            - labelSelector:
                matchExpressions:
                - key: app.[kubernetes](../../other/kubernetes/SKILL.md).io/name
                  operator: In
                  values:
                  - kafka-cluster
...
### Step 8: Airflow on [Kubernetes](../../other/kubernetes/SKILL.md) with KubernetesExecutor
```yaml
...
spec:
  podSelector:
    matchLabels:
      app.[kubernetes](../../other/kubernetes/SKILL.md).io/name: kafka-cluster
  policyTypes:
  - Ingress
  ingress:
  - from:
    - namespaceSelector:
        matchLabels:
          [kubernetes](../../other/kubernetes/SKILL.md).io/metadata.name: spark
    - namespaceSelector:
        matchLabels:
          [kubernetes](../../other/kubernetes/SKILL.md).io/metadata.name: airflow
    ports:
    - protocol: TCP
      port: 9092
    - protocol: TCP
...
```yaml
apiVersion: tuned.[openshift](../../../openshift/other/openshift/SKILL.md).io/v1
kind: Tuned
metadata:
  name: data-workloads
spec:
  ...
  recommend:
  - match:
    - label: tuned.[openshift](../../../openshift/other/openshift/SKILL.md).io/data
      value: "true"
    priority: 10
...
- Spot nodes must have `cluster-autoscaler.[kubernetes](../../other/kubernetes/SKILL.md).io/safe-to-evict: "true"`.
...
## References
  - ../../../references/data-infrastructure-k8s.md — Data Infrastructure on [Kubernetes](../../other/kubernetes/SKILL.md)
  - ../../../references/data-processing-k8s.md — Data Processing on [Kubernetes](../../other/kubernetes/SKILL.md)
  - ../../../references/data-workloads-k8s.md — Data Workloads on [Kubernetes](../../other/kubernetes/SKILL.md)
  - ../../../references/gpu-storage-k8s.md — GPU & Storage for [Kubernetes](../../other/kubernetes/SKILL.md) Data Workloads
