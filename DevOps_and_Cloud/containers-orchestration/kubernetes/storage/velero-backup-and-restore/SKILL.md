...
[Kubernetes](../../other/kubernetes/SKILL.md) has no built-in way to snapshot "everything a namespace or
...
[Kubernetes](../../other/kubernetes/SKILL.md) API objects to object storage (S3, Azure Blob, GCS, or
...
- Setting up scheduled, recurring backups of a namespace or entire
  cluster's [Kubernetes](../../other/kubernetes/SKILL.md) objects and persistent volumes.
- Recovering from an accidental `[kubectl](../../other/kubectl/SKILL.md) delete namespace`, a botched
...
- Velero CLI and server (commonly Velero 1.14.x/1.15.x at the time of
  ...
  [Kubernetes](../../other/kubernetes/SKILL.md) version — check the Velero compatibility matrix before
...
- Velero's own credentials (the [object-storage](../../../../cloud/common/storage/object-storage/SKILL.md) IAM
  role/service-principal/service-account key) stored as a [Kubernetes](../../other/kubernetes/SKILL.md)
