...
### Input Context
- [Kubernetes](../../other/kubernetes/SKILL.md) cluster version and size
...
- [Monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) and [alerting](../../../../observability-monitoring-logging/common/alerting/alerting/SKILL.md) configuration
...
- [Monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) integration with Prometheus/Grafana
...
|---|---|---|
| **[Kubernetes](../../other/kubernetes/SKILL.md)** | 1.21+ | 1.28+ |
| **Nodes** | 3 (for HA) | 3+ |
...
### Step 7: Configure [Monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
...
# 4. Verify
[kubectl](../../other/kubectl/SKILL.md) -n longhorn-system get pods -w
```
...
### Pitfall 5: Not [Monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) Disk Space
Longhorn allocates disk space for replicas. Running out of disk causes volume to become read-only. Set up [monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) alerts for disk usage at 70%, 85%, 95%. Configure `storageMinAllocatedPercentage` to reserve [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../../Cloud_Providers/azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../capacity/SKILL.md)/SKILL.md)/SKILL.md).
...
- Monthly: test backup restore, review [monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) alerts
...
5. Drain old node: `[kubectl](../../other/kubectl/SKILL.md) cordon <old-node>`
...
- [Monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) alerts for volume degraded and disk space
...
create_longhorn_backup() {
  ...
  [kubectl](../../other/kubectl/SKILL.md) -n longhorn-system create job \
...
monitor_longhorn_health() {
  while true; do
    for node in $([kubectl](../../other/kubectl/SKILL.md) get nodes -o name); do
...
- Configure **Storage Network** (separate from [Kubernetes](../../other/kubernetes/SKILL.md) cluster network) for replica traffic
...
- Restrict **Longhorn UI** access to cluster admins only via [Kubernetes](../../other/kubernetes/SKILL.md) Ingress with OIDC auth
