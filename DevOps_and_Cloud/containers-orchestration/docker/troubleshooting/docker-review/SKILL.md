...
# [Docker](../../other/docker/SKILL.md) Review
...
1. **Read-only.** Read Dockerfiles/Compose; run only read-only inspection/scan
   (`[docker](../../other/docker/SKILL.md) inspect`, `[docker](../../other/docker/SKILL.md) history`, `hadolint`, `trivy image`/`grype`,
...
- [ ] Size and cache claims are quantified (`[docker](../../other/docker/SKILL.md) history`/`dive` layer sizes,
