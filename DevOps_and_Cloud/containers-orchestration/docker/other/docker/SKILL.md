...
For complete Dockerfile templates (Node.js, [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md), Go) and `.dockerignore` patterns, see `resources/images.md`.
