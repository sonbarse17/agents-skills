...
# [MySQL](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)/Postgres
...
### [Docker](../docker/SKILL.md) Compose vs [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)
[Docker](../docker/SKILL.md) Compose: single host, simple networking, good for dev and small deployments. [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md): multi-host, service discovery, auto-scaling, self-healing, complex. Use Compose for development and small production, K8s for large-scale production.
...
| Aspect | [Docker](../docker/SKILL.md) Compose | [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) |
|---|---|---|
