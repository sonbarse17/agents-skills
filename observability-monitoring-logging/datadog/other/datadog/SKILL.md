...
Monitor infrastructure and applications with Datadog's unified [observability](../../../common/fundamentals/observability/SKILL.md) platform.

## When to Use This Skill

Use this skill when:
- Implementing enterprise-grade [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md)
- Setting up APM and distributed tracing
- Creating unified [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) for infrastructure and apps
- Configuring intelligent [alerting](../../../common/alerting/alerting/SKILL.md)
- [Monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md) cloud infrastructure (AWS, Azure, GCP)
...
# Process [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md)
process_config:
  enabled: true

# Container [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md)
...
- Create [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) per service
...
- [aws-vpc](../../../infrastructure/cloud-aws/[aws-vpc](../../Cloud_Providers/aws-vpc/SKILL.md)/) - AWS [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md)
