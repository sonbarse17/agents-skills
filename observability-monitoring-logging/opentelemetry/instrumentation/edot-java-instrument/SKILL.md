...
- [OpenTelemetry Java agent](https://[opentelemetry](../../other/opentelemetry/SKILL.md).io/docs/zero-code/java/agent/)
...
See the [EDOT Java setup guide](https://www.elastic.co/docs/reference/[opentelemetry](../../other/opentelemetry/SKILL.md)/edot-sdks/java/setup) for complete
