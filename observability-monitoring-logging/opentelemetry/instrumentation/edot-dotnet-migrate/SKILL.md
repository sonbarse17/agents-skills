...
- [Migration guide](https://www.elastic.co/docs/reference/[opentelemetry](../../other/opentelemetry/SKILL.md)/edot-sdks/dotnet/migration)
- [EDOT .NET setup](https://www.elastic.co/docs/reference/[opentelemetry](../../other/opentelemetry/SKILL.md)/edot-sdks/dotnet/setup)
- [EDOT .NET configuration](https://www.elastic.co/docs/reference/[opentelemetry](../../other/opentelemetry/SKILL.md)/edot-sdks/dotnet/configuration)
...
1. Add NuGet packages: `Elastic.[OpenTelemetry](../../other/opentelemetry/SKILL.md)` and `[OpenTelemetry](../../other/opentelemetry/SKILL.md).Instrumentation.AspNetCore` (for ASP.NET Core apps)
...
See the [EDOT .NET migration guide](https://www.elastic.co/docs/reference/[opentelemetry](../../other/opentelemetry/SKILL.md)/edot-sdks/dotnet/migration) for
complete examples.
