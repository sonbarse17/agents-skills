...
Azure Resource Manager SDK for managing Application Insights resources for application performance [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md).
...
| `Azure.Monitor.[OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).Exporter` | [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) export | `dotnet add package Azure.Monitor.[OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).Exporter` |
