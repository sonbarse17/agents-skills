...
```bash
pip install azure-monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)-exporter
```
...
| Scenario | Use |
|----------|-----|
| Quick setup, auto-instrumentation | `azure-monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)` (distro) |
| Custom [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) pipeline | `azure-monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)-exporter` (this) |
| Fine-grained control over telemetry | `azure-monitor-[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)-exporter` (this) |
...
from azure.monitor.[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).exporter import AzureMonitorMetricExporter
...
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).sdk._logs import LoggerProvider, LoggingHandler
from [opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).sdk._logs.export import BatchLogRecordProcessor
from azure.monitor.[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md).exporter import AzureMonitorLogExporter
