...
constrained — batch size, test reliability, deployment risk, [incident](../../incident-detection/incident/SKILL.md)
...
- Deciding what to improve next in the delivery pipeline, and wanting
  ...
  deployment risk vs. [incident](../../incident-detection/incident/SKILL.md) recovery) rather than guessing.
...
3. **Define MTTR as the time from a production [incident](../../incident-detection/incident/SKILL.md)'s detection/
...
6. **Watch for the classic ways these metrics get gamed, deliberately or
   ...
   - Change failure rate kept artificially low by not classifying a
     ...
     patching forward instead of formally rolling back so the [incident](../../incident-detection/incident/SKILL.md)
...
8. **Use the specific number to target the specific bottleneck** rather
   ...
   - High MTTR → look at [observability](../../fundamentals/observability/SKILL.md), rollback speed, and [incident](../../incident-detection/incident/SKILL.md)
     process; see
     [incident-response-and-on-call-management](../../../site-reliability-engineering/skills/[incident-response-and-on-call-management](../../../Software_Engineering_and_Other/Frontend/[incident-response](../[incident](../incident/SKILL.md)-response/SKILL.md)-and-[on-call-management](../../alerting/on-call-management/SKILL.md)/SKILL.md)/SKILL.md)
     and
...
- Agree on and document the exact definitions (what counts as "a
  deployment," "a change requiring remediation," an "[incident](../../incident-detection/incident/SKILL.md)") across
...
3. **Change failure rate**: 9% of deploys in the window required a
   ...
   counts) applied consistently rather than judgment-called per [incident](../../incident-detection/incident/SKILL.md).
4. **MTTR**: median 22 minutes for incidents tied to a bad deploy, pulled
   from the [incident](../../incident-detection/incident/SKILL.md) tool's declared/resolved timestamps — fast, because
...
- [incident-response-and-on-call-management](../../../site-reliability-engineering/skills/[incident-response-and-on-call-management](../../../Software_Engineering_and_Other/Frontend/[incident-response](../[incident](../incident/SKILL.md)-response/SKILL.md)-and-[on-call-management](../../alerting/on-call-management/SKILL.md)/SKILL.md)/SKILL.md) —
  the [incident](../../incident-detection/incident/SKILL.md) process that produces the declared/resolved timestamps
