...
siem_integration:
  ...
  operational:
    - [ ] Log pipeline health [monitoring](../../monitoring-strategy/monitoring/SKILL.md)
    - [ ] Storage [capacity](../../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../../Cloud_Providers/azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../capacity/SKILL.md)/SKILL.md)/SKILL.md) [alerting](../../alerting/alerting/SKILL.md)
