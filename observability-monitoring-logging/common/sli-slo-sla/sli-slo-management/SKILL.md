...
- **Burn Rate Alerts**: Instead of absolute thresholds, [alerting](../../alerting/alerting/SKILL.md) is based on the rate of budget consumption. A burn rate of 1 means the budget will be exactly exhausted in the 28-day window.
