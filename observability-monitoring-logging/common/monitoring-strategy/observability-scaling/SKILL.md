...
depends_on:
  ...
  - observability
---
# [Observability](../../fundamentals/observability/SKILL.md) & Scaling: Core Mechanics
...
%%{init: {"theme": "default", "flowchart": {"useMaxWidth": false}}}%%
    ...
    subgraph TracingOpenTelemetry ["[OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)<br><br><br>"]
        Req[Incoming Request] -->|"Extract(TraceContext)"| Span1[Root Span]
        Span1 -->|"Inject(W3C Headers)"| Downstream[Downstream RPC]
    end
```

## [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) Trace Context Propagation
