...
## Purpose
Define and enforce monitoring stack configuration with Prometheus, Grafana, Loki, and ELK for metrics, logs, traces, and [alerting](../../alerting/alerting/SKILL.md).
...
- Tool selection rationale (Prometheus vs [Datadog](../../../datadog/other/datadog/SKILL.md), etc.)
- Prometheus configuration (scrape configs, recording rules, [alerting](../../alerting/alerting/SKILL.md) rules)
...
| Tool | Purpose | When |
|---|---|---|
| **Prometheus** | Metrics collection + [alerting](../../alerting/alerting/SKILL.md) | [Kubernetes](../../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md), dynamic workloads |
| **Grafana** | [Dashboards](../../dashboard-design/dashboards/SKILL.md) + visualization | Universal (any data source) |
    ...
    rules:
      - alert: NodeDown
        ...
        annotations:
          ...
          [runbook](../../incident-detection/runbook/SKILL.md): "https://[runbook](../../incident-detection/runbook/SKILL.md).example.com/node-down"
...
- Grafana [dashboards](../../dashboard-design/dashboards/SKILL.md) organized by folder hierarchy: Infrastructure → Applications → Business → SLOs. No unorganized [dashboards](../../dashboard-design/dashboards/SKILL.md).
...
- Every Prometheus alert has a `[runbook](../../incident-detection/runbook/SKILL.md)` annotation pointing to a recovery procedure.
