...
- Managing [incident](../../incident-detection/incident/SKILL.md) response workflows

## Prerequisites

- [Monitoring](../../monitoring-strategy/monitoring/SKILL.md) system (Prometheus, [Datadog](../../../datadog/other/datadog/SKILL.md), etc.)
...
alerts:
  actionable:
    ...
    - Include [runbook](../../incident-detection/runbook/SKILL.md) links
    ...
    rules:
      ...
      - alert: ServiceDown
        ...
        annotations:
          ...
          runbook_url: "https://wiki.example.com/[runbooks](../../incident-detection/runbooks/SKILL.md)/service-down"
  ...
  - name: 'slack-high'
    slack_configs:
      - channel: '#alerts-high'
        ...
        actions:
          - type: button
            text: '[Runbook](../../incident-detection/runbook/SKILL.md)'
...
*[Runbook](../../incident-detection/runbook/SKILL.md):* {{ .Annotations.runbook_url }}
{{ end }}
{{ end }}
```
...
### [Runbook](../../incident-detection/runbook/SKILL.md) Template
...
- Every alert needs a [runbook](../../incident-detection/runbook/SKILL.md)
...
- Practice [incident](../../incident-detection/incident/SKILL.md) response regularly

## Related Skills

- [prometheus-grafana](../[prometheus-grafana](../../Cloud_Providers/prometheus-grafana/SKILL.md)/) - [Monitoring](../../monitoring-strategy/monitoring/SKILL.md) setup
- [incident-response](../../../security/operations/[incident-response](../[incident](../incident/SKILL.md)-response/SKILL.md)/) - [Incident](../../incident-detection/incident/SKILL.md) handling
- [runbook-creation](../../../compliance/continuity/[runbook-creation](../../../Software_Engineering_and_Other/Frontend/[runbook](../runbook/SKILL.md)-creation/SKILL.md)/) - [Runbook](../../incident-detection/runbook/SKILL.md) creation
