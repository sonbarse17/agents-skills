...
attrition and burnout long before it shows up in an [incident](../../incident-detection/incident/SKILL.md) report.
...
- **Give real recovery time after a bad night or a bad [incident](../../incident-detection/incident/SKILL.md)** — a rough overnight page
