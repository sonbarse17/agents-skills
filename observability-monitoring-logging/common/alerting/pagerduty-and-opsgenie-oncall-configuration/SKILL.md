...
- [servicenow-itsm-integration](../[servicenow-itsm-integration](../../../Software_Engineering_and_Other/Miscellaneous/servicenow-itsm-integration/SKILL.md)/SKILL.md) — syncing incidents created by this PagerDuty/Opsgenie configuration into a ServiceNow [incident](../../incident-detection/incident/SKILL.md)/change record for ITIL-heavy organizations.
