...
Effective patterns for on-call shift transitions, ensuring continuity, context transfer, and reliable [incident](../../incident-detection/incident/SKILL.md) response across shifts.
...
└── 5 min: Verify [alerting](../alerting/SKILL.md) setup
```
...
**The incoming engineer inherits a mid-[incident](../../incident-detection/incident/SKILL.md) and is immediately overwhelmed.**
Use the [incident](../../incident-detection/incident/SKILL.md) handoff template (Template 3) specifically. The outgoing engineer should remain available on Slack for 15 minutes after handoff, even if off-call, to answer clarifying questions.
...
**Incoming engineer cannot verify their [alerting](../alerting/SKILL.md) is working before the outgoing engineer logs off.**
