...
resource limit → `/[k8s-review](../../../../containers-orchestration/kubernetes/troubleshooting/k8s-review/SKILL.md)`, a late alert → `/[observability](../../fundamentals/observability/SKILL.md)`, an unsafe
...
- [ ] Follow-ups are routed to a skill and specific enough to become plans —
      never "improve [monitoring](../../monitoring-strategy/monitoring/SKILL.md)".
