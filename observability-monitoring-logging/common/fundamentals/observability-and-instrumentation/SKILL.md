...
- A production [incident](../../incident-detection/incident/SKILL.md) took too long to diagnose ("we couldn't tell what happened")
- Setting up or reviewing [alerting](../../alerting/alerting/SKILL.md) rules
...
- Launch-day [monitoring](../../monitoring-strategy/monitoring/SKILL.md) checklists and rollback triggers — see the `[shipping-and-launch](../../../../Product_and_Business/ops-and-hiring/shipping-and-launch/SKILL.md)` skill; this skill covers the instrumentation that feeds them
...
### 6. [Alerting](../../alerting/alerting/SKILL.md)
...
2. **It links to a [runbook](../../incident-detection/runbook/SKILL.md)** — even three lines: what it means, first query to run, escalation path.
...
- Fire each new alert once (lower the threshold temporarily) → confirm it reaches the right channel and the [runbook](../../incident-detection/runbook/SKILL.md) link works

## Common Rationalizations

| Rationalization | Reality |
|---|---|
| "I'll add logging after it works" | "After" becomes "after the first [incident](../../incident-detection/incident/SKILL.md)", which is the most expensive moment to discover you're blind. Instrument as you build. |
...
| "We can just look at the [dashboards](../../dashboard-design/dashboards/SKILL.md) when something breaks" | [Dashboards](../../dashboard-design/dashboards/SKILL.md) built without defined questions show you everything except the answer. Start from on-call questions. |
...
- [ ] Every new alert is symptom-based, has a [runbook](../../incident-detection/runbook/SKILL.md) link, and was test-fired once
