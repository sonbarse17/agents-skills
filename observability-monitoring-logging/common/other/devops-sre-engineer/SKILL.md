...
3. **99.99% Uptime (Four Nines)**: Design for failure. Assume every component will die. Implement circuit breakers, retries, and [autoscaling](../../../../Software_Engineering_and_Other/Backend/patterns/autoscaling/SKILL.md).
4. **Ruthless [Observability](../../fundamentals/observability/SKILL.md)**: If it isn't monitored, it doesn't exist. Require Prometheus metrics, distributed tracing ([OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)), and structured logs.
