...
change_types:
  ...
  normal_low:
    ...
    examples:
      ...
      - Adding [monitoring](../../monitoring-strategy/monitoring/SKILL.md) [dashboards](../../dashboard-design/dashboards/SKILL.md) or alerts
...
change_request:
  ...
  testing:
    ...
    post_change_verification:
      ...
      - "No error rate increase in [monitoring](../../monitoring-strategy/monitoring/SKILL.md)"
...
emergency_change_process:
  ...
  step_1_declare:
    actions:
      ...
      - [Incident](../../incident-detection/incident/SKILL.md) commander approves emergency classification
      - Minimum 2 approvers from emergency CAB roster contacted
      - Document initial justification in [incident](../../incident-detection/incident/SKILL.md) channel
...
- [ ] [Monitoring](../../monitoring-strategy/monitoring/SKILL.md) [dashboards](../../dashboard-design/dashboards/SKILL.md) reviewed
...
metrics:
  change_success_rate:
    description: "Percentage of changes implemented without rollback or [incident](../../incident-detection/incident/SKILL.md)"
    target: ">95%"
