...
# eBPF [Observability](../../fundamentals/observability/SKILL.md)

eBPF (extended Berkeley Packet Filter) allows you to run sandboxed programs in the Linux kernel without modifying kernel source code or loading kernel modules. This skill covers using eBPF for deep [observability](../../fundamentals/observability/SKILL.md), network [monitoring](../../monitoring-strategy/monitoring/SKILL.md), and security enforcement across cloud-native infrastructure.

---

## 1. When to Use

Use eBPF-based [observability](../../fundamentals/observability/SKILL.md) when you need:
...
Cilium replaces kube-proxy with eBPF-based networking, providing identity-aware security and deep network [observability](../../fundamentals/observability/SKILL.md) via Hubble.
...
### Hubble Network [Observability](../../fundamentals/observability/SKILL.md)
...
### Process Execution [Monitoring](../../monitoring-strategy/monitoring/SKILL.md)
...
Import these community [dashboards](../../dashboard-design/dashboards/SKILL.md) for eBPF metrics:
...
## 7. Network [Observability](../../fundamentals/observability/SKILL.md)
...
### DNS [Monitoring](../../monitoring-strategy/monitoring/SKILL.md)
...
## 8. Security [Monitoring](../../monitoring-strategy/monitoring/SKILL.md)
...
### File Integrity [Monitoring](../../monitoring-strategy/monitoring/SKILL.md)
