...
## Purpose
Set up crash reporting with proper SDK configuration, symbolication, breadcrumbs, non-fatal error capture, and release health [monitoring](../../monitoring-strategy/monitoring/SKILL.md) across all mobile platforms.
...
- [ ] Release health [monitoring](../../monitoring-strategy/monitoring/SKILL.md) enabled
...
├── Enterprise, full [observability](../../fundamentals/observability/SKILL.md) → [Datadog](../../../datadog/other/datadog/SKILL.md) Crash Reporting / New Relic
│   Pros: Unified metrics + traces + logs + crashes
│   Cons: Expensive, heavy SDK
└── Privacy-first, self-hosted → Countly / [Sentry](../../../sentry/other/sentry/SKILL.md) self-hosted
...
[Sentry](../../../sentry/other/sentry/SKILL.md):
```swift
// iOS
import [Sentry](../../../sentry/other/sentry/SKILL.md)
...
await SentryFlutter.init(
  (options) => options
    ..dsn = 'https://key@o123.ingest.[sentry](../../../sentry/other/sentry/SKILL.md).io/456'
...
// React Native
import * as [Sentry](../../../sentry/other/sentry/SKILL.md) from '@[sentry](../../../sentry/other/sentry/SKILL.md)/react-native';
[Sentry](../../../sentry/other/sentry/SKILL.md).init({
  dsn: 'https://key@o123.ingest.[sentry](../../../sentry/other/sentry/SKILL.md).io/456',
  tracesSampleRate: 0.2,
});
```
...
```kotlin
[Sentry](../../../sentry/other/sentry/SKILL.md).addBreadcrumb(Breadcrumb().apply {
...
### Step 5: Configure Release Health [Monitoring](../../monitoring-strategy/monitoring/SKILL.md)
...
jobs:
  upload-dsym:
    ...
    steps:
      ...
      - name: Upload dSYMs to [Sentry](../../../sentry/other/sentry/SKILL.md)
        run: |
          export SENTRY_AUTH_TOKEN=${{ secrets.SENTRY_AUTH_TOKEN }}
          export SENTRY_ORG=myorg
          export SENTRY_PROJECT=myapp
          [sentry](../../../sentry/other/sentry/SKILL.md)-cli upload-dif --include-sources ./build/ios/*.app.dSYM.zip
    ...
    private val checkRunnable = object : Runnable {
        override fun run() {
            ...
            if (elapsed > TIMEOUT_MS) {
                ...
                [Sentry](../../../sentry/other/sentry/SKILL.md).captureMessage("ANR detected: main thread blocked ${elapsed}ms")
            }
...
### [Monitoring](../../monitoring-strategy/monitoring/SKILL.md) and [Alerting](../../alerting/alerting/SKILL.md)
...
5. Profile latency with distributed tracing ([OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md))
