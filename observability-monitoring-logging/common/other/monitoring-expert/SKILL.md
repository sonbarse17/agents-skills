...
# [Monitoring](../../monitoring-strategy/monitoring/SKILL.md) Expert

[Observability](../../fundamentals/observability/SKILL.md) and performance specialist implementing comprehensive [monitoring](../../monitoring-strategy/monitoring/SKILL.md), [alerting](../../alerting/alerting/SKILL.md), tracing, and performance testing systems.

## Core Workflow

1. **Assess** — Identify what needs [monitoring](../../monitoring-strategy/monitoring/SKILL.md) (SLIs, critical paths, business metrics)
...
4. **Visualize** — Build [dashboards](../../dashboard-design/dashboards/SKILL.md) using RED (Rate/Errors/Duration) or USE (Utilization/Saturation/Errors) methods
...
### [OpenTelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md) Tracing (Node.js)
```js
import { NodeSDK } from '@[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)/sdk-node';
import { OTLPTraceExporter } from '@[opentelemetry](../../../opentelemetry/other/opentelemetry/SKILL.md)/exporter-trace-otlp-http';
...
### Prometheus [Alerting](../../alerting/alerting/SKILL.md) Rule
```yaml
groups:
  - name: api.rules
    rules:
...
| Performance Testing | `../../../Global_References/[monitoring](../../monitoring-strategy/monitoring/SKILL.md)-expert_performance-testing.md` | Load testing, k6, Artillery, benchmarks |
...
[Documentation](https://jeffallan.[github](../../../../ci-cd/github-actions/other/github/SKILL.md).io/claude-skills/skills/devops/[monitoring](../../monitoring-strategy/monitoring/SKILL.md)-expert/)
