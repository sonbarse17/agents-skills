...
Monitor applications and infrastructure with New Relic's [observability](../../../common/fundamentals/observability/SKILL.md) platform.

## When to Use This Skill

Use this skill when:
- Implementing full-stack [observability](../../../common/fundamentals/observability/SKILL.md)
- Setting up APM for applications
- [Monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md) infrastructure health
- Creating custom [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) and alerts
...
- Regular review of unused [dashboards](../../../common/dashboard-design/dashboards/SKILL.md) and alerts

## Related Skills

- [datadog](../[datadog](../datadog/SKILL.md)/) - Alternative [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md) platform
- [prometheus-grafana](../[prometheus-grafana](../../Cloud_Providers/prometheus-grafana/SKILL.md)/) - Open source [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md)
