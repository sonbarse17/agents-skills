...
> **Deployment note:** Diagnostic API availability differs between self-managed, ECH, and [Serverless](../../../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md). See
...
endpoint URL. On [Serverless](../../../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md), TLS is fully managed and transparent.
...
| [Serverless](../../../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md)   | Not applicable — licensing is fully managed by Elastic.                   |
...
| Tool / API                       | Self-managed | ECH           | [Serverless](../../../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md)    |
| -------------------------------- | ------------ | ------------- | ------------- |
