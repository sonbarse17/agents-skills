...
management APIs (see the [elasticsearch-authz](../elasticsearch-authz/SKILL.md) skill).
...
or [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md). Typically combined with role mappings to translate LDAP groups to Elasticsearch roles.
...
Authenticates against an Active Directory domain. Self-managed only — not available on ECH or [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md). Similar to
...
HTTP layer. On ECH, PKI support is limited — check deployment settings. Not available on [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md). Best for
...
`elasticsearch.yml`. On ECH, configure through the Cloud deployment settings UI. On [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md), SAML is handled at the
...
ECH, configure through the Cloud deployment settings UI. Not available on [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md). Like SAML, it relies on browser
...
`elasticsearch.yml`. On ECH, configure through the Cloud deployment settings UI. Not available on [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md). Supports
two token types:
...
Authenticates using Kerberos tickets via the SPNEGO mechanism. Self-managed only — not available on ECH or [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md).
...
use SAML or OIDC. For enterprise directory integration, use LDAP or AD with role mappings (see [elasticsearch-authz](../elasticsearch-authz/SKILL.md)).
...
**Elastic Cloud Hosted (ECH)** is managed by Elastic with no node-level access. **[Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md)** is fully managed SaaS.

| Realm            | Self-managed | ECH                     | [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md)         |
| ---------------- | ------------ | ----------------------- | ------------------ |
