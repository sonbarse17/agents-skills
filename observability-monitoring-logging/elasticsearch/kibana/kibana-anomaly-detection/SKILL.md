...
**Multi-mode:** "We had an [incident](../../../common/incident-detection/incident/SKILL.md) last night, scores were high but now low — is the job healthy?" → Investigate the
[incident](../../../common/incident-detection/incident/SKILL.md) → Explain the score drift → Troubleshoot if `hard_limit` or delayed data is suspected.
