...
- Kibana [audit](../../../../AI_and_Agents/Operations/audit/SKILL.md) logging is not user-configurable on [Serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md). Security events are managed by Elastic as part of the
  platform.
