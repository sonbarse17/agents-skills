...
# GCP [Audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) Logs

[Audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) GCP activity with Cloud [Audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) Logs for compliance, security investigation, and operational [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md).

## When to Use

- Enabling organization-wide [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) logging across GCP projects
...
- Setting up [alerting](../../../common/alerting/alerting/SKILL.md) on administrative and data access events
- Exporting logs to BigQuery for long-term analysis and reporting

## [Audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) Log Types
...
# Add [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) config to org-policy.json:
# {
#   "auditConfigs": [
#     {
#       "service": "allServices",
...
```bash
# Create BigQuery dataset for [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) log export
bq mk --dataset \
  --description "[Audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) log export" \
  --default_table_expiration 0 \
  --location US \
  PROJECT_ID:audit_logs

# Create organization-level log sink to BigQuery
gcloud logging sinks create org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-bigquery \
...
SINK_SA=$(gcloud logging sinks describe org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-bigquery \
...
gsutil mb -l US -b on gs://org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-logs-archive
gsutil retention set 7y gs://org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-logs-archive

gcloud logging sinks create org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-storage \
  storage.googleapis.com/org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-logs-archive \
  --organization=ORG_ID \
  --include-children \
  --log-filter='logName:"cloudaudit.googleapis.com"'

STORAGE_SA=$(gcloud logging sinks describe org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-storage \
  --organization=ORG_ID --format='value(writerIdentity)')

gsutil iam ch "$STORAGE_SA:objectCreator" gs://org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-logs-archive

# Create Pub/Sub sink for real-time streaming to SIEM
gcloud pubsub topics create [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-log-stream

gcloud logging sinks create org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-pubsub \
  pubsub.googleapis.com/projects/PROJECT_ID/topics/[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-log-stream \
  --organization=ORG_ID \
  --include-children \
...
PUBSUB_SA=$(gcloud logging sinks describe org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-pubsub \
  --organization=ORG_ID --format='value(writerIdentity)')

gcloud pubsub topics add-iam-policy-binding [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-log-stream \
  --member="$PUBSUB_SA" \
...
# Data access [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) log entries
...
## [Alerting](../../../common/alerting/alerting/SKILL.md) Policies

```bash
# Alert on service account key creation
gcloud alpha [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md) policies create \
...
# Create [alerting](../../../common/alerting/alerting/SKILL.md) policy using the log-based metric
gcloud alpha [monitoring](../../../common/monitoring-strategy/monitoring/SKILL.md) policies create \
...
```hcl
# Organization-level [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) log sink to BigQuery
resource "google_logging_organization_sink" "audit_bigquery" {
  name             = "org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-bigquery"
  org_id           = var.org_id
...
resource "google_bigquery_dataset" "audit_logs" {
  ...
  location      = "US"
  description   = "Organization [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) log export"
...
resource "google_storage_bucket" "audit_archive" {
  name          = "org-[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)-logs-archive"
  location      = "US"
  force_destroy = false
  project       = var.project_id
...
# Log-based [alerting](../../../common/alerting/alerting/SKILL.md)
...
gcp_audit_logs_checklist:
  ...
  log_routing:
    ...
    - [ ] Inclusion filters verified to capture all [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) log types
  ...
  [alerting](../../../common/alerting/alerting/SKILL.md):
...
- Create log-based metrics and [alerting](../../../common/alerting/alerting/SKILL.md) policies for high-severity events
- Stream critical [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) events via Pub/Sub to SIEM for real-time correlation
- Apply exemptions to exclude high-volume read-only service accounts from data access logs
- Restrict access to [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) log sinks and destinations with least-privilege IAM bindings
- Regularly run BigQuery analysis queries to detect anomalous patterns and generate compliance reports
- Monitor log sink health and delivery latency to ensure continuous [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) coverage
