...
— see `[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)` — not a reason to skip
straight to RL.
...
rewards; `[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)` covers judge
