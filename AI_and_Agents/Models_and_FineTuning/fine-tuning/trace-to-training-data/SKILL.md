...
This skill assumes `[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)`
...
to `[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)` first,
...
- **Scan for secrets and PII before any row ships,
  ...
  remain after redaction. Never [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) secrets.
...
- `[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)` — produces
