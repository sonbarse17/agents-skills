...
`[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)` built the
...
`[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)`, and the
...
2. **Held-out + frozen
   ...
   Re-run `[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)`'s
...
- `[quantized-export](../../inference-serving/quantized-export/SKILL.md)` — the only
