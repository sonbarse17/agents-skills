...
| No eval harness yet | Stop — see `[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)` |
...
exists — see `[eval-harness-first](../../evaluation/eval-harness-first/SKILL.md)`.
