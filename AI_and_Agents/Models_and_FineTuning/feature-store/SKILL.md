...
## Handoff
For model training with feature store integration, hand off to `ml-[ml-pipeline](../../Workflows/ml-pipeline/SKILL.md)`. For serving infrastructure, hand off to `[ml-model-serving](../model-serving/SKILL.md)`.
...
- **[Audit](../../Operations/audit/SKILL.md) trail**: Log all feature retrieval requests with identity and timestamp. Enable compliance [audit](../../Operations/audit/SKILL.md) of feature access.
