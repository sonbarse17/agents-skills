---
name: "Thought Node State Management"
description: >
  Managing state, memory, and context serialization across thought branches.
version: "2.0.0"
author: "j4flmao"
license: "MIT"
type: skill
...
# Thought Node State Management

## Purpose
This document provides a comprehensive guide to managing state, memory, and context serialization across thought branches. It is a core reference file for the `prompt-engineering/tree-of-thoughts` skill.
