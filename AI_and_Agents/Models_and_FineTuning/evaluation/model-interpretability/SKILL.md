...
Who is the explanation for?
  ...
  └── Regulator / Compliance
      ...
      └── [Audit](../../../Operations/common/audit/SKILL.md) trail with prediction + explanation logged
```
...
- Log explanations alongside predictions for [audit](../../../Operations/common/audit/SKILL.md) trail.
