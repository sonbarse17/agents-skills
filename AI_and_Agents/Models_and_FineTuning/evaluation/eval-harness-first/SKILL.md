...
- **Synthetic, when traces don't exist yet:**
  ...
  easiest to write.
- **Goldens are versioned like code** — [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)
...
`[checkpoint-promotion](../../fine-tuning/checkpoint-promotion/SKILL.md)` — a checkpoint that "looks
...
General-purpose evaluation guidance ([dashboards](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md), A/B
...
- `[dataset-curation](../../../../Data_Engineering/dataset-curation/SKILL.md)` — formats these traces into
  training rows.
- `[trace-to-training-data](../../fine-tuning/trace-to-training-data/SKILL.md)` — turns graded traces into
  training examples.
- `[checkpoint-promotion](../../fine-tuning/checkpoint-promotion/SKILL.md)` — consumes
