...
- **Production [monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)**: Log anomaly detection decisions for [audit](../../../Operations/common/audit/SKILL.md). Set up alerts on anomaly rate shifts.
