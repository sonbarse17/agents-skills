...
- [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) (for containerized deployment)
...
ollama run llama3.1:8b "Explain [Kubernetes](../../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) pods in one paragraph"
...
## [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Compose — Full Stack
...
response = ollama.chat(
    model="llama3.1:8b",
    messages=[{"role": "user", "content": "Explain [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) in 3 sentences"}],
)
...
ollama run devops-assistant "Set up a [GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions workflow for [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) builds"
```
...
| GPU not detected | Check `nvidia-smi`, reinstall CUDA drivers, verify [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) GPU runtime |
