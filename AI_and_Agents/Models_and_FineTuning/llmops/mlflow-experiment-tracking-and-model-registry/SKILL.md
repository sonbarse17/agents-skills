...
- Keep the artifact store durable and independent of the tracking server's
  ...
  server restart or [autoscaling](../../../../Software_Engineering_and_Other/Backend/patterns/autoscaling/SKILL.md) event doesn't lose logged models.
...
- Use aliases (or well-documented stage conventions) consistently across
  ...
  reproducibility and [audit](../../../Operations/common/audit/SKILL.md) trail applies end-to-end from run to registered
  model.
