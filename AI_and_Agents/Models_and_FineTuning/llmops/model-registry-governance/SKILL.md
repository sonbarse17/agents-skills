...
# Start MLflow tracking server with [PostgreSQL](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) backend and S3 artifact store
mlflow server \
  --backend-store-uri [postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://mlflow:password@db:5432/mlflow \
...
services:
  mlflow:
    ...
    command: >
      mlflow server
      --backend-store-uri [postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://mlflow:${DB_PASSWORD}@db:5432/mlflow
      --default-artifact-root s3://mlflow-artifacts/models
      --host 0.0.0.0
      --port 5000
      --serve-artifacts
...
| `retired` | Archived for [audit](../../../Operations/common/audit/SKILL.md) | None | None |
...
## [Audit](../../../Operations/common/audit/SKILL.md) Readiness
