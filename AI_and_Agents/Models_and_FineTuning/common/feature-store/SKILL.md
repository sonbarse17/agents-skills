...
Feature requirements
  ...
  ├── Managed, streaming + batch, built-in [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
...
- **Feast**: Open-source, self-hosted, batch features. Supports Redis, DynamoDB. [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) SDK.
- **Tecton**: Managed, declarative, streaming + batch, built-in [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md). Higher cost.
...
- **Feature drift without [alerting](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md)**: Should trigger validation alert on distribution shift.
...
## References
  - ../../../../Global_References/AI_and_Agents/feast-patterns.md — Feast Patterns
  - ../../../../Global_References/AI_and_Agents/feature-architecture.md — Feature Architecture & Tecton
  - ../../../../Global_References/AI_and_Agents/feature-computation.md — Feature Computation
  - ../../../../Global_References/AI_and_Agents/feature-serving.md — Feature Serving
  - ../../../../Global_References/AI_and_Agents/feature-store-advanced.md — Feature Store Advanced Topics
  - ../../../../Global_References/AI_and_Agents/feature-store-fundamentals.md — Feature Store Fundamentals
## Handoff
...
- **[Audit](../../../Operations/common/audit/SKILL.md) trail**: Log all feature retrieval requests with identity and timestamp. Enable compliance [audit](../../../Operations/common/audit/SKILL.md) of feature access.
