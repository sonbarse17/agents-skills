...
> See [shared tools](../references/mcp-tool-reference.md) for cross-phase tools and global parameters. See [scaffold tools](../../../references/scaffold_mcp-tools.md) for full parameter tables.
