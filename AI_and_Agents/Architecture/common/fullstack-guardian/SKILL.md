...
| Error Handling | `../../../references/fullstack-guardian_error-handling.md` | Implementing error flows |
...
| Architecture Decisions | `../../../references/architecture-decisions.md` | Tech selection, monolith vs [microservices](../../../../Software_Engineering_and_Other/Patterns/distributed-systems/microservices/SKILL.md) |
