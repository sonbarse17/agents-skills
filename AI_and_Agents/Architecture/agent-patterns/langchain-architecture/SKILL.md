...
LangSmith is the standard for [observability](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md):

- Request/response logging
- Token usage tracking
- Latency [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
- Error tracking
- Trace visualization
...
result = await agent.ainvoke(
    {"messages": [("user", "Search for [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) tutorials and calculate 25 * 4")]},
    config=config
)
```
