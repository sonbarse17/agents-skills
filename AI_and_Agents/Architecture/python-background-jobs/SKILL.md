...
# [Python](../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) Background Jobs & Task Queues
...
Detailed sections (starting with `## Advanced Patterns`) live in `../../../Global_References/[python](../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)-background-jobs_details.md`. Read that file when the navigation summary above is insufficient.
