...
5. **Design system boundaries around team/service ownership that will
   ...
   [platform-engineering-team-topology-and-operating-model](../../../[internal-developer-platform](../../../Product_and_Business/internal-developer-platform/SKILL.md)/skills/[platform-engineering-team-topology-and-operating-model](../../../Software_Engineering_and_Other/Frontend/platform-engineering/SKILL.md)-team-topology-and-operating-model/SKILL.md)/SKILL.md).
...
- [platform-engineering-team-topology-and-operating-model](../../../[internal-developer-platform](../../../Product_and_Business/internal-developer-platform/SKILL.md)/skills/[platform-engineering-team-topology-and-operating-model](../../../Software_Engineering_and_Other/Frontend/platform-engineering/SKILL.md)-team-topology-and-operating-model/SKILL.md)/SKILL.md) — the team-ownership and "thinnest viable platform" sizing discipline this skill's service-boundary design (step 5) should align with.
