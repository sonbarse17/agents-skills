...
A sudden cost or latency spike in one agent workflow is an [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md), not an
...
multi-day optimization effort under [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) pressure.
...
1. **Scope the blast radius first: one workflow, or everything?** If cost
   ...
   [llm-gateway-and-multi-provider-routing](../../../Models_and_FineTuning/llm-platform/llm-gateway/SKILL.md)-and-multi-provider-routing/SKILL.md)/SKILL.md)
...
7. **Apply the fastest safe stopgap, correlated to the identified change —
   ...
   > config with no previous version saved) risks replacing one [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md)
...
8. **Hand off to the deliberate optimization pass once contained.** Once
   ...
   [llm-cost-and-latency-optimization](../../../Models_and_FineTuning/llm-platform/llm-cost-and-latency-optimization/SKILL.md)/SKILL.md),
   not something to solve inside this [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md).
...
- Segment cost and latency [dashboards](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) by workflow/task type from the
...
- Prefer a clean rollback to the last known-good configuration over a
  forward fix improvised during the [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) — validate any forward fix
...
- Keep a running timeline of prompt/tool/model/index changes with
  ...
  memory during each [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md).
- Distinguish "legitimate traffic growth" from "regression" early and
  explicitly — treating growth as an [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) wastes urgency budget, and
...
- **Symptom:** An aggregate, account-wide cost dashboard shows only a
  ...
  **Fix:** Segment cost and latency metrics by workflow/task type as a
  standing practice, not only when an [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) is already suspected —
  aggregate-only [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) structurally cannot catch this class of spike
  early.
...
1. **Scope:** Cost [dashboards](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) for two other agents sharing the same model
...
- [llm-cost-and-latency-optimization](../../../Models_and_FineTuning/llm-platform/llm-cost-and-latency-optimization/SKILL.md)/SKILL.md) — the deliberate optimization pass this investigation feeds into once the active spike is contained.
...
- [llm-gateway-and-multi-provider-routing](../../../Models_and_FineTuning/llm-platform/llm-gateway/SKILL.md)-and-multi-provider-routing/SKILL.md)/SKILL.md) — when the spike is provider- or routing-correlated rather than workflow-specific.
- [vector-database-ingestion-pipeline-for-rag](../../../Infrastructure/vector-search/vector-database-ingestion-pipeline-for-rag/SKILL.md)/SKILL.md) — when a re-indexing run correlates with a RAG-backed workflow's spike.
