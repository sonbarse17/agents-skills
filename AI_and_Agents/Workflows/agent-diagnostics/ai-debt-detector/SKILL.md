...
AI agents generate code that passes the happy path but hides debt: missing error handling, orphaned resources, ignored failure modes, hallucinated packages, silent architectural drift. This skill forces a targeted [audit](../../../Operations/common/audit/SKILL.md) for the exact patterns AI agents get wrong.
...
AI agents systematically optimize for "looks correct" and "passes the happy path." They miss failure modes, orphan resources, and hallucinate dependencies at rates significantly higher than manual code. This skill forces an [audit](../../../Operations/common/audit/SKILL.md) for those specific blind spots.
