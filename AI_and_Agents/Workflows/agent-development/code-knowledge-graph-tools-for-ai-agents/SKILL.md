...
document/code *text*
([rag-pipeline-design](../../../Models_and_FineTuning/rag-embeddings/rag-pipeline-design/SKILL.md)/SKILL.md)) and from operating
...
([mcp-server-development](../../../Infrastructure/mcp/mcp-server-development/SKILL.md)/SKILL.md) covers
...
- An MCP-compatible agent host (Claude Code, Cursor, [GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Copilot, Gemini
...
3. **Wire the tool's MCP server into your agent host.** All three are
   ...
   (Claude Code, Cursor, Gemini CLI, [GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Copilot each have their own MCP
   config location); see
   [mcp-server-development](../../../Infrastructure/mcp/mcp-server-development/SKILL.md)/SKILL.md) for the
...
- **Symptom:** An agent given access to a code-graph tool's MCP server still
  ...
  **Fix:** Check that the tool's description in the MCP tool list makes
  ...
  guidance in [mcp-server-development](../../../Infrastructure/mcp/mcp-server-development/SKILL.md)/SKILL.md))
...
- [mcp-server-development](../../../Infrastructure/mcp/mcp-server-development/SKILL.md)/SKILL.md) — the general pattern for building and hardening an MCP server; these three tools each ship their own MCP server, so this skill is about consuming, not building, that surface.
- [rag-pipeline-design](../../../Models_and_FineTuning/rag-embeddings/rag-pipeline-design/SKILL.md)/SKILL.md) — semantic retrieval over document/code text, a distinct concern from these tools' structural graph indexing; the two are complementary when a corpus needs both kinds of lookup.
...
- [agent-architecture-design](../../../Architecture/agent-patterns/agent-architecture-design/SKILL.md)/SKILL.md) — the general principle of giving an agent narrow, well-described tools; applies directly to how these tools' MCP surfaces (17 tools for GitNexus vs. one for CodeGraph) get selected correctly by a model.
