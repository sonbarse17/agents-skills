...
1. **[GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Flavored Markdown (GFM)**: Enforce strict GFM standards. Use tables for dense data presentation.
