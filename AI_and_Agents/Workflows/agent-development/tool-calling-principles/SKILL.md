...
2. **Defensive Calling (The Principle of Skepticism)**
   ...
   *Axiom of Defense*: Validate assumptions prior to actuation. If reading a file, assume it may be locked or absent. Never [commit](../../../../ci-cd/common/git-workflow/commit/SKILL.md) destructive actions without explicit verification of state.
