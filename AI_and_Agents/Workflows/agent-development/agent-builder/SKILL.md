...
1. Consult the `[elasticsearch-esql](../../../../DevOps_and_Cloud/observability-monitoring-logging/elasticsearch/queries/elasticsearch-esql/SKILL.md)` skill for ES|QL syntax
2. Create tool:
...
For ES|QL syntax, functions, operators, and parameter rules, use the `[elasticsearch-esql](../../../../DevOps_and_Cloud/observability-monitoring-logging/elasticsearch/queries/elasticsearch-esql/SKILL.md)` skill. For workflow YAML
