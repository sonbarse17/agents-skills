...
2. **Scan for the P0 and P1 patterns** in `../../../Global_References/pattern-catalog.md`; the severity tiers are defined at the top of the catalog. Quick passes cover P0 and P1, a full [audit](../../Operations/common/audit/SKILL.md) covers P2 as well; default to a full [audit](../../Operations/common/audit/SKILL.md) unless asked for a quick pass. Quote the offending text for each flag rather than describing it.
