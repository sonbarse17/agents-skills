...
**Task:** a [code-review](../../../../DevOps_and_Cloud/ci-cd/common/other/code-review/SKILL.md) assistant agent's system prompt was producing
...
```
# Role
You are a [code-review](../../../../DevOps_and_Cloud/ci-cd/common/other/code-review/SKILL.md) assistant for the Payments team's [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) services.
