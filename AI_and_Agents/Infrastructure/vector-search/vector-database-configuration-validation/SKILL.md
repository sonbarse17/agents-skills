...
4. Run the existing 50-query labeled eval set (already maintained per
   [rag-pipeline-design](../../../Models_and_FineTuning/rag-embeddings/rag-pipeline-design/SKILL.md)/SKILL.md)) against both
   collections:
   ```
...
- [rag-pipeline-design](../../../Models_and_FineTuning/rag-embeddings/rag-pipeline-design/SKILL.md)/SKILL.md) — where the labeled (query, expected document) eval set referenced throughout this skill is originally built and maintained.
- [agent-evaluation-and-guardrails](../../../Models_and_FineTuning/evaluation/agent-evaluation-and-guardrails/SKILL.md)/SKILL.md) — general evaluation-harness discipline (thresholds decided in advance, regression gating) applied here specifically to retrieval recall.
