...
Full template library and detailed worked examples live in `../../../references/similarity-search-patterns_details.md`. Read that file when you need the concrete templates.
