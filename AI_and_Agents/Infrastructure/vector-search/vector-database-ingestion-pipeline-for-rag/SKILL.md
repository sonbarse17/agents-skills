...
in [rag-pipeline-design](../../../Models_and_FineTuning/rag-embeddings/rag-pipeline-design/SKILL.md)/SKILL.md)) and from the
...
1. **Run chunking as a discrete, versioned pipeline stage** with its
   ...
   them (per
   [rag-pipeline-design](../../../Models_and_FineTuning/rag-embeddings/rag-pipeline-design/SKILL.md)/SKILL.md)) means
...
- [rag-pipeline-design](../../../Models_and_FineTuning/rag-embeddings/rag-pipeline-design/SKILL.md)/SKILL.md) — the retrieval-quality design decisions (chunk size/overlap, metadata to attach, re-index-on-change principle) this pipeline implements operationally without repeating the design rationale.
