...
- **Pinecone**: Managed, scalable, [serverless](../../../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md)
...
Detailed pattern documentation lives in `../../../references/rag-implementation_details.md`. Read that file when the navigation tier above is insufficient.
