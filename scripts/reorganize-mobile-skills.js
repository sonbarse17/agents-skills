...
const PRIMARY_ROOT = 'Mobile';

const MISFILED = {
  appkit: 'Software_Engineering_and_Other/Frontend/desktop', // this is "desktop-appkit" macOS content
};

const SUBFOLDER = {
  android: 'platforms', ios: 'platforms', flutter: 'platforms', 'flutter-expert': 'platforms',
  'react-native-architecture': 'platforms',
  'deep-linking': 'features', 'in-app-purchase': 'features', 'push-notifications': 'features',
  'mobile-widgets': 'features', 'mobile-localization': 'features', 'ar-vr': 'features',
  'mdm-device-management': 'features',
  deployment: 'common', networking: 'common', patterns: 'common', testing: 'common',
  'mobile-engineer': 'common',
};
...
const outPath = path.join(REPO_ROOT, 'scripts', '.mobile-reorg-manifest.json');
