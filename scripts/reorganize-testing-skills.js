...
const PRIMARY_ROOT = 'Software_Engineering_and_Other/Testing';

const MISFILED = {
  testing: 'Mobile', // this is "mobile-testing" content
};

const SUBFOLDER = {
  'unit-testing': 'unit', 'angularjs-unit-test': 'unit',
  'integration-testing': 'integration', 'testcontainers-integration-testing-configuration': 'integration',
  'e2e-testing': 'e2e', 'e2e-testing-patterns': 'e2e', 'quality-e2e-testing': 'e2e', 'visual-testing': 'e2e',
  'contract-testing': 'contract', 'pact-configuration-validation': 'contract',
  'pact-contract-testing-configuration': 'contract',
  'acceptance-testing': 'acceptance', 'run-acceptance-tests': 'acceptance', 'bdd-atdd': 'acceptance',
  'regression-testing': 'regression', 'smoke-testing': 'regression',
  qa: 'common', 'qa-architect': 'common', 'test-master': 'common', test: 'common',
  'bats-testing-patterns': 'common', jest: 'common', 'test-driven-development-ecosystem': 'common',
};
...
const outPath = path.join(REPO_ROOT, 'scripts', '.testing-reorg-manifest.json');
