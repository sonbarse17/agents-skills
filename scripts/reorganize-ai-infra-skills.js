...
const PRIMARY_ROOT = 'AI_and_Agents/Infrastructure';

const MISFILED = {
  kql: 'cloud/azure/database', // Kusto Query Language, matches the azure-kusto cluster there
};

const SUBFOLDER = {
  'atlassian-mcp': 'mcp', mcp: 'mcp', 'mcp-builder': 'mcp', 'mcp-developer': 'mcp',
  'mcp-patterns': 'mcp', 'mcp-server-development': 'mcp', 'ui-widget-developer': 'mcp',
  'rag-architect': 'rag', 'rag-design': 'rag', 'rag-implementation': 'rag',
  'rag-infrastructure': 'rag', 'rag-observability-evals': 'rag', 'rag-patterns': 'rag',
  'hybrid-search-implementation': 'vector-search', 'similarity-search-patterns': 'vector-search',
  'vector-database-configuration-validation': 'vector-search',
  'vector-database-ingestion-pipeline-for-rag': 'vector-search',
  'vector-database-operations-pinecone-weaviate-milvus': 'vector-search',
  'vector-database-ops': 'vector-search', 'vector-databases': 'vector-search',
  'vector-index-tuning': 'vector-search',
};
...
const outPath = path.join(REPO_ROOT, 'scripts', '.ai-infra-reorg-manifest.json');
