...
const PRIMARY_ROOT = 'AI_and_Agents/Operations';

const MISFILED = {
  authentication: 'Software_Engineering_and_Other/Backend/auth', // this is "frontend-authentication" content
  'monitoring-expert': 'observability-monitoring-logging/common/other',
  'apm-observability': 'observability-monitoring-logging/common/other',
};

const SUBFOLDER = {
  'agent-core': 'agent-ops', 'agent-observability': 'agent-ops', 'ai-evals': 'agent-ops',
  'ai-safety': 'agent-ops', 'recsys-pipeline-architect': 'agent-ops',
  'ai-cost-optimization': 'cost-observability', 'ai-observability': 'cost-observability',
  'db-review': 'common', audit: 'common',
};
...
const outPath = path.join(REPO_ROOT, 'scripts', '.ai-ops-reorg-manifest.json');
