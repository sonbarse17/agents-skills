...
| Pattern | iOS | [Android](../../platforms/android/SKILL.md) | Flutter | React Native |
|---|---|---|---|---|
...
### [Android](../../platforms/android/SKILL.md) — Jetpack Compose
```kotlin
// ViewModel
@HiltViewModel
...
### [Android](../../platforms/android/SKILL.md) — MVI with StateFlow
```kotlin
// Intent (user actions)
...
Domain has no imports from [Android](../../platforms/android/SKILL.md), iOS, or platform SDKs.
```
...
### [Android](../../platforms/android/SKILL.md) — Navigation Compose
```kotlin
...
### [Android](../../platforms/android/SKILL.md) — Hilt
```kotlin
@Module
...
### ViewModel Test ([Android](../../platforms/android/SKILL.md))
```kotlin
...
- Prefer `StateFlow` over `LiveData` on [Android](../../platforms/android/SKILL.md) for better lifecycle handling
...
- `../../references/patterns_design-patterns.md` — Mobile Design Patterns
...
- `mobile/[android](../../platforms/android/SKILL.md)` — Jetpack Compose, Hilt, Navigation
