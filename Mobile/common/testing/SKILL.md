...
- CI provider ([GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions, Bitrise, GitLab CI)
...
### [Android](../../platforms/android/SKILL.md) — JUnit + MockK
```kotlin
...
### [Android](../../platforms/android/SKILL.md) — ViewModel Test
```kotlin
...
### [Android](../../platforms/android/SKILL.md) — Paparazzi
```kotlin
@Test
...
### [Android](../../platforms/android/SKILL.md) — Compose Test (Integration)
```kotlin
@Test
fun createOrderFlow() {
  composeTestRule.setContent {
...
### Espresso ([Android](../../platforms/android/SKILL.md)) + Compose
```kotlin
@Test
fun createOrderE2E() {
  composeTestRule.onNodeWithTag("add-order").performClick()
...
### [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions — Flutter
```yaml
name: Tests
on: [pull_request]
jobs:
...
```yaml
name: [Android](../../platforms/android/SKILL.md) Tests
on: [pull_request]
jobs:
  test:
    runs-on: ubuntu-latest
...
### [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions — React Native
```yaml
name: RN Tests
on: [pull_request]
jobs:
...
### Configuration
```kotlin
// [Android](../../platforms/android/SKILL.md) — build.gradle.kts
...
## Performance Testing
```kotlin
// [Android](../../platforms/android/SKILL.md) — Macrobenchmark for startup/scrolling
...
## References
- `../../references/testing_integration-testing.md` — Mobile Integration Testing
...
- `../../references/testing_unit-testing.md` — Mobile Unit Testing
...
- `mobile/[android](../../platforms/android/SKILL.md)` — Espresso, Robolectric, Compose test
