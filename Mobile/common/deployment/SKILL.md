...
- Fastlane setup for iOS and [Android](../../platforms/android/SKILL.md)
...
│   └── [Android](../../platforms/android/SKILL.md) → Play Internal Testing (no review, 100 testers)
├── External beta (>100 users)
│   ├── iOS → TestFlight External (up to 10k testers, Beta App Review required)
│   └── [Android](../../platforms/android/SKILL.md) → Open Beta (unlimited, no review)
├── Production release
│   ├── iOS → App Store via App Store Connect (App Review, 24-48h typical)
│   └── [Android](../../platforms/android/SKILL.md) → Play Console Production track (review hours-days)
└── Enterprise/internal (org-owned devices only)
    ├── iOS → Apple Developer Enterprise Program + MDM
    └── [Android](../../platforms/android/SKILL.md) → Managed Google Play + EMM / sideload APK
```
...
Configure Fastfile with beta and release lanes for both iOS and [Android](../../platforms/android/SKILL.md) with proper build and upload steps. Include Matchfile for code signing, Appfile for metadata, and Deliverfile/Supplyfile for store metadata.
...
Automate app metadata, screenshots, and pricing with Deliver (iOS) and Supply ([Android](../../platforms/android/SKILL.md)) to eliminate manual store work.
...
### [Android](../../platforms/android/SKILL.md) Fastfile

```ruby
default_platform(:[android](../../platforms/android/SKILL.md))

platform :[android](../../platforms/android/SKILL.md) do
...
### Supplyfile ([Android](../../platforms/android/SKILL.md) Metadata)
```ruby
...
metadata_path("metadata/[android](../../platforms/android/SKILL.md)")
...
### [Android](../../platforms/android/SKILL.md) Code Signing
```bash
# Generate keystore
...
jobs:
  build:
    ...
    steps:
      ...
      - uses: actions/upload-artifact@v4
        with:
          name: [android](../../platforms/android/SKILL.md)-apk-aab
...
[android](../../platforms/android/SKILL.md)-beta:
  stage: deploy
  tags:
    - linux
  script:
...
- [Android](../../platforms/android/SKILL.md): Use `sign-APK` or `sign-aab` step
...
5. google-play-deploy ([Android](../../platforms/android/SKILL.md))
...
Build number: auto-increment from git
  ...
  [Android](../../platforms/android/SKILL.md) versionCode = number_of_commits
  [Android](../../platforms/android/SKILL.md) versionName = manual bump
```
...
### [Android](../../platforms/android/SKILL.md) — Play Console Staged Rollout
```kotlin
...
### [Android](../../platforms/android/SKILL.md) Enterprise (Managed Google Play)
...
## [Android](../../platforms/android/SKILL.md) App Bundle (AAB)
...
### Fastlane Screengrab ([Android](../../platforms/android/SKILL.md))
```ruby
lane :screenshots do
  screengrab(
    ...
    locales: ["en-US", "de", "ja"],
    output_directory: "screenshots/[android](../../platforms/android/SKILL.md)"
  )
  supply(
...
```kotlin
// [Android](../../platforms/android/SKILL.md) — Build Config Fields in build.gradle.kts
[android](../../platforms/android/SKILL.md) {
  buildTypes {
    debug {
...
- `mobile/[android](../../platforms/android/SKILL.md)` — [Android](../../platforms/android/SKILL.md)-specific build variants
