...
### [Android](../android/SKILL.md) — JUnit + MockK
```kotlin
...
### [Android](../android/SKILL.md) — ViewModel Test
```kotlin
...
### [Android](../android/SKILL.md) — Paparazzi
```kotlin
@Test
...
### [Android](../android/SKILL.md) — Compose Test (Integration)
```kotlin
@Test
fun createOrderFlow() {
  composeTestRule.setContent {
...
### Espresso ([Android](../android/SKILL.md)) + Compose
```kotlin
@Test
fun createOrderE2E() {
  composeTestRule.onNodeWithTag("add-order").performClick()
...
```yaml
name: [Android](../android/SKILL.md) Tests
on: [pull_request]
jobs:
  test:
    runs-on: ubuntu-latest
...
### Configuration
```kotlin
// [Android](../android/SKILL.md) — build.gradle.kts
...
## Performance Testing
```kotlin
// [Android](../android/SKILL.md) — Macrobenchmark for startup/scrolling
...
- `mobile/[android](../android/SKILL.md)` — Espresso, Robolectric, Compose test
