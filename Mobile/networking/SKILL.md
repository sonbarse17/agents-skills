...
│   ├── [Android](../android/SKILL.md) → Retrofit + OkHttp
│   ├── Flutter → Dio or http
│   └── React Native → Axios or fetch
├── GraphQL (flexible queries, real-time subs)
│   ├── iOS → Apollo iOS
│   ├── [Android](../android/SKILL.md) → Apollo Kotlin
...
└── WebSocket (real-time, bidirectional)
    ...
    └── [Android](../android/SKILL.md) → OkHttp WebSocket
```
...
```kotlin
// [Android](../android/SKILL.md) — Paging 3
...
### [Android](../android/SKILL.md) — OkHttp CertificatePinner
```kotlin
...
- **Blocking main thread with network calls**: ANR on [Android](../android/SKILL.md), frozen UI on iOS. Always async
...
- `mobile/[android](../android/SKILL.md)` — OkHttp, Retrofit specifics
