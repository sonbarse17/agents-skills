...
| Pattern | iOS | [Android](../android/SKILL.md) | Flutter | React Native |
|---|---|---|---|---|
...
### [Android](../android/SKILL.md) — Jetpack Compose
```kotlin
// ViewModel
@HiltViewModel
...
### [Android](../android/SKILL.md) — MVI with StateFlow
```kotlin
// Intent (user actions)
...
Domain has no imports from [Android](../android/SKILL.md), iOS, or platform SDKs.
```
...
### [Android](../android/SKILL.md) — Navigation Compose
```kotlin
...
### ViewModel Test ([Android](../android/SKILL.md))
```kotlin
...
- Prefer `StateFlow` over `LiveData` on [Android](../android/SKILL.md) for better lifecycle handling
...
- `mobile/[android](../android/SKILL.md)` — Jetpack Compose, Hilt, Navigation
