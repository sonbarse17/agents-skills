...
macOS, Windows, iOS, and [Android](../../platforms/android/SKILL.md) — from zero-touch onboarding to remote wipe.
...
| [Android](../../platforms/android/SKILL.md) | Native | `adb shell getprop ro.crypto.state` |
