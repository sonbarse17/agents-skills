...
│   └── [Android](../../platforms/android/SKILL.md): server call Google Play Developer API with OAuth2
...
├── [Android](../../platforms/android/SKILL.md) only → Play Billing 6+ (with BillingClient.queryProductDetailsAsync)
├── iOS + [Android](../../platforms/android/SKILL.md) cross-platform
...
[Android](../../platforms/android/SKILL.md) (Google Play Console):
...
### Step 4: Implement Purchase Flow ([Android](../../platforms/android/SKILL.md) — Play Billing 6+)
...
// [Android](../../platforms/android/SKILL.md) — Google Play Developer API
...
```kotlin
// [Android](../../platforms/android/SKILL.md) — Subscription offer
...
### Purchase Flow
- **Not acknowledging [Android](../../platforms/android/SKILL.md) purchases**: 3-day window then auto-refund. Call `acknowledgePurchase` immediately
...
- **Not handling refund notifications**: Users get refunded but keep access. Implement RTDN (iOS) and real-time developer notifications ([Android](../../platforms/android/SKILL.md))
...
### [Android](../../platforms/android/SKILL.md) Testing
...
- Auto-renewable subscriptions acknowledged within 3 days ([Android](../../platforms/android/SKILL.md)) or auto-refund
...
- `mobile/[android](../../platforms/android/SKILL.md)` — Play Billing, Play Console product config
