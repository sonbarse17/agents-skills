...
## Purpose
Guide for implementing deep linking across iOS and [Android](../../platforms/android/SKILL.md) using universal links, custom URL schemes, and deferred deep linking.
...
### Output Artifact
Deep link configuration: apple-app-site-association JSON, [Android](../../platforms/android/SKILL.md) intent filters, route mapping table, navigation handler code.
...
├── Production → Universal Links (iOS) / App Links ([Android](../../platforms/android/SKILL.md))
...
├── Jetpack Navigation ([Android](../../platforms/android/SKILL.md)) → NavDeepLink with route patterns
...
4. **Deep link setup — [Android](../../platforms/android/SKILL.md)** — Add `intent-filter` to the activity in `AndroidManifest.xml` that should receive deep links. Include `<data [android](../../platforms/android/SKILL.md):scheme="https" [android](../../platforms/android/SKILL.md):host="app.example.com" />` and `[android](../../platforms/android/SKILL.md):autoVerify="true"`. For custom schemes, add a second intent-filter with `[android](../../platforms/android/SKILL.md):scheme="myapp"`. Verify app links via Google Search Console: add Digital Asset Links JSON at `https://{domain}/.well-known/assetlinks.json`. Check verification with `adb shell dumpsys package domain-preferred-apps`. Handle incoming links in `MainActivity.onCreate()` or `onNewIntent()` by extracting the intent data URI.
...
- **[Android](../../platforms/android/SKILL.md) auto-verify timeout**: Verification is asynchronous. May take minutes to hours after first install.
...
```xml
<!-- [Android](../../platforms/android/SKILL.md) AndroidManifest.xml -->
<activity [android](../../platforms/android/SKILL.md):name=".MainActivity">
  <intent-filter [android](../../platforms/android/SKILL.md):autoVerify="true">
    <action [android](../../platforms/android/SKILL.md):name="[android](../../platforms/android/SKILL.md).intent.action.VIEW" />
    <category [android](../../platforms/android/SKILL.md):name="[android](../../platforms/android/SKILL.md).intent.category.DEFAULT" />
    <category [android](../../platforms/android/SKILL.md):name="[android](../../platforms/android/SKILL.md).intent.category.BROWSABLE" />
    <data [android](../../platforms/android/SKILL.md):scheme="https" [android](../../platforms/android/SKILL.md):host="app.example.com" />
  </intent-filter>
</activity>
```
...
| Scenario | iOS Command | [Android](../../platforms/android/SKILL.md) Command |
|----------|-------------|-----------------|
| Cold start (app not running) | `xcrun simctl openurl booted "https://app.example.com/profile/42"` | `adb shell am start -W -a [android](../../platforms/android/SKILL.md).intent.action.VIEW -d "https://app.example.com/profile/42"` |
| Warm start (app in background) | Same command (app resumes) | Same command (calls `onNewIntent`) |
| URL scheme (debug) | `xcrun simctl openurl booted "myapp://profile/42"` | `adb shell am start -W -a [android](../../platforms/android/SKILL.md).intent.action.VIEW -d "myapp://profile/42"` |
...
| [Android](../../platforms/android/SKILL.md) auto-verify timeout | App link not verified for hours | Use Digital Asset Links API, test with `adb shell dumpsys` |
...
- Run `adb shell dumpsys package domain-preferred-apps` to verify [Android](../../platforms/android/SKILL.md) app link status
...
### [Android](../../platforms/android/SKILL.md) Deep Link Handler (MainActivity)
```kotlin
...
## References
  ...
  - ../../references/deep-linking_platform-differences.md — Platform Differences — Deep Linking
