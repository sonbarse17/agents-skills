...
Cross-platform need?
├── Single platform
│   ├── [Android](../../platforms/android/SKILL.md) → Room (compile-time SQL, Flow, migrations)
...
- **Room** ([Android](../../platforms/android/SKILL.md)): compile-time SQL verification, Flow-based reactive queries, migrations
- **SQLDelight** (KMP): cross-platform, type-safe, generates drivers for [Android](../../platforms/android/SKILL.md)/iOS/JVM
- **CoreData** (iOS native): SwiftUI @FetchRequest, iCloud sync, lightweight migration
- **Realm**: [MongoDB](../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md) Atlas Device Sync, real-time sync, larger binary
...
[Android](../../platforms/android/SKILL.md): ConnectivityManager.NetworkCallback. iOS: NWPathMonitor. UI: persistent offline banner, sync status indicator, disable mutation buttons with tooltip.
...
### Repository Pattern — [Android](../../platforms/android/SKILL.md) Room
```kotlin
// OrderRepository.kt
...
### Background Sync — [Android](../../platforms/android/SKILL.md) WorkManager
```kotlin
...
```kotlin
// [Android](../../platforms/android/SKILL.md) — offline state in ViewModel
...
- `../../../references/offline-first_offline-first-architecture.md` — Offline-First Architecture
...
- `mobile/[android](../../platforms/android/SKILL.md)` — WorkManager, Room specifics
