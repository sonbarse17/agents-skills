...
## Purpose
Build glanceable, performant widget experiences across iOS and [Android](../../platforms/android/SKILL.md) with proper timeline management, refresh strategies, and platform-specific best practices.

## Agent Protocol

### Trigger
User mentions widgets, iOS WidgetKit, [Android](../../platforms/android/SKILL.md) App Widgets, Live Activities, complications, watchOS complications, Wear OS tiles, widget timeline, widget families, widget configuration, widget deep linking, widget refresh, or widget testing.
...
5. **[Android](../../platforms/android/SKILL.md) App Widgets**: RemoteViews with configuration activity.
...
//   [android](../../platforms/android/SKILL.md):layout_height="match_parent"
//   [android](../../platforms/android/SKILL.md):orientation="vertical"
//   [android](../../platforms/android/SKILL.md):padding="@dimen/widget_margin">
//   <LinearLayout [android](../../platforms/android/SKILL.md):orientation="horizontal" [android](../../platforms/android/SKILL.md):layout_width="match_parent">
//     <TextView [android](../../platforms/android/SKILL.md):id="@+id/widget_title" .../>
//     <ImageButton [android](../../platforms/android/SKILL.md):id="@+id/widget_settings" .../>
//   </LinearLayout>
//   <LinearLayout [android](../../platforms/android/SKILL.md):id="@+id/widget_list_container" [android](../../platforms/android/SKILL.md):orientation="vertical" .../>
// </LinearLayout>
```
...
// [Android](../../platforms/android/SKILL.md) periodic refresh
class TodoWidgetProvider : AppWidgetProvider() {
  override fun onUpdate(...) {
...
// [Android](../../platforms/android/SKILL.md): PendingIntent with custom URI
