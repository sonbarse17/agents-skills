...
- Platform(s) (iOS, [Android](../../platforms/android/SKILL.md), or both)
...
2. **[Android](../../platforms/android/SKILL.md) String Resources**: strings.xml with plurals and quantity strings.
...
```kotlin
// [Android](../../platforms/android/SKILL.md) locale formatting
...
```kotlin
// [Android](../../platforms/android/SKILL.md) locale management
...
```xml
<!-- [Android](../../platforms/android/SKILL.md) RTL — use start/end instead of left/right -->
<LinearLayout
  xmlns:[android](../../platforms/android/SKILL.md)="http://schemas.[android](../../platforms/android/SKILL.md).com/apk/res/[android](../../platforms/android/SKILL.md)"
  [android](../../platforms/android/SKILL.md):layout_width="match_parent"
  [android](../../platforms/android/SKILL.md):layout_height="wrap_content"
  [android](../../platforms/android/SKILL.md):paddingStart="16dp"
  [android](../../platforms/android/SKILL.md):paddingEnd="16dp"
  [android](../../platforms/android/SKILL.md):layout_marginStart="8dp"
  [android](../../platforms/android/SKILL.md):layout_marginEnd="8dp"
  [android](../../platforms/android/SKILL.md):gravity="start">

  <ImageView
    [android](../../platforms/android/SKILL.md):layout_width="24dp"
    [android](../../platforms/android/SKILL.md):layout_height="24dp"
    [android](../../platforms/android/SKILL.md):layout_marginEnd="8dp"
    [android](../../platforms/android/SKILL.md):src="@drawable/ic_back"
    [android](../../platforms/android/SKILL.md):autoMirrored="true"/>

  <TextView
    [android](../../platforms/android/SKILL.md):layout_width="0dp"
    [android](../../platforms/android/SKILL.md):layout_height="wrap_content"
    [android](../../platforms/android/SKILL.md):layout_weight="1"
    [android](../../platforms/android/SKILL.md):textAlignment="viewStart"/>
</LinearLayout>

<!-- Manifest -->
<application
  [android](../../platforms/android/SKILL.md):supportsRtl="true"
  ...>
```
...
```yaml
# .[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/workflows/localization-check.yml
...
jobs:
  check:
    ...
    steps:
      ...
      - name: Check [Android](../../platforms/android/SKILL.md) missing translations
        run: |
          for lang in es fr de ja zh ar he; do
            dir="[android](../../platforms/android/SKILL.md)/src/main/res/values-$lang"
            if [ "$lang" = "en" ]; then dir="[android](../../platforms/android/SKILL.md)/src/main/res/values"; fi
      ...
      - name: Validate [Android](../../platforms/android/SKILL.md) placeholder consistency
        run: |
          [python](../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) scripts/check_android_placeholders.py \
            --base [android](../../platforms/android/SKILL.md)/src/main/res/values/strings.xml \
            --translations [android](../../platforms/android/SKILL.md)/src/main/res/values-*/strings.xml
...
2. Always use NSLocalizedString (iOS) or @string/ ([Android](../../platforms/android/SKILL.md)) for all strings.
...
## References
  - ../../../Global_References/[android](../../platforms/android/SKILL.md)-localization.md — [Android](../../platforms/android/SKILL.md) Localization
  ...
  - ../../references/mobile-localization_rtl-support.md — Right-to-Left (RTL) Support
## Handoff
