...
- **Performance [Monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)**: Regular [profiling](../../Software_Engineering_and_Other/Frontend/performance/profiling/SKILL.md) and optimization
...
- **Performance Bottlenecks**: [Profiling](../../Software_Engineering_and_Other/Frontend/performance/profiling/SKILL.md) tools and optimization strategies
