...
# [Unity](../unity/SKILL.md) ECS Patterns

Production patterns for [Unity](../unity/SKILL.md)'s Data-Oriented Technology Stack (DOTS) including Entity Component System, Job System, and Burst Compiler.

## When to Use This Skill

- Building high-performance [Unity](../unity/SKILL.md) games
...
Detailed pattern documentation lives in `../../../Global_References/[unity](../unity/SKILL.md)-ecs-patterns_details.md`. Read that file when the navigation tier above is insufficient.
