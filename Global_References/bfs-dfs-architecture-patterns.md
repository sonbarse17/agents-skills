---
name: "Search Architecture Patterns (BFS/DFS)"
description: >
  Detailed architecture patterns for Tree of Thoughts search algorithms.
version: "2.0.0"
author: "j4flmao"
license: "MIT"
type: skill
...
# Search Architecture Patterns (BFS/DFS)

## Purpose
This document provides a comprehensive guide to detailed architecture patterns for tree of thoughts search algorithms. It is a core reference file for the `prompt-engineering/tree-of-thoughts` skill.
