...
## Handoff
`[data-distributed-compute](../distributed-compute/SKILL.md)` for Spark/Ray/Dask cluster tuning
`[data-data-catalog](../data-catalog/SKILL.md)` for registering batch tables and lineage
`[data-data-warehouse](../data-warehouse/SKILL.md)` for warehouse integration with batch pipelines
