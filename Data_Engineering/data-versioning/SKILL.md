...
git [commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) -m "add raw customers dataset"
...
# [Commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) changes
lakectl [commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) lakefs://data-lake/etl-dev -m "add revenue column to fct_orders"
...
# Rollback
lakectl revert lakefs://data-lake/main --[commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) <bad-[commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)-hash>
...
```
Experiment:
  - Git [commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) (code): a1b2c3d
  - DVC [commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) (data): e4f5g6h
...
```yaml
# .[github](../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/workflows/data-pipeline.yml
jobs:
  data-pipeline:
...
Track the full lineage from source data through transformations to output models. For DVC, lineage is captured in `dvc.yaml` and `dvc.lock` files — each stage defines its dependencies and outputs. For LakeFS, lineage is tracked through [commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) history and metadata. For Nessie, lineage is captured at the catalog level with atomic commits. Use OpenLineage alongside these tools for end-to-end lineage across the entire data platform.
...
- Run data validation in pre-[commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hooks (LakeFS) or pipeline stages (DVC).
...
- Use LakeFS hooks for automated data quality checks on [commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md).
...
| Multi-table atomic | No | Yes ([commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)) | Yes ([commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)) | No |
...
- Nessie metadata: each [commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) stores a snapshot of the Iceberg catalog. Multi-table commits are atomic but increase metadata size.
...
| Great Expectations | Data validation in pre-[commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hooks |
...
branching_strategy:
  main:
    description: "Production data — serving [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md), ML models, reports"
...
- **Metadata caching**: Cache Nessie [commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) log in memory (Redis) for fast branch listing operations.
...
## Handoff
`[data-data-platform](../data-platform/SKILL.md)` for versioning infrastructure. `[data-data-catalog](../data-catalog/SKILL.md)` for cataloging versioned datasets. `[data-data-observability](../data-[observability](../../DevOps_and_Cloud/Observability_and_SecOps/observability/SKILL.md)/SKILL.md)` for [monitoring](../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) version health. `[data-data-quality](../data-quality/SKILL.md)` for quality gates on merge.
