...
| Throughput drops mid-run | Check the power/temp log before assuming a config bug — see Thermal [Monitoring](../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) |
...
The worksheet in `../../Global_References/Data_Engineering/uma-accounting.md`
...
2. Estimate weights + optimizer + gradients +
   activations from `../../Global_References/Data_Engineering/uma-accounting.md`.
...
## Thermal [Monitoring](../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
...
`../../Global_References/Data_Engineering/uma-accounting.md`.
