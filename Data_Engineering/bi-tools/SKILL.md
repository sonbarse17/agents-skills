...
- Number of [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) and refresh frequency
...
- [ ] Dashboard scheduling and [alerting](../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md) configured
...
Best for design-heavy [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md).
...
No raw SQL in [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) — always use semantic layer.
...
developer (create and edit [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)),
viewer (view only, no export),
restricted (specific [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) only).
...
[Audit](../../AI_and_Agents/Operations/common/audit/SKILL.md): dashboard views, query executions, data exports.
Monthly access review, quarterly permission [audit](../../AI_and_Agents/Operations/common/audit/SKILL.md).
...
bi_tool_comparison:
  tableau:
    ...
    best_for: "Enterprise [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md), visual analytics, complex charting"
...
performance_optimization:
  dashboard_loading:
    ...
    - "Implement cache warming: pre-load [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) before business hours"
  
  query_optimization:
    - "Avoid cross-joins, unaggregated detail tables in [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)"
...
security_model:
  ...
  data_governance:
    - "No raw SQL in [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) — use semantic layer"
    - "Certified [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) only for executive consumption"
    - "Deprecated [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) removed within 30 days"
...
├── Decentralized (teams build own [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)) → Power BI or Tableau
└── Hybrid (central models, team [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)) → Any with semantic layer
```

## Rules
- One semantic layer, many [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)
...
- No raw SQL in [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) — use semantic layer
- Executive [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) show trends, not raw numbers
...
│   └── No → Power BI / Tableau (managed [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md))
├── Real-time [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) (< 5s latency)?
...
| Dashboard per business question | Exploding dashboard count | Parameterized [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) |
...
- **Data masking**: Mask PII columns (email, SSN) in shared [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md).
- **[Audit](../../AI_and_Agents/Operations/common/audit/SKILL.md) logging**: Log all query executions, dashboard views, and exports to SIEM.
- **Network security**: Deploy BI tools in private subnets with reverse proxy (Nginx/Caddy) and WAF.
- **Token management**: Rotate embed tokens hourly; never expose API keys in [dashboards](../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md).

## Handoff
`[data-data-warehouse](../data-warehouse/SKILL.md)` for optimizing warehouse for BI queries
`[data-data-quality](../data-quality/SKILL.md)` for validating dashboard data accuracy
