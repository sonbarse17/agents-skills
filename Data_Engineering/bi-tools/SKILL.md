...
- Number of [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) and refresh frequency
...
- [ ] Dashboard scheduling and [alerting](../../observability-monitoring-logging/common/alerting/alerting/SKILL.md) configured
...
Best for design-heavy [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md).
...
No raw SQL in [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) — always use semantic layer.
...
developer (create and edit [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)),
viewer (view only, no export),
restricted (specific [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) only).
...
bi_tool_comparison:
  tableau:
    ...
    best_for: "Enterprise [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md), visual analytics, complex charting"
...
performance_optimization:
  dashboard_loading:
    ...
    - "Implement cache warming: pre-load [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) before business hours"
  
  query_optimization:
    - "Avoid cross-joins, unaggregated detail tables in [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)"
...
security_model:
  ...
  data_governance:
    - "No raw SQL in [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) — use semantic layer"
    - "Certified [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) only for executive consumption"
    - "Deprecated [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) removed within 30 days"
...
├── Decentralized (teams build own [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)) → Power BI or Tableau
└── Hybrid (central models, team [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)) → Any with semantic layer
```

## Rules
- One semantic layer, many [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)
...
- No raw SQL in [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) — use semantic layer
- Executive [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) show trends, not raw numbers
...
│   └── No → Power BI / Tableau (managed [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md))
├── Real-time [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) (< 5s latency)?
...
| Dashboard per business question | Exploding dashboard count | Parameterized [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) |
...
- **Data masking**: Mask PII columns (email, SSN) in shared [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md).
...
- **Token management**: Rotate embed tokens hourly; never expose API keys in [dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md).
