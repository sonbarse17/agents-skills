...
`[deployment-strategies](../../DevOps_and_Cloud/ci-cd/common/deployment/deployment-strategies/SKILL.md)` for how to stage and gate a rollout, since migration phases are just
...
- **Use a feature flag to control which path serves live traffic**, so verification can happen
  ...
  `[feature-flags](../../DevOps_and_Cloud/ci-cd/common/other/feature-flags/SKILL.md)` for the mechanics of that rollout.
