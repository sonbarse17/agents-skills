...
- **CHECK:** `../../Global_References/Data_Engineering/gotcha-checks.md` G1 — the wheel's
  CUDA build tag.
...
- **CHECK:** `../../Global_References/Data_Engineering/gotcha-checks.md` G2 — is flash-attn
...
- **FIX:** bare pip — skip flash-attn, use SDPA (unchanged). On
  ...
  `../../Global_References/Data_Engineering/gotcha-checks.md` G2.
...
- **CHECK:** `../../Global_References/Data_Engineering/gotcha-checks.md` G3 — read `free -g`
...
- **CHECK:** `../../Global_References/Data_Engineering/gotcha-checks.md` G4 — sample
...
- **CHECK:** `../../Global_References/Data_Engineering/gotcha-checks.md` G5 — observed step
...
- **CHECK:** `../../Global_References/Data_Engineering/gotcha-checks.md`
...
- **CHECK:** `../../Global_References/Data_Engineering/gotcha-checks.md` G7 — capability
...
- **CHECK:** `../../Global_References/Data_Engineering/gotcha-checks.md` G10 — the
...
`../../Global_References/Data_Engineering/gotcha-checks.md`. See also
