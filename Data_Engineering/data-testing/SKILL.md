...
data-diff \
  --warehouse-type [postgresql](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) \
  --warehouse-type [postgresql](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) \
  --warehouse-conn "[postgresql](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://user:pass@prod:5432/warehouse" \
  --warehouse-conn "[postgresql](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://user:pass@staging:5432/warehouse" \
