...
- CI/CD setup ([GitHub](../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions, dbt Cloud CI)
...
#### [GitHub](../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions Pipeline

```yaml
# .[github](../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/workflows/dbt_ci.yml
name: dbt CI/CD
on: [pull_request]
jobs:
  dbt_ci:
...
│   └── Data [Vault](../../Security/cryptography-secrets/vault/SKILL.md) → Hubs, links, satellites
└── CI/CD for data?
    ├── Yes → dbt CI with [GitHub](../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions + slim CI
...
- **Credential management**: Store warehouse credentials in dbt profiles via environment variables; never [commit](../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md).
...
`data-quality` for data quality testing and [monitoring](../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
