...
- Evaluate DMS [Serverless](../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) vs provisioned suitability
...
### 2.5 DMS [Serverless](../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) (if applicable)
Replication configs, [serverless](../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) replications, DCU utilization.
...
## Step 3: Collect [Observability](../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md) Data (7-Day Historical)
...
**DMS [Serverless](../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md)** (namespace: AWS/DMS, if applicable):
...
- DMS [Serverless](../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md) evaluated for variable workloads
...
### Appendix
Refer to the AWS DMS documentation for detailed guidance on best practices, [monitoring](../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md), troubleshooting, release notes, [serverless](../../Software_Engineering_and_Other/Patterns/data-performance/serverless/SKILL.md), and data validation.
