...
- Evaluate DMS [Serverless](../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md) vs provisioned suitability
...
### 2.5 DMS [Serverless](../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md) (if applicable)
Replication configs, [serverless](../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md) replications, DCU utilization.
...
**DMS [Serverless](../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md)** (namespace: AWS/DMS, if applicable):
...
- DMS [Serverless](../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md) evaluated for variable workloads
