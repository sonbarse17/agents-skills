...
# etc/catalog/postgres.properties ([PostgreSQL](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md))
connector.name=[postgresql](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)
connection-url=jdbc:[postgresql](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://postgres-prod:5432/analytics
...
# etc/catalog/[mongodb](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md).properties ([MongoDB](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md))
connector.name=[mongodb](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)
[mongodb](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md).connection-url=[mongodb](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)://${MONGO_USER}:${MONGO_PASS}@mongo-prod:27017
[mongodb](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md).read-preference=primaryPreferred
...
|---|---|---|
| **[PostgreSQL](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)** | Full SQL pushdown (filter, agg, join, sort, limit) | Predicate, aggregation, limit |
| **Hive/Iceberg** | Partial pushdown (partition pruning, filter) | Partition filter, row filter |
| **[MongoDB](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)** | Partial (filter, project) | Predicate pushdown only |
| **Kafka** | N/A (stream data) | Topic + partition filter only |
| **Elasticsearch** | Full (query DSL → filter/agg) | Predicate, aggregation |
| **[MySQL](../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)** | Full SQL pushdown | Predicate, aggregation, limit |
...
connector.name=[mongodb](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)
pushdown_filter_enabled=true
pushdown_aggregation_enabled=false  # [MongoDB](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md) aggregation pushdown limited
```
...
```sql
-- Cross-source join: orders (Postgres) + customers (Hive) + payments ([MongoDB](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md))
SELECT
    o.order_id,
    o.total_amount,
...
LEFT JOIN [mongodb](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md).payments.transactions p ON o.order_id = p.order_id
...
-- Good: push aggregation to [PostgreSQL](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) (if enabled)
...
JOIN [postgresql](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md).ecommerce.customers c
    ON o.customer_id = c.id
LEFT JOIN [mongodb](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md).reviews.reviews r
