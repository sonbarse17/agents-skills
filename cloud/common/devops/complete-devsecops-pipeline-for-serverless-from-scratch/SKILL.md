...
# Complete [DevSecOps](../../../../Security/devsecops/SKILL.md) Pipeline Deployment for [Serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md), From Scratch

## Purpose

A [serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md) [DevSecOps](../../../../Security/devsecops/SKILL.md) pipeline's gate sequence differs from the
[Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) variant of this skill in two structural ways. First, its SCA
...
admission policy bounds what a compromised pod can do in [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md).
...
- A [serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md) pipeline has individual security tools bolted on ad hoc,
...
- The user wants to understand why a [serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md) pipeline's primary release
  gate is IAM role scope rather than a [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)-style admission policy,
...
- A working CI/CD pipeline that already packages a zip/layer, uploads it,
  and deploys via SAM/[Serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md) Framework with alias-based traffic
  shifting — see
  [complete-[cicd-pipeline](../../../../DevOps_and_Cloud/CI_CD/cicd-pipeline/SKILL.md)-deployment-for-[serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-from-scratch](../../../cicd-tooling/skills/[complete-[cicd-pipeline](../../CI_CD/cicd-pipeline/SKILL.md)-deployment-for-[serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-from-scratch](../complete-[cicd-pipeline](../../CI_CD/cicd-pipeline/SKILL.md)-deployment-for-[serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-from-scratch/SKILL.md)/SKILL.md)
...
This is where the [serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-specific risk lives. Scan **after** the
...
dependencies than for a comparable [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) service running behind a
...
not just a CI-side check, and is the [serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md) equivalent of requiring an
admission-controller-verified signed image in [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) (per
[supply-chain-security-slsa-sbom](../[supply-chain-security-slsa-sbom](../../../Security/[supply-chain-security](../../../Security/supply-chain-security/SKILL.md)-slsa-sbom/SKILL.md)/SKILL.md)).

### Phase 4 — Least-privilege execution-role scoping as the primary release gate

Where the [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) variant's primary pre-deploy gate is a policy check
on the rendered manifest, the [serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md) equivalent is a **diff review of
...
Package upload, SAM/[Serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md) Framework deploy, alias-based canary — per
[complete-[cicd-pipeline](../../../../DevOps_and_Cloud/CI_CD/cicd-pipeline/SKILL.md)-deployment-for-[serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-from-scratch](../../../cicd-tooling/skills/[complete-[cicd-pipeline](../../CI_CD/cicd-pipeline/SKILL.md)-deployment-for-[serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-from-scratch](../complete-[cicd-pipeline](../../CI_CD/cicd-pipeline/SKILL.md)-deployment-for-[serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-from-scratch/SKILL.md)/SKILL.md).
...
involved (unlike [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)'s External Secrets Operator model):
...
- **Symptom:** The SCA scan (Phase 2) reports clean because it only
  ...
  **Fix:** Scan the unpacked, fully-resolved package after the
  ...
  base CI/CD [serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md) skill, restated here because it's specifically the
...
jobs:
  ...
  build: { /* zip packaging, per the base [serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md) CI/CD skill */ }
...
- [complete-[cicd-pipeline](../../../../DevOps_and_Cloud/CI_CD/cicd-pipeline/SKILL.md)-deployment-for-[serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-from-scratch](../../../cicd-tooling/skills/[complete-[cicd-pipeline](../../CI_CD/cicd-pipeline/SKILL.md)-deployment-for-[serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-from-scratch](../complete-[cicd-pipeline](../../CI_CD/cicd-pipeline/SKILL.md)-deployment-for-[serverless](../../../../DevOps_and_Cloud/Containers_and_Orchestration/serverless/SKILL.md)-from-scratch/SKILL.md)/SKILL.md) — the base packaging/deploy pipeline this skill adds security gates onto.
