...
compute layer is genuinely unavoidable, and `[caching-strategies](../../../../Software_Engineering_and_Other/Backend/patterns/caching-strategies/SKILL.md)` for keeping a fast local cache
...
drift, use `[cost-optimization](../../cost/cost-optimization/SKILL.md)`; this step is about not committing to a shape that is expensive by
construction.
...
case" — that is its own cost, covered in `[multi-cloud](../../other/multi-cloud/SKILL.md)`.
