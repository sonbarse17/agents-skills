...
import { S3Event } from '[aws-lambda](../../../aws/compute/aws-lambda/SKILL.md)';
...
## Handoff
`[backend-caching](../../../../DevOps_and_Cloud/Observability_and_SecOps/caching/SKILL.md)` for CDN cache strategy and edge caching patterns
