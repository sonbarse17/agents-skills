...
- Awareness of, and a check against, any active
  ...
  database replica, a cross-region backup [vault](../../../../Security/cryptography-secrets/vault/SKILL.md), a manually retained
...
2. **Cross-check every candidate against tags and DR/backup policy
   ...
   backup [vault](../../../../Security/cryptography-secrets/vault/SKILL.md)/retention policy (e.g. a snapshot inside an AWS Backup
   [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) Lock retention window, or a disk explicitly retained as a
...
- [disaster-recovery-and-backup-strategy](../[disaster-recovery-and-backup-strategy](../[disaster-recovery](../../Observability_and_SecOps/disaster-recovery/SKILL.md)-and-backup-strategy/SKILL.md)/SKILL.md) —
  ...
  (pilot-light replica, cross-region backup [vault](../../../../Security/cryptography-secrets/vault/SKILL.md), retained pre-change
