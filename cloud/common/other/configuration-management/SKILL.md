...
[Ansible](../../../../infrastructure-as-code/ansible/other/ansible/SKILL.md), Chef, and Puppet exist to describe *desired state*, not a sequence of steps. The moment
...
[Ansible](../../../../infrastructure-as-code/ansible/other/ansible/SKILL.md) has no way to know if it changed anything. The `apt` or `package` module, by contrast,
...
the module system of configuration management — see `[terraform-modules](../../../../infrastructure-as-code/terraform/modules/terraform-modules/SKILL.md)` for the equivalent
...
simpler and more reliable. See `[immutable-infrastructure](../../../../infrastructure-as-code/common/patterns/immutable-infrastructure/SKILL.md)` for that model and how to decide
between the two.
...
`[infrastructure-testing](../../../../infrastructure-as-code/common/testing/infrastructure-testing/SKILL.md)` for the broader pattern this fits into.
...
fleet that was never evaluated against the [immutable-infrastructure](../../../../infrastructure-as-code/common/patterns/immutable-infrastructure/SKILL.md) alternative — rather than
