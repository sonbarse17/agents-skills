...
[Ansible](../../../../DevOps_and_Cloud/Infrastructure_as_Code/ansible/SKILL.md), Chef, and Puppet exist to describe *desired state*, not a sequence of steps. The moment
...
[Ansible](../../../../DevOps_and_Cloud/Infrastructure_as_Code/ansible/SKILL.md) has no way to know if it changed anything. The `apt` or `package` module, by contrast,
...
the module system of configuration management — see `[terraform-modules](../../../../DevOps_and_Cloud/Infrastructure_as_Code/terraform-modules/SKILL.md)` for the equivalent
...
simpler and more reliable. See `[immutable-infrastructure](../../../../DevOps_and_Cloud/Infrastructure_as_Code/immutable-infrastructure/SKILL.md)` for that model and how to decide
between the two.
...
`[infrastructure-testing](../../../../DevOps_and_Cloud/Infrastructure_as_Code/infrastructure-testing/SKILL.md)` for the broader pattern this fits into.
...
fleet that was never evaluated against the [immutable-infrastructure](../../../../DevOps_and_Cloud/Infrastructure_as_Code/immutable-infrastructure/SKILL.md) alternative — rather than
