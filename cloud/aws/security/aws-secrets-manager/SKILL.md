...
resource "aws_lambda_function" "rotation" {
  ...
  function_name    = "secrets-rotation-[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)"
...
connection_string = (
    f"[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://{creds['username']}:{creds['password']}"
