...
4. **Correlate findings with the [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md)** by matching:
   - Affected services or components
   - Timeframes (when the vulnerability was introduced vs. when the [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md) occurred)
...
5. **Present findings to the customer** with:
   ...
   - Explanation of how this vulnerability may relate to the [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md)
...
- Link the security finding to the observed [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md) behavior when possible.
