...
- Setting up OIDC federation for [GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md) Actions or other CI/CD systems
...
## OIDC Federation for [GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md) Actions

```bash
# Create the [GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md) OIDC identity provider
aws iam create-open-id-connect-provider \
  --url https://token.actions.githubusercontent.com \
  --client-id-list sts.amazonaws.com \
  --thumbprint-list "6938fd4d98bab03faadb97b34396831e3780aea1"

# Create a role for [GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md) Actions with repo-scoped trust
aws iam create-role \
...
[GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md) Actions workflow usage:
...
```hcl
# OIDC provider for [GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md) Actions
resource "aws_iam_openid_connect_provider" "[github](../../../../ci-cd/github-actions/other/github/SKILL.md)" {
  url             = "https://token.actions.githubusercontent.com"
  client_id_list  = ["sts.amazonaws.com"]
  thumbprint_list = ["6938fd4d98bab03faadb97b34396831e3780aea1"]
}

# Role for [GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md) Actions
resource "aws_iam_role" "github_actions" {
  ...
  assume_role_policy = jsonencode({
    ...
    Statement = [{
      Effect = "Allow"
      Principal = {
        Federated = aws_iam_openid_connect_provider.[github](../../../../ci-cd/github-actions/other/github/SKILL.md).arn
      }
      Action = "sts:AssumeRoleWithWebIdentity"
      Condition = {
        StringEquals = {
