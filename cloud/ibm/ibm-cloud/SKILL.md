...
resource "ibm_resource_instance" "cos" {
  name              = "cos-prod"
  service           = "cloud-[object-storage](../../common/storage/object-storage/SKILL.md)"
  plan              = "standard"
  location          = "global"
  resource_group_id = data.ibm_resource_group.rg.id
}
...
resource "ibm_iam_access_group_policy" "ops_backup" {
  ...
  resource_attributes {
    name     = "serviceName"
    value    = "cloud-[object-storage](../../common/storage/object-storage/SKILL.md)"
...
- Configure **IBM Cloud Databases for etcd** with [autoscaling](../../../Software_Engineering_and_Other/Backend/patterns/autoscaling/SKILL.md) for K8s control plane durability
