...
Build persistent agents on Azure AI Foundry using the Microsoft Agent Framework [Python](../../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) SDK.
...
async def main():
    async with (
        ...
        result = await agent.run("Calculate the factorial of 20 in [Python](../../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)")
        print(result.text)
```
...
| Tool | Import | Purpose |
|------|--------|---------|
| `HostedCodeInterpreterTool` | `from agent_framework import HostedCodeInterpreterTool` | Execute [Python](../../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) code |
...
async def main():
    async with (
        ...
        result = await agent.run(
            "Search for [Python](../../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) best practices and summarize",
            thread=thread,
        )
