...
description: >-
  Azure Bot Service Management SDK for Python. Use for creating, managing, and
  configuring Azure Bot Service resources.

  Triggers: "azure-mgmt-botservice", "AzureBotService", "bot management",
  "conversational AI", "bot channels".
license: MIT
metadata:
  author: Microsoft
  version: 1.0.0
...
5. **Store MSA App ID/Secret securely** — use Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md)
...
| File | Contents |
|------|----------|
| [../../../../../Global_References/cloud/azure-mgmt-botservice-py_capabilities.md](../../../../../Global_References/cloud/azure-mgmt-botservice-py_capabilities.md) | Additional non-hero capabilities, operation-group coverage, and production checklists. |
| [../../../../../Global_References/cloud/azure-mgmt-botservice-py_non-hero-scenarios.md](../../../../../Global_References/cloud/azure-mgmt-botservice-py_non-hero-scenarios.md) | Dedicated non-hero examples for secondary/advanced scenarios. |
