...
description: >
  Azure Key Vault Certificates library for Rust. Create, manage, and use X.509
  certificates including self-signed and CA-issued.

  Triggers: "keyvault certificates rust", "CertificateClient rust", "create
  certificate rust", "self-signed certificate rust", "X.509 rust".
license: MIT
metadata:
  author: Microsoft
...
# Azure Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) Certificates library for Rust

Manage X.509 certificates for TLS/SSL, code signing, and authentication.

Use this skill when:

- An app needs to create or manage X.509 certificates in Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) from Rust
...
Certificates in Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) have an associated key. Use the Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) Keys SDK for crypto operations:
...
| Role                             | Access                      |
| -------------------------------- | --------------------------- |
| `Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) Certificate User`     | Use certificates            |
| `Key [Vault](../../../../../Security/cryptography-secrets/vault/SKILL.md) Certificates Officer` | Full certificate management |
...
| Source Code   | https://[github](../../../../../ci-cd/github-actions/other/github/SKILL.md).com/Azure/azure-sdk-for-rust/tree/main/sdk/keyvault/azure_security_keyvault_certificates |
