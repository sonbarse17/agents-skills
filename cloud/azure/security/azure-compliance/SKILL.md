...
| Property | Details |
|---|---|
| Best for | Compliance scans, security audits, Key [Vault](../../../../Security/vault/SKILL.md) expiration checks |
| Primary capabilities | Comprehensive Resources Assessment, Key [Vault](../../../../Security/vault/SKILL.md) Expiration [Monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) |
| MCP tools | azqr, subscription and resource group listing, Key [Vault](../../../../Security/vault/SKILL.md) item inspection |
...
- [Audit](../../../../AI_and_Agents/Operations/audit/SKILL.md) Key [Vault](../../../../Security/vault/SKILL.md) keys, secrets, and certificates for expiration
...
- "Show me expired certificates/keys/secrets in my Key [Vault](../../../../Security/vault/SKILL.md)"
- "Check what's expiring in the next 30 days"
- "[Audit](../../../../AI_and_Agents/Operations/audit/SKILL.md) my Key [Vault](../../../../Security/vault/SKILL.md) for compliance"
...
- Permissions to read resource configuration and Key [Vault](../../../../Security/vault/SKILL.md) metadata
...
| Key [Vault](../../../../Security/vault/SKILL.md) Expiration | [../../../Global_References/[azure-keyvault](../azure-keyvault/SKILL.md)-expiration-[audit](../../../../AI_and_Agents/Operations/audit/SKILL.md).md](../../../Global_References/[azure-keyvault](../azure-keyvault/SKILL.md)-expiration-[audit](../../../../AI_and_Agents/Operations/audit/SKILL.md).md) |
...
| `keyvault_key_list` | List all keys in [vault](../../../../Security/vault/SKILL.md) |
| `keyvault_key_get` | Get key details including expiration |
| `keyvault_secret_list` | List all secrets in [vault](../../../../Security/vault/SKILL.md) |
| `keyvault_secret_get` | Get secret details including expiration |
| `keyvault_certificate_list` | List all certificates in [vault](../../../../Security/vault/SKILL.md) |
...
4. Review Key [Vault](../../../../Security/vault/SKILL.md) Expiration [Monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) output for keys, secrets, and certificates.
...
- Keep Key [Vault](../../../../Security/vault/SKILL.md) expiration policies documented and enforced

## SDK Quick References

For programmatic Key [Vault](../../../../Security/vault/SKILL.md) access, see the condensed SDK guides:

- **Key [Vault](../../../../Security/vault/SKILL.md) ([Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md))**: [Secrets/Keys/Certs](references/sdk/[azure-keyvault-py](../[azure-keyvault-py](../azure-sdk-[python](../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)/skills/[azure-keyvault](../azure-keyvault/SKILL.md)-py/SKILL.md)/SKILL.md).md)
