---
name: microsoft-docs
description: Understand Microsoft technologies by querying official
  documentation. Use whenever the user asks how something works, wants
  tutorials, needs configuration options, limits, quotas, or best practices for
  any Microsoft technology (Azure, .NET, M365, Windows, Power Platform,
  etc.)—even if they don't mention "docs." If the question is about
...
# ✅ Specific
"Azure Functions [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) v2 programming model"
