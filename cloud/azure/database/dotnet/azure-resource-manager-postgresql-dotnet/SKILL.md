...
# Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) (.NET)

Azure Resource Manager SDK for managing [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) Flexible Server deployments.

## Installation

```bash
dotnet add package Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)
...
> **Note**: This skill focuses on [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) Flexible Server. Single Server is deprecated and scheduled for retirement.
...
AZURE_POSTGRESQL_SERVER_NAME=<your-[postgresql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)-server>  # Required: [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) Flexible Server name
...
using Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md);
using Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md).FlexibleServers;
...
Subscription
└── ResourceGroup
    └── PostgreSqlFlexibleServer              # [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) Flexible Server instance
...
### 1. Create [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) Flexible Server

```csharp
using Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md).FlexibleServers;
using Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md).FlexibleServers.Models;
...
ArmOperation<PostgreSqlFlexibleServerResource> operation = await servers
    .CreateOrUpdateAsync(WaitUntil.Completed, "my-[postgresql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)-server", data);
...
PostgreSqlFlexibleServerResource server = await resourceGroup
    .GetPostgreSqlFlexibleServerAsync("my-[postgresql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)-server");
...
// Common [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) configurations to tune
string[] commonParams = { 
    "max_connections", 
    "shared_buffers", 
    "work_mem", 
...
ArmOperation<PostgreSqlFlexibleServerResource> operation = await servers
    .CreateOrUpdateAsync(WaitUntil.Completed, "my-[postgresql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)-restored", restoreData);
```
...
ArmOperation<PostgreSqlFlexibleServerResource> operation = await servers
    .CreateOrUpdateAsync(WaitUntil.Completed, "my-[postgresql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)-replica", replicaData);
```
...
## [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) Versions

| Version | Enum Value |
|---------|------------|
| [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) 11 | `Ver11` |
| [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) 12 | `Ver12` |
| [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) 13 | `Ver13` |
| [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) 14 | `Ver14` |
| [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) 15 | `Ver15` |
| [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) 16 | `Ver16` |
...
{
    ArmOperation<PostgreSqlFlexibleServerResource> operation = await servers
        .CreateOrUpdateAsync(WaitUntil.Completed, "my-[postgresql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)", data);
}
...
| SDK | Purpose | Install |
|-----|---------|---------|
| `Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)` | [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) management (this SDK) | `dotnet add package Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)` |
| `Azure.ResourceManager.[MySql](../../../../../Software_Engineering_and_Other/Databases/mysql/SKILL.md)` | [MySQL](../../../../../Software_Engineering_and_Other/Databases/mysql/SKILL.md) management | `dotnet add package Azure.ResourceManager.[MySql](../../../../../Software_Engineering_and_Other/Databases/mysql/SKILL.md)` |
| `Npgsql` | [PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) data access | `dotnet add package Npgsql` |
| `Npgsql.EntityFrameworkCore.[PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)` | EF Core provider | `dotnet add package Npgsql.EntityFrameworkCore.[PostgreSQL](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)` |

## Reference Links

| Resource | URL |
|----------|-----|
| NuGet Package | https://www.nuget.org/packages/Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) |
| API Reference | https://learn.microsoft.com/dotnet/api/azure.resourcemanager.[postgresql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) |
| Product Documentation | https://learn.microsoft.com/azure/[postgresql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)/flexible-server/ |
| [GitHub](../../../../../ci-cd/github-actions/other/github/SKILL.md) Source | https://[github](../../../../../ci-cd/github-actions/other/github/SKILL.md).com/Azure/azure-sdk-for-net/tree/main/sdk/[postgresql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md)/Azure.ResourceManager.[PostgreSql](../../../../../Software_Engineering_and_Other/Databases/postgresql/SKILL.md) |
