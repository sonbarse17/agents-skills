...
- Use **Azure Policy `deployIfNotExists` and `modify` effects** to
  ...
  relying on `[audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)` effects that only report non-compliance.
...
- Keep policy assignments **idempotent and Git-versioned**; policy drift
  ...
  during an [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md).
