...
// parameters.prod.json
{
  ...
  "parameters": {
    ...
    "adminPublicKey": {
      "reference": {
        "keyVault": {
          "id": "/subscriptions/{sub-id}/resourceGroups/{rg}/providers/Microsoft.KeyVault/vaults/{[vault](../../../../Security/cryptography-secrets/vault/SKILL.md)}"
        },
...
| Parameter file secrets in source control | Secrets stored as plain text | Use Key [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md) references in parameter files |
