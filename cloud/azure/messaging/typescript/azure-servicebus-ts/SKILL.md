...
description: Build messaging applications using Azure Service Bus SDK for
  ...
  topics/subscriptions, message sessions, dead-letter handling, or enterprise
  messaging patterns.
license: MIT
metadata:
  author: Microsoft
...
# Azure Service Bus SDK for [TypeScript](../../../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md)
...
- [Queues vs Topics Patterns](../../../../../Global_References/cloud/queues-topics.md) - Queue/topic patterns, sessions, receive modes, message settlement
- [Error Handling and Reliability](../../../../../Global_References/cloud/azure-servicebus-ts_error-handling.md) - ServiceBusError codes, DLQ handling, lock renewal, graceful shutdown
