...
```bash
# [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) function app on Consumption plan
...
### HTTP Trigger -- [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)
...
### Blob Trigger -- [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)
...
### Timer Trigger -- [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)
...
### Service Bus Trigger -- [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)
...
### Cosmos DB Change Feed Trigger -- [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)
...
```bash
# Initialize a new [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) function project
func init MyFunctionProject --[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)
...
# Deploy with build step for [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)
...
resource "azurerm_linux_function_app" "main" {
  ...
  app_settings = {
    FUNCTIONS_WORKER_RUNTIME       = "[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)"
...
| `ModuleNotFoundError` in [Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) | Dependencies not installed during deploy | Use `--build remote` flag or include `requirements.txt` in package |
