...
# Azure Monitor [OpenTelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md) Exporter for Java
...
<dependency>
    ...
    <artifactId>azure-monitor-[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md)-exporter</artifactId>
...
<dependency>
    <groupId>com.azure</groupId>
    <artifactId>azure-monitor-[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md)-autoconfigure</artifactId>
...
```java
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).sdk.autoconfigure.AutoConfiguredOpenTelemetrySdk;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).sdk.autoconfigure.AutoConfiguredOpenTelemetrySdkBuilder;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).api.[OpenTelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md);
import com.azure.monitor.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).exporter.AzureMonitorExporter;
...
[OpenTelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md) [openTelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md) = sdkBuilder.build().getOpenTelemetrySdk();
```
...
```java
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).api.trace.Tracer;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).api.trace.Span;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).context.Scope;

// Get tracer
Tracer tracer = [openTelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).getTracer("com.example.myapp");
...
```java
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).api.common.AttributeKey;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).api.common.Attributes;
...
```java
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).sdk.trace.SpanProcessor;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).sdk.trace.ReadWriteSpan;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).sdk.trace.ReadableSpan;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).context.Context;
...
## Metrics (via [OpenTelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md))

```java
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).api.metrics.Meter;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).api.metrics.LongCounter;
import io.[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).api.metrics.LongHistogram;

Meter meter = [openTelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md).getMeter("com.example.myapp");
...
The `azure-monitor-[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md)-autoconfigure` package provides:
- Automatic instrumentation of common libraries
- Simplified configuration
- Better integration with [OpenTelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md) SDK
...
1. **Use autoconfigure** — Migrate to `azure-monitor-[opentelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md)-autoconfigure`
...
5. **Use semantic conventions** — Follow [OpenTelemetry](../../../../../DevOps_and_Cloud/Observability_and_SecOps/opentelemetry/SKILL.md) semantic conventions
