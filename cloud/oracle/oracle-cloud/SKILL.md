...
### Step 10: [Monitoring](../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) and Alerts
```hcl
...
## References
  ...
  - ../../../Global_References/cloud/oracle-cloud-advanced.md — Oracle Cloud Advanced Topics
  - ../../../Global_References/cloud/oracle-cloud-fundamentals.md — Oracle Cloud Fundamentals
## Handoff
...
- Configure **[Vault](../../../Security/cryptography-secrets/vault/SKILL.md) (KMS)** for encryption keys — encrypt all block volumes, object storage, and databases
