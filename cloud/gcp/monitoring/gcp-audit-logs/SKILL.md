...
[Audit](../../../../AI_and_Agents/Operations/audit/SKILL.md) GCP activity with Cloud [Audit](../../../../AI_and_Agents/Operations/audit/SKILL.md) Logs for compliance, security investigation, and operational [monitoring](../../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md).
...
- Setting up [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) on administrative and data access events
...
## [Alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) Policies

```bash
# Alert on service account key creation
gcloud alpha [monitoring](../../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md) policies create \
...
# Create [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) policy using the log-based metric
gcloud alpha [monitoring](../../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md) policies create \
...
# Log-based [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md)
...
- Create log-based metrics and [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) policies for high-severity events
