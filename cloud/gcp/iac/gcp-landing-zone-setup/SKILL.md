...
3. **Apply Organization Policy constraints at the folder level.** Example
   ...
   `[cloud-iam-hardening](../../../common/identity/cloud-iam-hardening/SKILL.md)`) removes the need for them almost entirely.
...
- Disable **service account key creation org-wide** and use Workload
  ...
  accounts for GCE/GKE/Cloud Run — see `[cloud-iam-hardening](../../../common/identity/cloud-iam-hardening/SKILL.md)` for the
  detailed pattern.
