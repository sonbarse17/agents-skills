...
- [knative-[serverless](../../../../Software_Engineering_and_Other/Patterns/serverless/SKILL.md)-configuration](../[knative-[serverless](../../Containers_and_Orchestration/serverless/SKILL.md)-configuration](../../Containers_and_Orchestration/knative-[serverless](../../Containers_and_Orchestration/serverless/SKILL.md)-configuration/SKILL.md)/SKILL.md) — the scale-to-zero/revision model Gen2 Cloud Functions builds on, generalized to any container on [Kubernetes](../../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) via Knative Serving.
