...
│   ├── Yield-bearing [vault](../../Security/cryptography-secrets/vault/SKILL.md) → ERC-4626 (share-based accounting)
...
| ERC-4626 | [Vault](../../Security/cryptography-secrets/vault/SKILL.md) | Standardized yield-bearing share accounting |
...
### ERC-4626 Yield-Bearing [Vault](../../Security/cryptography-secrets/vault/SKILL.md) (Solidity)
```solidity
...
| ERC-4626 [Vault](../../Security/cryptography-secrets/vault/SKILL.md) | Inflation attack | Virtual shares + assets (OpenZeppelin fix) |
