...
| **Add endpoint behavior exception** | `fetch_endpoint_rule` (get rule definition from [GitHub](../../ci-cd/github-actions/other/github/SKILL.md)) → `add_endpoint_exception` (scoped to rule.id)  |
...
**Scripts:** `fetch-endpoint-rule-from-[github](../../ci-cd/github-actions/other/github/SKILL.md).js` (get rule TOML by id), `add-endpoint-exception.js` (add to Endpoint
...
**Endpoint behavior tuning:** `fetch-endpoint-rule-from-[github](../../ci-cd/github-actions/other/github/SKILL.md).js` (get rule TOML by id), `add-endpoint-exception.js`
