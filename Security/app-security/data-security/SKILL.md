...
Tokenization: {format-preserving / random / [vault](../../cryptography-secrets/vault/SKILL.md)-based}
...
- **KMS**: Managed service (AWS KMS, GCP Cloud KMS, Azure Key [Vault](../../cryptography-secrets/vault/SKILL.md)). Automatic key rotation. Access control via IAM.
...
- **Tokenization**: Replace sensitive data with tokens. [Vault](../../cryptography-secrets/vault/SKILL.md)-based (lookup table) or format-preserving (algorithmic).
...
de_identification:
  ...
  pseudonymization:
    tokenization:
      description: "Replace identifier with token, mapping stored in secure [vault](../../cryptography-secrets/vault/SKILL.md)"
      reversibility: "Reversible with [vault](../../cryptography-secrets/vault/SKILL.md) access"
...
### [PostgreSQL](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) Column-Level Encryption
```sql
...
### [PostgreSQL](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) Row-Level Security
```sql
-- Enable RLS on table
...
- Self-service data security with [policy-as-code](../../policy-as-code/policy-as-code/SKILL.md)
...
## References
  - ../../../Global_References/data-loss-prevention.md — Data Loss Prevention (DLP)
  - ../../../Global_References/data-masking-classification.md — Data Masking, Classification & Compliance
  - ../../../Global_References/data-privacy-compliance.md — Data Privacy Compliance
  - ../../../Global_References/data-security-advanced.md — Data Security Advanced Topics
