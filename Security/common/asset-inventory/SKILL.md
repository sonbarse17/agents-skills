...
asset_categories:
  ...
  security:
    ...
    - KMS keys / Key [Vault](../../cryptography-secrets/vault/SKILL.md) keys
    - Certificates (ACM, Key [Vault](../../cryptography-secrets/vault/SKILL.md), Certificate Manager)
...
- Enforce tagging at provisioning time through IaC defaults and [policy-as-code](../../policy-as-code/policy-as-code/SKILL.md) guardrails
