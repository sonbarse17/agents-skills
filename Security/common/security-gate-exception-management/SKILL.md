...
- An underlying gate or control already in place to grant exceptions
  ...
  ([sast-integration](../../scanning/sast-integration/SKILL.md)/SKILL.md),
  [software-composition-analysis-sca](../../scanning/software-composition-analysis-sca/SKILL.md)/SKILL.md)),
  an admission-policy exclusion mechanism
  ([opa-gatekeeper-policy-authoring](../../policy-as-code/opa-gatekeeper-policy-authoring/SKILL.md)/SKILL.md),
...
- **Symptom:** Facing a blocked release, a team disables the entire
  ...
  **Fix:** This removes coverage for every other finding the gate would
  ...
  [critical-vulnerability-emergency-response](../../incident-response/critical-vulnerability-emergency-response/SKILL.md)/SKILL.md)),
...
- [secure-cicd-gates](../../app-security/secure-cicd-gates/SKILL.md)/SKILL.md) — the gate design
