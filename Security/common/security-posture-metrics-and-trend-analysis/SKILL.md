...
[secure-cicd-gates](../../app-security/secure-cicd-gates/SKILL.md)/SKILL.md), and
...
- The severity-to-action/SLA table from
  [secure-cicd-gates](../../app-security/secure-cicd-gates/SKILL.md)/SKILL.md) as the benchmark
...
6. **Track gate override/bypass frequency** — how often a required
   ...
   [secure-cicd-gates](../../app-security/secure-cicd-gates/SKILL.md)/SKILL.md).
...
- [secure-cicd-gates](../../app-security/secure-cicd-gates/SKILL.md)/SKILL.md) — the
