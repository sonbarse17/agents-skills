...
description: Master network protocol reverse engineering including packet
  analysis, protocol dissection, and custom protocol documentation. Use when
  analyzing network traffic, understanding proprietary protocols, or debugging
...
[MySQL](../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)       - 0x00 length prefix, protocol version
[PostgreSQL](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)  - 0x00 0x00 0x00 startup length
Redis       - "*" RESP array prefix
[MongoDB](../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)     - BSON documents with specific header
```
