...
services:
  sonarqube:
    ...
    ports:
      - "9000:9000"
    environment:
      - SONAR_JDBC_URL=jdbc:[postgresql](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://db:5432/sonar
  ...
  db:
    ...
    environment:
      ...
      - POSTGRES_DB=sonar
    volumes:
      - postgresql_data:/var/lib/[postgresql](../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)/data
