...
questionnaire, or upcoming [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) asks. This skill guides mapping controls
...
**This is explicitly not a certification or [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) process.** SOC 2 reports
...
a stage 1/stage 2 [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md); PCI-DSS compliance validation (SAQ or a Report on
...
[audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md)-ready and gives a compliance/legal team accurate, evidence-backed
input to work with — it does not itself produce a certification, an
attestation, legal compliance, or a guarantee of passing an [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md). Always
involve qualified compliance, legal, and (where required) accredited
[audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) professionals for the actual certification or attestation process,
...
- A user asks "which SOC 2 criteria does our [Vault](../../cryptography-secrets/vault/SKILL.md)-based secrets rotation
...
- Preparing a controls matrix or evidence package ahead of a SOC 2 Type
  II [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md), an ISO 27001 certification/surveillance [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md), a PCI-DSS
...
- Access to the actual technical control implementations to cite as
  evidence sources: secrets manager [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) logs, IAM policy/role
...
- A named internal or external compliance owner — this skill supports
  ...
  them. For SOC 2, the CPA firm performing the [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md); for ISO 27001, the
...
2. **Inventory the technical controls already implemented**, grounded in
   ...
   [supply-chain-security-slsa-sbom](../../common/devsecops/SKILL.md)/skills/[supply-chain-security-slsa-sbom](../../supply-chain/supply-chain-security/SKILL.md)-slsa-sbom/SKILL.md)/SKILL.md),
...
4. **For each mapping, identify the evidence an assessor would need**:
   not "we have a secrets manager" but "[Vault](../../cryptography-secrets/vault/SKILL.md) [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) log showing automatic
...
5. **Explicitly flag gaps** — framework requirements with no mapped
   ...
   [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) timeline.
...
7. **Set up continuous evidence collection** where possible (automated
   log export, scheduled [access-review](../../identity-access/access-review/SKILL.md) reminders, scan result retention)
   rather than manually gathering evidence once a year right before an
   [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) — auditors for SOC 2 Type II and PCI-DSS specifically test
   whether a control operated effectively **over a period of time**, not
   whether it was correctly configured on the day of the [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md).
...
9. **Re-validate the matrix on a cadence** (e.g. before each [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) cycle,
   ...
   is actually running" is one of the most common [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) findings.
...
- Keep the matrix in version control or a GRC tool with change history —
  a static spreadsheet from eighteen months ago is itself an [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md)
...
- Reuse one control across multiple frameworks rather than treating each
  framework as a separate project — a single [Vault](../../cryptography-secrets/vault/SKILL.md) rotation policy can
...
- Be explicit with stakeholders, every time, that this mapping is
  [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md)-**preparation**, not an [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) outcome — say so in the deliverable
...
- **Symptom:** The controls matrix lists "Secrets rotation — implemented"
  ...
  *before* the [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) — a mapping without evidence is a claim, not a
  control.
...
- **Symptom:** The team declares "we are SOC 2 compliant" or "we are PCI
  ...
  **Fix:** State clearly, every time, that only an accredited certification
  ...
  produces [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md)-ready technical mapping and evidence, not the attestation
  itself.
...
recertification) targeted before the next [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) window. This matrix
reflects engineering's technical control mapping as input to your [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md)
