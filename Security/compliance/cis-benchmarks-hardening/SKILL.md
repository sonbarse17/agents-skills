...
configuration benchmarks ([Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md), [Docker](../../../containers-orchestration/docker/other/docker/SKILL.md), Linux distributions such as
...
for the target (kube-bench for [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md), [Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) Bench for Security for
...
- A user asks to "run a CIS benchmark scan against this [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) cluster /
  [Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) host / Linux server."
- Interpreting kube-bench, [Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) Bench, or CIS-CAT scan output and deciding
  what to fix first.
...
- A finding is a false positive or genuinely inapplicable (e.g. a managed
  [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) control plane check that only applies to self-managed
...
- Know which CIS Benchmark and profile level applies: e.g. "CIS [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md)
  Benchmark v1.9 (aligned to [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) 1.27+)", "CIS [Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) Benchmark
...
- Tooling, matched to target:
  - **kube-bench** (Aqua Security) for [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) control-plane and
    worker-node checks — run as a Job/DaemonSet inside the cluster or as a
    standalone binary on each node. Note that managed [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) (EKS,
  ...
  - **[Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) Bench for Security** for [Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) Engine hosts — shell script
  ...
  - Cluster/host access sufficient to read the relevant config files
    (kubelet config, `/etc/[docker](../../../containers-orchestration/docker/other/docker/SKILL.md)/daemon.json`, systemd unit files, etc.)
...
2. **Run the automated scan.**
   - [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md), as a Job using the upstream kube-bench image against a
     cluster node:
     ```bash
     [kubectl](../../../containers-orchestration/kubernetes/other/kubectl/SKILL.md) run kube-bench --rm -it --restart=Never \
       --image=[docker](../../../containers-orchestration/docker/other/docker/SKILL.md).io/aquasec/kube-bench:v0.9.3 \
       --overrides='{"spec":{"hostPID":true,"nodeSelector":{"[kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md).io/os":"linux"}}}' \
       -- --benchmark cis-1.24 --json > kube-bench-results.json
     ```
   - [Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) host:
     ```bash
     [docker](../../../containers-orchestration/docker/other/docker/SKILL.md) run --rm --net host --pid host --userns host --cap-add audit_control \
       ...
       -v /var/lib:/var/lib:ro -v /var/run/[docker](../../../containers-orchestration/docker/other/docker/SKILL.md).sock:/var/run/[docker](../../../containers-orchestration/docker/other/docker/SKILL.md).sock:ro \
       --label docker_bench_security \
       [docker](../../../containers-orchestration/docker/other/docker/SKILL.md)/[docker](../../../containers-orchestration/docker/other/docker/SKILL.md)-bench-security
     ```
...
5. **Remediate what applies.** Common remediations: set kubelet
   ...
   disable [Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) legacy registry/`--insecure-registry` flags, set
   `[docker](../../../containers-orchestration/docker/other/docker/SKILL.md).sock` permissions to non-world-writable, enable auditd rules
   ...
   apply it via
   [container-image-hardening](../../../[devsecops](../devsecops/SKILL.md)/skills/[container-image-hardening](../../../containers-orchestration/docker/security/container-image-hardening/SKILL.md)/SKILL.md)
...
- Treat kube-bench/[Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) Bench findings on managed cloud services (EKS,
...
- Automate remediation only for checks with a clearly safe, idempotent
  ...
  disabling a needed [Docker](../../../containers-orchestration/docker/other/docker/SKILL.md) feature) need a change-managed rollout, not an
  auto-apply script.
...
- Re-run scans on every base image update and on a recurring schedule
  ...
  themselves are periodically revised as new [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md)/[Docker](../../../containers-orchestration/docker/other/docker/SKILL.md)/OS versions
...
- Cross-check overlapping findings instead of fixing the same class of
  ...
  and a [container-image-hardening](../../../containers-orchestration/docker/security/container-image-hardening/SKILL.md) non-root-user recommendation are the
...
- **Symptom:** kube-bench reports dozens of FAILs on a managed EKS/AKS/GKE
  ...
  **Fix:** Managed [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) control planes are operated by the cloud
...
Illustrative kube-bench run against a self-managed [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) 1.27 cluster,
CIS [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) Benchmark v1.24 profile, Level 1:
...
waivers:
  - control_id: "1.3.7"
    benchmark: "CIS [Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) Benchmark v1.24"
...
[Kubernetes](../../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) Benchmark v1.24, Level 1. 2 of 3 fails remediated this sprint
