...
configuration benchmarks ([Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md), [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md), Linux distributions such as
...
for the target (kube-bench for [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md), [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Bench for Security for
...
- A user asks to "run a CIS benchmark scan against this [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) cluster /
  [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) host / Linux server."
- Interpreting kube-bench, [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Bench, or CIS-CAT scan output and deciding
  what to fix first.
...
- A finding is a false positive or genuinely inapplicable (e.g. a managed
  [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) control plane check that only applies to self-managed
...
- Know which CIS Benchmark and profile level applies: e.g. "CIS [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)
  Benchmark v1.9 (aligned to [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) 1.27+)", "CIS [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Benchmark
...
- Tooling, matched to target:
  - **kube-bench** (Aqua Security) for [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) control-plane and
    worker-node checks — run as a Job/DaemonSet inside the cluster or as a
    standalone binary on each node. Note that managed [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) (EKS,
  ...
  - **[Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Bench for Security** for [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Engine hosts — shell script
  ...
  - Cluster/host access sufficient to read the relevant config files
    (kubelet config, `/etc/[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)/daemon.json`, systemd unit files, etc.)
...
2. **Run the automated scan.**
   - [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md), as a Job using the upstream kube-bench image against a
     cluster node:
     ```bash
     [kubectl](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubectl/SKILL.md) run kube-bench --rm -it --restart=Never \
       --image=[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).io/aquasec/kube-bench:v0.9.3 \
       --overrides='{"spec":{"hostPID":true,"nodeSelector":{"[kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md).io/os":"linux"}}}' \
       -- --benchmark cis-1.24 --json > kube-bench-results.json
     ```
   - [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) host:
     ```bash
     [docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) run --rm --net host --pid host --userns host --cap-add audit_control \
       ...
       -v /var/lib:/var/lib:ro -v /var/run/[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).sock:/var/run/[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).sock:ro \
       --label docker_bench_security \
       [docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)/[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-bench-security
     ```
...
5. **Remediate what applies.** Common remediations: set kubelet
   ...
   disable [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) legacy registry/`--insecure-registry` flags, set
   `[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).sock` permissions to non-world-writable, enable auditd rules
   ...
   apply it via
   [container-image-hardening](../../../[devsecops](../devsecops/SKILL.md)/skills/[container-image-hardening](../../../DevOps_and_Cloud/containers-orchestration/docker/security/container-image-hardening/SKILL.md)/SKILL.md)
...
- Treat kube-bench/[Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Bench findings on managed cloud services (EKS,
...
- Automate remediation only for checks with a clearly safe, idempotent
  ...
  disabling a needed [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) feature) need a change-managed rollout, not an
  auto-apply script.
...
- Re-run scans on every base image update and on a recurring schedule
  ...
  themselves are periodically revised as new [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)/[Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)/OS versions
...
- Cross-check overlapping findings instead of fixing the same class of
  ...
  and a [container-image-hardening](../../../DevOps_and_Cloud/containers-orchestration/docker/security/container-image-hardening/SKILL.md) non-root-user recommendation are the
...
- **Symptom:** kube-bench reports dozens of FAILs on a managed EKS/AKS/GKE
  ...
  **Fix:** Managed [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) control planes are operated by the cloud
...
- **Symptom:** Findings are suppressed by editing the scanner's config to
  ...
  **Fix:** Use a reviewed, version-controlled waiver file with
  ...
  future [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) responder) needs to be able to answer "was this
  intentional and reviewed" without archaeology.
- **Symptom:** A benchmark remediation (e.g. disabling anonymous kubelet
  auth, tightening a [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) daemon flag) is applied directly to production
...
Illustrative kube-bench run against a self-managed [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) 1.27 cluster,
CIS [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) Benchmark v1.24 profile, Level 1:
...
waivers:
  - control_id: "1.3.7"
    benchmark: "CIS [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) Benchmark v1.24"
...
[Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) Benchmark v1.24, Level 1. 2 of 3 fails remediated this sprint
...
- [container-image-hardening](../../../[devsecops](../devsecops/SKILL.md)/skills/[container-image-hardening](../../../DevOps_and_Cloud/containers-orchestration/docker/security/container-image-hardening/SKILL.md)/SKILL.md) — non-root users, read-only rootfs, and capability drops that satisfy many [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)/[Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) CIS controls at the image level.
