...
- `../../../Global_References/Security/osqueryd-deployment.md` - Deploy osqueryd for continuous [monitoring](../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) and fleet management
