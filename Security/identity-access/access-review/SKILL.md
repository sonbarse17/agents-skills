...
Implement periodic access review processes for AWS IAM, [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md), Okta, and other identity providers, including automated reporting, certification workflows, and unused permission detection.
...
```bash
#!/usr/bin/env bash
# [aws-iam](../../../DevOps_and_Cloud/cloud/aws/identity/aws-iam/SKILL.md)-review.sh - Comprehensive IAM access review report
...
## [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Access Review

```bash
#!/usr/bin/env bash
# [github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)-access-review.sh - [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) organization access [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md)

ORG="your-org"
OUTPUT_DIR="./access-review/[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/$(date +%Y-%m)"
mkdir -p "$OUTPUT_DIR"

echo "=== [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Organization Access Review ==="
...
```yaml
# [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions - Automated access review reminder and tracking
  ...
  generate-review:
    ...
    steps:
      ...
      - name: Generate access reports
        ...
        run: |
          bash scripts/[aws-iam](../../../DevOps_and_Cloud/cloud/aws/identity/aws-iam/SKILL.md)-review.sh
          bash scripts/[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)-access-review.sh
      ...
      - name: Create review issue
        ...
        run: |
          ...
          - [ ] Review outside collaborators on [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)
