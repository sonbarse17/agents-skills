...
Phase 5: [Audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) Logging
1. Format log entry
2. Add context
3. Write to stream
...
## Reference Guides
1. [OIDC Auth Code Flow](../../../Global_References/Security/oidc_flow_auth_code.md)
2. [OIDC Implicit Flow](../../../Global_References/Security/oidc_flow_implicit.md)
3. [RBAC Core Logic](../../../Global_References/Security/rbac_core_logic.md)
4. [RBAC Decision Matrix](../../../Global_References/Security/rbac_decision_matrix.md)
5. [RBAC Policy Evaluation](../../../Global_References/Security/rbac_policy_evaluation.md)
6. [OIDC Token Validation](../../../Global_References/Security/oidc_token_validation.md)
7. [RBAC [Audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) Logging](../../../Global_References/Security/rbac_audit_logging.md)
8. [RBAC Integration Patterns](../../../Global_References/Security/rbac_integration_patterns.md)
