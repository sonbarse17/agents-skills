...
privacy_by_design:
  ...
  data_protection_impact_assessment_dpia:
    triggers: ["Processing sensitive data", "Large-scale [monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)", "Systematic [profiling](../../Software_Engineering_and_Other/Frontend/profiling/SKILL.md)", "New technology deployment"]
    sections:
