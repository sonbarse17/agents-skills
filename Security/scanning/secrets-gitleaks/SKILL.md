...
This skill provides comprehensive guidance for integrating Gitleaks into [DevSecOps](../../common/devsecops/SKILL.md) workflows, from pre-[commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) hooks to CI/CD pipelines, with emphasis on preventing secret leakage before code reaches production.
...
# Generate SARIF report for [GitHub](../../../ci-cd/github-actions/other/github/SKILL.md)/GitLab integration
...
```bash
# Install pre-[commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) hook (run in repository root)
...
- `install_precommit.sh` - Automated pre-[commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) hook installation with configuration prompts
...
- `[github](../../../ci-cd/github-actions/other/github/SKILL.md)-action.yml` - Complete [GitHub](../../../ci-cd/github-actions/other/github/SKILL.md) Actions workflow template
- `[gitlab-ci](../../../ci-cd/gitlab-ci/pipelines/gitlab-ci/SKILL.md).yml` - Complete GitLab CI pipeline template
...
# 2. Install pre-[commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) hook
./scripts/install_precommit.sh

# 3. Test hook with dummy [commit](../../../ci-cd/common/git-workflow/commit/SKILL.md)
echo "api_key = 'EXAMPLE_KEY_12345'" > test.txt
git add test.txt
git [commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) -m "test"  # Should be blocked by gitleaks
...
# 2. Generate SARIF for [GitHub](../../../ci-cd/github-actions/other/github/SKILL.md) Security tab
...
2. Add to allowlist in `.gitleaks.toml`:
   ...
   ```
3. Use [commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) allowlists for specific false positives:
   ```toml
   [allowlist]
...
### Issue: Pre-[commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) Hook Blocking Valid Commits

**Symptoms**: Developers unable to [commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) code with legitimate patterns
...
4. Temporary bypass (use with caution): `git [commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) --no-verify`
...
- [Gitleaks Official Documentation](https://[github](../../../ci-cd/github-actions/other/github/SKILL.md).com/gitleaks/gitleaks)
