...
This skill provides comprehensive guidance for integrating Gitleaks into [DevSecOps](../../common/devsecops/SKILL.md) workflows, from pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hooks to CI/CD pipelines, with emphasis on preventing secret leakage before code reaches production.
...
# or: [docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) pull zricethezav/gitleaks:latest
...
# Generate SARIF report for [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/GitLab integration
gitleaks detect --report-path findings.sarif --report-format sarif
```

**When to use**: Initial security [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md), compliance checks, [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) response.

### 2. Pre-[Commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) Hook Protection

Prevent secrets from being committed in the first place:

```bash
# Install pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hook (run in repository root)
...
- Scan execution timestamps and scope (repository, branch, [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) range)
- Number and types of secrets detected
- Remediation actions taken (credential rotation, [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) history cleanup)
...
- `install_precommit.sh` - Automated pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hook installation with configuration prompts
...
- `[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)-action.yml` - Complete [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions workflow template
- `[gitlab-ci](../../../DevOps_and_Cloud/ci-cd/gitlab-ci/pipelines/gitlab-ci/SKILL.md).yml` - Complete GitLab CI pipeline template
...
git clone --mirror https://[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).com/org/repo.git [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md)-repo
...
# 2. Install pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hook
./scripts/install_precommit.sh

# 3. Test hook with dummy [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)
echo "api_key = 'EXAMPLE_KEY_12345'" > test.txt
git add test.txt
git [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) -m "test"  # Should be blocked by gitleaks
...
# 2. Generate SARIF for [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Security tab
...
- **[GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions**: Use `gitleaks/gitleaks-action@v2` for native integration with Security tab
- **GitLab CI**: [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-based scanning with artifact retention for [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) trails
- **[Jenkins](../../../DevOps_and_Cloud/ci-cd/jenkins/other/jenkins/SKILL.md)**: Execute via [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) or installed binary in pipeline stages
- **[CircleCI](../../../DevOps_and_Cloud/ci-cd/circleci/other/circleci/SKILL.md)**: [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) executor with orb support
- **Azure Pipelines**: Task-based integration with results publishing

### Security Tools Ecosystem

- **SIEM Integration**: Export JSON findings to Splunk, ELK, or [Datadog](../../../DevOps_and_Cloud/observability-monitoring-logging/datadog/other/datadog/SKILL.md) for centralized [monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
- **Vulnerability Management**: Import SARIF reports into Snyk, SonarQube, or Checkmarx
- **Secret Management**: Integrate findings with HashiCorp [Vault](../../cryptography-secrets/vault/SKILL.md) or AWS Secrets Manager rotation workflows
...
- **Development**: Pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hooks provide immediate feedback to developers
- **Code Review**: PR/MR checks prevent secrets from reaching main branches
- **Testing**: Scan test environments and [infrastructure-as-code](../../../DevOps_and_Cloud/infrastructure-as-code/common/other/infrastructure-as-code/SKILL.md)
...
2. Add to allowlist in `.gitleaks.toml`:
   ...
   ```
3. Use [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) allowlists for specific false positives:
   ```toml
   [allowlist]
   commits = ["[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)-sha-here"]
   ```
...
### Issue: Pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) Hook Blocking Valid Commits

**Symptoms**: Developers unable to [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) code with legitimate patterns
...
4. Temporary bypass (use with caution): `git [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) --no-verify`
...
6. Document [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) in security [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) log
...
- [Gitleaks Official Documentation](https://[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).com/gitleaks/gitleaks)
