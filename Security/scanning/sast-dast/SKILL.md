...
- CI/CD platform ([GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions, GitLab CI, [Jenkins](../../../DevOps_and_Cloud/ci-cd/jenkins/other/jenkins/SKILL.md), [CircleCI](../../../DevOps_and_Cloud/ci-cd/circleci/other/circleci/SKILL.md))
...
├── Private with [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Advanced Security → CodeQL included
└── Private without GHAS → Semgrep (free) + SonarQube Community (free)

What languages are in the codebase?
├── [Python](../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md), JavaScript/[TypeScript](../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md), Java, Go → Any tool works
...
├── CI/CD (automated, pipeline) → ZAP [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) (best CI integration)
...
### Semgrep
Semgrep is the recommended default SAST tool for most projects. It is fast, multi-language, and excels at custom rule writing. Rule packs come from the Semgrep Registry. Rules are written in YAML with a pattern-matching syntax that can detect code patterns across function boundaries. Semgrep supports all major languages ([Python](../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md), JavaScript/[TypeScript](../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md), Java, Go, Rust, Ruby, C#, PHP, Kotlin, Scala) and runs in CI with diff-aware scanning. Install via `pip install semgrep` or use the official [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Action. Key strengths: pattern-based matching that goes beyond regex, support for metavariables and ellipsis operators, community-maintained rule packs, and a built-in rule testing framework.

### CodeQL
CodeQL is best for deep interprocedural analysis and variant analysis. Developed by [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md), it uses a declarative query language (QL) to find vulnerabilities across the codebase. A single CodeQL query can find all variants of a vulnerability pattern (e.g., all paths where user input reaches a SQL query). CodeQL requires a compiled database of the codebase, which is built during the CI scan step. It supports C/C++, C#, Go, Java/Kotlin, JavaScript/[TypeScript](../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md), [Python](../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md), and Ruby. CodeQL is free for public repositories and included in [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Advanced Security for private repos. Key strengths: variant analysis, data flow tracking across function and file boundaries, and deep semantic understanding of the code.
...
### OWASP ZAP
OWASP ZAP (Zed Attack Proxy) is the recommended default DAST tool. It is free, open-source, and community-maintained. ZAP can be run as a desktop application, a daemon for CI integration, or a [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) container. Scan modes: automated scan (spider → passive → active), API scan (import OpenAPI/GraphQL schema), and baseline scan (passive-only, safe for production). ZAP supports authenticated scanning via context-based session management, bearer token injection, and form-based authentication. The HUD (Heads-Up Display) mode provides browser-based interaction for manual testing. Key strengths: free and open-source, extensive active scan rules, API scanning, and [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-native CI integration.
...
| CI integration | [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Action, CLI | [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Action | SonarScanner CLI, [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Action | Snyk CLI, [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Action |
| Diff-aware | Yes (--baseline-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)) | Yes (PR analysis) | Yes (new code analysis) | Yes |
...
| CI integration | [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) + CLI action | Pro only (REST API) | Yes (CLI + REST API) |
...
| Extensibility | Scripts (JS, [Python](../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)) | BApp Store (100+ extensions) | Limited |
...
Full codebase scans take 30-60 minutes, blocking CI pipelines. Use diff-aware scanning for PRs (Semgrep `--baseline-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)`, SonarQube new code analysis). Save full scans for nightly builds.
...
- Run SAST on every PR diff (Semgrep `--baseline-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)`). Full scan nightly.
...
### ZAP vs Burp Suite
ZAP is free, open-source, and CI-friendly ([Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md), CLI). Burp Suite Pro offers better manual testing workflows and a rich extension ecosystem. Use ZAP for CI/CD automation. Use Burp for professional manual [pentesting](../../pentest-redteam/pentesting/SKILL.md).
...
### [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions — SAST + DAST Pipeline
```yaml
...
```yaml
# .[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/security-gates.yml
quality_gates:
  sast:
    error_threshold: 0
    warn_threshold: 10
...
- ZAP [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) container: 2-4GB RAM for active scans, 1GB for baseline. CPU: 2-4 cores.
...
## References
  - ../../../Global_References/Security/dast-automation.md — DAST Automation
  - ../../../Global_References/Security/dast-tools.md — DAST Tools
  - ../../../Global_References/Security/sast-dast-advanced.md — Sast Dast Advanced Topics
  - ../../../Global_References/Security/sast-dast-fundamentals.md — Sast Dast Fundamentals
  - ../../../Global_References/Security/sast-rules-customization.md — SAST Rule Customization
  - ../../../Global_References/Security/sast-tools.md — SAST Tools
  - ../../../Global_References/Security/sast-tool-selection-integration.md — SAST tool selection and CI integration guide
  - ../../../Global_References/Security/dast-scoping-execution.md — DAST scoping, execution, and reporting patterns
## Handoff
`[security-api-security](../../app-security/api-security/SKILL.md)` for API-specific scanning and protection rules
