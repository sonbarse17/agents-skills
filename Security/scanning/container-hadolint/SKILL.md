...
Hadolint is a Dockerfile linter that validates container build files against security best practices and the CIS [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Benchmark. It analyzes Dockerfile instructions to identify misconfigurations, anti-patterns, and security vulnerabilities before images are built and deployed.

Hadolint integrates ShellCheck to validate RUN instructions, ensuring shell commands follow security best practices. With 100+ built-in rules mapped to CIS [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Benchmark controls, Hadolint provides comprehensive security validation for container images.
...
# Linux via binary
wget -O /usr/local/bin/hadolint https://[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).com/hadolint/hadolint/releases/latest/download/hadolint-Linux-x86_64
chmod +x /usr/local/bin/hadolint

# Via [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)
[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) pull hadolint/hadolint
```
...
[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) run --rm -i hadolint/hadolint < Dockerfile
```
...
**When to use**: Developer workstation, pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) validation, iterative Dockerfile development.
...
jobs:
  lint:
    ...
    steps:
      ...
      - name: Upload SARIF to [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Security
        if: always()
...
Create `.hadolint.yaml` to [customize](../../../DevOps_and_Cloud/cloud/azure/ai/customize/SKILL.md)/SKILL.md)/SKILL.md) rules:
...
trustedRegistries:
  - [docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).io/library  # Official [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Hub images
...
hadolint --trusted-registry [docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).io/library Dockerfile
...
**When to use**: Complex builds, security-hardened images, production [containerization](../../../DevOps_and_Cloud/containers-orchestration/docker/other/containerization/SKILL.md).

### 6. Pre-[Commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) Hook Integration

Prevent insecure Dockerfiles from being committed:

```bash
# Install pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hook using bundled script
./scripts/install_precommit.sh

# Or manually create hook
cat << 'EOF' > .git/hooks/pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)
#!/bin/bash
...
chmod +x .git/hooks/pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)
```
...
- **Build Secrets**: Use [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) BuildKit secrets (`RUN --mount=type=secret`) instead of ARG for credentials
...
- **CIS [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Benchmark 1.6**: Hadolint rules map to CIS controls (see `references/cis_mapping.md`)
...
- **OWASP [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Security**: Validates against OWASP container security best practices
...
- `install_precommit.sh` - Automated pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hook installation
...
- `cis_mapping.md` - Detailed CIS [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Benchmark control mapping
...
- `[github-actions](../../DevOps_and_Cloud/CI_CD/[github](../../DevOps_and_Cloud/CI_CD/github/SKILL.md)-actions/SKILL.md).yml` - Complete [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions workflow
- `[gitlab-ci](../../../DevOps_and_Cloud/ci-cd/gitlab-ci/pipelines/gitlab-ci/SKILL.md).yml` - Complete GitLab CI pipeline
- `precommit-config.yaml` - Pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) framework configuration
...
FROM [docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).io/library/node:18.19.0-alpine3.19
...
- **[GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions**: Native hadolint-action with SARIF support for Security tab
- **GitLab CI**: GitLab Code Quality format integration
- **[Jenkins](../../../DevOps_and_Cloud/ci-cd/jenkins/other/jenkins/SKILL.md)**: Checkstyle format for [Jenkins](../../../DevOps_and_Cloud/ci-cd/jenkins/other/jenkins/SKILL.md) Warnings plugin
- **[CircleCI](../../../DevOps_and_Cloud/ci-cd/circleci/other/circleci/SKILL.md)**: [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-based executor with artifact retention
...
- **IaC Security**: Chain with Checkov for [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)/Terraform validation
- **SBOM Generation**: Export findings alongside Syft/Trivy SBOM reports
- **Security [Dashboards](../../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)**: Export JSON to Grafana, Kibana, [Datadog](../../../DevOps_and_Cloud/observability-monitoring-logging/datadog/other/datadog/SKILL.md) for centralized [monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)

### SDLC Integration

- **Development**: Pre-[commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) hooks provide immediate feedback
...
trustedRegistries:
  ...
  - gcr.io/my-project
  - [docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).io/library
```
...
# .hadolint.yaml
trustedRegistries:
  - [docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).io/library      # Official images only
  - gcr.io/distroless      # Google distroless
  - cgr.dev/chainguard     # Chainguard images

# This will error on:
# FROM nginx:latest                    ❌ ([docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).io/nginx)
# FROM [docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).io/library/nginx:latest  ✅ (trusted)
```
...
- [Hadolint [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Repository](https://[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).com/hadolint/hadolint)
- [CIS [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Benchmark](https://www.cisecurity.org/benchmark/[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md))
- [Docker Best Practices](https://docs.[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md).com/develop/develop-images/dockerfile_best-practices/)
- [ShellCheck Documentation](https://www.shellcheck.net/)
- [OCI Image Specification](https://[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).com/opencontainers/image-spec)
