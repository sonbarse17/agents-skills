...
[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) run -d --name zap \
  -p 8080:8080 \
...
```bash
# Quick baseline scan
[docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) run --rm -v $(pwd):/zap/wrk \
  ghcr.io/zaproxy/zaproxy:stable \
...
- [penetration-testing](../../pentest-redteam/penetration-testing/SKILL.md)/) - Manual testing
- [waf-setup](../../app-security/waf-setup/SKILL.md)/) - WAF configuration
