...
National Vulnerability Database/NVD, [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Advisory Database, OSV.dev,
...
- The user needs a Software Bill of Materials (SBOM) as an input — SCA
  ...
  [supply-chain-security-slsa-sbom](../../supply-chain/supply-chain-security/SKILL.md)-slsa-sbom/SKILL.md)/SKILL.md).
...
- Tool options:
  ...
  - **Dependabot** (native to [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)) or **Renovate** (self-hosted or
...
- Network egress from CI to the relevant vulnerability database/registry
  (NVD, OSV.dev, [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Advisory API, or a mirrored internal feed for
...
7. **Feed results into the same triage/ticketing pipeline as SAST/DAST**
   findings (see [secure-cicd-gates](../../app-security/secure-cicd-gates/SKILL.md)/SKILL.md)) so
...
- **Symptom:** The same CVE is reported by three different tools with
  ...
  **Fix:** Pick one primary source of truth for severity (e.g. the
  vendor/[GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Advisory Database CVSS score) for gating decisions, and
...
`.[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/workflows/sca.yml`:
```yaml
name: sca
on: [pull_request]
jobs:
...
└─────────┴────────────────┴──────────┴──────────┴───────────────┴───────────────┘
```
Remediation: bump `ejs` to `>=3.1.10` (`npm install ejs@3.1.10`), [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)
...
- [secure-cicd-gates](../../app-security/secure-cicd-gates/SKILL.md)/SKILL.md) — how to combine SCA
