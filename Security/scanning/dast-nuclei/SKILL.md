...
For OAuth, SAML, and MFA scenarios, see `../../../Global_References/Security/authentication_patterns.md`.
...
3. Check for false positives using `../../../Global_References/Security/false_positive_guide.md`
4. Map confirmed vulnerabilities to OWASP Top 10 using `../../../Global_References/Security/owasp_mapping.md`
...
- `../../../Global_References/Security/template_development.md` - Complete template authoring guide
...
- **Too Many False Positives**: Filter by severity (`-severity critical,high`), exclude tags (`-etags tech,info`). See `../../../Global_References/Security/false_positive_guide.md`
...
- **Auth Headers Not Working**: Debug with `-debug`, verify token format, see `../../../Global_References/Security/authentication_patterns.md`
