...
| A05: Security Misconfiguration | Hardened default configs (see [container-image-hardening](../../../[devsecops](../../../Security/devsecops/SKILL.md)/skills/[container-image-hardening](../../containers-orchestration/docker/security/container-image-hardening/SKILL.md)/SKILL.md), [cis-benchmarks-hardening](../[cis-benchmarks-hardening](../../../Security/[cis-benchmarks](../../Observability_and_SecOps/cis-benchmarks/SKILL.md)-hardening/SKILL.md)/SKILL.md)); no default credentials; minimal error verbosity in prod | Some — IaC/config scanning rules | Can detect verbose error messages, exposed debug endpoints, default credentials | **Medium** |
