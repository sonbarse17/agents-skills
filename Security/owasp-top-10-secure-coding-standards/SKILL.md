...
[threat-modeling](../threat-modeling/SKILL.md) and testing because no scanner can infer intended
...
- [container-image-hardening](../../../[devsecops](../../../Security/devsecops/SKILL.md)/skills/[container-image-hardening](../../DevOps_and_Cloud/Containers_and_Orchestration/container-image-hardening/SKILL.md)/SKILL.md) — hardened defaults underlying A05 (Security Misconfiguration) prevention at the container level.
