...
This skill provides comprehensive guidance for integrating Gitleaks into [DevSecOps](../devsecops/SKILL.md) workflows, from pre-[commit](../../ci-cd/common/git-workflow/commit/SKILL.md) hooks to CI/CD pipelines, with emphasis on preventing secret leakage before code reaches production.
