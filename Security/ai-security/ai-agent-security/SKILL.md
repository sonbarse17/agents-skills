...
```yaml
# [vault](../../cryptography-secrets/vault/SKILL.md)-agent-policy.hcl — [Vault](../../cryptography-secrets/vault/SKILL.md) policy for AI agent credentials
...
[vault](../../cryptography-secrets/vault/SKILL.md) token create \
