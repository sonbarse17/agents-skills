...
```yaml
# .[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/workflows/model-build-slsa.yml
  ...
  train-and-package:
    ...
    steps:
      ...
      - name: Package model as OCI artifact
        run: |
          oras push ghcr.io/acme/ml-models/sentiment:${{ [github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).ref_name }} \
      ...
      - name: Sign and attest
        run: |
          cosign sign ghcr.io/acme/ml-models/sentiment:${{ [github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).ref_name }}
          cosign attest --predicate training-sbom.json \
            --type cyclonedx \
            ghcr.io/acme/ml-models/sentiment:${{ [github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).ref_name }}

      - name: Generate provenance
        uses: slsa-framework/slsa-[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)-generator/.[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/workflows/generator_container_slsa3.yml@v2.0.0
        with:
...
provenance:
  ...
  training_config:
    source: "git://[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).com/acme/ml-models@abc123"
    hyperparameters:
...
```yaml
# .[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/workflows/registry-scan.yml
...
```yaml
# [kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) deployment hardening
apiVersion: apps/v1
kind: Deployment
metadata:
  name: model-serving
...
| Provenance attestation missing | SLSA generator not configured | Add slsa-[github](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)-generator to the build workflow |
