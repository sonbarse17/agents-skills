...
- **Noise**: Aggressive scans are easily detected by security [monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
...
- **SIEM Integration**: Parse Nmap output for security [monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
...
- **Port Scan Detection**: [Monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) for SYN packets without completion
