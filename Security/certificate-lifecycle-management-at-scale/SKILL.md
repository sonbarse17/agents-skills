...
happens. [cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../containers-orchestration/kubernetes/security/cert-manager-tls-automation/SKILL.md)/SKILL.md)
solves this well *inside* a single [Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) cluster via a
reconciliation loop, but most enterprises have a fleet that isn't just
[Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md): VMs, on-prem load balancers, network appliances, multiple
...
- Standing up or reviewing an enterprise CA hierarchy (root, one or more
  ...
  services, not just one [Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) cluster.
- Integrating a fleet's certificate issuance with an enterprise CA —
  ...
  [vault-operations-and-pki-engine-configuration](../[vault-operations-and-pki-engine-configuration](../[vault](../../../Security/vault/SKILL.md)-operations-and-pki-engine-configuration/SKILL.md)/SKILL.md)
...
- Deciding the right split between cert-manager (for in-cluster
  [Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) workloads) and enterprise-CA-integrated automation (for
...
- [Monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)/[alerting](../../observability-monitoring-logging/common/alerting/alerting/SKILL.md) infrastructure (Prometheus + a blackbox/certificate
  ...
  controller.
- [Change-management](../../observability-monitoring-logging/common/other/change-management/SKILL.md) awareness for anything issued from a shared
...
1. **Build (or validate) the CA hierarchy before automating rotation on
   ...
   intermediate ([vault-operations-and-pki-engine-configuration](../[vault-operations-and-pki-engine-configuration](../[vault](../../../Security/vault/SKILL.md)-operations-and-pki-engine-configuration/SKILL.md)/SKILL.md))
...
4. **Automate rotation per fleet segment, matched to that segment's
   ...
   appliances, and multiple [Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) clusters uniformly:
   - **[Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) workloads:** `cert-manager` per cluster remains the
     right tool — see
...
5. **Set `renewBefore`-equivalent margins deliberately per fleet
   ...
   — a VM fleet needing a [change-management](../../observability-monitoring-logging/common/other/change-management/SKILL.md)-approved deployment window
   needs a longer lead time than an automated [Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) reconcile loop:
   ```
   [Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) (cert-manager, automated reconcile): renew 15-30 days before expiry
...
- Match rotation automation to each fleet segment's actual deployment
  mechanism and lead time ([Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) reconcile loop vs. a
...
2. [Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md) clusters: each cluster's cert-manager `ClusterIssuer` is
...
- [cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../containers-orchestration/kubernetes/security/cert-manager-tls-automation/SKILL.md)/SKILL.md) —
  the [Kubernetes](../../containers-orchestration/kubernetes/other/kubernetes/SKILL.md)-native reconciliation piece this skill's fleet-wide
