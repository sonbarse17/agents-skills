...
- Auth method to use (token, [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md), OIDC, AppRole, AWS IAM).
- Secrets engine needed (KV, database, PKI, Transit, AWS).
- Dynamic vs static secret requirements.

### Output Artifact
Writes to Vault CLI commands, Terraform HCL for Vault, Vault policy HCL, and/or [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) injector annotations.
...
- [ ] Auth method is configured ([Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md), AppRole, OIDC, or token).
...
### Step 3: Dynamic Database Secrets — [PostgreSQL](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)
```bash
...
vault write database/config/postgres-prod \
  ...
  connection_url="[postgresql](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://{{username}}:{{password}}@postgres:5432/app" \
...
```bash
vault write database/config/[mysql](../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)-prod \
  plugin_name=[mysql](../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)-database-plugin \
  allowed_roles="app-[mysql](../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)" \
  connection_url="{{username}}:{{password}}@tcp([mysql](../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md).example.com:3306)/" \
  username="vault_admin" \
  password="vault_pass"

vault write database/roles/app-[mysql](../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md) \
  db_name=[mysql](../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)-prod \
...
### Step 6: Auth Methods
```bash
# [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) auth
vault auth enable [kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)
vault write auth/[kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)/config \
  ...
  token_reviewer_jwt="$(cat /var/run/secrets/[kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md).io/serviceaccount/token)" \
...
vault write auth/[kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)/role/my-app \
...
auto_auth {
  method "[kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)" {
    mount_path = "auth/[kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)"
    config = {
      role = "my-app"
    }
  }
...
### Step 10: Vault Agent Injector ([Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md))
```yaml
apiVersion: apps/v1
kind: Deployment
metadata:
...
resource "vault_kubernetes_auth_backend_config" "k8s" {
  backend = vault_auth_backend.[kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md).path
  kubernetes_host = "https://[kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md).default.svc"
}
...
## References
  - ../../references/vault_secrets-engines.md — Secrets Engines
  ...
  - ../../references/vault_vault-policies.md — Vault Policies
## Handoff
