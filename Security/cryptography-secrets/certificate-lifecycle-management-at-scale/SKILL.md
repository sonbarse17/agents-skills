...
happens. [cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/security/cert-manager-tls-automation/SKILL.md)/SKILL.md)
solves this well *inside* a single [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) cluster via a
reconciliation loop, but most enterprises have a fleet that isn't just
[Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md): VMs, on-prem load balancers, network appliances, multiple
...
[Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) controller has visibility, building expiry [monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) that
...
- Standing up or reviewing an enterprise CA hierarchy (root, one or more
  ...
  services, not just one [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) cluster.
- Integrating a fleet's certificate issuance with an enterprise CA —
  ...
  Azure Key [Vault](../vault/SKILL.md)-integrated CA), or HashiCorp [Vault](../vault/SKILL.md)'s PKI engine used
...
- Automating certificate rotation across a mixed fleet — VMs, on-prem
  appliances, multiple [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) clusters, load balancers — where no
  single cluster-scoped controller has visibility into every
  certificate.
- Building or improving fleet-wide certificate expiry [monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) and
  [alerting](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md), so an expiring cert is caught weeks ahead rather than
  discovered as an outage.
- Investigating a recurring pattern of expiry-related outages and
  wanting a systemic fix (inventory, automation, [alerting](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md)) rather than
...
- Deciding the right split between cert-manager (for in-cluster
  [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) workloads) and enterprise-CA-integrated automation (for
...
- Administrative access to the chosen enterprise CA integration point:
  ...
  [Vault](../vault/SKILL.md)'s PKI engine API if [Vault](../vault/SKILL.md) is the org's chosen internal CA.
...
- A distribution/rotation mechanism appropriate to each fleet segment:
  a configuration management tool ([Ansible](../../../DevOps_and_Cloud/infrastructure-as-code/ansible/other/ansible/SKILL.md)/Puppet/Chef) pushing renewed
  certs to VMs and appliances, `cert-manager` for in-cluster [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)
...
- [Monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)/[alerting](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md) infrastructure (Prometheus + a blackbox/certificate
  exporter, a dedicated certificate-[monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) SaaS, or a scheduled
  ...
  controller.
- [Change-management](../../../DevOps_and_Cloud/observability-monitoring-logging/common/other/change-management/SKILL.md) awareness for anything issued from a shared
...
1. **Build (or validate) the CA hierarchy before automating rotation on
   ...
   ```
   If the org already runs [Vault](../vault/SKILL.md)'s PKI engine for internal issuance, its
   intermediate ([vault-operations-and-pki-engine-configuration](../vault/SKILL.md)-operations-and-pki-engine-configuration/SKILL.md)/SKILL.md))
...
4. **Automate rotation per fleet segment, matched to that segment's
   ...
   appliances, and multiple [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) clusters uniformly:
   - **[Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) workloads:** `cert-manager` per cluster remains the
     right tool — see
     ...
     enterprise CA ([Vault](../vault/SKILL.md) PKI backend, or a cert-manager
     `venafi-issuer`/ACME-fronted enterprise CA integration where
     available) rather than a public ACME CA.
   - **VMs/on-prem servers:** a configuration management run ([Ansible](../../../DevOps_and_Cloud/infrastructure-as-code/ansible/other/ansible/SKILL.md)
     example) that requests renewal ahead of `renewBefore`-equivalent
     margin and redeploys the cert + reloads the consuming service:
     ```yaml
     # [ansible](../../../DevOps_and_Cloud/infrastructure-as-code/ansible/other/ansible/SKILL.md) playbook task (illustrative)
...
5. **Set `renewBefore`-equivalent margins deliberately per fleet
   ...
   — a VM fleet needing a [change-management](../../../DevOps_and_Cloud/observability-monitoring-logging/common/other/change-management/SKILL.md)-approved deployment window
   needs a longer lead time than an automated [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) reconcile loop:
   ```
   [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) (cert-manager, automated reconcile): renew 15-30 days before expiry
...
6. **Alert on expiry as a first-class, fleet-wide signal**, independent
   ...
   automation failing silently is exactly the case [alerting](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md) exists to
   catch:
   ```yaml
   # Prometheus [alerting](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md) rule using a blackbox/certificate exporter
   ...
   policy (see
   [pagerduty-and-opsgenie-oncall-configuration](../../../[incident](../../Observability_and_SecOps/incident/SKILL.md)-tooling-and-itsm/skills/[pagerduty-and-opsgenie-oncall-configuration](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/pagerduty-and-opsgenie-oncall-configuration/SKILL.md)/SKILL.md)),
...
7. **Plan and rehearse intermediate/root CA rotation** as a
   ...
   > discipline as a [Vault](../vault/SKILL.md) seal migration (see
   > [vault-operations-and-pki-engine-configuration](../vault/SKILL.md)-operations-and-pki-engine-configuration/SKILL.md)/SKILL.md)),
...
- Match rotation automation to each fleet segment's actual deployment
  mechanism and lead time ([Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) reconcile loop vs. a
...
- Alert on expiry independently of whether automation "should" have
  ...
  scenario expiry [alerting](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md) exists to catch, and it should page, not just
  log.
...
- Prefer a single enterprise CA integration point ([Vault](../vault/SKILL.md) PKI, AD CS, or
  ...
  is what makes a single fleet-wide inventory and [monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) approach
  actually complete.
...
- **Symptom:** A production outage occurs at exactly midnight with no
  ...
  **Fix:** This is an inventory gap, not a [monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)-tool failure —
  ...
  as any other unmanaged-asset finding, since automation and [alerting](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md)
...
- **Symptom:** Different teams have each stood up their own small
  internal CA over time (a self-signed root here, a [Vault](../vault/SKILL.md) PKI mount
...
**Scenario:** An enterprise runs three fleet segments — 40 [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)
...
one enterprise root, with fleet-wide expiry [monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) after a recent
outage caused by an unmanaged VM's certificate expiring unnoticed.

1. CA hierarchy consolidated onto [Vault](../vault/SKILL.md)'s PKI engine as the single
   Production Issuing CA, itself signed by an offline enterprise root
   (see
   [vault-operations-and-pki-engine-configuration](../vault/SKILL.md)-operations-and-pki-engine-configuration/SKILL.md)/SKILL.md)
   for that setup).

2. [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md) clusters: each cluster's cert-manager `ClusterIssuer` is
   pointed at [Vault](../vault/SKILL.md)'s PKI engine instead of a public ACME CA:
   ```yaml
   apiVersion: cert-manager.io/v1
   kind: ClusterIssuer
   metadata: { name: [vault](../vault/SKILL.md)-enterprise-ca }
   spec:
     [vault](../vault/SKILL.md):
       server: "https://[vault](../vault/SKILL.md).example.internal:8200"
       ...
       auth:
         [kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md):
           role: "cert-manager"
           mountPath: "/v1/auth/[kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)"
   ```

3. VM fleet: an [Ansible](../../../DevOps_and_Cloud/infrastructure-as-code/ansible/other/ansible/SKILL.md) playbook run nightly checks each host's
   certificate expiry against a 45-day threshold, requests renewal from
   [Vault](../vault/SKILL.md)'s PKI `issue` endpoint, deploys the renewed cert, and reloads
...
4. Fleet-wide inventory reconciles active scan results (step 3 of the
   guidance) against [Vault](../vault/SKILL.md)'s PKI issuance log nightly, flagging any
...
5. Prometheus [alerting](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md) (step 6) fires a `warning` at 30 days and a
...
Result: a single enterprise CA ([Vault](../vault/SKILL.md)-backed), one consolidated
inventory covering all three fleet segments regardless of deployment
mechanism, and expiry [alerting](../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md) that pages on-call well before any
...
- [cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/security/cert-manager-tls-automation/SKILL.md)/SKILL.md) —
  the [Kubernetes](../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)-native reconciliation piece this skill's fleet-wide
