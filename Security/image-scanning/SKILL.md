...
`[supply-chain-security](../supply-chain-security/SKILL.md)` and `[container-registry](../../containers-orchestration/docker/registry/container-registry/SKILL.md)`; this step is only about not losing the scan
