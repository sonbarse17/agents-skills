...
- Confirm written authorization for network [monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
...
- **Written Authorization**: Obtain explicit permission for network [monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
...
- **PCI-DSS**: Network security [monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) requirements
- **ISO 27001**: A.12.4 Logging and [monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
- **GDPR**: Data protection and privacy requirements

## Common Patterns

### Pattern 1: [Incident](../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md) Response Investigation

```bash
# Capture traffic during [incident](../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md)
sudo tshark -i eth0 -w incident_$(date +%Y%m%d_%H%M%S).pcap -a duration:300

# Analyze for lateral movement
tshark -r [incident](../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md).pcap -Y "smb2 or rdp or ssh" -T fields -e ip.src -e ip.dst

# Identify C2 communication
tshark -r [incident](../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md).pcap -Y "http or dns" -T fields -e ip.dst -e http.host -e dns.qry.name

# Extract IOCs
tshark -r [incident](../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md).pcap -Y "ip.dst" -T fields -e ip.dst | sort -u > ioc_ips.txt
tshark -r [incident](../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md).pcap -Y "dns.qry.name" -T fields -e dns.qry.name | sort -u > ioc_domains.txt
```
...
```bash
#!/bin/bash
# continuous_monitor.sh - Continuous network [monitoring](../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)
...
while read line; do
  ...
  # Trigger [incident](../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md) response workflow
