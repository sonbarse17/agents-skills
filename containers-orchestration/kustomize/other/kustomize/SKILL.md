...
Use this skill when:
- Managing [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) configs across environments
...
- [kubectl](../../../kubernetes/other/kubectl/SKILL.md) 1.14+ (includes kustomize)
- Or standalone kustomize CLI
- Basic [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) manifest knowledge
...
secretGenerator:
  - name: myapp-secrets
    ...
    files:
      - tls.crt
      - tls.key
    type: [kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/tls
```
...
# kustomization.yaml
commonLabels:
  app.[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/name: myapp
  app.[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/environment: production
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) kustomize overlays/production

# Apply to cluster
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply -k overlays/production

# Delete resources
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) delete -k overlays/production

# View diff
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) diff -k overlays/production

# Build with standalone kustomize
kustomize build overlays/production

# Build and apply
kustomize build overlays/production | [kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply -f -
```
...
- [argocd-gitops](../[argocd-gitops](../[argocd](../argocd/SKILL.md)-[gitops](../../../common/gitops/gitops/SKILL.md)/SKILL.md)/) - [GitOps](../../../common/gitops/gitops/SKILL.md) deployment
