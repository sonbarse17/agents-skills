...
Use this skill to keep Helm-based [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) deployments reproducible, auditable, and safe across environments.
...
6. Verify: `helm list`, `helm status <release>`, `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get pods -n <namespace>`.
...
- **[kubectl](../../../kubernetes/other/kubectl/SKILL.md)** — inspect and manage [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) resources created by Helm
- **[docker](../../../docker/other/docker/SKILL.md)** — build container images referenced in Helm chart values
