...
## Purpose
Develop, test, deploy, and operate Helm charts for [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) with best practices for templating, dependency management, security, CI/CD integration, and advanced patterns.
...
dependencies:
  ...
  - name: redis
    version: "19.6.1"
    repository: "oci://registry-1.[docker](../../../docker/other/docker/SKILL.md).io/bitnamicharts"
...
# @param global.imageRegistry Global [Docker](../../../docker/other/docker/SKILL.md) image registry
# @param global.imagePullSecrets Global [Docker](../../../docker/other/docker/SKILL.md) image pull secrets
...
app.[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/name: {{ include "my-app.name" . }}
...
- Use Chart.yaml `kubeVersion` to prevent install on incompatible [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) versions.
...
- `devops-[gitops](../../../common/gitops/gitops/SKILL.md)` for [GitOps](../../../common/gitops/gitops/SKILL.md) workflow integration.
