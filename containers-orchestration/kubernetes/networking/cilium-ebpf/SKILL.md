...
helm upgrade --install cilium cilium/cilium --namespace kube-system \
  ...
  --set ipam.mode=[kubernetes](../../other/kubernetes/SKILL.md) \
  --set devices='{eth0}' \
...
metadata:
  annotations:
    [kubernetes](../../other/kubernetes/SKILL.md).io/ingress-bandwidth: "100M"
    [kubernetes](../../other/kubernetes/SKILL.md).io/egress-bandwidth: "100M"
...
spec:
  ...
  ingress:
    - fromEndpoints:
        - matchLabels:
            "k8s:io.[kubernetes](../../other/kubernetes/SKILL.md).pod.namespace": kube-system
...
[kubectl](../../other/kubectl/SKILL.md) get ciliumendpoints -A
...
[kubectl](../../other/kubectl/SKILL.md) get ciliumendpoints --all-namespaces -o json \
...
bpf:
  ...
  tproxy: true
ipam:
  mode: [kubernetes](../../other/kubernetes/SKILL.md)
encryption:
  type: wireguard
  wireguard:
