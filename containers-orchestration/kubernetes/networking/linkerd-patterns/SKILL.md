...
description: Implement Linkerd service mesh patterns for lightweight,
  security-focused service mesh deployments. Use when setting up Linkerd,
  configuring traffic policies, or implementing zero-trust networking with
  minimal overhead.
tags:
  - ci_cd
  - linkerd-patterns
...
Production patterns for Linkerd service mesh - the lightweight, security-first service mesh for [Kubernetes](../../other/kubernetes/SKILL.md).
...
# Install CRDs
linkerd install --crds | [kubectl](../../other/kubectl/SKILL.md) apply -f -

# Install control plane
linkerd install | [kubectl](../../other/kubectl/SKILL.md) apply -f -

# Verify installation
linkerd check

# Install viz extension (optional)
linkerd viz install | [kubectl](../../other/kubectl/SKILL.md) apply -f -
```
...
linkerd multicluster install | [kubectl](../../other/kubectl/SKILL.md) apply -f -

# Link clusters
linkerd multicluster link --cluster-name west \
  --api-server-address https://west.example.com:6443 \
  | [kubectl](../../other/kubectl/SKILL.md) apply -f -

# Export a service to other clusters
[kubectl](../../other/kubectl/SKILL.md) label svc/my-service mirror.linkerd.io/exported=true
...
# View proxy logs
[kubectl](../../other/kubectl/SKILL.md) logs deploy/my-app -c linkerd-proxy
