...
- **Slimmed Backstage**: a single-replica backend (no HA, since the
  ...
  packaging follows
  [helm-chart-authoring](../../../[kubernetes](../../Containers_and_Orchestration/kubernetes/SKILL.md)-platform/skills/[helm-chart-authoring](../../../helm/charts/helm-chart-authoring/SKILL.md)/SKILL.md);
