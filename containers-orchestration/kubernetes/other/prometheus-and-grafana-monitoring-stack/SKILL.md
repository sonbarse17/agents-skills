...
# Prometheus and Grafana [Monitoring](../../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md) Stack
...
on an interval, evaluates [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) rules against them, and hands firing
alerts to Alertmanager for routing/deduplication/silencing, while Grafana
turns the same time-series data into [dashboards](../../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md). The stack is simple to
...
too short a window, missing `by()` clauses that collapse [dashboards](../../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md) to a
single line), [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) rules that page on transient blips, and
hand-edited Grafana [dashboards](../../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md) that drift from what's checked into git.
...
[alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) rules and Alertmanager routing that produce actionable pages
instead of noise, and provisioning Grafana as code so [dashboards](../../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md) survive
a cluster rebuild.
...
- Writing or debugging a PromQL query for a dashboard panel, a
  recording rule, or an [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) rule.
- Defining or tuning Prometheus [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) rules and Alertmanager
  routing trees, grouping, inhibition, and silences.
- Provisioning Grafana datasources and [dashboards](../../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md) declaratively
...
- Reducing alert fatigue — too many pages, duplicate pages across
  teams, or alerts with no clear owner/[runbook](../../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md).
...
1. **Install the stack with an explicit, pinned chart version:**
   ...
   helm upgrade --install kube-prom-stack prometheus-community/kube-prometheus-stack \
     --namespace [monitoring](../../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md) --create-namespace \
     --version 65.5.0 \
     -f values-[monitoring](../../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md).yaml
   ```
...
5. **Add recording rules for anything queried repeatedly** ([dashboards](../../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md),
...
6. **Write [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) rules with a `for:` duration** to suppress
   flapping/transient blips, and attach severity + [runbook](../../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md) labels so
         ...
         rules:
           - alert: PaymentsAPIHighErrorRate
             ...
             annotations:
               ...
               runbook_url: "https://[runbooks](../../../../DevOps_and_Cloud/Observability_and_SecOps/runbooks/SKILL.md).internal/payments-api-error-rate"
...
8. **Provision Grafana datasources and [dashboards](../../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md) as code**, not
   ...
   datasources:
     - name: Prometheus
       type: prometheus
       access: proxy
       url: http://kube-prom-stack-prometheus.[monitoring](../../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md):9090
       isDefault: true
       jsonData:
         timeInterval: 30s
   ```
...
- **Every alert must have `severity` and `team` (or equivalent
  ...
  clear owner and no [runbook](../../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md) is a page nobody knows how to act on.
- **Set `for:` on every [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) rule** long enough to ride out normal
...
- **Alert on symptoms (error rate, latency, saturation), not on every
  ...
  produces far less noise than [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) on every internal metric.
...
- **Version-control Grafana [dashboards](../../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md) and Alertmanager config** in the
  same repo/pipeline as the rest of the platform config — [dashboards](../../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md)
...
- **Symptom:** The same underlying [incident](../../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md) produces five separate
...
dashboard, and no [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) — the team wants to be paged only on genuine
...
5. Route `severity="critical", team="payments"` to a PagerDuty
   ...
   the same job if both trip during the same [incident](../../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md).
...
7. Run `promtool check rules` and `promtool test rules` in CI against
   the [alerting](../../../../DevOps_and_Cloud/Observability_and_SecOps/alerting/SKILL.md) rule file before merging, catching a typo'd metric name
