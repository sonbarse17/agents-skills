...
- A container runtime already installed and configured with the CRI
  ...
  [container-runtime-[docker](../../../docker/other/docker/SKILL.md)-containerd](../[container-runtime-[docker](../docker/SKILL.md)-containerd](../container-runtime-[docker](../docker/SKILL.md)-containerd/SKILL.md)/SKILL.md)
...
8. **For managing cluster lifecycle declaratively instead, install
   ...
   ```bash
   clusterctl init --infrastructure <provider>   # e.g. [docker](../../../docker/other/docker/SKILL.md), metal3, aws
   ```
...
- [container-runtime-[docker](../../../docker/other/docker/SKILL.md)-containerd](../[container-runtime-[docker](../docker/SKILL.md)-containerd](../container-runtime-[docker](../docker/SKILL.md)-containerd/SKILL.md)/SKILL.md) — installing/configuring the container runtime kubeadm requires on every node before `init`/`join`.
