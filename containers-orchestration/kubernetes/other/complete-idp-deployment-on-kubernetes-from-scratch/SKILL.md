...
- A Node.js/Yarn toolchain to build and [customize](../../../../cloud/azure/ai/customize/SKILL.md)/SKILL.md)/SKILL.md) the Backstage app.
...
[ingress-nginx-configuration](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[ingress-nginx-configuration](../../networking/ingress-nginx-configuration/SKILL.md)/SKILL.md);
...
packaging follows
[helm-chart-authoring](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[helm-chart-authoring](../../../helm/charts/helm-chart-authoring/SKILL.md)/SKILL.md);
...
**Phase 7 — [Multi-tenancy](../../../common/other/multi-tenancy/SKILL.md).** Namespace-per-team is the default and
