...
- For multi-server HA: either an external SQL datastore ([MySQL](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md),
  [PostgreSQL](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md), or the officially supported etcd-compatible options) or
...
1. **Decide the datastore/HA model before installing anything**:
   ...
   - **Multi-server, external datastore ([MySQL](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)/[PostgreSQL](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md))**: control
