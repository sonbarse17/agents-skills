...
- [secrets-management](../../../../Security/devsecops/SKILL.md)/skills/[secrets-management](../../../../cloud/common/security/secrets-management/SKILL.md)/SKILL.md) — how the backup-target credentials referenced above should actually be sourced and rotated.
