...
# [Kubernetes](../../other/kubernetes/SKILL.md) Storage
...
```bash
[kubectl](../../other/kubectl/SKILL.md) get pvc <name>                       # Pending? check events
[kubectl](../../other/kubectl/SKILL.md) describe pvc <name>                  # provisioning failure reason
[kubectl](../../other/kubectl/SKILL.md) get storageclass                     # is the referenced class real, and is one default?
```
...
When a node fails, [Kubernetes](../../other/kubernetes/SKILL.md) reschedules the pod elsewhere, but the volume has to actually be
