...
- [Kubernetes](../../other/kubernetes/SKILL.md) 1.28+ with GPU nodes
- KServe installed (or Triton standalone)
- `[kubectl](../../other/kubectl/SKILL.md)` and `helm` configured
...
helm repo add kserve https://kserve.[github](../../../../ci-cd/github-actions/other/github/SKILL.md).io/[helm-charts](../../../helm/charts/helm-charts/SKILL.md)
helm repo update
...
# Verify
[kubectl](../../other/kubectl/SKILL.md) get pods -n kserve
[kubectl](../../other/kubectl/SKILL.md) get crd | grep kserve
```
...
```bash
[kubectl](../../other/kubectl/SKILL.md) apply -f inference-service.yaml

# Get inference service URL
[kubectl](../../other/kubectl/SKILL.md) get inferenceservice sklearn-iris -n models
# NAME           URL                                          READY   ...
...
[kubectl](../../other/kubectl/SKILL.md) patch inferenceservice llama-3-8b -n models \
  --type='json' \
...
[kubectl](../../other/kubectl/SKILL.md) rollout status deployment/llama-3-8b-predictor -n models
[kubectl](../../other/kubectl/SKILL.md) get inferenceservice llama-3-8b -n models -w
```
...
| Canary stuck at 0% | KNative routing issue | Check `[kubectl](../../other/kubectl/SKILL.md) get ksvc -n models` |
