...
[Kubernetes](../../other/kubernetes/SKILL.md) and most modern orchestration platforms were designed around the assumption that
...
The single most common way to lose data on [Kubernetes](../../other/kubernetes/SKILL.md) is storage that is tied to the node
...
Running a database or queue yourself on [Kubernetes](../../other/kubernetes/SKILL.md) is not free just because the compute is
