...
- [secrets-management](../../../../Security/common/devsecops/SKILL.md)/skills/[secrets-management](../../../../cloud/common/security/secrets-management/SKILL.md)/SKILL.md) — broader secret-handling practices this skill's `TriggerAuthentication` validation applies specifically to KEDA triggers.
