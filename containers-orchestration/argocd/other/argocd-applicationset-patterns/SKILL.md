...
- Argo CD ≥ 2.9 with the `ApplicationSet` controller enabled (bundled by
  ...
  `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get pods -n [argocd](../argocd/SKILL.md) -l app.[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/name=[argocd](../argocd/SKILL.md)-applicationset-controller`).
...
7. **Verify what a change to a generator will produce before merging:**
   ...
   [kubectl](../../../kubernetes/other/kubectl/SKILL.md) get applicationset payments-api-envs -n [argocd](../argocd/SKILL.md) -o yaml   # inspect .status.conditions
   [kubectl](../../../kubernetes/other/kubectl/SKILL.md) get applications -n [argocd](../argocd/SKILL.md) -l [argocd](../argocd/SKILL.md).argoproj.io/application-set-name=payments-api-envs
   ```
...
- **Symptom:** A new cluster was registered but no `Application` was
  ...
  **Fix:** Check the cluster Secret's labels against the generator's
  ...
  `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get secret -n [argocd](../argocd/SKILL.md) -l [argocd](../argocd/SKILL.md).argoproj.io/secret-type=cluster --show-labels`.
...
- **Symptom:** Removing a directory from the Git generator's match (a
  ...
  live [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) resources for that service immediately, with no
...
- **Symptom:** Two different generator branches (e.g., a List generator
  ...
  **Fix:** Template names must be unique across everything the
  ...
  `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get applications -n [argocd](../argocd/SKILL.md) -l [argocd](../argocd/SKILL.md).argoproj.io/application-set-name=<name>`
...
- **Symptom:** A template field renders as an empty string instead of
  ...
  **Fix:** Set `goTemplateOptions: ["missingkey=error"]` so a
  ...
  `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) describe applicationset <name> -n [argocd](../argocd/SKILL.md)` for the resulting
...
after applying, `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get applications -n [argocd](../argocd/SKILL.md) -l
