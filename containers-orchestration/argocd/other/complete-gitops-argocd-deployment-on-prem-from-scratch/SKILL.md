...
# Complete [GitOps](../../../common/gitops/gitops/SKILL.md)/Argo CD Deployment On-Prem, From Scratch
...
short-lived via HashiCorp [Vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)'s [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) secrets engine rather than a
...
- Starting from a bare, already-provisioned self-managed [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)
...
- Standing up a second/third on-prem environment (a separate physical
  ...
  elsewhere.
- Migrating a team off manual `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply`/`helm upgrade` deploys on
  on-prem infrastructure onto a full [GitOps](../../../common/gitops/gitops/SKILL.md) flow, starting from zero.
...
- Optional but recommended for anything beyond a small/dev deployment: a
  ...
  [vault-operations-and-pki-engine-configuration](../../../../Security/security-scanning/SKILL.md)-tooling/skills/[vault-operations-and-pki-engine-configuration](../[vault](../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)-operations-and-pki-engine-configuration/SKILL.md)/SKILL.md)
...
```bash
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get svc -A -o wide | grep LoadBalancer
```
...
back to [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-native credentials, scoped as narrowly as possible per
...
credentials instead**: configure [Vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)'s [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) secrets engine (or a
...
```bash
[vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md) write auth/[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)/config \
...
```bash
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) create secret [docker](../../../docker/other/docker/SKILL.md)-registry harbor-pull-secret \
  --[docker](../../../docker/other/docker/SKILL.md)-server=harbor.internal.example.com \
  --[docker](../../../docker/other/docker/SKILL.md)-username=[argocd](../argocd/SKILL.md)-reader \
  --[docker](../../../docker/other/docker/SKILL.md)-password="${HARBOR_ROBOT_TOKEN}" \
  ...
  [vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md):
    ...
    auth:
      [kubernetes](../../../kubernetes/other/kubernetes/SKILL.md):
        role: cert-manager
        mountPath: /v1/auth/[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)
```
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get secret harbor-pull-secret -n [argocd](../argocd/SKILL.md) -o jsonpath='{.data.\.dockerconfigjson}' | base64 -d
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get certificate -n [argocd](../argocd/SKILL.md) [argocd](../argocd/SKILL.md)-server-tls -o jsonpath='{.status.conditions}'
```
Confirm the Harbor pull secret's embedded token is still valid (robot
tokens can expire independently of the [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Secret they're stored
...
- **Symptom:** A Harbor `imagePullSecret` worked at initial setup and later
  ...
  **Fix:** Harbor robot account tokens have their own expiration
  independent of the [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Secret storing them — check the robot
  account's expiry in Harbor directly (`[docker](../../../docker/other/docker/SKILL.md) login` manually against the
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply -f metallb-ip-pool.yaml
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply -f [argocd](../argocd/SKILL.md)-manager-rbac.yaml --context payments-staging

# Phase 3 — Harbor pull secret + internal-CA Ingress
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) create secret [docker](../../../docker/other/docker/SKILL.md)-registry harbor-pull-secret \
  --[docker](../../../docker/other/docker/SKILL.md)-server=harbor.internal.example.com \
  --[docker](../../../docker/other/docker/SKILL.md)-username=[argocd](../argocd/SKILL.md)-reader --[docker](../../../docker/other/docker/SKILL.md)-password="${HARBOR_ROBOT_TOKEN}" -n [argocd](../argocd/SKILL.md)
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply -f [argocd](../argocd/SKILL.md)-server-ingress-internal-ca.yaml
...
- [vault-operations-and-pki-engine-configuration](../../../../Security/security-scanning/SKILL.md)-tooling/skills/[vault-operations-and-pki-engine-configuration](../[vault](../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)-operations-and-pki-engine-configuration/SKILL.md)/SKILL.md) and [sealed-secrets-and-external-secrets-operator](../../../../Security/security-scanning/SKILL.md)-tooling/skills/[sealed-secrets-and-external-secrets-operator](../../../kubernetes/security/sealed-secrets-and-external-secrets-operator/SKILL.md)/SKILL.md) — standing up [Vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md) and syncing its issued credentials into Argo CD's cluster registration.
- [gitops-workflow](../../../devops/skills/[gitops-workflow](../[gitops](../gitops/SKILL.md)-workflow/SKILL.md)/SKILL.md) — the vendor-neutral [GitOps](../../../common/gitops/gitops/SKILL.md) concepts this on-prem [runbook](../../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md) implements.
