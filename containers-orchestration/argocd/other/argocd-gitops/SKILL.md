...
# [ArgoCD](../argocd/SKILL.md) [GitOps](../../../common/gitops/gitops/SKILL.md)

Implement declarative continuous delivery for [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) with [ArgoCD](../argocd/SKILL.md).

## When to Use This Skill

Use this skill when:
- Implementing [GitOps](../../../common/gitops/gitops/SKILL.md) workflows for [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)
...
- [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) cluster with [ArgoCD](../argocd/SKILL.md) installed
- [kubectl](../../../kubernetes/other/kubectl/SKILL.md) configured
...
```bash
# Create namespace
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) create namespace [argocd](../argocd/SKILL.md)

# Install [ArgoCD](../argocd/SKILL.md)
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply -n [argocd](../argocd/SKILL.md) -f https://raw.githubusercontent.com/argoproj/[argo-cd](../argo-cd/SKILL.md)/stable/manifests/install.yaml

# Get admin password
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) -n [argocd](../argocd/SKILL.md) get secret [argocd](../argocd/SKILL.md)-initial-admin-secret \
  -o jsonpath="{.data.password}" | base64 -d

# Port forward to access UI
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) port-forward svc/[argocd](../argocd/SKILL.md)-server -n [argocd](../argocd/SKILL.md) 8080:443
...
spec:
  project: default
  source:
    repoURL: https://[github](../../../../ci-cd/github-actions/other/github/SKILL.md).com/org/myapp-manifests.git
    targetRevision: main
...
spec:
  project: default
  source:
    repoURL: https://[github](../../../../ci-cd/github-actions/other/github/SKILL.md).com/org/myapp-chart.git
    targetRevision: main
    path: charts/myapp
    helm:
      valueFiles:
...
### [Kustomize](../../../kustomize/other/kustomize/SKILL.md) Application

```yaml
apiVersion: argoproj.io/v1alpha1
kind: Application
metadata:
  name: myapp-[kustomize](../../../kustomize/other/kustomize/SKILL.md)
  namespace: [argocd](../argocd/SKILL.md)
spec:
  project: default
  source:
...
spec:
  ...
  sourceRepos:
    - https://[github](../../../../ci-cd/github-actions/other/github/SKILL.md).com/org/*
  destinations:
    - namespace: myapp-*
      server: https://[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).default.svc
...
```yaml
# In [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) manifests
apiVersion: v1
kind: ConfigMap
metadata:
  name: myconfig
...
stringData:
  url: https://[github](../../../../ci-cd/github-actions/other/github/SKILL.md).com/org/private-repo.git
  username: git
  password: ghp_xxxx
---
# SSH key
...
metadata:
  ...
  labels:
    [argocd](../argocd/SKILL.md).argoproj.io/secret-type: repository
stringData:
  url: git@[github](../../../../ci-cd/github-actions/other/github/SKILL.md).com:org/private-repo.git
  sshPrivateKey: |
...
- [kustomize](../[kustomize](../kustomize/SKILL.md)/) - [Kustomize](../../../kustomize/other/kustomize/SKILL.md) overlays
