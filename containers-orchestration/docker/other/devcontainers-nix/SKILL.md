...
// .devcontainer/devcontainer.json
{
  ...
  "features": {
    ...
    "ghcr.io/devcontainers/features/[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md):1": { "version": "3.12" },
    "ghcr.io/devcontainers/features/[docker](../docker/SKILL.md)-in-[docker](../docker/SKILL.md):2": {},
    "ghcr.io/devcontainers/features/[kubectl](../../../kubernetes/other/kubectl/SKILL.md)-helm-minikube:1": {}
  },
  ...
  "customizations": {
    "vscode": {
      "extensions": [
        ...
        "ms-[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md).[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)"
      ],
      "settings": {
...
### [Docker](../docker/SKILL.md) Compose Dev Container
...
services:
  ...
  db:
    ...
    volumes:
      - pgdata:/var/lib/[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)/data
    ports:
      - "5432:5432"
...
RUN curl -LO "https://dl.k8s.io/release/$(curl -sL https://dl.k8s.io/release/stable.txt)/bin/linux/amd64/[kubectl](../../../kubernetes/other/kubectl/SKILL.md)" \
    && install [kubectl](../../../kubernetes/other/kubectl/SKILL.md) /usr/local/bin/
      ...
      in {
        devShells.default = pkgs.mkShell {
          buildInputs = with pkgs; [
            ...
            [kubectl](../../../kubernetes/other/kubectl/SKILL.md)
            [kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-helm
            opentofu
            awscli2
            jq
            yq-go
...
# Add packages
devbox add nodejs@20 [python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)@3.12 [postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)@16
devbox add go@1.22 [kubectl](../../../kubernetes/other/kubectl/SKILL.md) helm
...
```json
{
  ...
  "packages": [
    "nodejs@20",
    "[python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md)@3.12",
    "go@1.22",
    "[kubectl](../../../kubernetes/other/kubectl/SKILL.md)@1.29",
    "[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-helm@3.14",
    "opentofu@1.8",
    "awscli2@2.15",
    "jq@1.7",
    "[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)@16",
    "redis@7"
  ],
  "env": {
    "PROJECT_ROOT": "$PWD",
    "DATABASE_URL": "[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://localhost:5432/dev"
  },
  "shell": {
    "init_hook": [
    ...
    "scripts": {
      "dev": "npm run dev",
      "test": "npm test",
      "db:start": "pg_ctl -D .devbox/virtenv/[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)/data start",
      "db:stop": "pg_ctl -D .devbox/virtenv/[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)/data stop",
...
| Reproducibility | Good ([Docker](../docker/SKILL.md)) | Excellent | Excellent (Nix) |
| Speed | Slow (build image) | Fast (cached) | Fast (cached) |
| IDE support | VS Code, JetBrains | Any terminal | Any terminal |
| CI integration | [Docker](../docker/SKILL.md)-based | Nix actions | Devbox action |
...
- Keep dev environment close to production (same Node/[Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md) versions)
...
| Dev Container won't build | Check [Docker](../docker/SKILL.md) disk space, rebuild with `--no-cache` |
