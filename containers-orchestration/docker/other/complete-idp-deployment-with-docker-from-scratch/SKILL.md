...
- A small team or early-stage platform effort that has not adopted
  [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) and has no near-term plan to, but still wants a service
...
- [Docker](../docker/SKILL.md) Engine and [Docker](../docker/SKILL.md) Compose v2 on every host this stack runs on;
  no [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) assumption anywhere in this skill.
- A small, fixed number of hosts (this model does not scale past what a
  ...
  [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-based variants instead of scaling this one further).
...
- The Dapr CLI (`dapr init`) for self-hosted/standalone mode — this is a
  materially different Dapr operating mode than the [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)
...
- No expectation of an automated, policy-gated self-service provisioning
  ...
  versus the [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) variants' Scaffolder-action-driven provisioning is
  named directly.
...
database — Backstage itself doesn't require [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) to run, though most
...
skill's examples assume a [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-oriented deployment target for
...
definition plus a `Dockerfile`, not a Helm chart or [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) manifest —
this is the most concrete way this variant differs from every [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-
...
pipeline shape to Compose rather than a [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) ephemeral namespace.
...
[Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) annotation-based sidecar injection
[dapr-distributed-runtime-configuration](../../../[serverless](../serverless/SKILL.md)-and-alternative-compute/skills/[dapr-distributed-runtime-configuration](../../../common/other/dapr-distributed-runtime-configuration/SKILL.md)/SKILL.md)
...
[Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) deployment would, per
[dapr-configuration-validation](../../../[serverless](../serverless/SKILL.md)-and-alternative-compute/skills/[dapr-configuration-validation](../../../common/other/dapr-configuration-validation/SKILL.md)/SKILL.md).
...
in this variant, because there's no [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) API or cloud SDK for such
...
## What's missing, compared to the [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-based variants
...
or a full cloud/on-prem [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) variant once any of the following is
...
- **Symptom:** Two services on the same Compose host can reach each
  ...
  **Fix:** This isn't a misconfiguration to patch — it's the "no tenant
  ...
  matters, that's a signal to graduate to a [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-based variant with
...
- **Symptom:** A Dapr sidecar fails to start with a component-loading
  error that looks identical to a [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Dapr issue, but the fix
  documented for [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) (checking a `Scopes` annotation on the
  ...
  **Fix:** Confirm the `components/` directory is actually mounted into
  ...
  different from the annotation-based [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) injection most Dapr
...
6 internal services via [Docker](../docker/SKILL.md) Compose on two VMs, with no [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)
