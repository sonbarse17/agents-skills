...
- Container runtime ([Docker](../../other/docker/SKILL.md), [Podman](../../../podman/other/podman/SKILL.md))
...
| [Docker](../../other/docker/SKILL.md) Scout | Commercial | Fast | [GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md) integration |
...
# [Docker](../../other/docker/SKILL.md)
[docker](../../other/docker/SKILL.md) pull aquasec/trivy
```
...
# Scan [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) manifests
trivy config k8s/
```
...
jobs:
  scan:
    ...
    steps:
      ...
      - name: Build image
        run: [docker](../../other/docker/SKILL.md) build -t myapp:${{ [github](../../../../ci-cd/github-actions/other/github/SKILL.md).sha }} .
...
## [Docker](../../other/docker/SKILL.md) Scout

### Usage

```bash
# Enable [Docker](../../other/docker/SKILL.md) Scout
[docker](../../other/docker/SKILL.md) scout quickview myapp:latest

# Full CVE report
[docker](../../other/docker/SKILL.md) scout cves myapp:latest

# Compare images
[docker](../../other/docker/SKILL.md) scout compare myapp:v1 myapp:v2

# Recommendations
[docker](../../other/docker/SKILL.md) scout recommendations myapp:latest
```

### CI Integration

```yaml
- name: [Docker](../../other/docker/SKILL.md) Scout
  uses: [docker](../../other/docker/SKILL.md)/scout-action@v1
  with:
    command: cves
...
gcloud artifacts [docker](../../other/docker/SKILL.md) images describe \
  us-central1-[docker](../../other/docker/SKILL.md).pkg.dev/project/myrepo/myapp:latest \
