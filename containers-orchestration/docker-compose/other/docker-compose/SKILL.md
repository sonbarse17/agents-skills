...
# [Docker](../../../docker/other/docker/SKILL.md) Compose
...
- [Docker](../../../docker/other/docker/SKILL.md) Engine with Compose plugin (v2)
- Basic [Docker](../../../docker/other/docker/SKILL.md) knowledge
...
```yaml
# [docker](../../../docker/other/docker/SKILL.md)-compose.yml
version: '3.8'
...
```yaml
# [docker](../../../docker/other/docker/SKILL.md)-compose.yml (base)
services:
  web:
    image: myapp:latest
    ports:
...
# [docker](../../../docker/other/docker/SKILL.md)-compose.override.yml (development - auto-loaded)
services:
  web:
    build: .
    volumes:
...
# [docker](../../../docker/other/docker/SKILL.md)-compose.prod.yml (production)
services:
  web:
    deploy:
      replicas: 3
...
[docker](../../../docker/other/docker/SKILL.md) compose up

# Production
[docker](../../../docker/other/docker/SKILL.md) compose -f [docker](../../../docker/other/docker/SKILL.md)-compose.yml -f [docker](../../../docker/other/docker/SKILL.md)-compose.prod.yml up

# Merge and view final config
[docker](../../../docker/other/docker/SKILL.md) compose -f [docker](../../../docker/other/docker/SKILL.md)-compose.yml -f [docker](../../../docker/other/docker/SKILL.md)-compose.prod.yml config
```
...
```bash
# Start services
[docker](../../../docker/other/docker/SKILL.md) compose up -d

# Start specific service
[docker](../../../docker/other/docker/SKILL.md) compose up -d web

# Stop services
[docker](../../../docker/other/docker/SKILL.md) compose stop

# Stop and remove containers
[docker](../../../docker/other/docker/SKILL.md) compose down

# Stop and remove everything including volumes
[docker](../../../docker/other/docker/SKILL.md) compose down -v --rmi all

# Restart services
[docker](../../../docker/other/docker/SKILL.md) compose restart web
```
...
```bash
# Build images
[docker](../../../docker/other/docker/SKILL.md) compose build

# Build without cache
[docker](../../../docker/other/docker/SKILL.md) compose build --no-cache

# Build and start
[docker](../../../docker/other/docker/SKILL.md) compose up --build
...
```bash
# View logs
[docker](../../../docker/other/docker/SKILL.md) compose logs -f

# View specific service logs
[docker](../../../docker/other/docker/SKILL.md) compose logs -f web

# View running services
[docker](../../../docker/other/docker/SKILL.md) compose ps

# View resource usage
[docker](../../../docker/other/docker/SKILL.md) compose top
```
...
[docker](../../../docker/other/docker/SKILL.md) compose run --rm web npm test

# Execute in running container
[docker](../../../docker/other/docker/SKILL.md) compose exec web /bin/sh

# Scale service
[docker](../../../docker/other/docker/SKILL.md) compose up -d --scale worker=3
```
...
```bash
[docker](../../../docker/other/docker/SKILL.md) compose watch
```
...
services:
  proxy:
    ...
    ports:
      ...
      - "443:443"
    volumes:
      - /var/run/[docker](../../../docker/other/docker/SKILL.md).sock:/var/run/[docker](../../../docker/other/docker/SKILL.md).sock:ro
