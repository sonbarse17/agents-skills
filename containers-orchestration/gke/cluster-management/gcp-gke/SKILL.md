...
# Google [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Engine (GKE)

Deploy, operate, and scale managed [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) clusters on Google Cloud Platform.
...
- Google Cloud SDK (`gcloud`) and `[kubectl](../../../kubernetes/other/kubectl/SKILL.md)` installed
- APIs enabled: [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) Engine, Compute Engine
- IAM role `roles/container.admin` for cluster management

```bash
gcloud services enable container.googleapis.com compute.googleapis.com
gcloud components install [kubectl](../../../kubernetes/other/kubectl/SKILL.md)
```
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) create namespace myapp
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) create serviceaccount app-ksa --namespace=myapp
gcloud iam service-accounts add-iam-policy-binding \
  app-gsa@${PROJECT_ID}.iam.gserviceaccount.com \
  --role=roles/iam.workloadIdentityUser \
  --member="serviceAccount:${PROJECT_ID}.svc.id.goog[myapp/app-ksa]"
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) annotate serviceaccount app-ksa --namespace=myapp \
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: web
        image: us-central1-[docker](../../../docker/other/docker/SKILL.md).pkg.dev/PROJECT_ID/repo/web-app:v1.2.0
      ...
      - maxSkew: 1
        topologyKey: topology.[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/zone
...
metadata:
  ...
  namespace: myapp
  annotations:
    [kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/ingress.class: "gce"
    networking.gke.io/managed-certificates: "web-cert"
    [kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).io/ingress.global-static-ip-name: "web-static-ip"
spec:
  rules:
...
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) top nodes && [kubectl](../../../kubernetes/other/kubectl/SKILL.md) top pods --namespace=myapp
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) scale deployment web-app --replicas=5 --namespace=myapp
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) autoscale deployment web-app --namespace=myapp --min=3 --max=20 --cpu-percent=70
[kubectl](../../../kubernetes/other/kubectl/SKILL.md) logs -f deployment/web-app --namespace=myapp --all-containers
```
...
| Nodes `NotReady` | Disk/memory pressure or network issue | Run `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) describe node`; check taints and conditions |
...
- **[gcp-networking](../../../../cloud/gcp/networking/gcp-networking/SKILL.md)** - VPC, firewall rules, and load balancers for GKE clusters
- **[terraform-gcp](../../../../cloud/gcp/iac/terraform-gcp/SKILL.md)** - Provision GKE clusters with Infrastructure as Code
- **[gcp-compute](../../../../cloud/gcp/compute/gcp-compute/SKILL.md)** - When workloads are better suited for VMs than containers
- **[gcp-cloud-sql](../../../../cloud/gcp/database/gcp-cloud-sql/SKILL.md)** - Connecting GKE pods to Cloud SQL via sidecar proxy
