...
- [Docker](../../../docker/other/docker/SKILL.md) installed for building and pushing images
...
aws ecr get-login-password --region us-east-1 | \
  [docker](../../../docker/other/docker/SKILL.md) login --username AWS --password-stdin 123456789012.dkr.ecr.us-east-1.amazonaws.com

# Build, tag, and push
[docker](../../../docker/other/docker/SKILL.md) build -t myapp:latest .
[docker](../../../docker/other/docker/SKILL.md) tag myapp:latest 123456789012.dkr.ecr.us-east-1.amazonaws.com/myapp:latest
[docker](../../../docker/other/docker/SKILL.md) push 123456789012.dkr.ecr.us-east-1.amazonaws.com/myapp:latest
```
