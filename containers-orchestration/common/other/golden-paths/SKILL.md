...
- **A working health/readiness endpoint** from the first [commit](../../../../ci-cd/common/git-workflow/commit/SKILL.md), so [autoscaling](../../../../Software_Engineering_and_Other/Backend/patterns/autoscaling/SKILL.md) and rollout
...
team prefers a different framework. Discoverability depends on this too: `[service-catalog](../service-catalog/SKILL.md)` can only
...
visible in `[service-catalog](../service-catalog/SKILL.md)`, with a stated reason.
