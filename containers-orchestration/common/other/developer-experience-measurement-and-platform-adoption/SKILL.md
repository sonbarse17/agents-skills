...
- **Symptom:** A metric the platform team optimizes for (e.g. "% of new
  ...
  **Fix:** This is a sign the metric itself became the target rather than
  ...
  [idp-adoption-rollout-and-[change-management](../../../../observability-monitoring-logging/common/other/change-management/SKILL.md)-strategy](../[idp-adoption-rollout-and-[change-management](../change-management/SKILL.md)-strategy](../idp-adoption-rollout-and-[change-management](../change-management/SKILL.md)-strategy/SKILL.md)/SKILL.md)
