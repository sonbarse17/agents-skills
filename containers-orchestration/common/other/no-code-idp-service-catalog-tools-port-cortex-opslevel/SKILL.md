...
5. **Define a Cortex Scorecard** as a set of YAML rules with tiered
   ...
   rules:
     - title: Has an on-call rotation configured
       ...
       level: Bronze
       weight: 1
     - title: Has a documented [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)
       expression: "entity.hasDocument('[runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)')"
       level: Silver
       weight: 2
...
7. **Define OpsLevel maturity via a Rubric of Checks**, OpsLevel's
   ...
   ```hcl
   resource "opslevel_rubric_check_has_documentation" "[runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)" {
     name     = "Has a [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)"
     enabled  = true
     category = opslevel_rubric_category.production_readiness.id
     level    = opslevel_level.silver.id
     document_type    = "[runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)"
...
because the bar was set to what already existed; Silver ([runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) required)
