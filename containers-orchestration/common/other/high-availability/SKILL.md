...
health-check contract, version rollout strategy, migration plan with data sync, failover [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md),
and [monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md)/[alerting](../../../../observability-monitoring-logging/common/alerting/alerting/SKILL.md) matrix.
...
- [ ] Failover [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) with RPO/RTO targets and rollback path
- [ ] [Monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md): replication lag, LB pool health, error budget burn, deploy success
...
```ini
# [MySQL](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md) primary (my.cnf) — semi-sync, GTID, row-based
[mysqld]
server_id = 1
log_bin = [mysql](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)-bin
binlog_format = ROW
gtid_mode = ON
...
```
```conf
# [PostgreSQL](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) primary — streaming + slot, synchronous_commit per workload
wal_level = replica
max_wal_senders = 10
...
backend be_db_reads
  balance roundrobin
  option [mysql](../../../../Software_Engineering_and_Other/Databases/relational/mysql/SKILL.md)-check user haproxy_check
...
```
```yaml
# [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) rolling — surge 25% / unavailable 0, preStop drain
apiVersion: apps/v1
kind: Deployment
metadata: {name: api}
spec:
...
```
```sql
-- Phase 1: [PostgreSQL](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) safe DDL
...
7            3                    geo-distributed
```
Use etcd / Consul / ZooKeeper / Raft built into the DB (CockroachDB, TiDB, [MongoDB](../../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)). Lease-based leader.
...
```
[Runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) skeleton (must be tested quarterly for ≥99.99%):
```
...
6. NOTIFY     — page on-call, post status page, log [incident](../../../../observability-monitoring-logging/common/incident-detection/incident/SKILL.md)
7. REBUILD    — old primary becomes new standby (pg_rewind / reseed)
8. POSTMORTEM — within 48h; update [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md); adjust budget
```

### Step 11: [Monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) + Burn-Rate [Alerting](../../../../observability-monitoring-logging/common/alerting/alerting/SKILL.md)
...
- Connection draining ≥ 15s, terminationGracePeriod ≥ 60s on [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).
...
```ini
# Patroni configuration for [PostgreSQL](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) HA
scope: mydb
namespace: /service/
name: pg-primary
...
[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md):
  ...
  data_dir: /data/[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)
  bin_dir: /usr/lib/[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)/16/bin
  authentication:
    replication:
      username: replicator
...
- Game day: surprise failover scenario. Team follows [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) without prior notice. Measure response time.
- Post-drill: update [runbook](../../../../observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) based on findings. Add automation for manual steps discovered during drill.
...
- Connection pooling with PgBouncer: reduce [PostgreSQL](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) connection overhead. Transaction pooling mode.
...
- Replica lag [monitoring](../../../../observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md): alert on > 5s lag for async, > 1s for semi-sync. Investigate immediately.
...
- [Audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) logging: all schema changes logged. DDL triggers in [PostgreSQL](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md). Review weekly.
...
## Handoff
- `[enterprise-sla-management](../../../../observability-monitoring-logging/common/sli-slo-sla/sla-management/SKILL.md)` for SLA contract wording, customer credits, multi-tier SLA structure.
