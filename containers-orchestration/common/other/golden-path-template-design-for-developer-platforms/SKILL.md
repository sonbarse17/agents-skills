...
- [humanitec-score-workload-specification](../humanitec-score-workload-specification/SKILL.md)/SKILL.md) — the Score workload spec as an alternative templating substrate for the same tiering and parameterization principles.
