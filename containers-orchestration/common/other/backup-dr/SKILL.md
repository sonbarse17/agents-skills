...
- Infrastructure type (on-prem VMs, cloud instances, [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md), databases, files).
...
workloads:
  - name: production-database
    tier: 1
    type: [postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)
    rpo: 15m
    rto: 1h
...
resource "aws_backup_vault" "primary" {
  name        = "primary-backup-[vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)"
  kms_key_arn = aws_kms_key.backup.arn
}

resource "aws_backup_vault" "dr" {
  name        = "dr-backup-[vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)"
...
def create_full_backup():
    ...
    cmd = [
        "pg_dump",
        f"--dbname=[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)://{DB_USER}@{DB_HOST}:{DB_PORT}/{DB_NAME}",
...
def backup_wal():
    ...
    wal_dir = Path("/var/lib/[postgresql](../../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)/16/main/pg_wal")
    s3_client = boto3.client("s3")
...
| Cross-region copy fails | IAM role missing permissions | Check [vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md) policy and KMS key permissions |
| Snapshot deletion blocked | Lock policy or retention lock | Check backup [vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md) lock and retention settings |
