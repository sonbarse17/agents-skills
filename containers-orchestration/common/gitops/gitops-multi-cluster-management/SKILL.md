...
Once an organization runs more than a few [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) clusters (per
...
- A hub cluster running Argo CD ≥ 2.9 with network reachability
  (typically via the spoke cluster's [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) API endpoint, reachable
...
- `[argocd](../../../argocd/other/argocd/SKILL.md)` CLI with hub cluster context configured
  (`[argocd](../../../argocd/other/argocd/SKILL.md) login <HUB_ARGOCD_SERVER>`), and `[kubectl](../../../kubernetes/other/kubectl/SKILL.md)` contexts for each
...
1. **Register each spoke cluster with the hub**, either via the CLI
   ...
   ```bash
   [argocd](../../../argocd/other/argocd/SKILL.md) cluster add <SPOKE_KUBECONFIG_CONTEXT> \
     --name us-east-1-prod \
   ...
   metadata:
     ...
     labels:
       [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/secret-type: cluster
       tier: production
       region: us-east-1
   type: Opaque
   stringData:
...
2. **Scope the spoke-side ServiceAccount narrowly**, created on each
   ...
   kind: ServiceAccount
   metadata:
     name: [argocd](../../../argocd/other/argocd/SKILL.md)-manager
     namespace: kube-system
   ---
   apiVersion: rbac.authorization.k8s.io/v1
   kind: ClusterRole
   metadata:
     name: [argocd](../../../argocd/other/argocd/SKILL.md)-manager-role
   rules:
     - apiGroups: ["*"]
       resources: ["*"]
   ...
   metadata:
     name: [argocd](../../../argocd/other/argocd/SKILL.md)-manager-role-binding
   subjects:
     - kind: ServiceAccount
       name: [argocd](../../../argocd/other/argocd/SKILL.md)-manager
       namespace: kube-system
...
7. **Verify fleet state centrally:**
   ```bash
   [argocd](../../../argocd/other/argocd/SKILL.md) cluster list
   [argocd](../../../argocd/other/argocd/SKILL.md) app list -l [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/application-set-name=fleet-baseline
   [kubectl](../../../kubernetes/other/kubectl/SKILL.md) get applications -n [argocd](../../../argocd/other/argocd/SKILL.md) -o custom-columns=NAME:.metadata.name,SYNC:.status.sync.status,HEALTH:.status.health.status
   ```
   A single `[argocd](../../../argocd/other/argocd/SKILL.md) app list` (or equivalent `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get applications`)
...
- Register clusters declaratively (a `Secret` manifest committed to Git,
  ...
  `[argocd](../../../argocd/other/argocd/SKILL.md) cluster add` run ad hoc from someone's laptop — the former is
...
- Scope the hub's credential on each spoke to the minimum RBAC that
  ...
  spoke's `[argocd](../../../argocd/other/argocd/SKILL.md)-manager` `ClusterRole` as something to narrow per
...
- **Symptom:** A newly registered cluster doesn't receive any of the
  ...
  **Fix:** Check the cluster Secret's labels against every fleet
  ...
  `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get secret -n [argocd](../../../argocd/other/argocd/SKILL.md) -l [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/secret-type=cluster
...
- **Symptom:** A spoke cluster's `[argocd](../../../argocd/other/argocd/SKILL.md)-manager` credential was scoped
...
2. Apply the canary `ApplicationSet`:
   ...
   ```
3. Verify with `[argocd](../../../argocd/other/argocd/SKILL.md) app list -l
   [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/application-set-name=network-policy-baseline-canary`
...
5. `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) get applications -n [argocd](../../../argocd/other/argocd/SKILL.md) -l
   [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/application-set-name=network-policy-baseline-canary
