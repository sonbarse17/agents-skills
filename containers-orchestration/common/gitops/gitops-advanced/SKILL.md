...
### Trigger
Exact user phrases: "[GitOps](../gitops/SKILL.md) advanced", "multi-cluster [GitOps](../gitops/SKILL.md)", "ApplicationSet", "[ArgoCD](../../../argocd/other/argocd/SKILL.md) ApplicationSet", "sync wave", "sync phase", "progressive delivery [GitOps](../gitops/SKILL.md)", "cluster bootstrapping", "[GitOps](../gitops/SKILL.md) at scale", "[ArgoCD](../../../argocd/other/argocd/SKILL.md) multi-cluster", "[ArgoCD](../../../argocd/other/argocd/SKILL.md) image updater", "[GitOps](../gitops/SKILL.md) secrets", "SealedSecrets", "External Secrets Operator", "[ArgoCD](../../../argocd/other/argocd/SKILL.md) projects", "[ArgoCD](../../../argocd/other/argocd/SKILL.md) RBAC", "[ArgoCD](../../../argocd/other/argocd/SKILL.md) HA", "[ArgoCD](../../../argocd/other/argocd/SKILL.md) cluster federation", "[ArgoCD](../../../argocd/other/argocd/SKILL.md) [argocd](../../../argocd/other/argocd/SKILL.md)-notifications", "Config Management Plugins".
...
### Output Artifact
ApplicationSet YAML manifests, [ArgoCD](../../../argocd/other/argocd/SKILL.md) project configurations, sync wave strategies, cluster registration configs, and [GitOps](../gitops/SKILL.md) workflow documentation.

### Response Format
YAML manifests (ApplicationSet, [ArgoCD](../../../argocd/other/argocd/SKILL.md) Config, AppProject), shell commands, and architecture diagrams. No preamble. No postamble. No filler.
...
```
Which topology?
  < 10 clusters → Hub cluster ([ArgoCD](../../../argocd/other/argocd/SKILL.md) in one cluster manages others)
...
Cluster API integration:
  Cluster API provisions clusters → [ArgoCD](../../../argocd/other/argocd/SKILL.md) bootstraps them
  ...
  template:
    ...
    spec:
      ...
      source:
        ...
        path: "{{path}}"
      destination:
        server: https://[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).default.svc
...
metadata:
  ...
  annotations:
    [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/sync-wave: "-3"
spec:
  source:
...
metadata:
  ...
  annotations:
    [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/sync-wave: "-1"
    [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/sync-wave-hook: "Sync"
spec:
  source:
...
metadata:
  name: backend-api
  annotations:
    [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/sync-wave: "0"
    [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/sync-wave-hook: "Sync"
spec:
  source:
...
metadata:
  name: frontend
  annotations:
    [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/sync-wave: "2"
spec:
  source:
...
metadata:
  name: infrastructure
  namespace: [argocd](../../../argocd/other/argocd/SKILL.md)
spec:
...
metadata:
  name: ingress-nginx
  annotations:
    [argocd](../../../argocd/other/argocd/SKILL.md).argoproj.io/sync-wave: "-4"
spec:
  source:
    repoURL: https://[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md).[github](../../../../ci-cd/github-actions/other/github/SKILL.md).io/ingress-nginx
    chart: ingress-nginx
...
```yaml
# CAPI Cluster definition — creates a [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) cluster
...
spec:
  ...
  destination:
    name: workload-prod-1  # Cluster registered in [ArgoCD](../../../argocd/other/argocd/SKILL.md)
    namespace: [argocd](../../../argocd/other/argocd/SKILL.md)
  syncPolicy:
    automated:
      prune: true
...
creation_rules:
  - path_regex: secrets/.*\.yaml
    age: age1abc123...
---
# Encrypted secret in git (decrypted by [ArgoCD](../../../argocd/other/argocd/SKILL.md) with SOPS plugin)
...
### Step 6: [ArgoCD](../../../argocd/other/argocd/SKILL.md) Image Updater
...
metadata:
  name: myapp
  annotations:
    [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater.argoproj.io/image-list: myapp=ghcr.io/org/myapp
    [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater.argoproj.io/myapp.helm.image-name: image.repository
    [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater.argoproj.io/myapp.helm.image-tag: image.tag
    [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater.argoproj.io/myapp.update-strategy: latest
    [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater.argoproj.io/myapp.allow-tags: regex:^v?\d+\.\d+\.\d+$
    [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater.argoproj.io/myapp.pull-secret: pullsecret
    [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater.argoproj.io/write-back-method: git
    [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater.argoproj.io/git-branch: main
    [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater.argoproj.io/write-back-target: kustomization
spec:
  source:
  ...
  destination:
    ...
    namespace: production
---
# [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater config
apiVersion: v1
kind: ConfigMap
metadata:
  name: [argocd](../../../argocd/other/argocd/SKILL.md)-image-updater-config
  namespace: [argocd](../../../argocd/other/argocd/SKILL.md)
data:
  config.json: |
    {
      "git_user": "[argocd](../../../argocd/other/argocd/SKILL.md)-image-updater",
      ...
      "registries": [
        ...
        {
          "name": "[Docker](../../../docker/other/docker/SKILL.md) Hub",
          "api_url": "https://registry-1.[docker](../../../docker/other/docker/SKILL.md).io",
          "prefix": "[docker](../../../docker/other/docker/SKILL.md).io",
          "ping": true,
          "credentials": "pullsecret:[argocd](../../../argocd/other/argocd/SKILL.md)/dockerhub-creds"
        }
      ]
    }
```
...
```yaml
# [ArgoCD](../../../argocd/other/argocd/SKILL.md) Projects for team isolation
apiVersion: argoproj.io/v1alpha1
kind: AppProject
metadata:
  name: team-platform
  ...
  roles:
    ...
    - name: checkout-readonly
      ...
      groups:
        - myorg:everyone
---
# [ArgoCD](../../../argocd/other/argocd/SKILL.md) RBAC ConfigMap
apiVersion: v1
kind: ConfigMap
metadata:
  name: [argocd](../../../argocd/other/argocd/SKILL.md)-rbac-cm
  namespace: [argocd](../../../argocd/other/argocd/SKILL.md)
data:
...
kind: ConfigMap
metadata:
  name: [argocd](../../../argocd/other/argocd/SKILL.md)-notifications-cm
  namespace: [argocd](../../../argocd/other/argocd/SKILL.md)
data:
  service.slack: |
    token: $slack-token
...
### [ArgoCD](../../../argocd/other/argocd/SKILL.md) HA Configuration
```
Control plane:
  - 3 replicas for [argocd](../../../argocd/other/argocd/SKILL.md)-server, [argocd](../../../argocd/other/argocd/SKILL.md)-repo-server, [argocd](../../../argocd/other/argocd/SKILL.md)-application-controller
  - [argocd](../../../argocd/other/argocd/SKILL.md)-dex-server: 2 replicas (if using OIDC)
  - [argocd](../../../argocd/other/argocd/SKILL.md)-redis: sentinel-based HA

Backend:
  - [argocd](../../../argocd/other/argocd/SKILL.md)-repo-server: 2+ replicas, 2 CPU, 4Gi RAM per 100 repos
  - [argocd](../../../argocd/other/argocd/SKILL.md)-application-controller: 2+ replicas, 2 CPU, 2Gi RAM per 1000 apps
  - [argocd](../../../argocd/other/argocd/SKILL.md)-server: 4+ replicas for API + UI

Database:
  - Redis for caching only (loss-tolerant)
  - State stored in [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) secrets (backed by etcd)
```
...
Sync cadence:
  Default: 3m (polling)
  Webhook: [GitHub](../../../../ci-cd/github-actions/other/github/SKILL.md)/GitLab webhook to [argocd](../../../argocd/other/argocd/SKILL.md)-server (60s latency)
...
| Feature | [ArgoCD](../../../argocd/other/argocd/SKILL.md) | Flux v2 |
|---------|--------|---------|
| Multi-cluster | Native (hub/spoke) | Native (Kustomization with KubeConfig) |
| ApplicationSet | Built-in | Manual ([Kustomize](../../../kustomize/other/kustomize/SKILL.md) overlay per cluster) |
| Sync waves | Annotations | depends-on in Kustomization |
| Image updates | [ArgoCD](../../../argocd/other/argocd/SKILL.md) Image Updater | Image Automation Controllers |
| Secrets integration | SOPS/External Secrets/SealedSecrets | SOPS native |
| RBAC/Projects | Native | Native (roles + accounts) |
| Notifications | [argocd](../../../argocd/other/argocd/SKILL.md)-notifications | Notification controller |
| Config Management | CMP (any tool) | [Kustomize](../../../kustomize/other/kustomize/SKILL.md) + Helm |
...
## References
- ../../../Global_References/applicationset-generators.md — [ArgoCD](../../../argocd/other/argocd/SKILL.md) ApplicationSet Generators
...
- references/[argocd](../../../argocd/other/argocd/SKILL.md)-notifications.md — [ArgoCD](../../../argocd/other/argocd/SKILL.md) Notifications and Webhooks
