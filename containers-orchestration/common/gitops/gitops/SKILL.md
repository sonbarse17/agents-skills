...
which is a far stronger artifact than a [Jenkins](../../../../ci-cd/jenkins/other/jenkins/SKILL.md) job log claiming the same thing happened. [Kustomize](../../../kustomize/other/kustomize/SKILL.md)
...
## 3. Never let anyone or anything run [kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply against these clusters
...
Drift — cluster state diverging from the repo — will happen: a debugging `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) edit`, a
