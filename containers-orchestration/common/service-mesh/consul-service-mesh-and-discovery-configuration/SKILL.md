...
Consul solves a problem [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-native meshes (Istio, Linkerd) don't:
service discovery and mesh connectivity across environments that aren't
a single [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) cluster — VMs, bare metal, multiple [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)
...
- For [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) workloads: the `consul-k8s` Helm chart installed with
...
2. **Write intentions to explicitly allow required traffic** — Consul's
   ...
   [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) CRD (`ServiceIntentions`) if using `consul-k8s`. The
...
[Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) and `payments-api` running on a fleet of VMs in a different
...
`checkout-service`, running on [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) in a peered cluster, resolves
