...
**Use when:** deploying a web app/API to AKS; containerizing for [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md); generating manifests; AKS CI/CD; DS001–DS013 failures.

**Not for:** provisioning clusters (`[azure-kubernetes](../../Cloud_Providers/azure-skills/skills/[azure-kubernetes](../azure-[kubernetes](../kubernetes/SKILL.md)/SKILL.md)/SKILL.md)`), AKS Automatic readiness (`[azure-[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-automatic-readiness](../../Cloud_Providers/azure-skills/skills/[azure-kubernetes](../../Cloud_Providers/azure-skills/skills/[azure-kubernetes](../azure-[kubernetes](../kubernetes/SKILL.md)/SKILL.md)/SKILL.md)/[azure-[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-automatic-readiness](../[azure-kubernetes](../../Cloud_Providers/azure-skills/skills/[azure-kubernetes](../azure-[kubernetes](../kubernetes/SKILL.md)/SKILL.md)/SKILL.md)/[azure-[kubernetes](../../../kubernetes/other/kubernetes/SKILL.md)-automatic-readiness](../[azure-kubernetes](../../Cloud_Providers/azure-skills/skills/[azure-kubernetes](../azure-[kubernetes](../kubernetes/SKILL.md)/SKILL.md)/SKILL.md)-automatic-readiness/SKILL.md)/SKILL.md)/SKILL.md)`), non-AKS targets.

## Workflow

Requires: existing AKS cluster, `az login`, `[kubectl](../../../kubernetes/other/kubectl/SKILL.md)` configured. Follow `phases/quick-deploy.md`. On failure: `../../../Global_References/rollback.md`.
