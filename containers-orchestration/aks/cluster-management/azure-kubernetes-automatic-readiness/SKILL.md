...
| Related skills | [azure-kubernetes](../../Cloud_Providers/azure-skills/skills/[azure-kubernetes](../azure-[kubernetes](../kubernetes/SKILL.md)/SKILL.md)/SKILL.md) (cluster creation), [azure-diagnostics](../../Cloud_Providers/[azure-diagnostics](../../Cloud_Providers/azure-skills/skills/azure-diagnostics/SKILL.md)/SKILL.md) (live troubleshooting), [azure-validate](../../Cloud_Providers/azure-skills/skills/[azure-validate](../../Cloud_Providers/azure-validate/SKILL.md)/SKILL.md) (readiness checks) |
...
### Route to `[azure-kubernetes](../../Cloud_Providers/azure-skills/skills/[azure-kubernetes](../azure-[kubernetes](../kubernetes/SKILL.md)/SKILL.md)/SKILL.md)` instead:
...
### Route to `[azure-diagnostics](../../Cloud_Providers/[azure-diagnostics](../../Cloud_Providers/azure-skills/skills/azure-diagnostics/SKILL.md)/SKILL.md)` instead:
...
1. **Read-only**: NEVER modify cluster state. Assessment is read-only. Do not run `[kubectl](../../../kubernetes/other/kubectl/SKILL.md) apply`, `az aks update`, or any command that changes the cluster.
...
Use when the user has local [Kubernetes](../../../kubernetes/other/kubernetes/SKILL.md) manifests, Helm charts, or [Kustomize](../../../kustomize/other/kustomize/SKILL.md) overlays in their workspace. Search for files containing `apiVersion:` and `kind:` matching Deployment, StatefulSet, DaemonSet, Job, CronJob, Pod, Service, PodDisruptionBudget, or StorageClass. For Helm charts, look for `Chart.yaml` and rendered templates under `templates/`.
...
Use patterns in `../../../Global_References/common-fixes.md` and generate a before/after diff. Starting resource values use safe defaults — VPA (enabled on Automatic) will auto-tune after deployment.
...
```
See `../../../Global_References/migration-guide-summary.md` for the full migration checklist.
...
**Cluster config issues remain (Day-0 decisions):** API Server VNet Integration, node pool OS SKU (requires recreating system node pools), and ephemeral OS disks require a new cluster — redirect to `[azure-kubernetes](../../Cloud_Providers/azure-skills/skills/[azure-kubernetes](../azure-[kubernetes](../kubernetes/SKILL.md)/SKILL.md)/SKILL.md)` skill for cluster creation help.
...
| File | When to load |
|------|--------------|
| `../../../Global_References/constraint-spec-v1.yaml` | Always load for offline validation — all constraint IDs, severities, and fix patterns |
| `../../../Global_References/common-fixes.md` | When generating deterministic fixes — before/after YAML patterns |
| `../../../Global_References/migration-guide-summary.md` | When user asks about migration steps or after assessment is complete |
| `../../../Global_References/mcp-integration.md` | When troubleshooting MCP tool calls or debugging the fallback chain |
