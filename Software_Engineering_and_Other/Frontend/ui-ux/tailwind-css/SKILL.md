...
- `../../../references/tailwind-css_component-patterns.md` -- Component Patterns Reference
- `../../../references/tailwind-css_configuration.md` -- Tailwind Configuration Reference
- `../../../references/tailwind-css_design-tokens.md` -- Design Tokens Reference
- `../../../references/tailwind-css_performance.md` -- Tailwind CSS Performance Reference
...
Next skill: `[frontend-storybook](../../architecture/storybook/SKILL.md)` (if component documentation is needed next)
