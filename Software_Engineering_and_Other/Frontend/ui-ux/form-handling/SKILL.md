...
Form complexity?
  ...
  |     |-- Svelte --> [SvelteKit](../../frameworks/sveltekit/SKILL.md) Forms or Felte
  |
  ...
  |
  |-- Cross-framework / [monorepo](../../build-tools/monorepo/SKILL.md) -->
...
- Infer [TypeScript](../../common/typescript/SKILL.md) types from schema: `z.infer<typeof schema>`.
