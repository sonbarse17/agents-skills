...
See `../../../../Global_References/Software_Engineering_and_Other/tokens.md` for the complete token reference.
...
See `../../../../Global_References/Software_Engineering_and_Other/styling.md` for full styling guide and `../../../../Global_References/Software_Engineering_and_Other/styling-libraries.md` for library interop.
...
See `../../../../Global_References/Software_Engineering_and_Other/layout.md` for the full layout guide.
...
See `../../../../Global_References/Software_Engineering_and_Other/astryx_theme.md` for defineTheme, component overrides, custom variants, nesting, and token utilities.
...
See `../../../../Global_References/Software_Engineering_and_Other/cli.md` for all commands, JSON API, programmatic API, and integrations.
...
See `../../../../Global_References/Software_Engineering_and_Other/working-with-ai.md` for full AI integration guide.
...
See `../../../../Global_References/Software_Engineering_and_Other/migration.md` for the full migration guide.
...
- `../../../../Global_References/Software_Engineering_and_Other/principles.md` — Design philosophy, rules, anti-patterns
- `../../../../Global_References/Software_Engineering_and_Other/tokens.md` — Complete token reference (color, spacing, size, radius, shadow, motion, typography)
- `../../../../Global_References/Software_Engineering_and_Other/styling.md` — xstyle prop, Tailwind bridge, className, compound components, data attributes, StyleX build setup
- `../../../../Global_References/Software_Engineering_and_Other/styling-libraries.md` — Interop with Tailwind, StyleX, Panda, Chakra, MUI, Emotion, UnoCSS, CSS Modules, non-CSS
- `../../../../Global_References/Software_Engineering_and_Other/layout.md` — Shell, navigation, structure, spacing, density, breakpoints
- `../../../../Global_References/Software_Engineering_and_Other/astryx_theme.md` — defineTheme, extending, component overrides, custom variants, runtime vs built, nesting, token utilities, useTheme
- `../../../../Global_References/Software_Engineering_and_Other/cli.md` — All commands, JSON API, programmatic API, doctor, integrations, configuration
- `../../../../Global_References/Software_Engineering_and_Other/migration.md` — Migration order, CLI workflow, cascade layer safety, shadcn/Radix mapping, verification checklist
- `../../../../Global_References/Software_Engineering_and_Other/working-with-ai.md` — Agent docs, MCP server, --dense flag, AI workflow, Cursor setup
