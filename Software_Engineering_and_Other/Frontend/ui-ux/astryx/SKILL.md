...
See `../../../references/astryx_theme.md` for defineTheme, component overrides, custom variants, nesting, and token utilities.
...
- `../../../references/astryx_theme.md` — defineTheme, extending, component overrides, custom variants, runtime vs built, nesting, token utilities, useTheme
