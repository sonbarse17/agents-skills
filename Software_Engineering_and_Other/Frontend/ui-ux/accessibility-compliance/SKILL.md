...
description: Implement WCAG 2.2 compliant interfaces with mobile accessibility,
...
Detailed pattern documentation lives in `../../../../Global_References/Software_Engineering_and_Other/accessibility-compliance_details.md`. Read that file when the navigation tier above is insufficient.
