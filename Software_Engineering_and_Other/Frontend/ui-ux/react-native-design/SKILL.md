...
description: Master React Native styling, navigation, and Reanimated animations
...
1. **Use [TypeScript](../../common/typescript/SKILL.md)**: Define navigation and prop types for type safety
