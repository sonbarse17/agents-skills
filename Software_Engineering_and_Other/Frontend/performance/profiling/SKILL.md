...
`[load-testing](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/capacity-monitoring/load-testing/SKILL.md)` to get a profile that reflects the real hot path.
