...
- Nothing runtime-specific beyond whatever the targets themselves invoke
  ([Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md), a compiler, `terraform`, `[kubectl](../../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubectl/SKILL.md)`, etc.) — Make itself has no
...
3. **Use `:=` (immediate expansion) for variables by default**, reserving
   ...
   .PHONY: [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-build
   [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-build:
   	[docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) build -t $(IMAGE_TAG) .
   ```
...
.PHONY: help build test lint [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-build deploy clean
...
[docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-build: ## Build a tagged container image
	[docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) build -t $(IMAGE_TAG) .
