...
description: Master monorepo management with Turborepo, Nx, and pnpm workspaces
  to build efficient, scalable multi-package repositories with optimized builds
  and dependency management. Use when setting up monorepos, optimizing builds,
  or managing shared dependencies.
tags:
  - frontend
  - monorepo-management
depends_on:
...
#   tsconfig/     - Shared [TypeScript](../../common/typescript/SKILL.md) configs
...
// package.json (root)
{
  ...
  "devDependencies": {
    "turbo": "^1.10.0",
    "prettier": "^3.0.0",
    "[typescript](../../common/typescript/SKILL.md)": "^5.0.0"
  },
...
2. **Shared Configs**: Centralize ESLint, [TypeScript](../../common/typescript/SKILL.md), Prettier configs
