...
Full template library and detailed worked examples live in `../../../references/bazel-build-optimization_details.md`. Read that file when you need the concrete templates.
