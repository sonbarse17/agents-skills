...
- Standing up a private package registry or pull-through proxy/mirror
  (Artifactory, Nexus, [GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Packages, Verdaccio, a cloud-native
...
- A chosen artifact/package registry solution: a managed offering ([GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)
...
2. **[Commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) lockfiles and enforce them in CI** so builds are reproducible
...
5. **Respond to a yanked/compromised upstream package deliberately**:
   ...
   exposed to a package being deleted out from under you mid-[incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) —
...
6. **Define and enforce artifact retention** so storage doesn't grow
   ...
   [GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Container Registry cleanup via a scheduled workflow using
...
- Treat major dependency upgrades as their own reviewed change with a
  ...
  [release-versioning-and-changelog-automation](../../../../DevOps_and_Cloud/ci-cd/common/other/changelog-automation/SKILL.md)/SKILL.md)/SKILL.md)
  when the upgrade affects your own published artifact's versioning
  contract.
- Record artifact provenance (which [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)/pipeline run produced a given
  artifact) as metadata/labels on the artifact itself, so retention
  cleanup and [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) response can trace an artifact back to its build —
...
- **Symptom:** A build that passed last week fails today with no code
  ...
  version.
  **Fix:** This indicates missing or unenforced lockfiles — [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) the
...
2. For any environment that hadn't cached it yet, pin an explicit
   ...
   regenerate `package-lock.json`, then [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) the lockfile update.
