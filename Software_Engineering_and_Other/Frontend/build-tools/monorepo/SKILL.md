...
- CI provider ([GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions, GitLab CI, [CircleCI](../../../../DevOps_and_Cloud/ci-cd/circleci/other/circleci/SKILL.md)).
...
// nx.json
{
  ...
  "plugins": [
    {
      "plugin": "@nx/js/[typescript](../../common/typescript/SKILL.md)",
      "options": {
...
env:
  ...
  NX_BRANCH: ${{ [github](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).head_ref || [github](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).ref_name }}
...
jobs:
  ...
  e2e:
    needs: [quality]
    runs-on: ubuntu-latest
    if: [github](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).event_name == 'push' || ([github](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).event_name == 'pull_request' && [github](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).event.pull_request.draft == false)
    steps:
      - uses: actions/checkout@v4
        with:
          fetch-depth: 0
...
- Nx Cloud access tokens must be stored as CI secrets — never [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) to repository
