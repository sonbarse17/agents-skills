...
- [Profiling](../../performance/profiling/SKILL.md) performance (Core Web Vitals, paint timing, layout shifts)
...
| "Performance [profiling](../../performance/profiling/SKILL.md) is overkill" | A 1-second performance trace catches issues that hours of code review miss. |
