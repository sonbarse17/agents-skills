...
### Input Context
- Project type (library, app, [monorepo](../../build-tools/monorepo/SKILL.md))
...
├── [Monorepo](../../build-tools/monorepo/SKILL.md) → Turborepo + tsup per package + tsc --noEmit for type-check
...
├── [Monorepo](../../build-tools/monorepo/SKILL.md) → project references + composite: true + incremental
...
## TypeScript [Monorepo](../../build-tools/monorepo/SKILL.md) Management

[Monorepo](../../build-tools/monorepo/SKILL.md) with multiple TypeScript packages needs careful config:
...
- `../../../references/typescript_typescript-advanced.md` — Advanced TypeScript Patterns
