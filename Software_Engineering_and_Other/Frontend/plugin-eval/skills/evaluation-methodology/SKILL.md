...
description: PluginEval quality methodology — dimensions, rubrics, statistical
  methods, and scoring formulas. Use this skill when understanding how plugin
  quality is measured, when interpreting a low score on a specific dimension,
  when deciding how to improve a skill's triggering accuracy or orchestration
  fitness, when calibrating scoring thresholds for your marketplace, or when
  explaining quality badges to external partners like Neon.
tags:
  - skills
...
Related: [Full rubric anchors](../../../../../AI_and_Agents/references/rubrics.md)
...
dimensions using anchored rubrics (see [../../../../../AI_and_Agents/references/rubrics.md](../../../../../AI_and_Agents/references/rubrics.md)):
...
- Detailed rubrics → `../../../../../AI_and_Agents/references/rubrics.md`
...
- [Full Rubric Anchors — all 4 judge dimensions](../../../../../AI_and_Agents/references/rubrics.md)
