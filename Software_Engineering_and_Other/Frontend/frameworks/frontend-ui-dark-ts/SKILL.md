...
description: Build dark-themed React applications using Tailwind CSS with custom
  theming, glassmorphism effects, and Framer Motion animations. Use when
  creating dashboards, admin panels, or data-rich interfaces with a refined dark
  aesthetic.
license: MIT
metadata:
  author: Microsoft
...
| `vite` | ^5.x | Build tool |
| `[typescript](../../common/typescript/SKILL.md)` | ^5.x | Type safety |
...
- [Design Tokens](../../../references/frontend-ui-dark-ts_design-tokens.md) — Complete color system, spacing, typography scales
- [Components](../../../references/components.md) — Button, Card, Input, Dialog, Tabs, and more
- [Patterns](../../../references/frontend-ui-dark-ts_patterns.md) — Page layouts, navigation, lists, forms
