...
- Use `@property({ hasChanged })` to [customize](../../../../DevOps_and_Cloud/cloud/azure/ai/customize/SKILL.md)/SKILL.md)/SKILL.md) change detection.
...
| [TypeScript](../../common/typescript/SKILL.md) | Full support | Required | Optional |
