...
- **XSS via compat**: `preact/compat` may expose React patterns like `createElement` with dangerouslySetInnerHTML. [Audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) compat-using components for injection vectors. Use PropTypes or [TypeScript](../../common/typescript/SKILL.md) runtime checks for user input.
