...
Detailed pattern documentation lives in `../../../references/nextjs-app-router-patterns_details.md`. Read that file when the navigation tier above is insufficient.
