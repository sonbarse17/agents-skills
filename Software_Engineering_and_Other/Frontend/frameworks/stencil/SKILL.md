...
## Purpose
Build reusable, framework-agnostic web components using Stencil's [TypeScript](../../common/typescript/SKILL.md)-first compiler — optimized for design systems, component libraries, and performance-critical UIs.
...
| [TypeScript](../../common/typescript/SKILL.md) | Required | Optional | Optional |
