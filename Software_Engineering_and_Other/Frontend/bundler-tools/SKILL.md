...
- Project size and [monorepo](../monorepo/SKILL.md) structure
...
Generating full source maps in production slows the build and exposes source code. Use `hidden-source-map` for error [monitoring](../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md) or disable entirely.

### 7. Missing [TypeScript](../typescript/SKILL.md) Path Aliases Resolution
...
- **Rollup plugins:** `@rollup/plugin-commonjs`, `@rollup/plugin-node-resolve`, `@rollup/plugin-[typescript](../typescript/SKILL.md)`
...
6. Source maps only in development -- disable in production or use hidden source maps for error [monitoring](../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md).
...
- `../../../Global_References/bundler-[performance-tuning](../performance-tuning/SKILL.md).md` -- Bundler Performance Tuning
