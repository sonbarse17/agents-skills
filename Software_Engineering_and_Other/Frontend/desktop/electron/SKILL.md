...
## Purpose
Build cross-platform desktop applications using Electron — combining Chromium (for rendering) and Node.js (for system access). Electron enables web technologies (HTML, CSS, JavaScript/[TypeScript](../../common/typescript/SKILL.md)) to deliver native-capable desktop experiences with access to the file system, operating system APIs, native menus, and auto-updating.
