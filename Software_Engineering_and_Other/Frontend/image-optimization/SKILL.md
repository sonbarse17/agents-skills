...
Layer *order* still matters for cache reuse (see `[containerization](../../../containers-orchestration/docker/other/containerization/SKILL.md)`), but here the goal is layer
...
machines), build a single manifest list with `[docker](../../../containers-orchestration/docker/other/docker/SKILL.md) buildx build --platform linux/amd64,linux/arm64`
...
`[docker](../../../containers-orchestration/docker/other/docker/SKILL.md) history` and a layer-inspection tool (dive, or `[docker](../../../containers-orchestration/docker/other/docker/SKILL.md) buildx imagetools inspect`) show
