...
2.  **[Micro-Frontends](../micro-frontends/SKILL.md) (MFE):** Isolate domains. Ensure zero shared runtime state between MFEs. Employ strict module federation and versioning contracts.
