...
```bash
npx storybook@latest init --type react    # or vue3, angular, nextjs, [sveltekit](../../frameworks/sveltekit/SKILL.md)
```
...
```
```yml
# .[github](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/workflows/chromatic.yml
