...
- Deployment platform ([Kubernetes](../../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md), S3/CDN, Netlify, Vercel)
...
Number of independent teams?
  ...
  |     |-- Alternative: [monorepo](../../build-tools/monorepo/SKILL.md) with package boundaries
  |
...
**Rule**: Microfrontend overhead makes sense at 3+ independent teams working on the same product. Below that, monolith SPA or [monorepo](../../build-tools/monorepo/SKILL.md) with package boundaries is sufficient.
...
## References
  ...
  - ../../../references/microfrontend_module-federation.md — Module Federation Reference
## Handoff
