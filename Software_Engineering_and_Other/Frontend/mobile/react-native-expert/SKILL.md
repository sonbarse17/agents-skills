...
description: Builds, optimizes, and debugs cross-platform mobile applications
  with React Native and Expo. Implements navigation hierarchies (tabs, stacks,
  drawers), configures native modules, optimizes FlatList rendering with memo
  and useCallback, and handles platform-specific code for iOS and Android. Use
  when building a React Native or Expo mobile app, setting up navigation,
  integrating native modules, improving scroll performance, handling SafeArea or
  keyboard input, or configuring Expo SDK projects.
license: MIT
metadata:
...
1. **Setup** — Expo Router or React Navigation, [TypeScript](../../common/typescript/SKILL.md) config → _run `npx expo doctor` to verify environment and SDK compatibility; fix any reported issues before proceeding_
2. **Structure** — Feature-based organization
3. **Implement** — Components with platform handling → _verify on iOS simulator and [Android](../../../../Mobile/platforms/android/SKILL.md) emulator; check Metro bundler output for errors before moving on_
...
- **[Android](../../../../Mobile/platforms/android/SKILL.md) build fails** → check `adb logcat` or Gradle output → resolve SDK/NDK version mismatch → rebuild with `npx expo run:[android](../../../../Mobile/platforms/android/SKILL.md)`
...
| Platform | `../../../references/platform-handling.md` | iOS/[Android](../../../../Mobile/platforms/android/SKILL.md) code, SafeArea, keyboard |
...
| Structure | `../../../references/react-native-expert_project-structure.md` | Project setup, architecture |
...
- Test on both iOS and [Android](../../../../Mobile/platforms/android/SKILL.md) real devices
- Use KeyboardAvoidingView for forms
- Handle [Android](../../../../Mobile/platforms/android/SKILL.md) back button in navigation
...
const styles = StyleSheet.create({
  chip: {
    ...
    ...Platform.select({
      ...
      [android](../../../../Mobile/platforms/android/SKILL.md): { elevation: 3 },
    }),
  },
...
1. **Component code** — [TypeScript](../../common/typescript/SKILL.md), with prop types defined
2. **Platform handling** — `Platform.select` or `.ios.tsx` / `.[android](../../../../Mobile/platforms/android/SKILL.md).tsx` splits as needed
...
[Documentation](https://jeffallan.[github](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).io/claude-skills/skills/frontend/react-native-expert/)
