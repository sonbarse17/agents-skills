...
- **Storing secrets in code**: API keys, connection strings in source code. Use Azure Key [Vault](../../Miscellaneous/vault/SKILL.md), [GitHub](../../../ci-cd/github-actions/other/github/SKILL.md) Secrets, or `Secrets.json` (user secrets in development). Never [commit](../../../ci-cd/common/git-workflow/commit/SKILL.md) secrets.
