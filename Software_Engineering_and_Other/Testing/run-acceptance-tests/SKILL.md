...
1. The acceptance tests may require additional environment variables for
   ...
   - The provider's `Configure` method shows how credentials are resolved;
     use the `[provider-configuration](../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-configuration](../../Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-configuration/SKILL.md)/SKILL.md)` skill (if available) to understand a
...
provider's sweepers if it registers them (see the `[provider-test-patterns](../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-test-patterns](../../Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-test-patterns/SKILL.md)/SKILL.md)`
skill's sweeper reference, if available). For writing or restructuring
tests, use the `[provider-test-patterns](../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-test-patterns](../../Miscellaneous/agent-skills-main/plugins/terraform/skills/provider-test-patterns/SKILL.md)/SKILL.md)` skill.
