...
- `[quality-acceptance-testing](../../acceptance/acceptance-testing/SKILL.md)` — if acceptance criteria gaps were uncovered
- `[quality-e2e-testing](../../e2e/e2e-testing/SKILL.md)` — for end-to-end coverage of newly identified risk areas
- `[quality-integration-testing](../../integration/integration-testing/SKILL.md)` — for deeper investigation of regression failures
