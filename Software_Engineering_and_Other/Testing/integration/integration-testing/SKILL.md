...
- CI environment capabilities ([Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) availability)
...
- CI integration configured with [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) and parallel execution
...
9. **Integrate CI**: Configure [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md), pre-pull images, set generous timeouts, parallelize test execution
...
│   ├── Database → TestContainers ([PostgreSQL](../../../Databases/relational/postgresql/SKILL.md), [MySQL](../../../Databases/relational/mysql/SKILL.md), etc.)
...
Does CI support [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)?
...
1. **In-memory database substitutes**: H2/SQLite are not [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md)/[MySQL](../../../Databases/relational/mysql/SKILL.md) — different SQL dialect, constraints, and transaction behavior. Always use the real database in a container
...
| Infrastructure | [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)/containers | None | Full environment |
| When | After unit tests | Every [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) | Pre-release |
...
- CI resources: [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) requires privileged mode or dedicated runners. Plan resource allocation
...
### [TypeScript](../../../Frontend/common/typescript/SKILL.md) + TestContainers — Message Queue Integration Test
  ...
  integration:
    ...
    steps:
      ...
      - name: Pre-pull container images
        run: |
          [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) pull postgres:16-alpine
          [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) pull confluentinc/cp-kafka:7.6.0
          [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) pull wiremock/wiremock:3.5.4
...
Using H2 for [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) or SQLite for [MySQL](../../../Databases/relational/mysql/SKILL.md). In-memory substitutes have different SQL dialects, constraint behaviors, and transaction semantics. Tests pass with H2 but fail with [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) in production. Always use the real database in a container.
...
- CI resources: [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) requires privileged mode or dedicated runners. Use `TESTCONTAINERS_RYUK_DISABLED: true` in CI.
- Container image caching: pre-pull all images in CI to avoid network timeouts. Use `[docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) pull` in a setup step.
...
## References
- ../../../../Global_References/Software_Engineering_and_Other/api-testing.md — API Integration Testing Patterns
- ../../../../Global_References/Software_Engineering_and_Other/containerized-testing.md — Containerized Testing
- ../../../../Global_References/Software_Engineering_and_Other/contract-driven.md — Contract-Driven Integration Testing
- ../../../../Global_References/Software_Engineering_and_Other/database-testing.md — Database Integration Testing
- ../../../../Global_References/Software_Engineering_and_Other/integration-testing-advanced.md — Integration Testing Advanced Topics
- ../../../../Global_References/Software_Engineering_and_Other/integration-testing-architecture.md — Integration Testing Architecture and System Design
- ../../../../Global_References/Software_Engineering_and_Other/integration-testing-fundamentals.md — Integration Testing Fundamentals
- ../../../../Global_References/Software_Engineering_and_Other/integration-testing-strategy.md — Integration Testing Strategy and Workflow Patterns
- ../../../../Global_References/Software_Engineering_and_Other/messaging-testing.md — Message Queue Integration Testing
- ../../../../Global_References/Software_Engineering_and_Other/test-containers.md — TestContainers Patterns

## Handoff
After integration testing, hand off to:
- `[quality-e2e-testing](../../e2e/e2e-testing/SKILL.md)` — for end-to-end validation of complete workflows
- `[quality-contract-testing](../../contract/contract-testing/SKILL.md)` — for formal contract verification between services
- `[quality-regression-testing](../../regression/regression-testing/SKILL.md)` — for regression suite updates
- `[quality-smoke-testing](../../regression/smoke-testing/SKILL.md)` — for BVT smoke test inclusion
