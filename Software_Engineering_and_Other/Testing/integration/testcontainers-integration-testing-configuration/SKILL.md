...
by programmatically starting real, disposable [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) containers (a real
...
resource and [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-availability considerations that most commonly break
...
- Setting up Testcontainers to run correctly in a CI runner, especially
  one using [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md), a remote [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) daemon, or a
...
- Deciding whether a given integration point is worth a real container
  ...
  [pact-contract-testing-configuration](../../contract/pact-contract-testing-configuration/SKILL.md)/SKILL.md))
  or a lighter-weight fake.

## Prerequisites & environment

- A [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) daemon reachable from wherever tests run — local [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)
  Desktop/[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) Engine for developer machines, and a CI runner with
  [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) available (either the runner's own [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) socket mounted in,
  or a [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) sidecar/service, depending on the CI platform).
...
- Testcontainers' own **Ryuk** reaper container (started automatically
  by default) requires the [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) socket to be reachable with
  permission to start and stop containers — a locked-down CI [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)
...
6. **Confirm the CI runner actually has [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) available and correctly
   configured** before assuming a Testcontainers suite will "just work"
   the same as on a developer laptop:
   ```yaml
   # [GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions: ubuntu-latest runners include [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) by default;
   ...
   ```
   ```yaml
   # GitLab CI: needs an explicit [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) service and TLS config
   test:
     image: eclipse-temurin:21-jdk
     services:
       - [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md):24-dind
     variables:
       DOCKER_HOST: tcp://[docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md):2376
       DOCKER_TLS_CERTDIR: "/certs"
     script:
       - ./gradlew test
   ```
   A CI platform that doesn't provide [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) by default (or provides it
   only via an explicitly-declared [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) service, as GitLab
...
- Confirm [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) availability and resource sizing in CI explicitly
...
- **Symptom:** A Testcontainers suite passes reliably on every
  ...
  refused or "cannot connect to the [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) daemon" error.
  **Fix:** The CI runner either has no [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) daemon available at all,
  or (on platforms like GitLab CI) needs an explicit [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)
  service declared and `DOCKER_HOST` configured (step 6) — this isn't a
  test-code bug, it's a CI environment gap. Confirm [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)'s actual
...
- **Symptom:** Over weeks, a shared CI runner (or a developer's local
  [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) daemon) accumulates dozens of leftover, no-longer-needed
  containers from past test runs.
  **Fix:** Testcontainers' Ryuk reaper (which cleans up containers after
  the test process exits) either couldn't reach the [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) socket due to
...
producer — both need to run reliably in [GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions CI, in parallel
...
CI ([GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Actions, [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) available by default on `ubuntu-latest`, no
extra [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-in-[Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) configuration needed):
```yaml
jobs:
  test:
    runs-on: ubuntu-latest
...
- [makefile-authoring-and-validation](../[makefile-authoring-and-validation](../../Frontend/makefile-authoring-and-validation/SKILL.md)/SKILL.md) — a common place to wrap the [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)-availability and resource-sizing preconditions this skill's CI guidance depends on into a single reusable local/CI entry point.
