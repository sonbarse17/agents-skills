...
- `[quality-e2e-testing](../../e2e/e2e-testing/SKILL.md)` — for end-to-end automation of accepted scenarios
- `[quality-smoke-testing](../../regression/smoke-testing/SKILL.md)` — for BVT smoke test inclusion of critical paths
