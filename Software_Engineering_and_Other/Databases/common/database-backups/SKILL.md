...
## [PostgreSQL](../../relational/postgresql/SKILL.md) Backups

### Logical Backup with pg_dump

```bash
#!/bin/bash
# pg_backup.sh — [PostgreSQL](../../relational/postgresql/SKILL.md) logical backup
set -euo pipefail
...
echo "[$(date)] [PostgreSQL](../../relational/postgresql/SKILL.md) backup complete: $FILENAME ($(du -h "$FILENAME" | cut -f1))"
```
...
```bash
#!/bin/bash
# pg_basebackup.sh — [PostgreSQL](../../relational/postgresql/SKILL.md) physical backup for PITR
set -euo pipefail
...
### [PostgreSQL](../../relational/postgresql/SKILL.md) Restore
...
## [MySQL](../../relational/mysql/SKILL.md) Backups

### Logical Backup with mysqldump

```bash
#!/bin/bash
# mysql_backup.sh — [MySQL](../../relational/mysql/SKILL.md) logical backup
set -euo pipefail

DB_NAME="mydb"
DB_USER="backup_user"
DB_PASS="${MYSQL_BACKUP_PASSWORD}"
BACKUP_DIR="/backups/[mysql](../../relational/mysql/SKILL.md)"
DATE=$(date +%Y%m%d_%H%M%S)
...
echo "[$(date)] [MySQL](../../relational/mysql/SKILL.md) backup complete: $FILENAME ($(du -h "$FILENAME" | cut -f1))"
```
...
```bash
#!/bin/bash
# xtrabackup.sh — [MySQL](../../relational/mysql/SKILL.md) physical backup
set -euo pipefail

BACKUP_DIR="/backups/[mysql](../../relational/mysql/SKILL.md)/full_$(date +%Y%m%d)"
...
### [MySQL](../../relational/mysql/SKILL.md) Restore

```bash
# Restore from compressed mysqldump
gunzip < /backups/[mysql](../../relational/mysql/SKILL.md)/mydb_20250115_020000.sql.gz | [mysql](../../relational/mysql/SKILL.md) -u root -p mydb

# Restore from XtraBackup
sudo systemctl stop [mysql](../../relational/mysql/SKILL.md)
sudo rm -rf /var/lib/[mysql](../../relational/mysql/SKILL.md)/*
xtrabackup --move-back --target-dir=/backups/[mysql](../../relational/mysql/SKILL.md)/full_20250115
sudo chown -R [mysql](../../relational/mysql/SKILL.md):[mysql](../../relational/mysql/SKILL.md) /var/lib/[mysql](../../relational/mysql/SKILL.md)
sudo systemctl start [mysql](../../relational/mysql/SKILL.md)
```

## [MongoDB](../../nosql/mongodb/SKILL.md) Backups

### Logical Backup with mongodump

```bash
#!/bin/bash
# mongo_backup.sh — [MongoDB](../../nosql/mongodb/SKILL.md) backup
set -euo pipefail

MONGO_URI="[mongodb](../../nosql/mongodb/SKILL.md)://backup_user:${MONGO_BACKUP_PASSWORD}@localhost:27017"
BACKUP_DIR="/backups/[mongodb](../../nosql/mongodb/SKILL.md)"
DATE=$(date +%Y%m%d_%H%M%S)
...
echo "[$(date)] [MongoDB](../../nosql/mongodb/SKILL.md) backup complete: $TARGET"
```

### [MongoDB](../../nosql/mongodb/SKILL.md) Restore

```bash
# Restore all databases
mongorestore --uri="[mongodb](../../nosql/mongodb/SKILL.md)://admin:secret@localhost:27017" \
  --gzip --drop /backups/[mongodb](../../nosql/mongodb/SKILL.md)/20250115_020000/

# Restore a single database
mongorestore --uri="[mongodb](../../nosql/mongodb/SKILL.md)://admin:secret@localhost:27017" \
  --gzip --drop --db mydb /backups/[mongodb](../../nosql/mongodb/SKILL.md)/20250115_020000/mydb/

# Restore a single collection
mongorestore --uri="[mongodb](../../nosql/mongodb/SKILL.md)://admin:secret@localhost:27017" \
  --gzip --drop --db mydb --collection users \
  /backups/[mongodb](../../nosql/mongodb/SKILL.md)/20250115_020000/mydb/users.bson.gz
```
...
# Upload [PostgreSQL](../../relational/postgresql/SKILL.md) backup
aws s3 cp "${BACKUP_DIR}/postgres/" "${S3_BUCKET}/postgres/${DATE}/" \
  --recursive --storage-class STANDARD_IA \
  --sse AES256

# Upload [MySQL](../../relational/mysql/SKILL.md) backup
aws s3 cp "${BACKUP_DIR}/[mysql](../../relational/mysql/SKILL.md)/" "${S3_BUCKET}/[mysql](../../relational/mysql/SKILL.md)/${DATE}/" \
  --recursive --storage-class STANDARD_IA \
  --sse AES256

# Upload [MongoDB](../../nosql/mongodb/SKILL.md) backup
aws s3 cp "${BACKUP_DIR}/[mongodb](../../nosql/mongodb/SKILL.md)/" "${S3_BUCKET}/[mongodb](../../nosql/mongodb/SKILL.md)/${DATE}/" \
  --recursive --storage-class STANDARD_IA \
  --sse AES256
...
restic backup /backups/postgres /backups/[mysql](../../relational/mysql/SKILL.md) /backups/[mongodb](../../nosql/mongodb/SKILL.md)
...
# [PostgreSQL](../../relational/postgresql/SKILL.md): nightly at 02:00
0 2 * * * backup /opt/scripts/pg_backup.sh >> /var/log/backup-pg.log 2>&1

# [MySQL](../../relational/mysql/SKILL.md): nightly at 02:30
30 2 * * * backup /opt/scripts/mysql_backup.sh >> /var/log/backup-[mysql](../../relational/mysql/SKILL.md).log 2>&1

# [MongoDB](../../nosql/mongodb/SKILL.md): nightly at 03:00
...
run_backup "[PostgreSQL](../../relational/postgresql/SKILL.md)" /opt/scripts/pg_backup.sh
run_backup "[MySQL](../../relational/mysql/SKILL.md)"      /opt/scripts/mysql_backup.sh
run_backup "[MongoDB](../../nosql/mongodb/SKILL.md)"    /opt/scripts/mongo_backup.sh
...
- **Use `--single-transaction`**: For [MySQL](../../relational/mysql/SKILL.md) and [PostgreSQL](../../relational/postgresql/SKILL.md) logical backups to get a consistent snapshot.
...
- [postgresql](../[postgresql](../../Backend/postgresql/SKILL.md)/) - [PostgreSQL](../../relational/postgresql/SKILL.md) administration and pg_dump details
- [mysql](../[mysql](../../Backend/mysql/SKILL.md)/) - [MySQL](../../relational/mysql/SKILL.md) administration and mysqldump details
- [mongodb](../[mongodb](../../Backend/mongodb/SKILL.md)/) - [MongoDB](../../nosql/mongodb/SKILL.md) administration and mongodump details
