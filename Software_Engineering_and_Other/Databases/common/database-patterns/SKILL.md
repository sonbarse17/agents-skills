...
- The database type is known ([PostgreSQL](../../relational/postgresql/SKILL.md), [MySQL](../../relational/mysql/SKILL.md), [MongoDB](../../nosql/mongodb/SKILL.md), SQLite).
...
3. Three-phase destructive changes:
   ...
   - Phase 3 (after [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) period): Remove old column/table.
...
```yaml
# [PostgreSQL](../../relational/postgresql/SKILL.md) connection pool
pool:
