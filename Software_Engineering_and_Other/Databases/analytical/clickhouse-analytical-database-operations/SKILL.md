...
- [timescaledb-time-series-operations-and-configuration](../[timescaledb-time-series-operations-and-configuration](../timescaledb-time-series-operations-and-configuration/SKILL.md)/SKILL.md) — a [PostgreSQL](../../relational/postgresql/SKILL.md)-extension alternative for time-series workloads, useful as a contrast when deciding between a dedicated OLAP engine and a [PostgreSQL](../../relational/postgresql/SKILL.md)-based approach.
