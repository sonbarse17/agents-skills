...
# [mysql](../../relational/mysql/SKILL.md)://USERNAME:PASSWORD@HOST/my-app?sslmode=verify_identity
...
DATABASE_URL="[mysql](../../relational/mysql/SKILL.md)://root@127.0.0.1:3306/my-app"

# .env.production (using PlanetScale connection string)
DATABASE_URL="[mysql](../../relational/mysql/SKILL.md)://USERNAME:PASSWORD@us-east.connect.psdb.cloud/my-app?sslaccept=strict"
```
...
datasource db {
  provider     = "[mysql](../../relational/mysql/SKILL.md)"
...
services:
  [mysql](../../relational/mysql/SKILL.md):
    image: [mysql](../../relational/mysql/SKILL.md):8.0
...
- [mysql](../[mysql](../../Backend/mysql/SKILL.md)/) - [MySQL](../../relational/mysql/SKILL.md) tuning fundamentals
