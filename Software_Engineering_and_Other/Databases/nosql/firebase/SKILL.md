...
## Purpose
Architect [serverless](../../../Patterns/data-performance/serverless/SKILL.md) backends on Firebase — Firestore document modeling, Authentication providers, Cloud Functions triggers, Storage security, Hosting configuration, and operational best practices.
...
export const scheduledCleanup = functions.pubsub
  ...
  .onRun(async () => {
    ...
    await batch.[commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)();
  });
```
