...
- Designing a new caching layer for a service backed by a database
  ([PostgreSQL](../../relational/postgresql/SKILL.md), [MongoDB](../../nosql/mongodb/SKILL.md), etc.) and choosing between cache-aside,
