...
### 4. Reshard deliberately, with [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md), never as a blind migration
...
review since a prior [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) lost 30 minutes of session data on an
unplanned restart.

1. Review current persistence: RDB-only, `save 3600 1` (hourly
   snapshot) — this is why 30 minutes of writes were lost on restart, a
   30-minute window is far larger than the [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md)'s actual tolerance.
