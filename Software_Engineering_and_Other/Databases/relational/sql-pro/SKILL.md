...
|-------|-----------|-----------|
| Query Patterns | `../../../references/sql-pro_query-patterns.md` | JOINs, CTEs, subqueries, recursive queries |
...
| Dialect Differences | `../../../references/dialect-differences.md` | [PostgreSQL](../postgresql/SKILL.md) vs [MySQL](../mysql/SKILL.md) vs SQL Server specifics |
