...
is Neo4j's rough equivalent of a Cassandra hot partition or a [MongoDB](../../nosql/mongodb/SKILL.md)
...
the Cypher equivalent of [PostgreSQL](../../relational/postgresql/SKILL.md)'s `EXPLAIN ANALYZE` — use it, not
