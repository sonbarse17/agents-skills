...
Neptune: [serverless](../../../Patterns/data-performance/serverless/SKILL.md) or provisioned. Storage auto-scales to 128TB. Use Neptune Streams for change data capture. Enable DFE (Data Format Efficiency) for faster query execution.
...
```cypher
// APOC periodic batch [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)
CALL apoc.periodic.[commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)(
...
8. **No batch [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) on large imports**: importing millions of nodes in a single transaction causes OOM.
...
Graph vs document ([MongoDB](../../nosql/mongodb/SKILL.md)): document stores embed related data, limiting traversal to one level. Graph stores normalize relationships, enabling arbitrary-depth traversal. Use graph for highly connected data, document for aggregate-root patterns.
...
- Bulk import (neo4j-admin): 1M nodes/sec on SSD. LOAD CSV with periodic [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md): 10K-50K nodes/sec.
...
## Handoff
`[data-nosql-database](../../nosql/nosql-database/SKILL.md)` for non-relational data stores
