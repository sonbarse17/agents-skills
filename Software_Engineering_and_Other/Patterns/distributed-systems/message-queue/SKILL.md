...
| Credential exposure | Use IAM roles (AWS), service accounts, or [vault](../../../../Security/cryptography-secrets/vault/SKILL.md), never hardcoded creds |
...
│
├── [Serverless](../../data-performance/serverless/SKILL.md), fully managed, no ops
