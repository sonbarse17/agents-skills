  ...
  Query: {
    users: async (_, __, { tracer }) => {
      return tracer.startActiveSpan('users.query', (span) => {
        span.setAttribute('db.system', '[postgresql](../../../Databases/relational/postgresql/SKILL.md)');
...
- [Federation Deployment](../../../references/graphql-federation_federation-deployment.md) — Production deployment, CI/CD, rollback procedures
...
- [Federated Tracing](../../../references/federated-tracing.md) — [OpenTelemetry](../../../../DevOps_and_Cloud/observability-monitoring-logging/opentelemetry/other/opentelemetry/SKILL.md), Studio integration, distributed tracing
