...
### Input Context
- Database technology ([PostgreSQL](../../../Databases/relational/postgresql/SKILL.md), [MySQL](../../../Databases/relational/mysql/SKILL.md), SQL Server, etc.).
...
- [ ] [Monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) in place for outbox backlog.
...
What throughput do you need?
  ...
  └── Moderate throughput, want logical replication, no extra infra
      └── [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) LISTEN/NOTIFY + polling as fallback
```
...
```
Application -> [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) WAL -> Debezium connector -> Kafka -> Consumer
...
```json
{
  ...
  "config": {
    "connector.class": "io.debezium.connector.[postgresql](../../../Databases/relational/postgresql/SKILL.md).PostgresConnector",
...
### Step 7: [Monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) and [Alerting](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md)
...
## [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) LISTEN/NOTIFY as Lightweight Relay
