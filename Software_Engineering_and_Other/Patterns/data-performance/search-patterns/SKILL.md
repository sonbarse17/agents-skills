...
- [ ] Operational concerns addressed (aliases, shards, snapshots, [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md))
...
Shard strategy: 20-40GB per shard, shard count = `cluster_nodes * 2` minimum. Heap: 50% of RAM, max 31GB per node (JVM pointer compression limit). Thread pools: search (13 threads, 1000 queue), write (8 threads, 200 queue). Circuit breakers: 95% heap for request, 75% for fielddata. Snapshots: daily to S3, retention 30 days. [Monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md): query latency p95/p99, indexing rate, merge rate, GC pauses.
...
| [Audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) trail | Enable [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md) logging for all cluster operations |
