...
For test failures (npm shown — substitute the repository's own test command, per the [test-driven-development](../../dev-practice/test-driven-development/SKILL.md) skill's Discover the Stack First section):
```bash
