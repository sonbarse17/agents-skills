...
description: Design durable workflows with Temporal for distributed systems.
  Covers workflow vs activity separation, saga patterns, state management, and
...
Detailed pattern documentation lives in `../../../references/workflow-orchestration-patterns_details.md`. Read that file when the navigation tier above is insufficient.
...
- Workflow Patterns: docs.temporal.io/evaluate/use-cases-[design-patterns](../../architecture/design-patterns/SKILL.md)
