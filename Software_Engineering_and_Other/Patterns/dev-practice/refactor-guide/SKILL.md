...
4. [Commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)
5. Repeat
```
...
refactoring_workflow:
  ...
  step_3:
    ...
    rule: "Only one structural change per [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)"
  ...
  step_5:
    action: "[Commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)"
...
| Too big a refactoring | Many changes at once = many bugs | One technique per [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) |
...
| Renaming while restructuring | Impossible to review diff | One [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) for rename, another for restructure |
...
| Practice | Rationale |
|----------|-----------|
| One refactoring per [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) | Atomic, reviewable, reversible |
...
## Handoff
Hand off to `dev-loop-[code-review](../../../../DevOps_and_Cloud/ci-cd/common/other/code-review/SKILL.md)` for refactoring PR review. Hand off to `[dev-loop-tech-debt-tracker](../tech-debt-tracker/SKILL.md)` for debt tracking.
