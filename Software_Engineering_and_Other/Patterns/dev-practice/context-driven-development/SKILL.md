...
Detailed pattern documentation lives in `../../../../Global_References/Software_Engineering_and_Other/context-driven-development_details.md`. Read that file when the navigation tier above is insufficient.
...
4. **Version context**: [Commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) context changes alongside code changes
