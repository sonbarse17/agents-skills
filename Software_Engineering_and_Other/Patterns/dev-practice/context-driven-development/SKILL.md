...
Detailed pattern documentation lives in `../../../references/context-driven-development_details.md`. Read that file when the navigation tier above is insufficient.
