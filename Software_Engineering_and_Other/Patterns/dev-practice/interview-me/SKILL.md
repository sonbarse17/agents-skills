...
This skill closes the gap before it costs anything. The other Define-phase skills assume you already know roughly what you want: `[idea-refine](../../../../Product_and_Business/research-and-strategy/idea-refine/SKILL.md)` generates variations from an idea, `[spec-driven-development](../spec-driven-development/SKILL.md)` writes the requirements down, `[doubt-driven-development](../doubt-driven-development/SKILL.md)` stress-tests a plan after you've drafted one. Interview-me is the part before all of those, where you ask one question at a time, with your best guess attached, until you can predict what the user is going to say before they say it.
...
- **`[idea-refine](../../../../Product_and_Business/research-and-strategy/idea-refine/SKILL.md)`**: downstream. If the confirmed intent is "I want X but I don't know how to scope it," hand off to `[idea-refine](../../../../Product_and_Business/research-and-strategy/idea-refine/SKILL.md)` to generate variations against the now-explicit intent.
- **`[spec-driven-development](../spec-driven-development/SKILL.md)`**: downstream. If the confirmed intent is concrete ("I want X for Y users with Z success criteria"), hand off to `[spec-driven-development](../spec-driven-development/SKILL.md)` to write it down.
- **`[planning-and-task-breakdown](../planning-and-task-breakdown/SKILL.md)`**: two hops downstream of this skill (after the spec).
- **`[doubt-driven-development](../doubt-driven-development/SKILL.md)`**: opposite end of the timeline. Interview-me is pre-decision intent extraction; doubt-driven is post-decision artifact review. Both catch divergence, but at different moments.
- **`[source-driven-development](../source-driven-development/SKILL.md)`**: orthogonal. Interview-me clarifies what the user wants; SDD verifies framework facts. They don't compete.
...
- [ ] Any handoff to a downstream skill (`[idea-refine](../../../../Product_and_Business/research-and-strategy/idea-refine/SKILL.md)`, `[spec-driven-development](../spec-driven-development/SKILL.md)`) was framed in terms of the confirmed intent, not the original underspecified ask
