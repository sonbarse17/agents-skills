...
description: Grounds every implementation decision in official documentation.
  Use when you want authoritative, source-cited code free from outdated
  patterns. Use when building with any framework or library where correctness
  matters.
tags:
  - frontend
...
For the underlying threat model (LLM01: Prompt Injection), follow the `[security-and-hardening](../../../../Security/common/security-and-hardening/SKILL.md)` skill — this section covers extraction hygiene, that one covers the threat model.
