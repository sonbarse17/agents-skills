...
| Copy-paste of [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) messages | Repeats what git log already has | Synthesize: "3 commits refactored auth middleware for PKCE support" |
...
- **Git integration**: Cross-reference [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) SHAs for traceability; don't duplicate git log.
