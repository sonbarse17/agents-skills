...
4. **[Commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)** -- save your progress with a descriptive message (see `[git-workflow-and-versioning](../../../DevOps_and_Cloud/CI_CD/[git-workflow](../../../DevOps_and_Cloud/CI_CD/git-workflow/SKILL.md)-and-versioning/SKILL.md)` for atomic [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) guidance)
...
**Bad:** One [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) that adds a new component, refactors an existing one, and updates the build config.
...
- Avoid deleting something in one [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) and replacing it in the same [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) — separate them
...
| "These changes are too small to [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) separately" | Small commits are free. Large commits hide bugs and make rollbacks painful. |
