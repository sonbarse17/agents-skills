...
For detailed [profiling](../../../Frontend/performance/profiling/SKILL.md) and optimization, see `[performance-optimization](../../../Backend/patterns/performance-optimization/SKILL.md)`. Does the change introduce performance problems?
...
3. Is it actively maintained? (Check last [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md), open issues.)
...
5. **Keep the lockfile honest.** [Commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) it, review its diff, and never hand-edit it. The lockfile is the thing that actually pins what ships.
