...
- **`[debugging-and-error-recovery](../../debugging/debugging-and-error-recovery/SKILL.md)`**: when the reviewer surfaces a real failure mode, drop into the debugging skill to localize and fix.
