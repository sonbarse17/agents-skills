...
more by exercising judgment without a [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md): designing a component
...
miss, and root-causing an [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) that has no documented procedure to
...
[operational-[runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)-execution-and-escalation](../[operational-[runbook](../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md)-execution-and-escalation](../../../DevOps_and_Cloud/CI_CD/operational-[runbook](../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md)-execution-and-escalation/SKILL.md)/SKILL.md))
— here, the engineer is the one deciding what the "[runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)" should say,
...
- An [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) or bug has no existing [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) — its cause is ambiguous,
...
- Review tooling ([GitHub](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/GitLab PR review, a design-doc commenting tool)
...
- [Observability](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md) access (logs, traces, metrics, [dashboards](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md)) sufficient to
  investigate an [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) beyond what a [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)'s predefined checks
...
2. **Write the design down before writing code** — even a short design
   ...
   - Retry storm if a customer endpoint is down for hours: backoff caps
     at 2h and gives up after 4 attempts, [alerting](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md) rather than retrying
     indefinitely.
...
4. **When reviewing someone else's code or design, use a checklist that
   ...
   - **Rollback/[observability](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md)**: if this change misbehaves in
     ...
     become a multi-hour [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) by design?
...
6. **When an [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) or bug has no existing [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md), lead a structured
   ...
   this process out loud (in the [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) channel or a doc) so others
   can follow and contribute, rather than debugging silently and
   presenting only a final answer.

7. **After resolving a novel [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md), decide explicitly whether a
   [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) should now exist** for this failure mode — if a similar
   failure is plausible again, write the [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) so the next occurrence
   is entry-level, documented work instead of another ambiguous
   investigation; see
   [operational-[runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)-execution-and-escalation](../[operational-[runbook](../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md)-execution-and-escalation](../../../DevOps_and_Cloud/CI_CD/operational-[runbook](../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md)-execution-and-escalation/SKILL.md)/SKILL.md)
   for what a good [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) and its escalation triggers look like.
...
- When leading an ambiguous root-cause investigation, state your working
  ...
  conclusion.
- If an ambiguous [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) is likely to recur, treat writing the [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)
...
- **Symptom:** A novel [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) with no [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md) gets root-caused and
  ...
  scratch.
  **Fix:** Treat "should this become a [runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)" as an explicit step at
  the end of any ambiguous [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) (step 7) — a novel investigation that
...
- **Symptom:** A root-cause investigation jumps between several
  ...
  **Fix:** State the current hypothesis explicitly before testing it,
  ...
  [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) channel) — this both keeps the investigation converging and
...
- [operational-[runbook](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbook/SKILL.md)-execution-and-escalation](../[operational-[runbook](../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md)-execution-and-escalation](../../../DevOps_and_Cloud/CI_CD/operational-[runbook](../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md)-execution-and-escalation/SKILL.md)/SKILL.md) — the entry-level discipline this skill's engineers escalate from and, in turn, write new [runbooks](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/runbooks/SKILL.md) for once a novel [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md)'s root cause is understood.
- [technical-roadmap-ownership-and-cross-team-coordination](../../../../Product_and_Business/ops-and-hiring/technical-roadmap-ownership-and-cross-team-coordination/SKILL.md)/SKILL.md) — the next level of practice: sequencing and owning multiple such design efforts across a team's roadmap rather than one component at a time.
- [blameless-postmortem-and-root-cause-analysis](../../../site-reliability-engineering/skills/[blameless-postmortem-and-root-cause-analysis](../../Frontend/blameless-postmortem-and-[root-cause-analysis](../../../DevOps_and_Cloud/Observability_and_SecOps/root-cause-analysis/SKILL.md)/SKILL.md)/SKILL.md) — the structured, multi-contributing-factor analysis format an ambiguous [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md)'s root-cause findings should feed into once resolved.
