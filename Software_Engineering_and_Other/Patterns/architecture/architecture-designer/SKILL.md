...
description: Use when designing new high-level system architecture, reviewing
  existing designs, or making architectural decisions. Invoke to create
  architecture diagrams, write Architecture Decision Records (ADRs), evaluate
  technology trade-offs, design component interactions, and plan for
  scalability. Use for system design, architecture review, microservices
  structuring, ADR authoring, scalability planning, and infrastructure pattern
  selection — distinct from code-level design patterns or database-only design
  tasks.
license: MIT
metadata:
  ...
  triggers: architecture, system design, design pattern, microservices,
    scalability, ADR, technical design, infrastructure
  role: expert
  scope: design
  output-format: document
  related-skills: fullstack-guardian, devops-engineer, secure-code-guardian,
    microservices-architect, code-reviewer
tags:
  - patterns
...
graph TD
    ...
    OrderSvc --> DB[("Orders DB\n([PostgreSQL](../../../Databases/relational/postgresql/SKILL.md))")]
...
```markdown
# ADR-001: Use [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) for Order Storage
...
## Decision
Use [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) as the primary datastore for the Order Service.

## Alternatives Considered
- **[MongoDB](../../../Databases/nosql/mongodb/SKILL.md)** — flexible schema, but lacks strong ACID guarantees across documents.
