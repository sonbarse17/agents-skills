...
```markdown
# ADR-0001: Use [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) as Primary Database
...
The team has experience with [MySQL](../../../Databases/relational/mysql/SKILL.md), [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md), and [MongoDB](../../../Databases/nosql/mongodb/SKILL.md). We need ACID
...
### Option 1: [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md)

- **Pros**: ACID compliant, excellent JSON support (JSONB), built-in full-text
  search, PostGIS for geospatial, team has experience
- **Cons**: Slightly more complex replication setup than [MySQL](../../../Databases/relational/mysql/SKILL.md)

### Option 2: [MySQL](../../../Databases/relational/mysql/SKILL.md)

- **Pros**: Very familiar to team, simple replication, large community
- **Cons**: Weaker JSON support, no built-in full-text search (need
  Elasticsearch), no geospatial without extensions

### Option 3: [MongoDB](../../../Databases/nosql/mongodb/SKILL.md)
...
We will use **[PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) 15** as our primary database.

## Rationale

[PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) provides the best balance of:
...
- Need to learn [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md)-specific features (JSONB, full-text search syntax)
- Vertical scaling limits may require read replicas sooner
- Some team members need [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md)-specific training
...
- [PostgreSQL JSON Documentation](https://www.[postgresql](../../../Databases/relational/postgresql/SKILL.md).org/docs/current/datatype-json.html)
- [PostgreSQL Full Text Search](https://www.[postgresql](../../../Databases/relational/postgresql/SKILL.md).org/docs/current/textsearch.html)
...
In the context of **building a [microservices](../../distributed-systems/microservices/SKILL.md) architecture**,
...
```markdown
# ADR-0020: Deprecate [MongoDB](../../../Databases/nosql/mongodb/SKILL.md) in Favor of [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md)
...
ADR-0003 (2021) chose [MongoDB](../../../Databases/nosql/mongodb/SKILL.md) for user profile storage due to schema flexibility
needs. Since then:

- [MongoDB](../../../Databases/nosql/mongodb/SKILL.md)'s multi-document transactions remain problematic for our use case
- Our schema has stabilized and rarely changes
- We now have [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) expertise from other services
- Maintaining two databases increases operational burden

## Decision

Deprecate [MongoDB](../../../Databases/nosql/mongodb/SKILL.md) and migrate user profiles to [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md).

## Migration Plan

1. **Phase 1** (Week 1-2): Create [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) schema, dual-write enabled
2. **Phase 2** (Week 3-4): Backfill historical data, validate consistency
3. **Phase 3** (Week 5): Switch reads to [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md), monitor
4. **Phase 4** (Week 6): Remove [MongoDB](../../../Databases/nosql/mongodb/SKILL.md) writes, decommission
...
- Team can focus [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) expertise
...
│   ├── 0001-use-[postgresql](../../../Databases/relational/postgresql/SKILL.md).md
│   ├── 0002-caching-strategy.md
│   ├── 0003-[mongodb](../../../Databases/nosql/mongodb/SKILL.md)-user-profiles.md  # [DEPRECATED]
│   └── 0020-deprecate-[mongodb](../../../Databases/nosql/mongodb/SKILL.md).md      # Supersedes 0003
```
...
| ------------------------------------- | ---------------------------------- | ---------- | ---------- |
| [0001](0001-use-[postgresql](../../../Databases/relational/postgresql/SKILL.md).md)        | Use [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) as Primary Database | Accepted   | 2024-01-10 |
| [0002](0002-caching-strategy.md)      | Caching Strategy with Redis        | Accepted   | 2024-01-12 |
| [0003](0003-[mongodb](../../../Databases/nosql/mongodb/SKILL.md)-user-profiles.md) | [MongoDB](../../../Databases/nosql/mongodb/SKILL.md) for User Profiles          | Deprecated | 2023-06-15 |
| [0020](0020-deprecate-[mongodb](../../../Databases/nosql/mongodb/SKILL.md).md)     | Deprecate [MongoDB](../../../Databases/nosql/mongodb/SKILL.md)                  | Accepted   | 2024-01-15 |
...
# Create new ADR
adr new "Use [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) as Primary Database"

# Supersede an ADR
adr new -s 3 "Deprecate [MongoDB](../../../Databases/nosql/mongodb/SKILL.md) in Favor of [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md)"
