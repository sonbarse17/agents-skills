...
2. **Topology Definition**: Map the macro-architecture ([Microservices](../../distributed-systems/microservices/SKILL.md), Event Bus, Data Lakes, Shards).
...
5. **[Observability](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md) Injection**: Ensure metrics, tracing, and logging are baked into the fundamental design.
