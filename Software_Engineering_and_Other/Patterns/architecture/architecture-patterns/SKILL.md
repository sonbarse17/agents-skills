...
- Designing new backend services or [microservices](../../distributed-systems/microservices/SKILL.md) from scratch
...
- `[cqrs-implementation](../../distributed-systems/cqrs-implementation/SKILL.md)` — Use Clean Architecture as the structural foundation for CQRS command/query separation
- `[saga-orchestration](../../distributed-systems/saga-orchestration/SKILL.md)` — Sagas require well-defined aggregate boundaries, which DDD tactical patterns provide
- `[event-store-design](../../distributed-systems/event-store-design/SKILL.md)` — Domain events produced by aggregates feed directly into an event store
