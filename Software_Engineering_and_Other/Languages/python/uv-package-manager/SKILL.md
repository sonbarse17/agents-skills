...
For advanced workflows including [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) integration, lockfile management, performance optimization, tool comparison, common workflows, tool integration, troubleshooting, best practices, migration guides, and command reference, see [../../../references/uv-package-manager_advanced-patterns.md](../../../references/uv-package-manager_advanced-patterns.md)
