...
async def lifespan(app: FastAPI):
    # Startup
    engine = create_async_engine("[postgresql](../../Databases/relational/postgresql/SKILL.md)+asyncpg://user:pass@localhost/db")
