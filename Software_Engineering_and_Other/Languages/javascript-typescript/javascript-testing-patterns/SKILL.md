...
For full API integration test examples (supertest + [PostgreSQL](../../Databases/relational/postgresql/SKILL.md)) and database repository integration tests, see [../../../Global_References/advanced-testing-patterns.md](../../../Global_References/advanced-testing-patterns.md).
