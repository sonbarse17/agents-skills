...
├── Background job processor → Oban (persistent, [PostgreSQL](../../Databases/relational/postgresql/SKILL.md)-backed jobs)
...
```
Data access pattern?
├── Relational, complex queries → Ecto + [PostgreSQL](../../Databases/relational/postgresql/SKILL.md) (Phoenix standard)
