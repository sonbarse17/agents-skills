...
- Give scripts a `--dry-run` mode for anything destructive or
  ...
  `terraform plan`/[CloudFormation](../../../../DevOps_and_Cloud/infrastructure-as-code/cloudformation/other/cloudformation/SKILL.md) change sets/`[ansible](../../../../DevOps_and_Cloud/infrastructure-as-code/ansible/other/ansible/SKILL.md)-playbook --check`.
- Set explicit, descriptive exit codes (`exit 2` for usage errors, `exit 1`
  ...
  (CI, cron [alerting](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/alerting/alerting/SKILL.md)) can distinguish failure classes.
