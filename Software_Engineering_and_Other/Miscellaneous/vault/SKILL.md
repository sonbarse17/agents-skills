...
### Step 3: Dynamic Database Secrets — [PostgreSQL](../../Databases/relational/postgresql/SKILL.md)
```bash
vault secrets enable database

vault write database/config/postgres-prod \
  plugin_name=[postgresql](../../Databases/relational/postgresql/SKILL.md)-database-plugin \
  allowed_roles="app-role,readonly-role" \
  connection_url="[postgresql](../../Databases/relational/postgresql/SKILL.md)://{{username}}:{{password}}@postgres:5432/app" \
...
```bash
vault write database/config/[mysql](../../Databases/relational/mysql/SKILL.md)-prod \
  plugin_name=[mysql](../../Databases/relational/mysql/SKILL.md)-database-plugin \
  allowed_roles="app-[mysql](../../Databases/relational/mysql/SKILL.md)" \
  connection_url="{{username}}:{{password}}@tcp([mysql](../../Databases/relational/mysql/SKILL.md).example.com:3306)/" \
  username="vault_admin" \
  password="vault_pass"

vault write database/roles/app-[mysql](../../Databases/relational/mysql/SKILL.md) \
  db_name=[mysql](../../Databases/relational/mysql/SKILL.md)-prod \
