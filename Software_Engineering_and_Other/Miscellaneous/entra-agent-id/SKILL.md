...
| [../../references/sdk-sidecar.md](../../references/sdk-sidecar.md) | Microsoft Entra SDK for AgentID — endpoints, 3P agent patterns, [Docker](../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md)/K8s deployment, security |
