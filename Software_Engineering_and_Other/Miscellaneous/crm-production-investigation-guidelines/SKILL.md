...
The three possible [incident](../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md) titles are:
...
4. Do NOT conclude that the new [incident](../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md) is a symptom or side effect of an existing investigation.
...
Every [incident](../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md) is real and requires thorough investigation. Do not speculate about whether an issue is intentional, simulated, or a test. Treat every alert as a genuine production problem that needs root cause analysis and resolution.
...
Follow the evidence. Use CloudWatch Logs, CloudTrail, CloudWatch Metrics, and [Datadog](../../../DevOps_and_Cloud/Observability_and_SecOps/datadog/SKILL.md) to trace the timeline of events and identify what changed.
...
- [Monitoring](../../../DevOps_and_Cloud/Observability_and_SecOps/monitoring/SKILL.md): CloudWatch Metrics, CloudWatch Logs, [Datadog](../../../DevOps_and_Cloud/Observability_and_SecOps/datadog/SKILL.md)
