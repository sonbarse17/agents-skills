...
Implement required extraction on demand with a small task-local `[python](../../../../Languages/python/SKILL.md)-pptx` script. Capture only the information required for the new deck:
