...
description: "Implement Terraform provider configuration and authentication with
  the Plugin Framework: provider schema for credentials (Optional + Sensitive
  ...
  configure-time credential validation, and diagnostics that name every source
  tried. Use when implementing or reviewing a provider's Configure method or
  provider schema, adding authentication options (API keys, tokens, profiles,
  credentials files, assume-role), deciding how a provider should resolve
  credentials, debugging \"no valid credential sources\" or missing-credentials
...
provider uses via [`aws-sdk-go-base`](https://[github](../../../../../../../DevOps_and_Cloud/CI_CD/github/SKILL.md).com/hashicorp/aws-sdk-go-base),
...
Use the `[new-terraform-provider](../../../../../../../DevOps_and_Cloud/Infrastructure_as_Code/[new-terraform-provider](../new-terraform-provider/SKILL.md)/SKILL.md)` skill (if available) to scaffold the
provider this configuration lives in, and the `[provider-resources](../../../../../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-resources](../provider-resources/SKILL.md)/SKILL.md)` skill for
