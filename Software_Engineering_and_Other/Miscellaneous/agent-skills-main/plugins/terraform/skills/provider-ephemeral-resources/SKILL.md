...
`[provider-resources](../../../../../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-resources](../provider-resources/SKILL.md)/SKILL.md)` skill, if available, shows it); the client comes from
...
the `[provider-test-patterns](../../../../../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-test-patterns](../provider-test-patterns/SKILL.md)/SKILL.md)` skill (if available) — its ephemeral testing
...
`tfplugindocs` like every other page type. Use the `[provider-docs](../../../../../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-docs](../provider-docs/SKILL.md)/SKILL.md)` skill
