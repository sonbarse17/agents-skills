...
2. Add a state-compatibility step: apply a config with the last released
   ...
   plan. The `[provider-test-patterns](../../../../../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-test-patterns](../provider-test-patterns/SKILL.md)/SKILL.md)` skill (if available) documents the
   pattern.
...
Use the `[provider-resources](../../../../../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-resources](../provider-resources/SKILL.md)/SKILL.md)` skill (if available) for Framework CRUD,
finder, and waiter patterns in the ported code, and `[provider-test-patterns](../../../../../../../DevOps_and_Cloud/Infrastructure_as_Code/[provider-test-patterns](../provider-test-patterns/SKILL.md)/SKILL.md)`
