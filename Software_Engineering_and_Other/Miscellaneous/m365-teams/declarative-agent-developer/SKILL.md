...
1. **Detect** — Identify the specific problem. For JSON issues, attempt to parse the file and report syntax errors. For missing fields, check the manifest against the [Schema](../../../references/declarative-agent-developer_schema.md).
...
| Adding OAuth to an MCP or API plugin | [Authentication](../../../references/declarative-agent-developer_authentication.md) |
...
Before adding ANY feature, read the `version` field in `declarativeAgent.json` and check the [Schema](../../../references/declarative-agent-developer_schema.md) feature matrix. If the feature isn't supported in that version, **refuse** and offer to upgrade.
...
### Shared
- **[Authentication](../../../references/declarative-agent-developer_authentication.md)** — OAuth discovery, credentials, oauth/register lifecycle, OAuthPluginVault
- **[Best Practices](../../../references/declarative-agent-developer_best-practices.md)** — Security, performance, testing, compliance
...
- **[Deployment](../../../references/declarative-agent-developer_deployment.md)** — ATK CLI workflows, environments, CI/CD
...
- **[Schema](../../../references/declarative-agent-developer_schema.md)** — Official JSON schema for agent manifests
...
- **[Examples](../../../references/declarative-agent-developer_examples.md)** — JSON manifest examples
