...
| No manifest, user wants new project | **Scaffold** | → [Scaffolding Workflow](../../../../Global_References/Software_Engineering_and_Other/scaffolding-workflow.md) |
| Manifest exists with errors | **Fix** | Detect → Inform → Ask (see below). Do NOT deploy. |
| Valid project, user reports behavior issues | **Review** | → [Instruction Review](../../../../Global_References/Software_Engineering_and_Other/instruction-review.md) — run the full 5-phase review workflow |
| Valid agent project | **Edit** | → [Editing Workflow](../../../../Global_References/Software_Engineering_and_Other/editing-workflow.md) |

> **Detailed gate rules, examples, and anti-patterns:** [Workspace Gates](../../../../Global_References/Software_Engineering_and_Other/workspace-gates.md)
...
1. **Detect** — Identify the specific problem. For JSON issues, attempt to parse the file and report syntax errors. For missing fields, check the manifest against the [Schema](../../../../Global_References/Software_Engineering_and_Other/declarative-agent-developer_schema.md).
...
|----------|-------------------|
| Creating a NEW project from scratch | [Scaffolding Workflow](../../../../Global_References/Software_Engineering_and_Other/scaffolding-workflow.md) |
| Working with existing `.json` manifests | [Editing Workflow](../../../../Global_References/Software_Engineering_and_Other/editing-workflow.md) |
| Adding an API plugin | [API Plugins](../../../../Global_References/Software_Engineering_and_Other/api-plugins.md) |
| Adding an MCP server | [MCP Plugin](../../../../Global_References/Software_Engineering_and_Other/mcp-plugin.md) |
| Adding OAuth to an MCP or API plugin | [Authentication](../../../../Global_References/Software_Engineering_and_Other/declarative-agent-developer_authentication.md) |
| Reviewing or improving existing agent instructions | [Instruction Review](../../../../Global_References/Software_Engineering_and_Other/instruction-review.md) |
| User reports agent gives generic/wrong answers | [Instruction Review](../../../../Global_References/Software_Engineering_and_Other/instruction-review.md) |
| Localizing an agent into multiple languages | [Localization](../../../../Global_References/Software_Engineering_and_Other/localization.md) |
| Adding a new language to an already-localized agent | [Localization](../../../../Global_References/Software_Engineering_and_Other/localization.md) |
| Writing agent instructions | [Conversation Design](../../../../Global_References/Software_Engineering_and_Other/conversation-design.md) |
...
Before adding ANY feature, read the `version` field in `declarativeAgent.json` and check the [Schema](../../../../Global_References/Software_Engineering_and_Other/declarative-agent-developer_schema.md) feature matrix. If the feature isn't supported in that version, **refuse** and offer to upgrade.
...
> **Exception:** MCP servers are not supported by `npx -y --package @microsoft/m365agentstoolkit-cli atk add action`. Use the [MCP Plugin workflow](../../../../Global_References/Software_Engineering_and_Other/mcp-plugin.md) instead.

### 5. MCP Server Integration

When the user mentions an MCP server URL, follow the [MCP Plugin workflow](../../../../Global_References/Software_Engineering_and_Other/mcp-plugin.md). You MUST discover tools via the MCP protocol handshake (initialize → notifications/initialized → tools/list) — **NEVER fabricate tool names/descriptions**. For authenticated MCP servers, follow the [authentication guide](../../../../Global_References/Software_Engineering_and_Other/declarative-agent-developer_authentication.md) to configure OAuth.
...
1. Update instructions to describe the new/changed functionality — every data source should have clear intent coverage (WHEN and WHY to use it) per the [Instruction Review](../../../../Global_References/Software_Engineering_and_Other/instruction-review.md) quality bar. Built-in capabilities don't need exact names; actions/plugins should be named.
...
6. Run the [Diagnostic Checklist](../../../../Global_References/Software_Engineering_and_Other/instruction-review.md) against the updated instructions to verify quality
...
### Shared
- **[Authentication](../../../../Global_References/Software_Engineering_and_Other/declarative-agent-developer_authentication.md)** — OAuth discovery, credentials, oauth/register lifecycle, OAuthPluginVault
- **[Best Practices](../../../../Global_References/Software_Engineering_and_Other/declarative-agent-developer_best-practices.md)** — Security, performance, testing, compliance
- **[Conversation Design](../../../../Global_References/Software_Engineering_and_Other/conversation-design.md)** — Authoring instructions and conversation starters from scratch
- **[Instruction Review](../../../../Global_References/Software_Engineering_and_Other/instruction-review.md)** — Auditing, diagnosing, and improving existing instructions; anti-pattern detection; before/after rewrites
- **[Deployment](../../../../Global_References/Software_Engineering_and_Other/declarative-agent-developer_deployment.md)** — ATK CLI workflows, environments, CI/CD
- **[Localization](../../../../Global_References/Software_Engineering_and_Other/localization.md)** — Multi-language support, tokenized manifests, language files
- **[Workspace Gates](../../../../Global_References/Software_Engineering_and_Other/workspace-gates.md)** — Detailed gate rules, examples, anti-patterns

### Scaffolding
- **[Scaffolding Workflow](../../../../Global_References/Software_Engineering_and_Other/scaffolding-workflow.md)** — Step-by-step scaffolding instructions, naming rules, error handling

### JSON Development
- **[Editing Workflow](../../../../Global_References/Software_Engineering_and_Other/editing-workflow.md)** — Step-by-step JSON development instructions
- **[Schema](../../../../Global_References/Software_Engineering_and_Other/declarative-agent-developer_schema.md)** — Official JSON schema for agent manifests
- **[API Plugins](../../../../Global_References/Software_Engineering_and_Other/api-plugins.md)** — OpenAPI integration for JSON agents
- **[MCP Plugin](../../../../Global_References/Software_Engineering_and_Other/mcp-plugin.md)** — MCP server integration with RemoteMCPServer, OAuth, response semantics, logo handling
- **[Examples](../../../../Global_References/Software_Engineering_and_Other/declarative-agent-developer_examples.md)** — JSON manifest examples
