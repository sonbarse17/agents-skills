...
For custom engine agents using Azure OpenAI, add env vars to the YAML and set their values — see [../toolkit/manifest-and-yaml.md](../../microsoft-365-agents-toolkit/skills/teams-app-developer/toolkit/manifest-and-yaml.md) for details.

## References

- For YAML structure and env var flow → see [../toolkit/manifest-and-yaml.md](../../microsoft-365-agents-toolkit/skills/teams-app-developer/toolkit/manifest-and-yaml.md)
- For package, validate, share, collaborate → see [../toolkit/commands.md](../../microsoft-365-agents-toolkit/skills/teams-app-developer/toolkit/commands.md)
...
| Topic | Expert |
|---|---|
| `m365agents.yml` action catalog, lifecycle stages, full `atk` CLI reference | [../toolkit/lifecycle-cli.md](../../microsoft-365-agents-toolkit/skills/teams-app-developer/toolkit/lifecycle-cli.md) |
| `env/` files, `${{VAR}}` resolution, `SECRET_` prefix, multi-environment isolation | [../toolkit/environments.md](../../microsoft-365-agents-toolkit/skills/teams-app-developer/toolkit/environments.md) |
| Sideload → org catalog → Teams Store publish flow, `atk publish`, version bumping | [../toolkit/publish.md](../../microsoft-365-agents-toolkit/skills/teams-app-developer/toolkit/publish.md) |
