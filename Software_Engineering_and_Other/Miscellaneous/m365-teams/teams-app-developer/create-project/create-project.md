...
See [../toolkit/templates.md](../../microsoft-365-agents-toolkit/skills/teams-app-developer/toolkit/templates.md) for the complete template catalog with language support and descriptions.
...
- To understand project files → see [../toolkit/manifest-and-yaml.md](../../microsoft-365-agents-toolkit/skills/teams-app-developer/toolkit/manifest-and-yaml.md)
