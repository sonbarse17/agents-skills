...
description: >
  Build MCP servers for Copilot Chat using the OpenAI Apps SDK or MCP Apps SDK
  widget rendering support (any language). Use this skill when:

  - Creating MCP servers that integrate with M365 Copilot declarative agents

  - Building rich interactive widgets (React + Fluent UI) that render in Copilot
  Chat
  ...
  Do NOT use this skill for general agent development (scaffolding, manifests,
  deployment) — use declarative-agent-developer instead. This skill is ONLY for
  MCP server + widget development.

  Triggers: "MCP server for Copilot", "OpenAI Apps SDK", "Copilot widget",
  "structuredContent", "MCP plugin", "devtunnels MCP", "OAI app", "widget
  rendering", "UI widget"
tags:
  - skills
  - ui-widget-developer
...
| **From scratch** (no agent, no MCP server) | Full OAI app setup | Delegate agent scaffolding to `[declarative-agent-developer](../../../[declarative-agent-developer](../declarative-agent-developer/SKILL.md)/SKILL.md)` first, then return here for MCP server + widgets |
| **Existing M365 agent, new MCP server** | MCP server + widgets + mcpPlugin.json | Start at [Implementation](#implementation) |
| **Existing MCP server, add Copilot widgets** | Widget support added to existing server | Start at [Copilot Widget Protocol](../../../../../../AI_and_Agents/references/copilot-widget-protocol.md#adaptation-checklist-existing-mcp-server) |
| **Language choice** (non-[TypeScript](../../../../../Frontend/common/typescript/SKILL.md)) | Protocol requirements | See [Copilot Widget Protocol](../../../../../../AI_and_Agents/references/copilot-widget-protocol.md) for what to implement, [MCP Server Pattern ([TypeScript](../../../../../Frontend/common/typescript/SKILL.md))](../../../../../../AI_and_Agents/references/mcp-server-pattern.md) as a reference |
...
- `../../../../../../AI_and_Agents/references/widget-patterns.md`
- `../../../../../../AI_and_Agents/references/ui-widget-developer_best-practices.md`
...
**AGENT PROJECT DELEGATION:** This skill builds MCP servers and widgets, NOT declarative agent projects. If the user's request involves creating or configuring the declarative agent itself (scaffolding, `m365agents.yml`, `m365agents.local.yml`, `declarativeAgent.json`, manifest lifecycle), delegate to the `[declarative-agent-developer](../../../[declarative-agent-developer](../declarative-agent-developer/SKILL.md)/SKILL.md)` skill.
...
See [mcp-server-pattern.md](../../../../../../AI_and_Agents/references/mcp-server-pattern.md) for the complete resource and asset serving patterns.
...
For full protocol details, JSON shapes, and an adaptation checklist for existing MCP servers, see [../../../../../../AI_and_Agents/references/copilot-widget-protocol.md](../../../../../../AI_and_Agents/references/copilot-widget-protocol.md).

## Implementation

### MCP Server Pattern ([TypeScript](../../../../../Frontend/common/typescript/SKILL.md) Reference)

See [../../../../../../AI_and_Agents/references/mcp-server-pattern.md](../../../../../../AI_and_Agents/references/mcp-server-pattern.md) for complete implementation.

> For other languages, implement the requirements described in [Copilot Widget Protocol](../../../../../../AI_and_Agents/references/copilot-widget-protocol.md) using your language's MCP SDK. See the [Language SDK References](../../../../../../AI_and_Agents/references/copilot-widget-protocol.md#language-sdk-references) table for SDK packages.
...
See [../../../../../../AI_and_Agents/references/widget-patterns.md](../../../../../../AI_and_Agents/references/widget-patterns.md) for complete examples.
...
See [../../../../../../AI_and_Agents/references/plugin-schema.md](../../../../../../AI_and_Agents/references/plugin-schema.md) for mcpPlugin.json format.
...
DevTunnels expose your localhost MCP server to M365 Copilot using **named tunnels** for stable URLs. See [../../../../../../AI_and_Agents/references/devtunnels.md](../../../../../../AI_and_Agents/references/devtunnels.md) for setup scripts, command reference, and troubleshooting.
...
See [../../../../../../AI_and_Agents/references/ui-widget-developer_best-practices.md](../../../../../../AI_and_Agents/references/ui-widget-developer_best-practices.md) for detailed guidance.
