...
For custom engine agents using Azure OpenAI, add env vars to the YAML and set their values — see [../toolkit/manifest-and-yaml.md](../../../../../dev-tooling/toolkit/manifest-and-yaml.md) for details.

## References

- For YAML structure and env var flow → see [../toolkit/manifest-and-yaml.md](../../../../../dev-tooling/toolkit/manifest-and-yaml.md)
- For package, validate, share, collaborate → see [../toolkit/commands.md](../../../../../dev-tooling/toolkit/commands.md)
...
| Topic | Expert |
|---|---|
| `m365agents.yml` action catalog, lifecycle stages, full `atk` CLI reference | [../toolkit/lifecycle-cli.md](../../../../../dev-tooling/toolkit/lifecycle-cli.md) |
| `env/` files, `${{VAR}}` resolution, `SECRET_` prefix, multi-environment isolation | [../toolkit/environments.md](../../../../../dev-tooling/toolkit/environments.md) |
| Sideload → org catalog → Teams Store publish flow, `atk publish`, version bumping | [../toolkit/publish.md](../../../../../dev-tooling/toolkit/publish.md) |
