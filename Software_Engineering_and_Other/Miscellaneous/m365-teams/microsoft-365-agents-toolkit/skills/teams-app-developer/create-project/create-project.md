...
See [../toolkit/templates.md](../../../../../dev-tooling/toolkit/templates.md) for the complete template catalog with language support and descriptions.
...
- To understand project files → see [../toolkit/manifest-and-yaml.md](../../../../../dev-tooling/toolkit/manifest-and-yaml.md)
