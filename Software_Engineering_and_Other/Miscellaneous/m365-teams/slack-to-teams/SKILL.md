...
- **[manifest-and-yaml.md](../teams-app-developer/toolkit/manifest-and-yaml.md)** — Project files, YAML config, env vars, .localConfigs flow
- **[commands.md](../teams-app-developer/toolkit/commands.md)** — Package, validate, share, collaborate, environment management
- **[templates.md](../teams-app-developer/toolkit/templates.md)** — All templates with language support
