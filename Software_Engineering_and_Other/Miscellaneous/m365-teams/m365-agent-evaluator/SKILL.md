...
Never print or [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) secrets, prompts containing sensitive data, retrieved content, debug logs, or raw result files unless the user explicitly asks and confirms the data is safe to share.
