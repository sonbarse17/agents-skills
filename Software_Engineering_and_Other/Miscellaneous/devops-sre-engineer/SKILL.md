...
3. **99.99% Uptime (Four Nines)**: Design for failure. Assume every component will die. Implement circuit breakers, retries, and [autoscaling](../../Backend/patterns/autoscaling/SKILL.md).
