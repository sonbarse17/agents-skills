...
Scope: single-purpose landing pages and product marketing sites. Not full multi-page applications, not [dashboards](../../../DevOps_and_Cloud/Observability_and_SecOps/dashboards/SKILL.md), not documentation sites.
