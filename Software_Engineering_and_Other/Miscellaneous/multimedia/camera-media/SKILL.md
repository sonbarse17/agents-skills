...
│   [Android](../../../../Mobile/platforms/android/SKILL.md): CameraX (recommended) or Camera2 (manual control)
├── Select existing → Gallery picker
│   iOS 14+: PHPickerViewController (no full library permission needed)
│   [Android](../../../../Mobile/platforms/android/SKILL.md): ActivityResultContracts.PickVisualMedia (API 19+ system picker)
├── Document or file → File picker
│   iOS: UIDocumentPickerViewController
│   [Android](../../../../Mobile/platforms/android/SKILL.md): ActivityResultContracts.OpenDocument
└── QR/barcode → Camera preview with detection overlay
    iOS: AVCaptureMetadataOutput
    [Android](../../../../Mobile/platforms/android/SKILL.md): ML Kit BarcodeScanning + CameraX
```
...
├── List thumbnail → 512px, WebP ([Android](../../../../Mobile/platforms/android/SKILL.md)) or JPEG 80 (iOS)
├── Detail view → 1024px, JPEG 80, WebP on [Android](../../../../Mobile/platforms/android/SKILL.md)
...
| Feature | CameraX ([Android](../../../../Mobile/platforms/android/SKILL.md)) | AVFoundation (iOS) | Capacitor | Flutter |
|---------|------------------|-------------------|-----------|---------|
...
| H.265 (HEVC) | Better (2x H.264) | Better | Slower | iOS 11+, [Android](../../../../Mobile/platforms/android/SKILL.md) 5+ hardware |
| VP9 | Better (1.5x H.264) | Good | Slow | [Android](../../../../Mobile/platforms/android/SKILL.md) native, iOS via software |
...
├── [Android](../../../../Mobile/platforms/android/SKILL.md)-only → WebP — 25-35% smaller than JPEG
│   [Android](../../../../Mobile/platforms/android/SKILL.md) 4.0+ (decode), 4.3+ (encode), support varies by API
...
│   └── [Android](../../../../Mobile/platforms/android/SKILL.md): CameraX ImageCapture.CaptureMode.MINIMIZE_LATENCY
...
├── Add overlay → AVVideoComposition (iOS) / MediaCodec with GPU shader ([Android](../../../../Mobile/platforms/android/SKILL.md))
...
- Verify camera permission keys in Info.plist (iOS) and Manifest ([Android](../../../../Mobile/platforms/android/SKILL.md))
...
- Validate system photo picker works without storage permission ([Android](../../../../Mobile/platforms/android/SKILL.md) API 19+)
...
### CameraX [Android](../../../../Mobile/platforms/android/SKILL.md) — Photo Capture with ImageAnalysis
```kotlin
...
### [Android](../../../../Mobile/platforms/android/SKILL.md) CameraX Video Capture
```kotlin
...
├── Flash / Torch → Check hasFlash (iOS) / isFlashSupported ([Android](../../../../Mobile/platforms/android/SKILL.md))
...
├── HDR capture → supportsHighResolutionPhoto (iOS) / isHdrSupported ([Android](../../../../Mobile/platforms/android/SKILL.md))
│   HDR merges multiple exposures — better dynamic range
│   Increases processing time and file size
├── Portrait mode / Depth → isDepthDataDeliverySupported (iOS) / Depth API ([Android](../../../../Mobile/platforms/android/SKILL.md))
│   Requires dual camera (iOS) or time-of-flight sensor ([Android](../../../../Mobile/platforms/android/SKILL.md))
│   Depth data enables bokeh effect and AR occlusion
├── Night mode → Camera2 AUTO mode ([Android](../../../../Mobile/platforms/android/SKILL.md)) / AVCapturePhotoOutput.isAppleProRAWSupported (iOS)
...
| Capture memory | <200MB | Xcode Memory Gauge / [Android](../../../../Mobile/platforms/android/SKILL.md) Profiler |
...
│   [Android](../../../../Mobile/platforms/android/SKILL.md): CameraX concurrent camera (API 30+)
...
## References
  ...
  - ../../../../Global_References/Software_Engineering_and_Other/camera-permissions.md — Camera Permissions — iOS & [Android](../../../../Mobile/platforms/android/SKILL.md)
...
## Handoff
Hand off to [mobile-networking](../../../../Mobile/common/networking/SKILL.md) skill for upload progress tracking and retry logic, or mobile-storage for local media cache management.
