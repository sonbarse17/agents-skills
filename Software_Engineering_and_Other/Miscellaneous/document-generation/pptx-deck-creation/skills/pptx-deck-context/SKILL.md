...
4. Choose a documented design direction. Prefer a user brand guide, then read-only reference-deck evidence, then a reusable profile from `../../../../../../Global_References/Software_Engineering_and_Other/design-profiles.md`.
...
See `../../../../../../Global_References/Software_Engineering_and_Other/design-profiles.md` for reusable profile guidance.
