...
# Microsoft 365 Agents SDK ([Python](../../Languages/python/python/SKILL.md))
...
> **⚠️ Breaking Change**: Recent updates have changed the [Python](../../Languages/python/python/SKILL.md) import structure from `microsoft.agents` to `microsoft_agents` (using underscores instead of dots).
...
pip install [python](../../Languages/python/python/SKILL.md)-dotenv aiohttp
```
...
async def on_poem_message(context: TurnContext, _state: TurnState):
    ...
    streamed_response = await CLIENT.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": "Write a poem about [Python](../../Languages/python/python/SKILL.md)."}
        ],
        stream=True,
    )
...
| [GitHub](../../../ci-cd/github-actions/other/github/SKILL.md) samples ([Python](../../Languages/python/python/SKILL.md))       | https://[github](../../../ci-cd/github-actions/other/github/SKILL.md).com/microsoft/Agents-for-[python](../../Languages/python/python/SKILL.md)                                |
