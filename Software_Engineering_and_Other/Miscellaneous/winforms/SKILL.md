...
├── Complex LOB ([dashboards](../../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md), charts, real-time updates)
...
## References
  - ../../../Global_References/winforms-advanced.md — WinForms Advanced Topics
