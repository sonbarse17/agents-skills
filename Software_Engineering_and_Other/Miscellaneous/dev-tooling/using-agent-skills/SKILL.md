...
Task arrives
    ...
    ├── CI/CD pipeline work? ──────────→ [ci-cd-and-automation](../../../../DevOps_and_Cloud/ci-cd/common/pipeline-design/ci-cd-and-automation/SKILL.md)
...
9.  [doubt-driven-development](../../../Patterns/dev-practice/doubt-driven-development/SKILL.md)    → Cross-examine non-trivial decisions in-flight
10. [test-driven-development](../../../Patterns/dev-practice/test-driven-development/SKILL.md)     → Prove each slice works
...
13. [git-workflow-and-versioning](../../../DevOps_and_Cloud/CI_CD/[git-workflow](../../../DevOps_and_Cloud/CI_CD/git-workflow/SKILL.md)-and-versioning/SKILL.md) → Clean [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) history
...
| Ship | [ci-cd-and-automation](../../../../DevOps_and_Cloud/ci-cd/common/pipeline-design/ci-cd-and-automation/SKILL.md) | Automated quality gates on every change |
...
| Ship | [shipping-and-launch](../../../../Product_and_Business/ops-and-hiring/shipping-and-launch/SKILL.md) | Pre-launch checklist, [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md), rollback plan |
