...
**Example**: Azure Key [Vault](../../../../Security/vault/SKILL.md) Secrets (core workflow: retrieve a secret using managed identity). Alternative authentication workflows in `/references/`: local development with `DefaultAzureCredential`, workload identity, and service-principal credentials (client secret or certificate).
...
| `security`    | Key [Vault](../../../../Security/vault/SKILL.md), secrets, keys, certificates  | `[azure-keyvault-py](../../../DevOps_and_Cloud/Cloud_Providers/[azure-keyvault-py](../../../DevOps_and_Cloud/Cloud_Providers/azure-sdk-[python](../../Languages/python/python/SKILL.md)/skills/[azure-keyvault](../../../../cloud/azure/security/azure-keyvault/SKILL.md)-py/SKILL.md)/SKILL.md)`                          |
