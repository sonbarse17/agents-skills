...
## Purpose
Build cross-platform desktop applications using Electron — combining Chromium (for rendering) and Node.js (for system access). Electron enables web technologies (HTML, CSS, JavaScript/[TypeScript](../../Frontend/common/typescript/SKILL.md)) to deliver native-capable desktop experiences with access to the file system, operating system APIs, native menus, and auto-updating.
...
## Handoff
Hand off to `dev-loop-[code-review](../../../DevOps_and_Cloud/ci-cd/common/other/code-review/SKILL.md)` for security [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) of preload scripts. Hand off to `desktop-tauri` if native performance is critical.
