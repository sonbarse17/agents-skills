...
"temporarily" raised during an [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) until it's effectively
...
- Monitor rejection rate per client/tier continuously, and investigate
  before adjusting — a limit raised reactively during every [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md)
...
- **Symptom:** A rate limit sized from "round numbers that seemed
  ...
  abuse [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md).
...
- **Symptom:** During a traffic spike, an on-call engineer doubles or
  ...
  the [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) resolves, and the change is never reverted.
  **Fix:** This is a real, standing risk once left in place — the limit
  ...
  same raised ceiling) going forward. Treat any [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md)-time limit
  change as temporary and explicitly tracked for revert, and once the
  [incident](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) is over, investigate whether the real fix is a legitimate
...
[Monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md): a dashboard tracking 429 rate per partner and per limit type
