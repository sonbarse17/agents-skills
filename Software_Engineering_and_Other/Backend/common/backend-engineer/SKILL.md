...
2.  **[Observability](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md) (Tracing/Metrics):** If it's not measurable, it's broken. Enforce distributed tracing across all service boundaries. Maintain golden signals (Latency, Traffic, Errors, Saturation).
...
flowchart TD
    ...
    F -- Low --> H[Define [Observability](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md) Metrics]
    G --> H
