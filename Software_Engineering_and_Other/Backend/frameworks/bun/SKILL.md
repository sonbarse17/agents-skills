...
| [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) image size | ~200MB | ~350MB | ~200MB |
...
### Input Context
- Runtime (Bun, Bun in [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md))
...
async function buildAndDeploy() {
  ...
  // Build [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) image
  await $`[docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) build -t my-app:latest .`;

  // Deploy
  await $`[docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) push my-app:latest`;
...
### Deployment
- [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md): `oven/bun:latest` base image; multi-stage build for production
...
- Use `--smol` option in [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) to limit memory; set `BUN_RUNTIME_TRANSPILER_CACHE_PATH` to /tmp
...
## Rules
  - ../../../../Global_References/Software_Engineering_and_Other/bun-advanced.md — Bun Advanced Topics
  - ../../../../Global_References/Software_Engineering_and_Other/bun-deployment.md — Bun Deployment
  - ../../../../Global_References/Software_Engineering_and_Other/bun-ecosystem.md — Bun Ecosystem
  - ../../../../Global_References/Software_Engineering_and_Other/bun-essentials.md — Bun Essentials
  - ../../../../Global_References/Software_Engineering_and_Other/bun-fundamentals.md — Bun Fundamentals
  - ../../../../Global_References/Software_Engineering_and_Other/bun-tooling.md — Bun Tooling
## Handoff
