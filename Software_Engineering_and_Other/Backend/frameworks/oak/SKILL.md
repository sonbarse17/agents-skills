...
### Trigger
User request includes: `oak`, `oak backend`, `deno oak`, `oak middleware`, `oak router`, `deno http`, `oak context`, `oak [typescript](../../../Frontend/common/typescript/SKILL.md)`.

### Input Context
- Deno version (1.40+)
- Oak version (13.x)
- Language ([TypeScript](../../../Frontend/common/typescript/SKILL.md))
- Database (Deno KV, [MongoDB](../../../Databases/nosql/mongodb/SKILL.md) via deno_mongo, [PostgreSQL](../../../Databases/relational/postgresql/SKILL.md) via deno_postgres)
...
| [TypeScript](../../../Frontend/common/typescript/SKILL.md) context typing | Generic `State` param | `c.req.valid()` | Manual |
...
Decision: Complex middleware needs → Oak. [TypeScript](../../../Frontend/common/typescript/SKILL.md) validation-first → Hono. Max throughput/minimal → std/http.
...
- [Docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md): user `deno:alpine` image, run as non-root user
...
## Rules
- [TypeScript](../../../Frontend/common/typescript/SKILL.md) strict mode — all files .ts extension.
...
## References
  - ../../../../Global_References/Software_Engineering_and_Other/deno-runtime-guide.md — Deno Runtime Guide
  - ../../../../Global_References/Software_Engineering_and_Other/oak-middleware.md — Oak Middleware
  - ../../../../Global_References/Software_Engineering_and_Other/oak-performance.md — Oak Performance Optimization
  - ../../../../Global_References/Software_Engineering_and_Other/oak-routing-deployment.md — Oak Routing and Deployment
  - ../../../../Global_References/Software_Engineering_and_Other/oak-setup.md — Oak Setup Guide
  - ../../../../Global_References/Software_Engineering_and_Other/oak-testing.md — Oak Testing
## Handoff
