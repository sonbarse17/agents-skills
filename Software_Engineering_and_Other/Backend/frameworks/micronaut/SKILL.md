...
- Secrets: `micronaut-config-[kubernetes](../../../../DevOps_and_Cloud/containers-orchestration/kubernetes/other/kubernetes/SKILL.md)` or environment variables; never hardcoded
