...
# [Python](../../../Languages/python/python/SKILL.md) Django Architecture
...
- Use `prefetch_related()` for M2M/O2M (separate query, merged in [Python](../../../Languages/python/python/SKILL.md))
...
- [Sentry](../../../../DevOps_and_Cloud/observability-monitoring-logging/sentry/other/sentry/SKILL.md) integration for error tracking. Performance [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) enabled.
...
- Secrets: environment variables. Never [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) `.env` files.
## Performance Optimization
