...
Use this skill when:
- Building real-time collaborative apps (chat, [dashboards](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md), multiplayer)
