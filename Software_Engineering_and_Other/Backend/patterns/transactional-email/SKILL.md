...
- Store API keys in secrets manager (AWS Secrets Manager, HashiCorp [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md)), never in code or env files committed to git
