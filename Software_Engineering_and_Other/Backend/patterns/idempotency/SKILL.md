...
What are your latency and consistency requirements?
  ...
  └── DynamoDB → [Serverless](../../../Patterns/data-performance/serverless/SKILL.md), auto-scaling, TTL built-in
...
| DynamoDB | ~10ms | Full | Built-in | Per-use | [Serverless](../../../Patterns/data-performance/serverless/SKILL.md), AWS |
...
- Log all idempotency key hits for [audit](../../../../AI_and_Agents/Operations/common/audit/SKILL.md)
