...
useradd -m -s /bin/bash -G [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md),developers,ssh-users -c "Dev User" devuser
```
...
usermod -aG [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md),developers jsmith
...
# Allow ops team to run [docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md) commands only
%ops ALL=(ALL) NOPASSWD: /usr/bin/[docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md), /usr/bin/[docker-compose](../../../DevOps_and_Cloud/Containers_and_Orchestration/[docker](../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-compose/SKILL.md)
...
jsmith dbservers=(root) /usr/bin/systemctl restart [postgresql](../../../Databases/relational/postgresql/SKILL.md)
...
# Example: jsmith,Jane Smith,developers;[docker](../../../../DevOps_and_Cloud/containers-orchestration/docker/other/docker/SKILL.md),/bin/bash
...
- `[linux-administration](../../../Miscellaneous/os-admin/linux-administration/SKILL.md)` -- General Linux server management
- `[ssh-configuration](../../../Miscellaneous/os-admin/ssh-configuration/SKILL.md)` -- SSH key-based authentication for managed users
- `[systemd-services](../../../Miscellaneous/os-admin/systemd-services/SKILL.md)` -- Service accounts and systemd user instances
