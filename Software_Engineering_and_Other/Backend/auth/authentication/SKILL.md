...
- Auth provider (Auth0, Clerk, [Supabase](../../data-access/supabase/SKILL.md), [Firebase](../../../Databases/nosql/firebase/SKILL.md), Cognito, custom)
...
Team size and requirements?
  ...
  |     |-- Want database integration? --> [Supabase](../../data-access/supabase/SKILL.md) Auth
  |     |-- Need social login quick? --> [Firebase](../../../Databases/nosql/firebase/SKILL.md) Auth
...
// [Supabase](../../data-access/supabase/SKILL.md)
import { createClient } from '@[supabase](../../data-access/supabase/SKILL.md)/[supabase](../../data-access/supabase/SKILL.md)-js'
const [supabase](../../data-access/supabase/SKILL.md) = createClient(SUPABASE_URL, SUPABASE_ANON_KEY)
...
#### [Supabase](../../data-access/supabase/SKILL.md)
```[typescript](../../../Frontend/common/typescript/SKILL.md)
import { createClient, User } from '@[supabase](../../data-access/supabase/SKILL.md)/[supabase](../../data-access/supabase/SKILL.md)-js'
...
function useSupabaseAuth() {
  ...
  useEffect(() => {
    [supabase](../../data-access/supabase/SKILL.md).auth.getSession().then(({ data: { session } }) => {
      setUser(session?.user ?? null)
    })
    const { data: { subscription } } = [supabase](../../data-access/supabase/SKILL.md).auth.onAuthStateChange((_event, session) => {
      setUser(session?.user ?? null)
    })
    return () => subscription.unsubscribe()
  }, [])

  const loginWithGoogle = () => [supabase](../../data-access/supabase/SKILL.md).auth.signInWithOAuth({ provider: 'google' })
  const loginWithEmail = (email: string, password: string) =>
    [supabase](../../data-access/supabase/SKILL.md).auth.signInWithPassword({ email, password })
  const logout = () => [supabase](../../data-access/supabase/SKILL.md).auth.signOut()
...
| [Supabase](../../data-access/supabase/SKILL.md) | OAuth2, email/pw | 10+ providers | Yes | No | Free tier: 50K users |
| [Firebase](../../../Databases/nosql/firebase/SKILL.md) | OAuth2, email/pw, phone | 10+ providers | Yes | No | Free tier: 10K auth |
