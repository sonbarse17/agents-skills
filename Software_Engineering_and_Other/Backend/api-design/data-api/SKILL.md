...
- [ ] API [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) and logging set up
...
```yaml
# [docker-compose](../../../DevOps_and_Cloud/Containers_and_Orchestration/[docker](../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-compose/SKILL.md).hasura.yaml
version: "3.8"
services:
  postgres:
    image: postgres:16
...
### Step 8: API [Monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) and [Observability](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md)
...
[monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md):
  ...
  tracing:
    - [OpenTelemetry](../../../../DevOps_and_Cloud/observability-monitoring-logging/opentelemetry/other/opentelemetry/SKILL.md) for request tracing
...
## References
  - ../../../../Global_References/Software_Engineering_and_Other/data-api-error-handling.md — Data API Error Handling
  - ../../../../Global_References/Software_Engineering_and_Other/data-api-patterns.md — Data API Patterns
  - ../../../../Global_References/Software_Engineering_and_Other/data-api-security.md — Data API Security Reference
  - ../../../../Global_References/Software_Engineering_and_Other/data-api-versioning.md — Data API Versioning
  - ../../../../Global_References/Software_Engineering_and_Other/graphql-for-data.md — GraphQL for Data Reference
  - ../../../../Global_References/Software_Engineering_and_Other/hasura-postgrest.md — Hasura & PostgREST
...
- **Secrets management**: Store API keys and DB credentials in [vault](../../../../Security/cryptography-secrets/vault/SKILL.md) (HashiCorp [Vault](../../../../Security/cryptography-secrets/vault/SKILL.md), AWS Secrets Manager).

## Handoff
`[data-data-platform](../../../../Data_Engineering/data-platform/SKILL.md)` for deployment infrastructure. `[data-data-catalog](../../../../Data_Engineering/data-catalog/SKILL.md)` for API endpoint documentation. `[data-data-observability](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md)/SKILL.md)` for API [monitoring](../../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md). `[data-data-contracts](../../../../Data_Engineering/data-contracts/SKILL.md)` for API schema contracts.
