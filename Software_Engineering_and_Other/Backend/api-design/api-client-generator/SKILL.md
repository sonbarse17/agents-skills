...
Generated Artifacts (models, API clients, enums, interceptors)
    ↓
Integration (install as package, [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) generated code, or build step)
    ↓
...
```yaml
# .[github](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)/workflows/api-client-update.yml
  ...
  generate:
    ...
    steps:
      ...
      - name: Generate client
        run: |
          npm run generate-api -- --spec-url ${{ [github](../../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md).event.inputs.spec_url }}
      ...
      - name: Create PR
        ...
        run: |
          ...
          git [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) -m "chore: update API client from spec"
...
| Generate at build time (not [commit](../../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md)) | Always fresh, no stale generated code in repo |
