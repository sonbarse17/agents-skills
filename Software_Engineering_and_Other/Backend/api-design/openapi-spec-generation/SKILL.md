...
Full template library and detailed worked examples live in `../../../references/openapi-spec-generation_details.md`. Read that file when you need the concrete templates.
