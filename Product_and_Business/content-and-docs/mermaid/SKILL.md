...
See `../../references/gitgraph.md` for [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) types, cherry-pick, branch ordering, orientation, and theming.
...
See `../../references/mermaid_architecture.md` for edges, groups, junctions, alignment, layout tuning, and icons.
...
- `../../references/gitgraph.md` — [Commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) types, tags, cherry-pick, branch ordering, orientation, config, themes
...
- `../../references/mermaid_architecture.md` — Groups, services, edges, junctions, alignment, layout tuning, icons
