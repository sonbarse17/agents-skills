...
See `../../Global_References/Product_and_Business/flowchart.md` for all 30+ shapes, link types, subgraph options, and styling.
...
See `../../Global_References/Product_and_Business/sequence.md` for all arrow types, message grouping, notes, activations, and styling.
...
See `../../Global_References/Product_and_Business/gantt.md` for metadata syntax, section handling, dependencies, and styling.
...
See `../../Global_References/Product_and_Business/class.md` for all relationship types, annotations, generics, and styling.
...
See `../../Global_References/Product_and_Business/state.md` for composite states, choice, fork, concurrency, and styling.
...
See `../../Global_References/Product_and_Business/er.md` for cardinality, identification, attributes, keys, subgraphs, and styling.
...
See `../../Global_References/Product_and_Business/journey.md` for full syntax.
...
See `../../Global_References/Product_and_Business/quadrant.md` for axis config, point styling, classes, and theme variables.
...
See `../../Global_References/Product_and_Business/xychart.md` for config options, axis config, theme variables, and data labels.
...
See `../../Global_References/Product_and_Business/pie.md` for config options.
...
See `../../Global_References/Product_and_Business/mermaid_architecture.md` for edges, groups, junctions, alignment, layout tuning, and icons.
...
See `../../Global_References/Product_and_Business/block.md` for shapes, edges, composite blocks, styling, and layout.
...
See `../../Global_References/Product_and_Business/requirement.md` for types, relationships, styling, and direction.
...
See `../../Global_References/Product_and_Business/treemap.md` for config options, value formatting, and styling.
...
See `../../Global_References/Product_and_Business/mindmap.md` for shapes, icons, classes, and layouts.
...
See `../../Global_References/Product_and_Business/timeline.md` for sections, direction, styling, and themes.
...
See `../../Global_References/Product_and_Business/sankey.md` for CSV syntax, config, and node colors.
...
- `../../Global_References/Product_and_Business/flowchart.md` — All node shapes (30+), link types, subgraphs, styling, icons, markdown strings
- `../../Global_References/Product_and_Business/sequence.md` — Arrow types, loops, alt/par/critical/break, notes, activations, styling
- `../../Global_References/Product_and_Business/gantt.md` — Date format, axis format, duration units, excludes, milestones, compact mode, today marker
...
- `../../Global_References/Product_and_Business/pie.md` — showData, donut mode, legend position, highlight slice, config
- `../../Global_References/Product_and_Business/mermaid_architecture.md` — Groups, services, edges, junctions, alignment, layout tuning, icons
- `../../Global_References/Product_and_Business/block.md` — Columns, shapes, composite blocks, edges, space blocks, styling
- `../../Global_References/Product_and_Business/requirement.md` — Types, elements, relationships, direction, styling
- `../../Global_References/Product_and_Business/treemap.md` — Node hierarchy, styling, value formatting, config options
- `../../Global_References/Product_and_Business/mindmap.md` — Shapes, icons, classes, markdown strings, layouts
- `../../Global_References/Product_and_Business/timeline.md` — Time periods, events, sections, direction, styling, themes
- `../../Global_References/Product_and_Business/sankey.md` — CSV syntax, link colors, node alignment, label style, node colors
