...
description: Use when authoring or repairing a coordinate-explicit JSON
...
See `../../Global_References/Product_and_Business/layout-contract.md` for the compact schema and repair guidance.
