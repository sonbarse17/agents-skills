...
```markdown
# ADR-001: Use [PostgreSQL](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) for primary database
...
## Decision
Use [PostgreSQL](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) with Prisma ORM.

## Alternatives Considered

### [MongoDB](../../../Software_Engineering_and_Other/Databases/nosql/mongodb/SKILL.md)
...
- Cons: [PostgreSQL](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) has better JSON support, full-text search, and ecosystem tooling
- Rejected: [PostgreSQL](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) is the better fit for our feature requirements

## Consequences
- Prisma provides type-safe database access and migration management
- We can use [PostgreSQL](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md)'s full-text search instead of adding Elasticsearch
- Team needs [PostgreSQL](../../../Software_Engineering_and_Other/Databases/relational/postgresql/SKILL.md) knowledge (standard skill, low risk)
