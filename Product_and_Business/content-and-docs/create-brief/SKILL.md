...
- [master-orchestrator](../../planning-and-tracking/master-orchestrator/SKILL.md) has routed here, OR user has directly asked for a brief.
...
Next skill: [create-prd](../../product-management/create-prd/SKILL.md)
```
...
| PRD ([create-prd](../../product-management/create-prd/SKILL.md)) | Detailed functional requirements | Structured PRD artifact | After brief is approved |
...
```
create-brief --> [create-prd](../../product-management/create-prd/SKILL.md) --> create-stories --> create-roadmap
     |                                  |
     v                                  v
  [design-systems](../../../Software_Engineering_and_Other/Frontend/ui-ux/design-systems/SKILL.md)                    architecture
  (if needed)                       (if needed)
```
