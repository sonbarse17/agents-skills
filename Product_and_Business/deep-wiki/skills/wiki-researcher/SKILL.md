...
**Each iteration should include at least 1 [Mermaid](../../../mermaid/SKILL.md) diagram and 1 structured table** to make findings scannable and engaging.
...
- Include [Mermaid](../../../mermaid/SKILL.md) diagrams (dark-mode colors) when they clarify architecture or flow — add `<!-- Sources: ... -->` comment block after each diagram
