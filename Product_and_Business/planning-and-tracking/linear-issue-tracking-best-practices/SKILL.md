...
8. **Sync Linear with an external system (Slack, [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md), an [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md)
   ...
   common cases ([GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) PR status linking issue state automatically,
...
- Reserve Projects for genuinely cross-cycle, multi-person initiatives;
  ...
  exists.
- Prefer Linear's native integrations ([GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md), Slack, [Sentry](../../../DevOps_and_Cloud/observability-monitoring-logging/sentry/other/sentry/SKILL.md), etc.)
...
- When comparing to Jira for a new team, be concrete about the actual
  ...
  [jira-ticket-best-practices-and-workflow](../../../enterprise-collaboration/skills/[jira-ticket-best-practices-and-workflow](../jira-ticket-best-practices-and-workflow/SKILL.md)/SKILL.md)
  and, for full ITSM, [servicenow-itsm-integration](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/servicenow-itsm-integration/SKILL.md)/SKILL.md))
...
- **Symptom:** A team's Cycles routinely carry over 30-40% of committed
  ...
  **Fix:** The team is committing to a wish list, not real [capacity](../../AI_and_Agents/Infrastructure/deploy-model/[capacity](../../DevOps_and_Cloud/Cloud_Providers/azure-skills/skills/microsoft-foundry/models/deploy-model/[capacity](../../DevOps_and_Cloud/Observability_and_SecOps/capacity/SKILL.md)/SKILL.md)/SKILL.md) —
  ...
  [commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md) to that number going forward (step 3), rather than treating
...
- **Symptom:** A custom webhook-based sync between Linear and an
  ...
  **Fix:** Check whether Linear's native integration for that tool
  ([GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md), Slack, [Sentry](../../../DevOps_and_Cloud/observability-monitoring-logging/sentry/other/sentry/SKILL.md), and others) already covers the actual need
...
Triage handling, and a [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md)-driven issue-creation automation for
...
[GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) integration (native, not custom) automatically transitions
...
- [servicenow-itsm-integration](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/servicenow-itsm-integration/SKILL.md)/SKILL.md) —
