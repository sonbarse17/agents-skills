...
Is the product category well-understood by the team?
  ...
  |-- NO --> Do you have competitive analysis?
        ...
        |-- NO  --> Start with [create-brief](../../content-and-docs/create-brief/SKILL.md) first, then PRD after research
...
- If no brief exists, route to [create-brief](../../content-and-docs/create-brief/SKILL.md) first. Output: "No brief found. Activate [create-brief](../../content-and-docs/create-brief/SKILL.md) to define the product scope first."
...
| Availability | Uptime | 99.9% | [Monitoring](../../../DevOps_and_Cloud/observability-monitoring-logging/common/monitoring-strategy/monitoring/SKILL.md) |
...
- **Story tracking**: Jira, Linear, Asana, Trello, [GitHub](../../../DevOps_and_Cloud/ci-cd/github-actions/other/github/SKILL.md) Issues, Shortcut.
