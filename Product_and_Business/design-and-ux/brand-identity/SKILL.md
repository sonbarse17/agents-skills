...
## Handoff
Hand off to `[design-visual-design](../../../Software_Engineering_and_Other/Frontend/ui-ux/visual-design/SKILL.md)` for visual system implementation. Hand off to `design-[design-systems](../../../Software_Engineering_and_Other/Frontend/ui-ux/design-systems/SKILL.md)` for token/component implementation. Hand off to `[design-ux-research](../../research-and-strategy/ux-research/SKILL.md)` for audience validation.
