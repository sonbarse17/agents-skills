...
## Handoff
For persona insights to inform journey stages, hand off to `[product-persona-development](../../research-and-strategy/persona-development/SKILL.md)`. For analytics event tracking, hand off to `[product-analytics](../../research-and-strategy/analytics/SKILL.md)`. For user research validation, hand off to `[product-user-research](../../research-and-strategy/user-research/SKILL.md)`. For experiment execution on journey touchpoints, hand off to `[product-ab-testing](../../research-and-strategy/ab-testing/SKILL.md)`. For growth metric tracking across journey stages, hand off to `[product-growth-engineering](../../research-and-strategy/growth-engineering/SKILL.md)`.
