...
### Trigger
Exact user phrases: "information architecture" "sitemap" "user flow" "content hierarchy" "navigation" "content organization" "labeling" "taxonomy" "card sorting" "tree testing" "findability" "IA [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md)".
...
### Output Artifact
Information architecture specification with content [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md), sitemap, navigation design, taxonomy, and user flows.

### Response Format
```
## Information Architecture Plan
### Content [Audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) Summary
...
### Completion Criteria
- [ ] Content [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) completed with inventory and gap analysis
...
### Step 1: Content [Audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md)
...
Content [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) template:
...
Content [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) analysis outputs:
...
| Content migration without IA review | Moving content to new design without restructuring | Always conduct content [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) and IA review during redesign |
...
### Content [Audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) Template (Spreadsheet)
```
...
- Content [audit](../../../AI_and_Agents/Operations/common/audit/SKILL.md) must be conducted before any IA redesign of existing products.
