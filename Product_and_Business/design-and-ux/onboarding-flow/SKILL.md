...
## Handoff
For analytics tracking of onboarding metrics, hand off to `[product-analytics](../../research-and-strategy/analytics/SKILL.md)`. For A/B testing onboarding changes, hand off to `[product-ab-testing](../../research-and-strategy/ab-testing/SKILL.md)`.
