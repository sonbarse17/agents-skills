...
See `../../../Global_References/gitgraph.md` for [commit](../../ci-cd/common/git-workflow/commit/SKILL.md) types, cherry-pick, branch ordering, orientation, and theming.
...
- `../../../Global_References/gitgraph.md` — [Commit](../../ci-cd/common/git-workflow/commit/SKILL.md) types, tags, cherry-pick, branch ordering, orientation, config, themes
