...
| Best for | Invoices, contracts, compliance | Financials, data analysis | Data export, ETL | [Dashboards](../../observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md), email |
