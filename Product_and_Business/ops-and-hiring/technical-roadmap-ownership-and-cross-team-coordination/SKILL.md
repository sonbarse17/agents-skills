...
[incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) rates, declining velocity, and an eventual forced rewrite under
...
1. **Build (or refresh) the technical debt and platform-gap inventory
   ...
   user/team-facing cost if left unaddressed (increasing [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) rate,
...
2. **Sequence using an explicit allocation framework**, not case-by-case
   ...
   - 15% platform/infrastructure investment: work that reduces future
     ...
     harness, a CI speed improvement, an [observability](../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md) gap).
   ...
   (rising [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) rate, slowing delivery, an eventual unplanned
...
3. **Prioritize within each bucket using cost/impact, not recency or
   ...
   recurring toil/manual-fix patterns from [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) postmortems directly
...
- Frame cross-team conflicts around underlying requirements, not the
  ...
  needs are.
- Use data ([incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) rates, before/after pilot results, actual adoption
...
- **Symptom:** The roadmap has been 100% committed feature work for
  ...
  reprioritized down, and the team's [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) rate and average
...
1. **Inventory refresh**: the team's tech-debt inventory shows the order
   ...
   and the payment-retry logic from a prior [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md)'s postmortem action
...
2. **Allocation**: the team commits to 60% feature (two committed
   ...
   [observability](../../../DevOps_and_Cloud/observability-monitoring-logging/common/fundamentals/observability/SKILL.md) initiative another team is leading) — published in the
...
5. **Standard adoption, in parallel**: the tech lead has been trying to
   ...
   one willing team, publish that team's 30% faster [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md) triage time
...
- [system-design-technology-selection-and-decision-records](../../../AI_and_Agents/Architecture/enterprise-architecture/system-design-technology-selection-and-decision-records/SKILL.md)/SKILL.md) — the architect-level escalation path for a cross-team conflict or constraint question that can't be resolved by influence alone, and for standards that need to become an organization-wide architectural decision rather than a bottom-up pilot.
