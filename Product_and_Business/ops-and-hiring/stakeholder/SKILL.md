...
through structured reporting (status [dashboards](../../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md), highlight
...
│   ├── One-page [dashboards](../../../DevOps_and_Cloud/observability-monitoring-logging/common/dashboard-design/dashboards/SKILL.md) with RAG status
...
security [incident](../../../DevOps_and_Cloud/observability-monitoring-logging/common/incident-detection/incident/SKILL.md), stakeholder complaint escalation.
...
5. [Commit](../../../DevOps_and_Cloud/ci-cd/common/git-workflow/commit/SKILL.md): document agreement with owner and deadline.
...
## References
  - ../../Global_References/Product_and_Business/communication-plan.md — Communication Plan
  - ../../Global_References/Product_and_Business/stakeholder-advanced.md — Stakeholder Advanced Topics
  - ../../Global_References/Product_and_Business/stakeholder-fundamentals.md — Stakeholder Fundamentals
  - ../../Global_References/Product_and_Business/stakeholder-management.md — Stakeholder Management
  - ../../Global_References/Product_and_Business/stakeholder-mapping.md — Stakeholder Mapping
  - ../../Global_References/Product_and_Business/status-report-template.md — Status Report Template
## Handoff
