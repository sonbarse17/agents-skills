...
description: Build robust backtesting systems for trading strategies with proper
  handling of look-ahead bias, survivorship bias, and transaction costs. Use
...
Detailed sections (starting with `## Implementation Patterns`) live in `../../references/backtesting-frameworks_details.md`. Read that file when the navigation summary above is insufficient.
