...
### With Customer Journey Mapping ([product-customer-journey](../../design-and-ux/customer-journey/SKILL.md))
...
### With User Story Mapping (planning-[create-story](../../planning-and-tracking/create-story/SKILL.md))
...
## Handoff
For journey mapping with persona context, hand off to `[product-customer-journey](../../design-and-ux/customer-journey/SKILL.md)`. For user research to validate personas, hand off to `[product-user-research](../user-research/SKILL.md)`. For feature prioritization using persona scores, hand off to `product-feature-prioritization`.
