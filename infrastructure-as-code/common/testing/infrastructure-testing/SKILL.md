...
- **Push failures as far left as possible** — a mistake caught by a linter costs nothing; the same
  mistake caught by a failed production apply costs an [incident](../../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md).
...
right, without provisioning anything real. See `[terraform-modules](../../../terraform/modules/terraform-modules/SKILL.md)` for the module structure this
tests against.
