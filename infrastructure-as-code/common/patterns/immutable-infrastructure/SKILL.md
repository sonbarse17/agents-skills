...
- **Remove standing SSH access for config changes** — break-glass access for genuine [incident](../../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md)
...
- **Treat any manual change discovered on a running instance as an [incident](../../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md)**, not a shortcut that
