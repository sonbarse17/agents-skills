...
discipline applies equally to [CloudFormation](../../../cloudformation/other/cloudformation/SKILL.md), [Pulumi](../../../pulumi/other/pulumi/SKILL.md), or Bicep.
...
it becomes an [incident](../../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md): a renamed resource that Terraform reads as destroy-then-create, a
...
`[terraform-modules](../../../terraform/modules/terraform-modules/SKILL.md)` for how to design the interface once you're actually there.
