...
That's the same class of risk as an unpinned base image — see `[immutable-infrastructure](../../../common/patterns/immutable-infrastructure/SKILL.md)` for the
...
`[infrastructure-testing](../../../common/testing/infrastructure-testing/SKILL.md)` for the broader discipline this belongs to.
