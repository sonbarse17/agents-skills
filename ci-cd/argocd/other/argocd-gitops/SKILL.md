...
# [ArgoCD](../argocd/SKILL.md) [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)

Implement declarative continuous delivery for [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) with [ArgoCD](../argocd/SKILL.md).

## When to Use This Skill

Use this skill when:
- Implementing [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md) workflows for [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)
...
- [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) cluster with [ArgoCD](../argocd/SKILL.md) installed
- [kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) configured
...
```bash
# Create namespace
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) create namespace [argocd](../argocd/SKILL.md)

# Install [ArgoCD](../argocd/SKILL.md)
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply -n [argocd](../argocd/SKILL.md) -f https://raw.githubusercontent.com/argoproj/[argo-cd](../argo-cd/SKILL.md)/stable/manifests/install.yaml

# Get admin password
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) -n [argocd](../argocd/SKILL.md) get secret [argocd](../argocd/SKILL.md)-initial-admin-secret \
  -o jsonpath="{.data.password}" | base64 -d

# Port forward to access UI
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) port-forward svc/[argocd](../argocd/SKILL.md)-server -n [argocd](../argocd/SKILL.md) 8080:443
...
spec:
  project: default
  source:
    repoURL: https://[github](../../../github-actions/other/github/SKILL.md).com/org/myapp-manifests.git
    targetRevision: main
...
spec:
  project: default
  source:
    repoURL: https://[github](../../../github-actions/other/github/SKILL.md).com/org/myapp-chart.git
    targetRevision: main
    path: charts/myapp
    helm:
      valueFiles:
...
### [Kustomize](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kustomize/SKILL.md) Application

```yaml
apiVersion: argoproj.io/v1alpha1
kind: Application
metadata:
  name: myapp-[kustomize](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kustomize/SKILL.md)
  namespace: [argocd](../argocd/SKILL.md)
spec:
  project: default
  source:
...
spec:
  ...
  sourceRepos:
    - https://[github](../../../github-actions/other/github/SKILL.md).com/org/*
  destinations:
    - namespace: myapp-*
      server: https://[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md).default.svc
...
```yaml
# In [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) manifests
apiVersion: v1
kind: ConfigMap
metadata:
  name: myconfig
...
stringData:
  url: https://[github](../../../github-actions/other/github/SKILL.md).com/org/private-repo.git
  username: git
  password: ghp_xxxx
---
# SSH key
...
metadata:
  ...
  labels:
    [argocd](../argocd/SKILL.md).argoproj.io/secret-type: repository
stringData:
  url: git@[github](../../../github-actions/other/github/SKILL.md).com:org/private-repo.git
  sshPrivateKey: |
...
- [kustomize](../[kustomize](../kustomize/SKILL.md)/) - [Kustomize](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kustomize/SKILL.md) overlays
