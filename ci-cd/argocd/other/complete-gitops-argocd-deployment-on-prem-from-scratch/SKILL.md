...
# Complete [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)/Argo CD Deployment On-Prem, From Scratch
...
[Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)-native `ServiceAccount` tokens and RBAC, ideally made
short-lived via HashiCorp [Vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)'s [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) secrets engine rather than a
...
- Starting from a bare, already-provisioned self-managed [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)
  cluster (kubeadm, k3s, Cluster API, or a vendor distribution) with
  nothing [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)-related installed, needing a working Argo CD + first
...
- The user explicitly wants cluster-access credentials issued by [Vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)
  (short-lived) instead of a permanent [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) Secret bearer token.
- Standing up a second/third on-prem environment (a separate physical
  cluster or air-gapped site) for a service already [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)-managed
  elsewhere.
- Migrating a team off manual `[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply`/`helm upgrade` deploys on
  on-prem infrastructure onto a full [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md) flow, starting from zero.
...
- A self-managed [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) cluster already provisioned and reachable via
  `[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md)` — [bare-metal](../../../../AI_and_Agents/Models_and_FineTuning/bare-metal/SKILL.md)/VMware provisioning patterns are covered by
...
- `helm` ≥ 3.12, `[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md)`, and cluster-admin access to create
...
```bash
helm repo add argo https://argoproj.[github](../../../github-actions/other/github/SKILL.md).io/argo-helm
helm repo update
helm install [argocd](../argocd/SKILL.md) argo/[argo-cd](../argo-cd/SKILL.md) \
  --namespace [argocd](../argocd/SKILL.md) --create-namespace \
  --version 7.6.12 \
  --set server.service.type=ClusterIP
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) get pods -n [argocd](../argocd/SKILL.md)
```
...
back to [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)-native credentials, scoped as narrowly as possible per
...
credentials instead**: configure [Vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)'s [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) secrets engine (or a
...
path "[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)/creds/[argocd](../argocd/SKILL.md)-manager" { capabilities = ["read"] }
EOF
```
See
[vault-operations-and-pki-engine-configuration](../../../[security-scanning](../../../Security/security-scanning/SKILL.md)-tooling/skills/[vault-operations-and-pki-engine-configuration](../[vault](../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)-operations-and-pki-engine-configuration/SKILL.md)/SKILL.md)
...
```bash
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) create secret [docker](../../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-registry harbor-pull-secret \
  --[docker](../../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-server=harbor.internal.example.com \
  --[docker](../../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-username=[argocd](../argocd/SKILL.md)-reader \
  --[docker](../../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-password="${HARBOR_ROBOT_TOKEN}" \
...
via [cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../../../DevOps_and_Cloud/Containers_and_Orchestration/cert-manager-tls-automation/SKILL.md)/SKILL.md)'s
  ...
  [vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md):
    ...
    auth:
      [kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md):
        role: cert-manager
        mountPath: /v1/auth/[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)
```
...
in full:
```bash
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply -f payments-api-staging-application.yaml
...
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) get secret harbor-pull-secret -n [argocd](../argocd/SKILL.md) -o jsonpath='{.data.\.dockerconfigjson}' | base64 -d
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) get certificate -n [argocd](../argocd/SKILL.md) [argocd](../argocd/SKILL.md)-server-tls -o jsonpath='{.status.conditions}'
```
Confirm the Harbor pull secret's embedded token is still valid (robot
tokens can expire independently of the [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) Secret they're stored
...
- **Symptom:** A Harbor `imagePullSecret` worked at initial setup and later
  ...
  **Fix:** Harbor robot account tokens have their own expiration
  independent of the [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) Secret storing them — check the robot
  account's expiry in Harbor directly (`[docker](../../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md) login` manually against the
...
- **Symptom:** cert-manager's internal-CA `ClusterIssuer` ([Vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)-backed)
  ...
  though `[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) describe certificate` shows `Ready: True`.
...
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply -f metallb-ip-pool.yaml
...
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply -f [argocd](../argocd/SKILL.md)-manager-rbac.yaml --context payments-staging

# Phase 3 — Harbor pull secret + internal-CA Ingress
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) create secret [docker](../../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-registry harbor-pull-secret \
  --[docker](../../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-server=harbor.internal.example.com \
  --[docker](../../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-username=[argocd](../argocd/SKILL.md)-reader --[docker](../../../../DevOps_and_Cloud/Containers_and_Orchestration/docker/SKILL.md)-password="${HARBOR_ROBOT_TOKEN}" -n [argocd](../argocd/SKILL.md)
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply -f [argocd](../argocd/SKILL.md)-server-ingress-internal-ca.yaml
...
- [cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../../../DevOps_and_Cloud/Containers_and_Orchestration/cert-manager-tls-automation/SKILL.md)/SKILL.md) — the internal-CA `Issuer` pattern used instead of public ACME issuance.
- [vault-operations-and-pki-engine-configuration](../../../[security-scanning](../../../Security/security-scanning/SKILL.md)-tooling/skills/[vault-operations-and-pki-engine-configuration](../[vault](../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md)-operations-and-pki-engine-configuration/SKILL.md)/SKILL.md) and [sealed-secrets-and-external-secrets-operator](../../../[security-scanning](../../../Security/security-scanning/SKILL.md)-tooling/skills/[sealed-secrets-and-external-secrets-operator](../../../../DevOps_and_Cloud/Containers_and_Orchestration/sealed-secrets-and-external-secrets-operator/SKILL.md)/SKILL.md) — standing up [Vault](../../../../Software_Engineering_and_Other/Miscellaneous/vault/SKILL.md) and syncing its issued credentials into Argo CD's cluster registration.
- [gitops-workflow](../../../devops/skills/[gitops-workflow](../[gitops](../gitops/SKILL.md)-workflow/SKILL.md)/SKILL.md) — the vendor-neutral [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md) concepts this on-prem [runbook](../../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md) implements.
