...
# Complete [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)/Argo CD Deployment on GKE, From Scratch
...
[Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) ServiceAccount to a Google service account (GSA) via the
...
- Migrating a team off manual `[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply`/`helm upgrade` deploys to GKE
...
- `helm` ≥ 3.12, `[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md)`, `gcloud` CLI, and the
   ...
   config: |
     {
       "execProviderConfig": {
         ...
         "installHint": "Install gke-gcloud-auth-plugin for use with [kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) by following https://cloud.google.com/blog/products/containers-[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)/[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md)-auth-changes-in-gke",
...
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) exec -n [argocd](../argocd/SKILL.md) deploy/[argocd](../argocd/SKILL.md)-repo-server -- gcloud auth list
```
...
- Default to manual sync until the config repo's CI gates are trusted,
  matching the EKS/AKS variants of this [runbook](../../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md).
...
- [gitops-workflow](../../../devops/skills/[gitops-workflow](../[gitops](../gitops/SKILL.md)-workflow/SKILL.md)/SKILL.md) — the vendor-neutral [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md) concepts this GKE-specific [runbook](../../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md) implements.
