...
## Purpose
Implement [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md) workflows using Argo CD for [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) deployments with sync strategies, application sets, multi-cluster management, and security best practices.

## Agent Protocol

### Trigger
Exact user phrases: "[ArgoCD](../argocd/SKILL.md)", "Argo CD", "[GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)", "ApplicationSet", "Sync Policy", "Sync Wave", "[argocd](../argocd/SKILL.md) CLI", "Declarative [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)", "Progressive Delivery", "Rollback".
...
- Git provider ([GitHub](../../../github-actions/other/github/SKILL.md), GitLab, Bitbucket — affects webhook config).
...
| ApplicationSet (SCM generator) | One app per [GitHub](../../../github-actions/other/github/SKILL.md) repo in org | High |
...
| SCM ([GitHub](../../../github-actions/other/github/SKILL.md)) | All repos in an org | One Application per microservice |
...
| [GitHub](../../../github-actions/other/github/SKILL.md) OAuth | Simple for small teams | Only [GitHub](../../../github-actions/other/github/SKILL.md) users |
...
data:
  ...
  repositories: |
    - url: https://[github](../../../github-actions/other/github/SKILL.md).com/myorg/[gitops](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)-config
      passwordSecret:
        name: [github](../../../github-actions/other/github/SKILL.md)-token
        key: token
...
# Install with:
# [kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply -n [argocd](../argocd/SKILL.md) -f https://raw.githubusercontent.com/argoproj/argo-cd/stable/manifests/install.yaml
# [kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply -n [argocd](../argocd/SKILL.md) -f [argocd](../argocd/SKILL.md)-cm.yaml
# [kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply -n [argocd](../argocd/SKILL.md) -f [argocd](../argocd/SKILL.md)-rbac-cm.yaml
```
...
spec:
  project: default
  source:
    repoURL: https://[github](../../../github-actions/other/github/SKILL.md).com/myorg/payment-service.git
    targetRevision: main
    path: [kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)/overlays/production
    helm:
      valueFiles:
        - values-prod.yaml
      parameters:
        - name: replicaCount
          value: "3"
    [kustomize](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kustomize/SKILL.md):
      namePrefix: prod-
  destination:
...
spec:
  generators:
    ...
    - git:
        repoURL: https://[github](../../../github-actions/other/github/SKILL.md).com/myorg/[gitops](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)-config.git
        revision: HEAD
        directories:
  ...
  template:
    ...
    spec:
      project: default
      source:
        repoURL: https://[github](../../../github-actions/other/github/SKILL.md).com/myorg/{{path.basename}}.git
        targetRevision: main
        path: [kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)/overlays/{{path[1]}}
      destination:
        server: https://[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md).default.svc
...
spec:
  ...
  template:
    ...
    spec:
      project: default
      source:
        repoURL: https://[github](../../../github-actions/other/github/SKILL.md).com/myorg/{{app}}.git
        targetRevision: main
        path: [kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)/overlays/{{metadata.labels.environment}}
      destination:
        server: '{{server}}'
        namespace: '{{app}}'
      syncPolicy:
...
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) create sa $SERVICE_ACCOUNT_NAME -n $NAMESPACE
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) create clusterrolebinding $SERVICE_ACCOUNT_NAME \
  --clusterrole=cluster-admin \
  --serviceaccount=$NAMESPACE:$SERVICE_ACCOUNT_NAME

# Get the secret token
SECRET=$([kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) get sa $SERVICE_ACCOUNT_NAME -n $NAMESPACE -o jsonpath='{.secrets[0].name}')
TOKEN=$([kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) get secret $SECRET -n $NAMESPACE -o jsonpath='{.data.token}' | base64 -d)
APISERVER=$([kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) config view --minify -o jsonpath='{.clusters[0].cluster.server}')
...
| UI | Built-in Web UI | No native UI (use Weave [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)) |
| ApplicationSets | Built-in (powerful generators) | Not built-in (use [Kustomize](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kustomize/SKILL.md)) |
| Sync mechanism | Git → desired state → apply | Git → reconcile loop |
| Health assessment | Built-in LUA scripts | [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) status |
...
| RBAC | Fine-grained policy | [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) RBAC |
...
Engineers editing resources directly with [kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) in namespaces managed by Argo CD. Argo CD treats this as drift and will self-heal (or fail if self-heal is off).
...
|---|---|---|
| OutOfSync (drift) | Manual [kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) edit | Revert manual changes; enable self-heal |
...
- Never edit Argo CD managed resources directly with [kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md).
...
- Next skill: **[gitops](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)** — [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md) principles, Flux comparison
