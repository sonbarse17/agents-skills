...
Use this skill to manage [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md) deployments with Argo CD declaratively and safely.
...
- `resources/rbac-and-projects.md` — AppProject CRD, RBAC policies, SSO, [multi-tenancy](../../../../DevOps_and_Cloud/Containers_and_Orchestration/multi-tenancy/SKILL.md)
...
argocd app create my-app \
  --repo https://[github](../../../github-actions/other/github/SKILL.md).com/org/repo \
  --path k8s/overlays/production \
  --dest-server https://[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md).default.svc \
...
- Store repository credentials as [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) secrets, not as plain-text in Application manifests.

## Related Skills

[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md), helm
