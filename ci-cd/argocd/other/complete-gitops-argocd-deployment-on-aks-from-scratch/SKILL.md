...
# Complete [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)/Argo CD Deployment on AKS, From Scratch
...
successor to the deprecated AAD Pod Identity) federates a [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)
...
- Starting from a bare, already-provisioned AKS cluster with nothing
  [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)-related installed, needing a working Argo CD + first deployed app
...
- Standing up a second/third AKS-hosted environment for a service already
  [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md)-managed in one cluster.
- Migrating a team off manual `[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) apply`/`helm upgrade` deploys to AKS
  onto a full [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md) flow, starting from zero.
...
- `helm` ≥ 3.12, `[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md)`, `az` CLI ≥ 2.60, and the **Azure Workload
  Identity webhook** already installed on the cluster (bundled by
  `--enable-workload-identity`, but confirm with
  `[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) get pods -n kube-system -l azure-workload-identity.io/system=true`).
- The `kubelogin` binary available wherever Argo CD's exec credential runs
  (baked into the `[argocd](../argocd/SKILL.md)-application-controller`/`[argocd](../argocd/SKILL.md)-server` image or
...
1. **Cross-cluster access.** For Argo CD to manage a second AKS cluster
   ...
   `[argocd](../argocd/SKILL.md)-application-controller` ServiceAccount, and grant that identity
   `Azure [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) Service Cluster User Role` plus an AKS **Azure RBAC**
   binding (`Azure [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) Service RBAC Writer`) scoped to
   `payments-staging`:
   ```bash
   az identity create --name [argocd](../argocd/SKILL.md)-cross-cluster --resource-group payments-rg
   az identity federated-credential create \
     --name [argocd](../argocd/SKILL.md)-cross-cluster-fic --identity-name [argocd](../argocd/SKILL.md)-cross-cluster \
     --resource-group payments-rg \
     --issuer "$(az aks show -n payments-prod -g payments-rg --query oidcIssuerProfile.issuerUrl -o tsv)" \
     --subject system:serviceaccount:[argocd](../argocd/SKILL.md):[argocd](../argocd/SKILL.md)-application-controller \
     --audience api://AzureADTokenExchange

   az role assignment create \
     --assignee "$(az identity show -n [argocd](../argocd/SKILL.md)-cross-cluster -g payments-rg --query principalId -o tsv)" \
     --role "Azure [Kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md) Service RBAC Writer" \
...
2. **Private ACR image pulls for `[argocd](../argocd/SKILL.md)-repo-server`** (Helm OCI charts)
   and application workloads, using the same federation mechanics shown in
   [managed-[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)-eks-aks-gke](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[managed-[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)-eks-aks-gke](../managed-[kubernetes](../kubernetes/SKILL.md)-eks-aks-gke/SKILL.md)/SKILL.md):
   ```bash
   az identity create --name [argocd](../argocd/SKILL.md)-repo-server-acr --resource-group payments-rg
   az role assignment create \
     --assignee "$(az identity show -n [argocd](../argocd/SKILL.md)-repo-server-acr -g payments-rg --query principalId -o tsv)" \
     --role AcrPull \
     --scope "$(az acr show -n paymentsregistry --query id -o tsv)"
   az identity federated-credential create \
     --name [argocd](../argocd/SKILL.md)-repo-server-fic --identity-name [argocd](../argocd/SKILL.md)-repo-server-acr \
     --resource-group payments-rg \
     --issuer "$(az aks show -n payments-prod -g payments-rg --query oidcIssuerProfile.issuerUrl -o tsv)" \
     --subject system:serviceaccount:[argocd](../argocd/SKILL.md):[argocd](../argocd/SKILL.md)-repo-server
   ```
   ```yaml
   apiVersion: v1
   kind: ServiceAccount
...
[cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../../../DevOps_and_Cloud/Containers_and_Orchestration/cert-manager-tls-automation/SKILL.md)/SKILL.md)
...
[kubectl](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubectl/SKILL.md) exec -n [argocd](../argocd/SKILL.md) deploy/[argocd](../argocd/SKILL.md)-repo-server -- az account show
```
`az account show` from inside `[argocd](../argocd/SKILL.md)-repo-server` should show the
...
az identity create --name [argocd](../argocd/SKILL.md)-cross-cluster --resource-group payments-rg
az identity federated-credential create --name [argocd](../argocd/SKILL.md)-cross-cluster-fic \
  --identity-name [argocd](../argocd/SKILL.md)-cross-cluster --resource-group payments-rg \
  --issuer "$(az aks show -n payments-prod -g payments-rg --query oidcIssuerProfile.issuerUrl -o tsv)" \
  --subject system:serviceaccount:[argocd](../argocd/SKILL.md):[argocd](../argocd/SKILL.md)-application-controller
az role assignment create \
  --assignee "$(az identity show -n [argocd](../argocd/SKILL.md)-cross-cluster -g payments-rg --query principalId -o tsv)" \
...
- [managed-[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)-eks-aks-gke](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[managed-[kubernetes](../../../../DevOps_and_Cloud/Containers_and_Orchestration/kubernetes/SKILL.md)-eks-aks-gke](../managed-[kubernetes](../kubernetes/SKILL.md)-eks-aks-gke/SKILL.md)/SKILL.md) — AKS cluster/node-pool provisioning and Workload Identity mechanics this skill assumes and builds on.
...
- [ingress-nginx-configuration](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[ingress-nginx-configuration](../../../../Software_Engineering_and_Other/Frontend/ingress-nginx-configuration/SKILL.md)/SKILL.md) and [cert-manager-tls-automation](../../../[kubernetes](../kubernetes/SKILL.md)-platform/skills/[cert-manager-tls-automation](../../../../DevOps_and_Cloud/Containers_and_Orchestration/cert-manager-tls-automation/SKILL.md)/SKILL.md) — Phase 3's Ingress/TLS mechanics.
...
- [gitops-workflow](../../../devops/skills/[gitops-workflow](../[gitops](../gitops/SKILL.md)-workflow/SKILL.md)/SKILL.md) — the vendor-neutral [GitOps](../../../../DevOps_and_Cloud/Containers_and_Orchestration/gitops/SKILL.md) concepts this AKS-specific [runbook](../../../../DevOps_and_Cloud/Observability_and_SecOps/runbook/SKILL.md) implements.
