...
- Modifies CI configuration (`.[github](../../../github-actions/other/github/SKILL.md)/workflows/`, `.[gitlab-ci](../../../gitlab-ci/pipelines/gitlab-ci/SKILL.md).yml`)
...
The first invocation of `protect-mcp sign` will create the key. [Commit](../../git-workflow/commit/SKILL.md) the
