...
rollout is how you lose a tool you'll need in the next [incident](../../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md).
...
operational kill switch nobody exercises until the [incident](../../../../DevOps_and_Cloud/Observability_and_SecOps/incident/SKILL.md) where it's needed. Both states of
