...
| Aspect | Static Typed (TS, Rust, Java) | Dynamic ([Python](../../../../Software_Engineering_and_Other/Languages/python/python/SKILL.md), JS, Ruby) |
|--------|-----------------------------|---------------------------|
...
| Performance Review | Runtime [profiling](../../../../Software_Engineering_and_Other/Frontend/performance/profiling/SKILL.md), bundle analysis, query optimization | Flame graph, bundle report | Performance-critical features, regression investigation |
...
```yaml
# [GitHub](../../../github-actions/other/github/SKILL.md) Actions: Automated review gate
...
- **Husky + lint-staged**: Pre-[commit](../../git-workflow/commit/SKILL.md) hooks for pre-review quality.

### Review Workflow Configuration

```json
// .[github](../../../github-actions/other/github/SKILL.md)/CODEOWNERS
# Default reviewer
* @team/engineering
