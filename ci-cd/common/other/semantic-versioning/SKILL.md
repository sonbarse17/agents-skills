...
- Git repository with [commit](../../git-workflow/commit/SKILL.md) history
...
```yaml
[Commit](../../git-workflow/commit/SKILL.md) Type → Version Bump:
  feat:     → MINOR
  fix:      → PATCH
...
// .versionrc.json
{
  ...
  "skip": {
    "bump": false,
    "changelog": false,
    "[commit](../../git-workflow/commit/SKILL.md)": false,
    "tag": false
  },
  "commitUrlFormat": "https://[github](../../../github-actions/other/github/SKILL.md).com/owner/repo/[commit](../../git-workflow/commit/SKILL.md)/{{hash}}",
  "compareUrlFormat": "https://[github](../../../github-actions/other/github/SKILL.md).com/owner/repo/compare/{{previousTag}}...{{currentTag}}"
}
```
...
- {{ [commit](../../git-workflow/commit/SKILL.md).message | upper_first }}\
{% endfor %}
{% endfor %}
"""
trim = true
...
commit_preprocessors = [
    { pattern = '\((\w+)\s#([0-9]+)\)', replace = "([#${2}](https://[github](../../../github-actions/other/github/SKILL.md).com/owner/repo/issues/${2}))" },
]
commit_parsers = [
...
git [commit](../../git-workflow/commit/SKILL.md) -m "chore: bump version to $NEW_VERSION"
...
if __name__ == '__main__':
    ...
    subprocess.run(['git', '[commit](../../git-workflow/commit/SKILL.md)', '-m', f'chore: bump version to {new}'])
...
**Solution**: Check [commit](../../git-workflow/commit/SKILL.md) format, verify branch configuration

### Issue: Wrong Version Calculated
**Problem**: Major/minor/patch incorrectly determined
**Solution**: Review [commit](../../git-workflow/commit/SKILL.md) analyzer rules, check for missing prefixes
...
- [git-workflow](../[git-workflow](../../CI_CD/git-workflow/SKILL.md)/) - Branching strategies
- [github-actions](../../ci-cd/[github-actions](../../CI_CD/[github](../../CI_CD/github/SKILL.md)-actions/SKILL.md)/) - CI automation
- [feature-flags](../[feature-flags](../../CI_CD/feature-flags/SKILL.md)/) - Progressive rollout
