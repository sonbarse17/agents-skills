...
unreliable and always lags reality. Generate it from [commit](../../git-workflow/commit/SKILL.md) messages (conventional commits), PR
...
upgrading" — not a raw [commit](../../git-workflow/commit/SKILL.md) dump.
...
`[continuous-delivery](../../pipeline-design/continuous-delivery/SKILL.md)` — main is always releasable, incomplete work hides behind flags. Pick
