...
- A configuration strategy that separates environment-specific values
  ...
  every environment.
- Platform support for approval gates: [GitHub](../../../github-actions/other/github/SKILL.md) Environments (protection
...
4. **Implement the gate mechanically**, don't rely on process memory.
   [GitHub](../../../github-actions/other/github/SKILL.md) Actions example using environment protection + a required
   ...
   ```
   The `production` [GitHub](../../../github-actions/other/github/SKILL.md) Environment is configured (Settings →
...
5. A PR bumping the `prod` overlay to `1.4.2` is opened, referencing the
   ...
   `production` [GitHub](../../../github-actions/other/github/SKILL.md) Environment requires one reviewer from the
