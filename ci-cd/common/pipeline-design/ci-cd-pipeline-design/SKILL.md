...
- Migrating a pipeline between platforms (e.g., [Jenkins](../../../jenkins/other/jenkins/SKILL.md) to [GitHub](../../../github-actions/other/github/SKILL.md) Actions,
  or [GitHub](../../../github-actions/other/github/SKILL.md) Actions to GitLab CI).
...
- A version-controlled repository (Git) with a CI platform already
  available or to be provisioned: [GitHub](../../../github-actions/other/github/SKILL.md) Actions, GitLab CI, [Jenkins](../../../jenkins/other/jenkins/SKILL.md),
  [CircleCI](../../../circleci/other/circleci/SKILL.md), etc. Examples below use [GitHub](../../../github-actions/other/github/SKILL.md) Actions and GitLab CI syntax.
- Repository or project admin permission to configure branch protection,
  required status checks, and CI/CD variables/secrets.
- For [GitHub](../../../github-actions/other/github/SKILL.md) Actions: Actions enabled on the repo; runner availability
  ([GitHub](../../../github-actions/other/github/SKILL.md)-hosted or self-hosted) understood, since self-hosted runners
  need their own patching/security posture.
- For GitLab CI: a configured runner (shared or project-specific) and
  `.[gitlab-ci](../../../gitlab-ci/pipelines/gitlab-ci/SKILL.md).yml` support; GitLab 15+ recommended for modern
  `rules:`/`workflow:` syntax (older `only:`/`except:` still works but is
  deprecated in favor of `rules:`).
- Secrets already stored in the platform's secret store ([GitHub](../../../github-actions/other/github/SKILL.md) Actions
...
2. **Trigger scoping.** Run the full pipeline on pushes to the default
   ...
   [GitHub](../../../github-actions/other/github/SKILL.md) Actions:
   ```yaml
   name: ci
   on:
     pull_request:
     ...
     push:
       branches: [main]
   concurrency:
     group: ci-${{ [github](../../../github-actions/other/github/SKILL.md).workflow }}-${{ [github](../../../github-actions/other/github/SKILL.md).ref }}
...
4. **Add required quality gates as required status checks**, not just as
   jobs that "happen to run." In [GitHub](../../../github-actions/other/github/SKILL.md): Settings → Branches → branch
...
5. **Add a manual approval gate before production deploy** using [GitHub](../../../github-actions/other/github/SKILL.md)
   ...
   deploy-prod:
     ...
     steps:
       - run: ./deploy.sh prod ${{ [github](../../../github-actions/other/github/SKILL.md).sha }}
   ```
   Configure `production` as a protected [GitHub](../../../github-actions/other/github/SKILL.md) environment requiring
...
`.[github](../../../github-actions/other/github/SKILL.md)/workflows/ci-cd.yml`:
```yaml
name: ci-cd
on:
  pull_request:
...
concurrency:
  group: ${{ [github](../../../github-actions/other/github/SKILL.md).workflow }}-${{ [github](../../../github-actions/other/github/SKILL.md).ref }}
  cancel-in-progress: true
...
jobs:
  ...
  deploy-staging:
    ...
    steps:
      - run: ./deploy.sh staging ${{ [github](../../../github-actions/other/github/SKILL.md).sha }}
