...
| Feature | [GitHub](../../../github-actions/other/github/SKILL.md) Actions | GitLab CI | [Jenkins](../../../jenkins/other/jenkins/SKILL.md) | [CircleCI](../../../circleci/other/circleci/SKILL.md) |
|---|---|---|---|---|
...
### Step 1: Standard Pipeline — [GitHub](../../../github-actions/other/github/SKILL.md) Actions
```yaml
name: CI/CD Pipeline
on:
  push: { branches: [main] }
...
env:
  REGISTRY: ghcr.io
  IMAGE_NAME: ${{ [github](../../../github-actions/other/github/SKILL.md).repository }}
  NODE_VERSION: "22"
...
```yaml
# .[gitlab-ci](../../../gitlab-ci/pipelines/gitlab-ci/SKILL.md).yml
stages:
  - lint
  - test
  - build
