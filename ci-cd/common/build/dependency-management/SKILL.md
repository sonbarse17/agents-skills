...
### Output Artifact
Writes to .[github](../../../github-actions/other/github/SKILL.md)/dependabot.yml, renovate.json, or .[github](../../../github-actions/other/github/SKILL.md)/renovate.json.
...
| Auto-merge | Via [GitHub](../../../github-actions/other/github/SKILL.md) Actions | Built-in (platformAutomerge) |
...
| Rate limiting | [GitHub](../../../github-actions/other/github/SKILL.md) API limits | Configurable concurrency |
| [Monorepo](../../../../Software_Engineering_and_Other/Frontend/build-tools/monorepo/SKILL.md) support | Per-directory config | Automatic workspace detection |
| Self-hosted | Via [GitHub](../../../github-actions/other/github/SKILL.md) | Via Renovate self-hosted |
...
updates:
  - package-ecosystem: "npm"
    ...
    assignees:
      - "bot-owner"
    [commit](../../git-workflow/commit/SKILL.md)-message:
      prefix: "fix"
    ...
    ignore:
      - dependency-name: "react"
        versions: [">=19.0.0"]
      - dependency-name: "[typescript](../../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md)"
  ...
  - package-ecosystem: "[github-actions](../../../DevOps_and_Cloud/CI_CD/[github](../../../DevOps_and_Cloud/CI_CD/github/SKILL.md)-actions/SKILL.md)"
    ...
    groups:
      actions:
        patterns:
          - "actions/*"
          - "[github](../../../github-actions/other/github/SKILL.md)/codeql-action/*"
```
...
jobs:
  auto-merge:
    if: contains([github](../../../github-actions/other/github/SKILL.md).event.pull_request.labels.*.name, 'automerge')
  ...
  sbom:
    ...
    steps:
      ...
      - uses: advanced-security/sbom-generator-action@v0.0.1
        id: sbom
      - uses: [github](../../../github-actions/other/github/SKILL.md)/codeql-action/upload-sarif@v3
        with:
...
.gitignoring lock files means builds are non-reproducible and vulnerability scans are inaccurate. Lock files are the source of truth for what is actually installed. Always [commit](../../git-workflow/commit/SKILL.md) lock files.
...
### Anti-Pattern 4: Not Pinning [GitHub](../../../github-actions/other/github/SKILL.md) Actions
Using @v1 or @main for [GitHub](../../../github-actions/other/github/SKILL.md) Actions means the action can change without notice, potentially breaking CI or introducing supply chain vulnerabilities. Pin to SHA or full semver tag.
...
### [Monorepo](../../../../Software_Engineering_and_Other/Frontend/build-tools/monorepo/SKILL.md) Strategy
- One Dependabot config per [monorepo](../../../../Software_Engineering_and_Other/Frontend/build-tools/monorepo/SKILL.md) with per-directory updates.
...
## Rules
- Always [commit](../../git-workflow/commit/SKILL.md) lock files -- never .gitignore them.
- Never auto-merge major version updates without manual review.
- Pin [GitHub](../../../github-actions/other/github/SKILL.md) Action versions to SHA for supply chain security.
...
- Next skill: [monorepo](../../../../Software_Engineering_and_Other/Frontend/build-tools/monorepo/SKILL.md) -- workspace dependency graph, internal packages
...
### [Monorepo](../../../../Software_Engineering_and_Other/Frontend/build-tools/monorepo/SKILL.md) vs Polyrepo Dependency Strategy

| Aspect | [Monorepo](../../../../Software_Engineering_and_Other/Frontend/build-tools/monorepo/SKILL.md) | Polyrepo |
|---|---|---|
...
### YAML: Renovate Configuration for [Monorepo](../../../../Software_Engineering_and_Other/Frontend/build-tools/monorepo/SKILL.md)
...
- Mixing **lockfiles** across environments — [commit](../../git-workflow/commit/SKILL.md) the lockfile and regenerate on CI
...
- Split **[monorepo](../../../../Software_Engineering_and_Other/Frontend/build-tools/monorepo/SKILL.md) packages** into granular modules so consumers only install what they use
...
- Rotate **npm/[GitHub](../../../github-actions/other/github/SKILL.md) tokens** with minimal scopes (read:packages, no write access on CI)
