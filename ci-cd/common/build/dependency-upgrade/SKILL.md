...
echo "Upgrade order:
1. [TypeScript](../../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md)
2. React
3. React Router
4. Testing libraries
...
# Step 1: Update [TypeScript](../../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md)
npm install [typescript](../../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md)@latest
...
# For [TypeScript](../../../../Software_Engineering_and_Other/Frontend/common/typescript/SKILL.md) files
...
if npm run test; then
  ...
  git [commit](../../git-workflow/commit/SKILL.md) -m "chore: upgrade package"
else
