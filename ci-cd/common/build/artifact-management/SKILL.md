...
An artifact without metadata about its source [commit](../../git-workflow/commit/SKILL.md), build pipeline run, and dependency versions
...
**Done when:** given only an artifact's digest, you can trace it back to the exact [commit](../../git-workflow/commit/SKILL.md) and
