...
- CI platform ([GitHub](../../../github-actions/other/github/SKILL.md) Actions, GitLab CI, [CircleCI](../../../circleci/other/circleci/SKILL.md), [Jenkins](../../../jenkins/other/jenkins/SKILL.md))
...
```yaml
# .[github](../../../github-actions/other/github/SKILL.md)/workflows/dbt-ci.yml
name: dbt CI
on:
  pull_request:
    branches: [main]
...
```yaml
# .[github](../../../github-actions/other/github/SKILL.md)/workflows/promote-to-prod.yml
name: Promote to Production
on:
  workflow_dispatch:
    inputs:
      [commit](../../git-workflow/commit/SKILL.md)-sha:
        description: '[Commit](../../git-workflow/commit/SKILL.md) SHA to promote'
        required: true
  ...
  diff:
    ...
    steps:
      ...
      - name: dbt data diff
        id: dbt-diff
        run: |
          git checkout ${{ [github](../../../github-actions/other/github/SKILL.md).event.inputs.[commit](../../git-workflow/commit/SKILL.md)-sha }}
  ...
  approve:
    ...
    steps:
      - name: Manual approval required
        run: echo "Approved by ${{ [github](../../../github-actions/other/github/SKILL.md).actor }}"
...
```yaml
# .[github](../../../github-actions/other/github/SKILL.md)/workflows/schema-migration.yml
