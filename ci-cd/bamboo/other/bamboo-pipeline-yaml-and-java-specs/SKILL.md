...
from the repo, closer to [GitHub](../../../github-actions/other/github/SKILL.md) Actions/GitLab CI in spirit). This skill
covers both, plus Bamboo's plan → job → stage → task hierarchy (distinct
from [GitHub](../../../github-actions/other/github/SKILL.md) Actions' workflow → job → step or GitLab's stage → job model)
...
1. **Decide Java DSL vs. YAML specs.** Java DSL gives full programmatic
   ...
   diff, and closer to what teams coming from [GitHub](../../../github-actions/other/github/SKILL.md) Actions/GitLab expect,
...
- [secure-cicd-gates](../../../../Security/common/devsecops/SKILL.md)/skills/[secure-cicd-gates](../../../../Security/app-security/secure-cicd-gates/SKILL.md)/SKILL.md) — designing the severity/blocking policy for any scan tasks added into this plan.
