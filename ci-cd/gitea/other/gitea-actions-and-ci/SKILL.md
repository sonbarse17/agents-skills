...
that intentionally mirrors [GitHub](../../../github-actions/other/github/SKILL.md) Actions' workflow YAML syntax
(`.gitea/workflows/*.yml`, `on:`/`jobs:`/`steps:`), executed by a
self-hosted **act_runner** rather than [GitHub](../../../github-actions/other/github/SKILL.md)'s managed runners. This
matters operationally because most [GitHub](../../../github-actions/other/github/SKILL.md) Actions YAML is *reusable with
caveats*, but the caveats — a smaller set of built-in contexts, no
[GitHub](../../../github-actions/other/github/SKILL.md)-hosted runner equivalent, different marketplace-action
...
- A team self-hosts Gitea (or Forgejo, a Gitea fork) and wants to enable
  built-in CI instead of bolting on an external [Jenkins](../../../jenkins/other/jenkins/SKILL.md)/Drone instance.
- Porting an existing [GitHub](../../../github-actions/other/github/SKILL.md) Actions workflow to run on Gitea and hitting
...
- Deciding which third-party [GitHub](../../../github-actions/other/github/SKILL.md) Actions marketplace actions are safe/
...
- Familiarity with [GitHub](../../../github-actions/other/github/SKILL.md) Actions workflow YAML — see
  [github-actions-single-repo-workflows](../[github-actions-single-repo-workflows](../[github-actions](../[github](../github/SKILL.md)-actions/SKILL.md)-single-repo-workflows/SKILL.md)/SKILL.md)
...
2. **Register at least one act_runner.** Download/run the `act_runner`
   ...
   [GitHub](../../../github-actions/other/github/SKILL.md)-managed `ubuntu-latest` image behind the scenes.

3. **Write the workflow under `.gitea/workflows/`, not
   `.[github](../../../github-actions/other/github/SKILL.md)/workflows/`** — this is the single most common porting
   mistake:
   ```yaml
...
4. **Verify marketplace action compatibility before relying on one.**
   Gitea Actions supports actions written for [GitHub](../../../github-actions/other/github/SKILL.md) Actions in principle
   (it runs the same `action.yml` format), but actions calling [GitHub](../../../github-actions/other/github/SKILL.md)-
   specific REST APIs (e.g. posting a check run via the [GitHub](../../../github-actions/other/github/SKILL.md) API,
   using `actions/[github](../../../github-actions/other/github/SKILL.md)-script` against `[github](../../../github-actions/other/github/SKILL.md).com` endpoints) won't
...
7. **Treat every runner host as sensitive infrastructure**, since (unlike
   [GitHub](../../../github-actions/other/github/SKILL.md)-hosted runners, which are ephemeral and managed by [GitHub](../../../github-actions/other/github/SKILL.md)) a
...
- Keep `.gitea/workflows/*.yml` syntax close to plain [GitHub](../../../github-actions/other/github/SKILL.md) Actions YAML
  (avoid Gitea-only extensions unless necessary) if there's any chance of
  needing to run the same repo on [GitHub](../../../github-actions/other/github/SKILL.md) too — this maximizes portability
  in both directions.
- Explicitly document each registered runner's labels-to-image mapping
  ...
  [GitHub](../../../github-actions/other/github/SKILL.md)'s implicit `ubuntu-latest`/`macos-latest` meaning, Gitea's labels
...
- **Symptom:** A workflow file exists in the repo but no CI ever runs, no
  ...
  **Fix:** Check the file is under `.gitea/workflows/`, not
  `.[github](../../../github-actions/other/github/SKILL.md)/workflows/` (a straight copy from a [GitHub](../../../github-actions/other/github/SKILL.md)-based repo commonly
...
- **Symptom:** A marketplace action that works fine on [GitHub](../../../github-actions/other/github/SKILL.md) Actions
  fails on Gitea with an API error or silently no-ops (e.g. an action
  that's supposed to post a PR comment via the [GitHub](../../../github-actions/other/github/SKILL.md) API does nothing).
  **Fix:** The action is calling [GitHub](../../../github-actions/other/github/SKILL.md)'s REST API directly rather than
...
after previously running the same workflow logic on [GitHub](../../../github-actions/other/github/SKILL.md) Actions.
...
`.[github](../../../github-actions/other/github/SKILL.md)/workflows/ci.yml`, changing only the path and dropping one
[GitHub](../../../github-actions/other/github/SKILL.md)-API-dependent step):
```yaml
name: ci
on:
  pull_request:
    ...
    steps:
      ...
      - name: Upload coverage artifact
        ...
        with:
          ...
          path: coverage.out
```
The team drops a previously-used `[github](../../../github-actions/other/github/SKILL.md)-script` step that posted a PR
comment via the [GitHub](../../../github-actions/other/github/SKILL.md) REST API (not compatible against a Gitea instance)
