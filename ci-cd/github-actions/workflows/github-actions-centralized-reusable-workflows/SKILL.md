...
# [GitHub](../../other/github/SKILL.md) Actions Centralized Reusable Workflows
...
immediately. [GitHub](../../other/github/SKILL.md) Actions solves this at the organization level with
...
- More than a handful of repos have near-identical `.[github](../../other/github/SKILL.md)/workflows/*.yml`
...
- Migrating from [Jenkins](../../../jenkins/other/jenkins/SKILL.md) shared libraries to [GitHub](../../other/github/SKILL.md) Actions and wanting
...
- A dedicated repository to host reusable workflows/composite actions
  (commonly `.[github](../../other/github/SKILL.md)` at the org level for org-wide defaults, or a
...
1. **Define the reusable workflow with `workflow_call` as its trigger**,
   ...
   ```yaml
   # .[github](../../other/github/SKILL.md)/workflows/standard-node-ci.yml  (in org/actions-library)
...
2. **Call it from a consumer repo with a pinned version**, keeping the
   ...
   ```yaml
   # .[github](../../other/github/SKILL.md)/workflows/ci.yml  (in org/checkout-api)
   name: ci
   on:
     pull_request:
       branches: [main]
   ...
   jobs:
     ci:
       uses: org/actions-library/.[github](../../other/github/SKILL.md)/workflows/standard-node-ci.yml@v1.3.0
       with:
         node-version: "20"
   ...
   [Jenkins](../../../jenkins/other/jenkins/SKILL.md) shared library (see
   [jenkins-centralized-shared-library](../[jenkins-centralized-shared-library](../[jenkins](../jenkins/SKILL.md)-centralized-shared-library/SKILL.md)/SKILL.md)
...
5. **Nest reusable workflows sparingly** — [GitHub](../../other/github/SKILL.md) Actions allows calling a
   reusable workflow from within another reusable workflow up to a depth
   limit (4 levels as of current [GitHub](../../other/github/SKILL.md) Actions); design the org's
...
- Pin callers to a tagged version (`@v1.3.0`) or full [commit](../../../common/git-workflow/commit/SKILL.md) SHA, never
...
- Document a clear deprecation/migration path (a fixed window, e.g. 90
  ...
  used for [Jenkins](../../../jenkins/other/jenkins/SKILL.md) shared library majors — see
  [jenkins-centralized-shared-library](../[jenkins-centralized-shared-library](../[jenkins](../jenkins/SKILL.md)-centralized-shared-library/SKILL.md)/SKILL.md).
...
- **Symptom:** Someone deletes an old reusable-workflow version tag or
  ...
  **Fix:** Before deleting a version tag or moving/renaming the
  actions-library repo, search caller repos (e.g. a [GitHub](../../other/github/SKILL.md) code search for
  `uses: org/actions-library/.[github](../../other/github/SKILL.md)/workflows/standard-node-ci.yml@v1`)
  for references still pinned to that tag/path — treat this the same as
  the "don't delete a still-referenced [Jenkins](../../../jenkins/other/jenkins/SKILL.md) shared library version"
  warning in
  [jenkins-centralized-shared-library](../[jenkins-centralized-shared-library](../[jenkins](../jenkins/SKILL.md)-centralized-shared-library/SKILL.md)/SKILL.md).
...
`org/actions-library/.[github](../../other/github/SKILL.md)/workflows/standard-node-ci.yml` (excerpt
...
jobs:
  ...
  deploy:
    needs: security-scan
    if: [github](../../other/github/SKILL.md).ref == 'refs/heads/main'
    runs-on: ubuntu-latest
    environment: staging
    steps:
...
Caller repo (`org/checkout-api/.[github](../../other/github/SKILL.md)/workflows/ci.yml`), unchanged
...
jobs:
  ci:
    uses: org/actions-library/.[github](../../other/github/SKILL.md)/workflows/standard-node-ci.yml@v1.4.0
