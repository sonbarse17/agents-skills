...
description: Create production-ready GitHub Actions workflows for automated
  testing, building, and deploying applications. Use when setting up CI/CD with
  GitHub Actions, automating development workflows, or creating reusable
  workflow templates.
tags:
  - ci_cd
...
# [GitHub](../../other/github/SKILL.md) Actions Templates

Production-ready [GitHub](../../other/github/SKILL.md) Actions workflow patterns for testing, building, and deploying applications.

## Purpose

Create efficient, secure [GitHub](../../other/github/SKILL.md) Actions workflows for continuous integration and deployment across various tech stacks.
...
env:
  REGISTRY: ghcr.io
  IMAGE_NAME: ${{ [github](../../other/github/SKILL.md).repository }}
...
```yaml
# .[github](../../other/github/SKILL.md)/workflows/reusable-test.yml
...
jobs:
  call-test:
    uses: ./.[github](../../other/github/SKILL.md)/workflows/reusable-test.yml
    with:
      node-version: "20.x"
    secrets:
...
jobs:
  security:
    ...
    steps:
      ...
      - name: Upload Trivy results to [GitHub](../../other/github/SKILL.md) Security
        uses: [github](../../other/github/SKILL.md)/codeql-action/upload-sarif@v3
        with:
...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Notify Slack
        if: success()
        uses: slackapi/slack-[github](../../other/github/SKILL.md)-action@v1
        with:
...
- `[deployment-pipeline-design](../../../common/pipeline-design/deployment-pipeline-design/SKILL.md)` - For pipeline architecture
